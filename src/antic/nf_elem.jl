...
function coeff(x::AbsSimpleNumFieldElem, n::Int)
  ...
  z = QQFieldElem()
  ccall((:nf_elem_get_coeff_fmpq, libflint), Nothing, (Ref{QQFieldElem}, Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumField}), z, x, n, parent(x))
  return z
end

function num_coeff!(z::ZZRingElem, x::AbsSimpleNumFieldElem, n::Int)
  n < 0 && throw(DomainError(n, "Index must be non-negative"))
  ccall((:nf_elem_get_coeff_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumField}), z, x, n, parent(x))
  return z
end
...
function gen(a::AbsSimpleNumField)
  ...
  ccall((:nf_elem_gen, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), r, a)
  return r
end

function one(a::AbsSimpleNumField)
  r = AbsSimpleNumFieldElem(a)
  ccall((:nf_elem_one, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), r, a)
  return r
end

function zero(a::AbsSimpleNumField)
  r = AbsSimpleNumFieldElem(a)
  ccall((:nf_elem_zero, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), r, a)
  return r
end
...
function is_gen(a::AbsSimpleNumFieldElem)
  return ccall((:nf_elem_is_gen, libflint), Bool, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), a, a.parent)
end

function isone(a::AbsSimpleNumFieldElem)
  return ccall((:nf_elem_is_one, libflint), Bool, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), a, a.parent)
end

function iszero(a::AbsSimpleNumFieldElem)
  return ccall((:nf_elem_is_zero, libflint), Bool, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), a, a.parent)
end
...
function isinteger(a::AbsSimpleNumFieldElem)
  b = ccall((:nf_elem_is_integer, libflint), Cint, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), a, a.parent)
  return Bool(b)
end
...
function is_rational(a::AbsSimpleNumFieldElem)
  b = ccall((:nf_elem_is_rational, libflint), Cint, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), a, a.parent)
  return Bool(b)
end
...
function denominator(a::AbsSimpleNumFieldElem)
  z = ZZRingElem()
  ccall((:nf_elem_get_den, libflint), Nothing, (Ref{ZZRingElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), z, a, a.parent)
  return z
end
...
function elem_from_mat_row(a::AbsSimpleNumField, b::ZZMatrix, i::Int, d::ZZRingElem)
  ...
  z = a()
  ccall((:nf_elem_set_fmpz_mat_row, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{ZZMatrix}, Int, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), z, b, i - 1, d, a)
  return z
end

function elem_to_mat_row!(a::ZZMatrix, i::Int, d::ZZRingElem, b::AbsSimpleNumFieldElem)
  ccall((:nf_elem_get_fmpz_mat_row, libflint), Nothing, (Ref{ZZMatrix}, Int, Ref{ZZRingElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), a, i - 1, d, b, b.parent)
  nothing
end
...
function -(a::AbsSimpleNumFieldElem)
  r = a.parent()
  ccall((:nf_elem_neg, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), r, a, a.parent)
  return r
end
...
function +(a::AbsSimpleNumFieldElem, b::AbsSimpleNumFieldElem)
  ...
  check_parent(a, b)
  r = a.parent()
  ccall((:nf_elem_add, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end
...
function -(a::AbsSimpleNumFieldElem, b::AbsSimpleNumFieldElem)
  ...
  check_parent(a, b)
  r = a.parent()
  ccall((:nf_elem_sub, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end
...
function *(a::AbsSimpleNumFieldElem, b::AbsSimpleNumFieldElem)
  ...
  check_parent(a, b)
  r = a.parent()
  ccall((:nf_elem_mul, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end
...
function +(a::AbsSimpleNumFieldElem, b::Int)
  r = a.parent()
  ccall((:nf_elem_add_si, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end

function +(a::AbsSimpleNumFieldElem, b::ZZRingElem)
  r = a.parent()
  ccall((:nf_elem_add_fmpz, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end

function +(a::AbsSimpleNumFieldElem, b::QQFieldElem)
  r = a.parent()
  ccall((:nf_elem_add_fmpq, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{QQFieldElem}, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end

function -(a::AbsSimpleNumFieldElem, b::Int)
  r = a.parent()
  ccall((:nf_elem_sub_si, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end

function -(a::AbsSimpleNumFieldElem, b::ZZRingElem)
  r = a.parent()
  ccall((:nf_elem_sub_fmpz, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end

function -(a::AbsSimpleNumFieldElem, b::QQFieldElem)
  r = a.parent()
  ccall((:nf_elem_sub_fmpq, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{QQFieldElem}, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end

function -(a::Int, b::AbsSimpleNumFieldElem)
  r = b.parent()
  ccall((:nf_elem_si_sub, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), r, a, b, b.parent)
  return r
end

function -(a::ZZRingElem, b::AbsSimpleNumFieldElem)
  r = b.parent()
  ccall((:nf_elem_fmpz_sub, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), r, a, b, b.parent)
  return r
end

function -(a::QQFieldElem, b::AbsSimpleNumFieldElem)
  r = b.parent()
  ccall((:nf_elem_fmpq_sub, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{QQFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), r, a, b, b.parent)
  return r
end
...
function *(a::AbsSimpleNumFieldElem, b::Int)
  r = a.parent()
  ccall((:nf_elem_scalar_mul_si, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end

function *(a::AbsSimpleNumFieldElem, b::ZZRingElem)
  r = a.parent()
  ccall((:nf_elem_scalar_mul_fmpz, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end

function *(a::AbsSimpleNumFieldElem, b::QQFieldElem)
  r = a.parent()
  ccall((:nf_elem_scalar_mul_fmpq, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{QQFieldElem}, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end
...
function ^(a::AbsSimpleNumFieldElem, n::Int)
  r = a.parent()
  ccall((:nf_elem_pow, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumField}), r, a, abs(n), a.parent)
  if n < 0
    r = inv(r)
  end
  return r
...
function ==(a::AbsSimpleNumFieldElem, b::AbsSimpleNumFieldElem)
  ...
  check_parent(a, b)
  return ccall((:nf_elem_equal, libflint), Bool, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), a, b, a.parent)
end
...
function ==(a::AbsSimpleNumFieldElem, b::ZZRingElem)
  b = ccall((:nf_elem_equal_fmpz, libflint), Cint, (Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), a, b, a.parent)
  return Bool(b)
end

function ==(a::AbsSimpleNumFieldElem, b::QQFieldElem)
  b = ccall((:nf_elem_equal_fmpq, libflint), Cint, (Ref{AbsSimpleNumFieldElem}, Ref{QQFieldElem}, Ref{AbsSimpleNumField}), a, b, a.parent)
  return Bool(b)
end

function ==(a::AbsSimpleNumFieldElem, b::Int)
  b = ccall((:nf_elem_equal_si, libflint), Cint, (Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumField}), a, b, a.parent)
  return Bool(b)
end

function ==(a::AbsSimpleNumFieldElem, b::UInt)
  b = ccall((:nf_elem_equal_ui, libflint), Cint, (Ref{AbsSimpleNumFieldElem}, UInt, Ref{AbsSimpleNumField}), a, b, a.parent)
  return Bool(b)
end
...
function inv(a::AbsSimpleNumFieldElem)
  ...
  r = a.parent()
  ccall((:nf_elem_inv, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), r, a, a.parent)
  return r
end
...
function divexact(a::AbsSimpleNumFieldElem, b::AbsSimpleNumFieldElem; check::Bool=true)
  ...
  check_parent(a, b)
  r = a.parent()
  ccall((:nf_elem_div, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end
...
function divexact(a::AbsSimpleNumFieldElem, b::Int; check::Bool=true)
  ...
  r = a.parent()
  ccall((:nf_elem_scalar_div_si, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end
...
function divexact(a::AbsSimpleNumFieldElem, b::ZZRingElem; check::Bool=true)
  iszero(b) && throw(DivideError())
  r = a.parent()
  ccall((:nf_elem_scalar_div_fmpz, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end
...
function divexact(a::AbsSimpleNumFieldElem, b::QQFieldElem; check::Bool=true)
  iszero(b) && throw(DivideError())
  r = a.parent()
  ccall((:nf_elem_scalar_div_fmpq, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{QQFieldElem}, Ref{AbsSimpleNumField}), r, a, b, a.parent)
  return r
end
...
function norm(a::AbsSimpleNumFieldElem)
  z = QQFieldElem()
  ccall((:nf_elem_norm, libflint), Nothing, (Ref{QQFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), z, a, a.parent)
  return z
end
...
function tr(a::AbsSimpleNumFieldElem)
  z = QQFieldElem()
  ccall((:nf_elem_trace, libflint), Nothing, (Ref{QQFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), z, a, a.parent)
  return z
end
...
function representation_matrix(a::AbsSimpleNumFieldElem)
  ...
  ccall((:nf_elem_rep_mat, libflint), Nothing, (Ref{QQMatrix}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), z, a, K)
  return z
end
...
function representation_matrix_q(a::AbsSimpleNumFieldElem)
  ...
  d = ZZRingElem()
  ccall((:nf_elem_rep_mat_fmpz_mat_den, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZRingElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), z, d, a, K)
  return z, d
end
...
function zero!(a::AbsSimpleNumFieldElem)
  ccall((:nf_elem_zero, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), a, parent(a))
  return a
end

function mul!(z::AbsSimpleNumFieldElem, x::AbsSimpleNumFieldElem, y::AbsSimpleNumFieldElem)
  ccall((:nf_elem_mul, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), z, x, y, parent(x))
  return z
end
...
function mul_red!(z::AbsSimpleNumFieldElem, x::AbsSimpleNumFieldElem, y::AbsSimpleNumFieldElem, red::Bool)
  ccall((:nf_elem_mul_red, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}, Cint), z, x, y, parent(x), red)
  return z
end

function addeq!(z::AbsSimpleNumFieldElem, x::AbsSimpleNumFieldElem)
  ccall((:nf_elem_add, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), z, z, x, parent(x))
  return z
end

function add!(a::AbsSimpleNumFieldElem, b::AbsSimpleNumFieldElem, c::AbsSimpleNumFieldElem)
  ccall((:nf_elem_add, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), a, b, c, a.parent)
  return a
end
...
function reduce!(x::AbsSimpleNumFieldElem)
  ccall((:nf_elem_reduce, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), x, parent(x))
  return x
end
...
function add!(c::AbsSimpleNumFieldElem, a::AbsSimpleNumFieldElem, b::QQFieldElem)
  ccall((:nf_elem_add_fmpq, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{QQFieldElem}, Ref{AbsSimpleNumField}), c, a, b, a.parent)
  return c
end

function add!(c::AbsSimpleNumFieldElem, a::AbsSimpleNumFieldElem, b::ZZRingElem)
  ccall((:nf_elem_add_fmpz, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), c, a, b, a.parent)
  return c
end

function add!(c::AbsSimpleNumFieldElem, a::AbsSimpleNumFieldElem, b::Int)
  ccall((:nf_elem_add_si, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumField}), c, a, b, a.parent)
  return c
end
...
function sub!(c::AbsSimpleNumFieldElem, a::AbsSimpleNumFieldElem, b::QQFieldElem)
  ccall((:nf_elem_sub_fmpq, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{QQFieldElem}, Ref{AbsSimpleNumField}), c, a, b, a.parent)
  return c
end

function sub!(c::AbsSimpleNumFieldElem, a::AbsSimpleNumFieldElem, b::ZZRingElem)
  ccall((:nf_elem_sub_fmpz, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), c, a, b, a.parent)
  return c
end

function sub!(c::AbsSimpleNumFieldElem, a::AbsSimpleNumFieldElem, b::Int)
  ccall((:nf_elem_sub_si, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumField}), c, a, b, a.parent)
  return c
end
...
function sub!(c::AbsSimpleNumFieldElem, a::QQFieldElem, b::AbsSimpleNumFieldElem)
  ccall((:nf_elem_fmpq_sub, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{QQFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), c, a, b, a.parent)
  return c
end

function sub!(c::AbsSimpleNumFieldElem, a::ZZRingElem, b::AbsSimpleNumFieldElem)
  ccall((:nf_elem_fmpz_sub, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), c, a, b, a.parent)
  return c
end

function sub!(c::AbsSimpleNumFieldElem, a::Int, b::AbsSimpleNumFieldElem)
  ccall((:nf_elem_si_sub, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), c, a, b, b.parent)
  return c
end
...
function mul!(c::AbsSimpleNumFieldElem, a::AbsSimpleNumFieldElem, b::QQFieldElem)
  ccall((:nf_elem_scalar_mul_fmpq, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{QQFieldElem}, Ref{AbsSimpleNumField}), c, a, b, a.parent)
  return c
end

function mul!(c::AbsSimpleNumFieldElem, a::AbsSimpleNumFieldElem, b::ZZRingElem)
  ccall((:nf_elem_scalar_mul_fmpz, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), c, a, b, a.parent)
  return c
end

function mul!(c::AbsSimpleNumFieldElem, a::AbsSimpleNumFieldElem, b::Int)
  ccall((:nf_elem_scalar_mul_si, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumField}), c, a, b, a.parent)
  return c
end
...
function (a::AbsSimpleNumField)()
  ...
  ccall((:nf_elem_set_si, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumField}), z, 0, a)
  return z
end
...
function (a::AbsSimpleNumField)(c::Int)
  z = AbsSimpleNumFieldElem(a)
  ccall((:nf_elem_set_si, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Int, Ref{AbsSimpleNumField}), z, c, a)
  return z
end
...
function (a::AbsSimpleNumField)(c::ZZRingElem)
  z = AbsSimpleNumFieldElem(a)
  ccall((:nf_elem_set_fmpz, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), z, c, a)
  return z
end

function (a::AbsSimpleNumField)(c::QQFieldElem)
  z = AbsSimpleNumFieldElem(a)
  ccall((:nf_elem_set_fmpq, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{QQFieldElem}, Ref{AbsSimpleNumField}), z, c, a)
  return z
end
...
function (a::AbsSimpleNumField)(pol::QQPolyRingElem)
  ...
  ccall((:nf_elem_set_fmpq_poly, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{QQPolyRingElem}, Ref{AbsSimpleNumField}), z, pol, a)
  return z
end
...
function (a::QQPolyRing)(b::AbsSimpleNumFieldElem)
  ...
  r = a()
  ccall((:nf_elem_get_fmpq_poly, libflint), Nothing, (Ref{QQPolyRingElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), r, b, parent(b))
  return r
end
...
function rand(rng::AbstractRNG, sp::SamplerTrivial{<:Make2{AbsSimpleNumFieldElem,AbsSimpleNumField,<:AbstractUnitRange{Int}}})
  K, r = sp[][1:end]
  R = parent(K.pol)
  n = degree(K.pol)

...
function normalise(a::ZZAbsPowerSeriesRingElem, len::Int)
  if len > 0
    c = ZZRingElem()
    ccall((:fmpz_poly_get_coeff_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), c, a, len - 1)
  end
...
function coeff(x::ZZAbsPowerSeriesRingElem, n::Int)
  ...
  z = ZZRingElem()
  ccall((:fmpz_poly_get_coeff_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), z, x, n)
  return z
end
...
function is_gen(a::ZZAbsPowerSeriesRingElem)
  return precision(a) == 0 || ccall((:fmpz_poly_is_gen, libflint), Bool, (Ref{ZZAbsPowerSeriesRingElem},), a)
end
...
function isone(a::ZZAbsPowerSeriesRingElem)
  return precision(a) == 0 || ccall((:fmpz_poly_is_one, libflint), Bool, (Ref{ZZAbsPowerSeriesRingElem},), a)
end
...
function similar(f::AbsPowerSeriesRingElem, R::ZZRing, max_prec::Int, s::Symbol=var(parent(f)); cached::Bool=true)
  z = ZZAbsPowerSeriesRingElem()
  if base_ring(f) === R && s == var(parent(f)) && f isa ZZAbsPowerSeriesRingElem && max_precision(parent(f)) == max_prec
...
function abs_series(R::ZZRing, arr::Vector{T}, len::Int, prec::Int, var::VarName=:x; max_precision::Int=prec, cached::Bool=true) where {T}
...
function -(x::ZZAbsPowerSeriesRingElem)
  z = parent(x)()
  ccall((:fmpz_poly_neg, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}), z, x)
  z.prec = x.prec
  return z
end
...
function +(a::ZZAbsPowerSeriesRingElem, b::ZZAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = prec
  ccall((:fmpz_poly_add_series, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), z, a, b, lenz)
  return z
end
...
function -(a::ZZAbsPowerSeriesRingElem, b::ZZAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = prec
  ccall((:fmpz_poly_sub_series, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), z, a, b, lenz)
  return z
end
...
function *(a::ZZAbsPowerSeriesRingElem, b::ZZAbsPowerSeriesRingElem)
  ...
  ccall((:fmpz_poly_mullow, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), z, a, b, lenz)
  return z
end
...
function *(x::Int, y::ZZAbsPowerSeriesRingElem)
  z = parent(y)()
  z.prec = y.prec
  ccall((:fmpz_poly_scalar_mul_si, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), z, y, x)
  return z
end
...
function *(x::ZZRingElem, y::ZZAbsPowerSeriesRingElem)
  z = parent(y)()
  z.prec = y.prec
  ccall((:fmpz_poly_scalar_mul_fmpz, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZRingElem}), z, y, x)
  return z
end
...
function shift_left(x::ZZAbsPowerSeriesRingElem, len::Int)
  ...
  ccall((:fmpz_poly_shift_left, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), z, x, len)
  ccall((:fmpz_poly_set_trunc, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), z, z, zlen)
  return z
end
...
function shift_right(x::ZZAbsPowerSeriesRingElem, len::Int)
  ...
  if len >= xlen
    ...
    z.prec = x.prec - len
    ccall((:fmpz_poly_shift_right, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), z, x, len)
  end
  return z
end
...
function truncate(x::ZZAbsPowerSeriesRingElem, prec::Int)
  ...
  z = parent(x)()
  z.prec = prec
  ccall((:fmpz_poly_set_trunc, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), z, x, prec)
  return z
end
...
function ^(a::ZZAbsPowerSeriesRingElem, b::Int)
  ...
  elseif b == 0
    ...
    ccall((:fmpz_poly_pow_trunc, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int, Int), z, a, b, z.prec)
  end
  return z
end
...
function ==(x::ZZAbsPowerSeriesRingElem, y::ZZAbsPowerSeriesRingElem)
  ...
  return Bool(ccall((:fmpz_poly_equal_trunc, libflint), Cint, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), x, y, n))
end
...
function isequal(x::ZZAbsPowerSeriesRingElem, y::ZZAbsPowerSeriesRingElem)
  ...
  return Bool(ccall((:fmpz_poly_equal, libflint), Cint, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}), x, y))
end
...
function ==(x::ZZAbsPowerSeriesRingElem, y::ZZRingElem)
  ...
  elseif length(x) == 1
    z = ZZRingElem()
    ccall((:fmpz_poly_get_coeff_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), z, x, 0)
...
function divexact(x::ZZAbsPowerSeriesRingElem, y::ZZAbsPowerSeriesRingElem; check::Bool=true)
  ...
  z = parent(x)()
  z.prec = prec
  ccall((:fmpz_poly_div_series, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), z, x, y, prec)
  return z
end
...
function divexact(x::ZZAbsPowerSeriesRingElem, y::Int; check::Bool=true)
  ...
  z = parent(x)()
  z.prec = x.prec
  ccall((:fmpz_poly_scalar_divexact_si, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), z, x, y)
  return z
end
...
function divexact(x::ZZAbsPowerSeriesRingElem, y::ZZRingElem; check::Bool=true)
  ...
  z = parent(x)()
  z.prec = x.prec
  ccall((:fmpz_poly_scalar_divexact_fmpz, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZRingElem}), z, x, y)
  return z
end
...
function inv(a::ZZAbsPowerSeriesRingElem)
  ...
  ainv = parent(a)()
  ainv.prec = a.prec
  ccall((:fmpz_poly_inv_series, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), ainv, a, a.prec)
  return ainv
end
...
function Base.sqrt(a::ZZAbsPowerSeriesRingElem; check::Bool=true)
  ...
  flag = Bool(ccall((:fmpz_poly_sqrt_series, libflint), Cint, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), asqrt, a, a.prec))
...
function zero!(z::ZZAbsPowerSeriesRingElem)
  ccall((:fmpz_poly_zero, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem},), z)
  z.prec = parent(z).prec_max
  return z
end

function fit!(z::ZZAbsPowerSeriesRingElem, n::Int)
  ccall((:fmpz_poly_fit_length, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Int), z, n)
  return nothing
end

function setcoeff!(z::ZZAbsPowerSeriesRingElem, n::Int, x::ZZRingElem)
  ccall((:fmpz_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Int, Ref{ZZRingElem}), z, n, x)
  return z
end
...
function addeq!(a::ZZAbsPowerSeriesRingElem, b::ZZAbsPowerSeriesRingElem)
  ...
  lenz = max(lena, lenb)
  a.prec = prec
  ccall((:fmpz_poly_add_series, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), a, a, b, lenz)
  return a
end
...
function add!(c::ZZAbsPowerSeriesRingElem, a::ZZAbsPowerSeriesRingElem, b::ZZAbsPowerSeriesRingElem)
  ...
  lenc = max(lena, lenb)
  c.prec = prec
  ccall((:fmpz_poly_add_series, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}, Int), c, a, b, lenc)
  return c
end

function set_length!(a::ZZAbsPowerSeriesRingElem, n::Int)
  ccall((:_fmpz_poly_set_length, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Int), a, n)
  return a
end

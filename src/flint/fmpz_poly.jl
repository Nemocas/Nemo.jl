...
length(x::ZZPolyRingElem) = ccall((:fmpz_poly_length, libflint), Int, (Ref{ZZPolyRingElem},), x)

function coeff(x::ZZPolyRingElem, n::Int)
  n < 0 && throw(DomainError(n, "Index must be non-negative"))
  z = ZZRingElem()
  ccall((:fmpz_poly_get_coeff_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZPolyRingElem}, Int), z, x, n)
  return z
end
...
is_gen(x::ZZPolyRingElem) = ccall((:fmpz_poly_is_gen, libflint), Bool, (Ref{ZZPolyRingElem},), x)
...
function height(a::ZZPolyRingElem)
  z = ZZRingElem()
  ccall((:fmpz_poly_height, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZPolyRingElem}), z, a)
  return z
end
...
function -(x::ZZPolyRingElem)
  z = parent(x)()
  ccall((:fmpz_poly_neg, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, x)
  return z
end
...
function +(x::ZZPolyRingElem, y::ZZPolyRingElem)
  check_parent(x, y)
  z = parent(x)()
  ccall((:fmpz_poly_add, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, x, y)
  return z
end
...
function -(x::ZZPolyRingElem, y::ZZPolyRingElem)
  check_parent(x, y)
  z = parent(x)()
  ccall((:fmpz_poly_sub, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, x, y)
  return z
end
...
function *(x::ZZPolyRingElem, y::ZZPolyRingElem)
  check_parent(x, y)
  z = parent(x)()
  ccall((:fmpz_poly_mul, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, x, y)
  return z
end
...
function *(x::Int, y::ZZPolyRingElem)
  z = parent(y)()
  ccall((:fmpz_poly_scalar_mul_si, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Int), z, y, x)
  return z
end

function *(x::ZZRingElem, y::ZZPolyRingElem)
  z = parent(y)()
  ccall((:fmpz_poly_scalar_mul_fmpz, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZRingElem}), z, y, x)
  return z
end

function +(x::ZZPolyRingElem, y::Int)
  z = parent(x)()
  ccall((:fmpz_poly_add_si, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Int), z, x, y)
  return z
end

function +(x::ZZPolyRingElem, y::ZZRingElem)
  z = parent(x)()
  ccall((:fmpz_poly_add_fmpz, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZRingElem}), z, x, y)
  return z
end

function -(x::ZZPolyRingElem, y::Int)
  z = parent(x)()
  ccall((:fmpz_poly_sub_si, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Int), z, x, y)
  return z
end

function -(x::ZZPolyRingElem, y::ZZRingElem)
  z = parent(x)()
  ccall((:fmpz_poly_sub_fmpz, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZRingElem}), z, x, y)
  return z
end

function -(x::Int, y::ZZPolyRingElem)
  z = parent(y)()
  ccall((:fmpz_poly_si_sub, libflint), Nothing, (Ref{ZZPolyRingElem}, Int, Ref{ZZPolyRingElem}), z, x, y)
  return z
end

function -(x::ZZRingElem, y::ZZPolyRingElem)
  z = parent(y)()
  ccall((:fmpz_poly_fmpz_sub, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZRingElem}, Ref{ZZPolyRingElem}), z, x, y)
  return z
end
...
function ^(x::ZZPolyRingElem, y::Int)
  ...
  z = parent(x)()
  ccall((:fmpz_poly_pow, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Int), z, x, y)
  return z
end
...
function ==(x::ZZPolyRingElem, y::ZZPolyRingElem)
  check_parent(x, y)
  return ccall((:fmpz_poly_equal, libflint), Bool, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), x, y)
end
...
function ==(x::ZZPolyRingElem, y::ZZRingElem)
  ...
  elseif length(x) == 1
    z = ZZRingElem()
    ccall((:fmpz_poly_get_coeff_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZPolyRingElem}, Int), z, x, 0)
...
function truncate(a::ZZPolyRingElem, n::Int)
  ...
  z = parent(a)()
  ccall((:fmpz_poly_set_trunc, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Int), z, a, n)
  return z
end
...
function mullow(x::ZZPolyRingElem, y::ZZPolyRingElem, n::Int)
  ...
  z = parent(x)()
  ccall((:fmpz_poly_mullow, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Int), z, x, y, n)
  return z
end
...
function reverse(x::ZZPolyRingElem, len::Int)
  ...
  z = parent(x)()
  ccall((:fmpz_poly_reverse, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Int), z, x, len)
  return z
end
...
function shift_left(x::ZZPolyRingElem, len::Int)
  ...
  z = parent(x)()
  ccall((:fmpz_poly_shift_left, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Int), z, x, len)
  return z
end
...
function shift_right(x::ZZPolyRingElem, len::Int)
  len < 0 && throw(DomainError(len, "Shift must be non-negative"))
  z = parent(x)()
  ccall((:fmpz_poly_shift_right, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Int), z, x, len)
  return z
end
...
function divexact(x::ZZPolyRingElem, y::ZZPolyRingElem; check::Bool=true)
  ...
  if check
    r = parent(x)()
    ccall((:fmpz_poly_divrem, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, r, x, y)
    r != 0 && error("Not an exact division")
  else
    ccall((:fmpz_poly_div, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, x, y)
  end
  return z
end
...
function divides(x::ZZPolyRingElem, y::ZZPolyRingElem)
  ...
  iszero(y) && throw(DivideError())
  z = parent(x)()
  flag = Bool(ccall((:fmpz_poly_divides, libflint), Cint, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, x, y))
  return flag, z
end
...
function divexact(x::ZZPolyRingElem, y::ZZRingElem; check::Bool=true)
  iszero(y) && throw(DivideError())
  z = parent(x)()
  ccall((:fmpz_poly_scalar_divexact_fmpz, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZRingElem}), z, x, y)
  return z
end
...
function divexact(x::ZZPolyRingElem, y::Int; check::Bool=true)
  ...
  z = parent(x)()
  ccall((:fmpz_poly_scalar_divexact_si, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Int), z, x, y)
  return z
end
...
function pseudorem(x::ZZPolyRingElem, y::ZZPolyRingElem)
  ...
  ccall((:fmpz_poly_pseudo_rem, libflint), Nothing, (Ref{ZZPolyRingElem}, Ptr{Int}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), r, d, x, y)
  if (diff > d[1])
...
function pseudodivrem(x::ZZPolyRingElem, y::ZZPolyRingElem)
  ...
  r = parent(x)()
  d = Vector{Int}(undef, 1)
  ccall((:fmpz_poly_pseudo_divrem_divconquer, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ptr{Int}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), q, r, d, x, y)
  if (diff > d[1])
...
function gcd(x::ZZPolyRingElem, y::ZZPolyRingElem)
  check_parent(x, y)
  z = parent(x)()
  ccall((:fmpz_poly_gcd, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, x, y)
  return z
end

function content(x::ZZPolyRingElem)
  z = ZZRingElem()
  ccall((:fmpz_poly_content, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZPolyRingElem}), z, x)
  return z
end

function primpart(x::ZZPolyRingElem)
  z = parent(x)()
  ccall((:fmpz_poly_primitive_part, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, x)
  return z
end
...
function Base.sqrt(x::ZZPolyRingElem; check::Bool=true)
  z = parent(x)()
  flag = Bool(ccall((:fmpz_poly_sqrt, libflint), Cint, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, x))
...
function evaluate(x::ZZPolyRingElem, y::ZZRingElem)
  z = ZZRingElem()
  ccall((:fmpz_poly_evaluate_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZPolyRingElem}, Ref{ZZRingElem}), z, x, y)
  return z
end
...
function AbstractAlgebra._compose_right(x::ZZPolyRingElem, y::ZZPolyRingElem)
  check_parent(x, y)
  z = parent(x)()
  ccall((:fmpz_poly_compose, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, x, y)
  return z
end
...
function derivative(x::ZZPolyRingElem)
  z = parent(x)()
  ccall((:fmpz_poly_derivative, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, x)
  return z
end
...
function resultant(x::ZZPolyRingElem, y::ZZPolyRingElem)
  check_parent(x, y)
  z = ZZRingElem()
  ccall((:fmpz_poly_resultant, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, x, y)
  return z
end
...
function discriminant(x::ZZPolyRingElem)
  z = ZZRingElem()
  ccall((:fmpz_poly_discriminant, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZPolyRingElem}), z, x)
  return z
end
...
function resx(a::ZZPolyRingElem, b::ZZPolyRingElem)
  ...
  x = divexact(a, c1)
  y = divexact(b, c2)
  ccall((:fmpz_poly_xgcd_modular, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, u, v, x, y)
...
function signature(f::ZZPolyRingElem)
  ...
  ccall((:fmpz_poly_signature, libflint), Nothing, (Ptr{Int}, Ptr{Int}, Ref{ZZPolyRingElem}), r, s, f)
  return (r[1], s[1])
end
...
function interpolate(R::ZZPolyRing, x::Vector{ZZRingElem}, y::Vector{ZZRingElem})
  z = R()
  ...
  ccall((:fmpz_poly_interpolate_fmpz_vec, libflint), Nothing, (Ref{ZZPolyRingElem}, Ptr{Int}, Ptr{Int}, Int), z, ax, ay, length(x))
  return z
end
...
for (factor_fn, factor_fn_inner, flint_fn) in [(:factor, :_factor, "fmpz_poly_factor"), (:factor_squarefree, :_factor_squarefree, "fmpz_poly_factor_squarefree")]
  eval(
    quote
      ...
      function $factor_fn_inner(x::ZZPolyRingElem)
        ...
        ccall(($flint_fn, libflint), Nothing, (Ref{fmpz_poly_factor}, Ref{ZZPolyRingElem}), fac, x)
        res = Dict{ZZPolyRingElem,Int}()
        z = ZZRingElem()
        ccall((:fmpz_poly_factor_get_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{fmpz_poly_factor}), z, fac)
        for i in 1:(fac.num)
          f = parent(x)()
          ccall((:fmpz_poly_factor_get_fmpz_poly, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{fmpz_poly_factor}, Int), f, fac, i - 1)
...
function chebyshev_t(n::Int, x::ZZPolyRingElem)
  z = parent(x)()
  ccall((:fmpz_poly_chebyshev_t, libflint), Nothing, (Ref{ZZPolyRingElem}, Int), z, n)
  return is_gen(x) ? z : compose(z, x; inner=:second)
end

function chebyshev_u(n::Int, x::ZZPolyRingElem)
  z = parent(x)()
  ccall((:fmpz_poly_chebyshev_u, libflint), Nothing, (Ref{ZZPolyRingElem}, Int), z, n)
  return is_gen(x) ? z : compose(z, x; inner=:second)
end
...
function cyclotomic(n::Int, x::ZZPolyRingElem)
  z = parent(x)()
  ccall((:fmpz_poly_cyclotomic, libflint), Nothing, (Ref{ZZPolyRingElem}, Int), z, n)
  return is_gen(x) ? z : compose(z, x; inner=:second)
end
...
function swinnerton_dyer(n::Int, x::ZZPolyRingElem)
  z = parent(x)()
  ccall((:fmpz_poly_swinnerton_dyer, libflint), Nothing, (Ref{ZZPolyRingElem}, Int), z, n)
  return is_gen(x) ? z : compose(z, x; inner=:second)
end
...
function cos_minpoly(n::Int, x::ZZPolyRingElem)
  z = parent(x)()
  ccall((:fmpz_poly_cos_minpoly, libflint), Nothing, (Ref{ZZPolyRingElem}, Int), z, n)
  return is_gen(x) ? z : compose(z, x; inner=:second)
end
...
function theta_qexp(e::Int, n::Int, x::ZZPolyRingElem)
  z = parent(x)()
  ccall((:fmpz_poly_theta_qexp, libflint), Nothing, (Ref{ZZPolyRingElem}, Int, Int), z, e, n)
  return is_gen(x) ? z : compose(z, x; inner=:second)
end
...
function eta_qexp(e::Int, n::Int, x::ZZPolyRingElem)
  z = parent(x)()
  ccall((:fmpz_poly_eta_qexp, libflint), Nothing, (Ref{ZZPolyRingElem}, Int, Int), z, e, n)
  return is_gen(x) ? z : compose(z, x; inner=:second)
end
...
function zero!(z::ZZPolyRingElem)
  ccall((:fmpz_poly_zero, libflint), Nothing, (Ref{ZZPolyRingElem},), z)
  return z
end

function fit!(z::ZZPolyRingElem, n::Int)
  ccall((:fmpz_poly_fit_length, libflint), Nothing, (Ref{ZZPolyRingElem}, Int), z, n)
  return nothing
end

function setcoeff!(z::ZZPolyRingElem, n::Int, x::ZZRingElem)
  ccall((:fmpz_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZPolyRingElem}, Int, Ref{ZZRingElem}), z, n, x)
  return z
end
...
function addeq!(z::ZZPolyRingElem, x::ZZPolyRingElem)
  ccall((:fmpz_poly_add, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, z, x)
  return z
end

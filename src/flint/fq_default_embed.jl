...
function _unchecked_coerce!(z::FqFieldElem, a::FqField, b::FqPolyRepFieldElem)
  ...
  ccall((:fq_default_set_fmpz_poly, libflint), Nothing, (Ref{FqFieldElem}, Ref{ZZPolyRingElem}, Ref{FqField}), z, x, a)
end
...
function _fq_default_embed_gens(gen_sub::FqFieldElem, gen_sup::FqFieldElem, minpoly::FpPolyRingElem, sub_ctx::FqField, sup_ctx::FqField)
...
function _fq_default_embed_matrices(emb::FpMatrix, pro::FpMatrix, gen_sub::FqFieldElem, sub_ctx::FqField, gen_sup::FqFieldElem, sup_ctx::FqField, gen_minpoly::FpPolyRingElem)
  sub_ctx1 = _as_fq_finite_field(sub_ctx)
  sup_ctx1 = _as_fq_finite_field(sup_ctx)

  ccall(
    (:fq_embed_matrices, libflint),
    Nothing,
    (Ref{FpMatrix}, Ref{FpMatrix}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}, Ref{FpPolyRingElem}),
    emb,
    pro,
    _unchecked_coerce(sub_ctx1, gen_sub),
    sub_ctx1,
    _unchecked_coerce(sup_ctx1, gen_sup),
    sup_ctx1,
    gen_minpoly,
  )
end

...
function check_parent(a::ZZLaurentSeriesRingElem, b::ZZLaurentSeriesRingElem)
  parent(a) != parent(b) && error("Incompatible power series rings in Laurent series operation")
end
...
function polcoeff(a::ZZLaurentSeriesRingElem, n::Int)
  ...
  z = ZZRingElem()
  ccall((:fmpz_poly_get_coeff_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZLaurentSeriesRingElem}, Int), z, a, n)
  return z
end
...
function *(a::ZZLaurentSeriesRingElem, b::ZZLaurentSeriesRingElem)
  ...
  z = parent(a)()
  ccall((:fmpz_poly_mullow, libflint), Nothing, (Ref{ZZLaurentSeriesRingElem}, Ref{ZZLaurentSeriesRingElem}, Ref{ZZLaurentSeriesRingElem}, Int), z, a, b, lenz)
...
function isequal(x::ZZLaurentSeriesRingElem, y::ZZLaurentSeriesRingElem)
  ...
  if precision(x) != precision(y) || pol_length(x) != pol_length(y) || valuation(x) != valuation(y) || scale(x) != scale(y)
    return false
  end
  for i in 1:pol_length(x)
...
==(x::ZZLaurentSeriesRingElem, y::T) where {T<:RingElem} = precision(x) == 0 || ((pol_length(x) == 0 && iszero(y)) || (pol_length(x) == 1 && valuation(x) == 0 && polcoeff(x, 0) == y))

==(x::T, y::ZZLaurentSeriesRingElem) where {T<:RingElem} = y == x

==(x::ZZLaurentSeriesRingElem, y::Union{Integer,Rational,AbstractFloat}) = precision(x) == 0 || ((pol_length(x) == 0 && iszero(y)) || (pol_length(x) == 1 && valuation(x) == 0 && polcoeff(x, 0) == y))
...
function divexact(a::ZZLaurentSeriesRingElem, b::ZZLaurentSeriesRingElem; check::Bool=true)
  ...
  lenz = div(prec + sz - 1, sz)
  z = parent(a)()
  ccall((:fmpz_poly_div_series, libflint), Nothing, (Ref{ZZLaurentSeriesRingElem}, Ref{ZZLaurentSeriesRingElem}, Ref{ZZLaurentSeriesRingElem}, Int), z, a, b, lenz)
  z = set_precision!(z, prec + zval)
  z = set_valuation!(z, zval)
  z = set_scale!(z, sz)
  z = rescale!(z)
...
function inv(a::ZZLaurentSeriesRingElem)
  ...
  z = parent(a)()
  ccall((:fmpz_poly_inv_series, libflint), Nothing, (Ref{ZZLaurentSeriesRingElem}, Ref{ZZLaurentSeriesRingElem}, Int), ainv, a, lenz)
  ainv = rescale!(ainv)
  return ainv
end
...
function sqrt(a::ZZLaurentSeriesRingElem; check::Bool=true)
  ...
  asqrt = set_valuation!(asqrt, aval2)
  flag = Bool(ccall((:fmpz_poly_sqrt_series, libflint), Cint, (Ref{ZZLaurentSeriesRingElem}, Ref{ZZLaurentSeriesRingElem}, Int), asqrt, a, zlen))
...
function zero!(a::ZZLaurentSeriesRingElem)
  ccall((:fmpz_poly_zero, libflint), Nothing, (Ref{ZZLaurentSeriesRingElem},), a)
...
function setcoeff!(c::ZZLaurentSeriesRingElem, n::Int, a::ZZRingElem)
  ccall((:fmpz_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZLaurentSeriesRingElem}, Int, Ref{ZZRingElem}), c, n, a)
  return c
end
...
function mul!(c::ZZLaurentSeriesRingElem, a::ZZLaurentSeriesRingElem, b::ZZLaurentSeriesRingElem)
  ...
  lenb = min(lenb * sb, prec)
  if lena == 0 || lenb == 0
    ccall((:fmpz_poly_zero, libflint), Nothing, (Ref{ZZLaurentSeriesRingElem},), c)
    ...
    ccall((:fmpz_poly_mullow, libflint), Nothing, (Ref{ZZLaurentSeriesRingElem}, Ref{ZZLaurentSeriesRingElem}, Ref{ZZLaurentSeriesRingElem}, Int), c, a, b, lenc)
  end
  c = set_valuation!(c, aval + bval)
...
function eta_qexp(x::ZZLaurentSeriesRingElem)
  ...
  ccall((:fmpz_poly_eta_qexp, libflint), Nothing, (Ref{ZZLaurentSeriesRingElem}, Int, Int), z, 1, div(prec + zscale - 1, zscale))
...
function rand(rng::AbstractRNG, sp::SamplerTrivial{<:Make3{ZZLaurentSeriesRingElem,ZZLaurentSeriesRing,<:AbstractUnitRange{Int}}})
  S, val_range, v = sp[][1:end]
  R = base_ring(S)
  f = S()
  x = gen(S)
  for i in 0:(S.prec_max - 1)
    f += rand(rng, v) * x^i
  end
...
rand(rng::AbstractRNG, S::ZZLaurentSeriesRing, val_range::AbstractUnitRange{Int}, v...) = rand(rng, make(S, val_range, v...))

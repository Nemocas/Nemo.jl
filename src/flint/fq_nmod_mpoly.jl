...
function gens(R::fqPolyRepMPolyRing)
  ...
  for i in 1:(R.nvars)
    z = R()
    ccall((:fq_nmod_mpoly_gen, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), z, i - 1, R)
    A[i] = z
  end
  return A
end
...
function is_gen(a::fqPolyRepMPolyRingElem, i::Int)
  n = nvars(parent(a))
  !(1 <= i <= n) && error("Index must be between 1 and $n")
  return Bool(ccall((:fq_nmod_mpoly_is_gen, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), a, i - 1, a.parent))
end

function is_gen(a::fqPolyRepMPolyRingElem)
  return Bool(ccall((:fq_nmod_mpoly_is_gen, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), a, -1, a.parent))
end

function deepcopy_internal(a::fqPolyRepMPolyRingElem, dict::IdDict)
  z = parent(a)()
  ccall((:fq_nmod_mpoly_set, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, a, a.parent)
  return z
end

function length(a::fqPolyRepMPolyRingElem)
  n = ccall((:fq_nmod_mpoly_length, libflint), Int, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, a.parent)
  return n
end

function one(R::fqPolyRepMPolyRing)
  z = R()
  ccall((:fq_nmod_mpoly_one, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, R)
  return z
end

function zero(R::fqPolyRepMPolyRing)
  z = R()
  ccall((:fq_nmod_mpoly_zero, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, R)
  return z
end

function isone(a::fqPolyRepMPolyRingElem)
  b = ccall((:fq_nmod_mpoly_is_one, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, a.parent)
  return Bool(b)
end

function iszero(a::fqPolyRepMPolyRingElem)
  b = ccall((:fq_nmod_mpoly_is_zero, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, a.parent)
  return Bool(b)
end
...
function is_constant(a::fqPolyRepMPolyRingElem)
  b = ccall((:fq_nmod_mpoly_is_fq_nmod, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, parent(a))
  return Bool(b)
end
...
function coeff(a::fqPolyRepMPolyRingElem, i::Int)
  ...
  ccall((:fq_nmod_mpoly_get_term_coeff_fq_nmod, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), z, a, i - 1, a.parent)
  return z
end
...
function coeff(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem)
  ...
  z = base_ring(parent(a))()
  ccall((:fq_nmod_mpoly_get_coeff_fq_nmod_monomial, libflint), UInt, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, a, b, parent(a))
  return z
end
...
function degree(a::fqPolyRepMPolyRingElem, i::Int)
  ...
  if degrees_fit_int(a)
    d = ccall((:fq_nmod_mpoly_degree_si, libflint), Int, (Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), a, i - 1, a.parent)
    return d
  else
...
function degree_fmpz(a::fqPolyRepMPolyRingElem, i::Int)
  ...
  !(1 <= i <= n) && error("Index must be between 1 and $n")
  d = ZZRingElem()
  ccall((:fq_nmod_mpoly_degree_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), d, a, i - 1, a.parent)
  return d
end

# Return true if degrees fit into an Int
function degrees_fit_int(a::fqPolyRepMPolyRingElem)
  b = ccall((:fq_nmod_mpoly_degrees_fit_si, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, a.parent)
  return Bool(b)
end
...
function degrees(a::fqPolyRepMPolyRingElem)
  ...
  ccall((:fq_nmod_mpoly_degrees_si, libflint), Nothing, (Ptr{Int}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), degs, a, a.parent)
  return degs
end
...
function degrees_fmpz(a::fqPolyRepMPolyRingElem)
  ...
  ccall((:fq_nmod_mpoly_degrees_fmpz, libflint), Nothing, (Ptr{Ref{ZZRingElem}}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), degs, a, a.parent)
  return degs
end

# Return true if degree fits into an Int
function total_degree_fits_int(a::fqPolyRepMPolyRingElem)
  b = ccall((:fq_nmod_mpoly_total_degree_fits_si, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, a.parent)
  return Bool(b)
end
...
function total_degree(a::fqPolyRepMPolyRingElem)
  ...
  d = ccall((:fq_nmod_mpoly_total_degree_si, libflint), Int, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, a.parent)
  return d
end
...
function total_degree_fmpz(a::fqPolyRepMPolyRingElem)
  d = ZZRingElem()
  ccall((:fq_nmod_mpoly_total_degree_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), d, a, a.parent)
  return d
end
...
function coeff(a::fqPolyRepMPolyRingElem, vars::Vector{Int}, exps::Vector{Int})
  ...
  z = parent(a)()
  ccall(
    (:fq_nmod_mpoly_get_coeff_vars_ui, libflint),
    Nothing,
    (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ptr{Int}, Ptr{Int}, Int, Ref{fqPolyRepMPolyRing}),
    z,
    a,
    vars,
    exps,
...
function -(a::fqPolyRepMPolyRingElem)
  z = parent(a)()
  ccall((:fq_nmod_mpoly_neg, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, a, a.parent)
  return z
end
...
function +(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem)
  check_parent(a, b)
  z = parent(a)()
  ccall((:fq_nmod_mpoly_add, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, a, b, a.parent)
  return z
end
...
function -(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem)
  check_parent(a, b)
  z = parent(a)()
  ccall((:fq_nmod_mpoly_sub, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, a, b, a.parent)
  return z
end
...
function *(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem)
  check_parent(a, b)
  z = parent(a)()
  ccall((:fq_nmod_mpoly_mul, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, a, b, a.parent)
  return z
end
...
function ^(a::fqPolyRepMPolyRingElem, b::Int)
  ...
  z = parent(a)()
  r = ccall((:fq_nmod_mpoly_pow_ui, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, UInt, Ref{fqPolyRepMPolyRing}), z, a, UInt(b), parent(a))
...
function ^(a::fqPolyRepMPolyRingElem, b::ZZRingElem)
  b < 0 && throw(DomainError(b, "Exponent must be non-negative"))
  z = parent(a)()
  r = ccall((:fq_nmod_mpoly_pow_fmpz, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{ZZRingElem}, Ref{fqPolyRepMPolyRing}), z, a, b, parent(a))
  iszero(r) && error("Unable to compute power")
  return z
end
...
function gcd(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem)
  check_parent(a, b)
  z = parent(a)()
  r = ccall((:fq_nmod_mpoly_gcd, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, a, b, a.parent)
...
function gcd_with_cofactors(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem)
  ...
  bbar = parent(a)()
  r = ccall(
    (:fq_nmod_mpoly_gcd_cofactors, Nemo.libflint),
    Cint,
    (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}),
    z,
    abar,
    bbar,
    a,
...
function (::Type{Fac{fqPolyRepMPolyRingElem}})(fac::fq_nmod_mpoly_factor, preserve_input::Bool=false)
  ...
  for i in 0:(fac.num - 1)
    f = R()
    if preserve_input
      ccall((:fq_nmod_mpoly_factor_get_base, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fq_nmod_mpoly_factor}, Int, Ref{fqPolyRepMPolyRing}), f, fac, i, R)
    else
      ccall((:fq_nmod_mpoly_factor_swap_base, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fq_nmod_mpoly_factor}, Int, Ref{fqPolyRepMPolyRing}), f, fac, i, R)
    end
    F.fac[f] = ccall((:fq_nmod_mpoly_factor_get_exp_si, libflint), Int, (Ref{fq_nmod_mpoly_factor}, Int, Ref{fqPolyRepMPolyRing}), fac, i, R)
  end
  c = base_ring(R)()
  ccall((:fq_nmod_mpoly_factor_get_constant_fq_nmod, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{fq_nmod_mpoly_factor}), c, fac)
  F.unit = R(c)
  return F
end
...
function factor(a::fqPolyRepMPolyRingElem)
  ...
  ok = ccall((:fq_nmod_mpoly_factor, libflint), Cint, (Ref{fq_nmod_mpoly_factor}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), fac, a, R)
...
function factor_squarefree(a::fqPolyRepMPolyRingElem)
  ...
  R = parent(a)
  fac = fq_nmod_mpoly_factor(R)
  ok = ccall((:fq_nmod_mpoly_factor_squarefree, libflint), Cint, (Ref{fq_nmod_mpoly_factor}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), fac, a, R)
  ok == 0 && error("unable to compute factorization")
  return Fac{fqPolyRepMPolyRingElem}(fac, false)
end
...
function is_square(a::fqPolyRepMPolyRingElem)
  return Bool(ccall((:fq_nmod_mpoly_is_square, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, a.parent))
end

function is_square_with_sqrt(a::fqPolyRepMPolyRingElem)
  q = parent(a)()
  flag = ccall((:fq_nmod_mpoly_sqrt, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), q, a, a.parent)
  return (Bool(flag), q)
end
...
function ==(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem)
  check_parent(a, b)
  return ccall((:fq_nmod_mpoly_equal, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, b, a.parent) != 0
end
...
function Base.isless(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem)
  ...
  return ccall((:fq_nmod_mpoly_cmp, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, b, a.parent) < 0
end
...
function ==(a::fqPolyRepMPolyRingElem, b::fqPolyRepFieldElem)
  return Bool(ccall((:fq_nmod_mpoly_equal_fq_nmod, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepMPolyRing}), a, b, a.parent))
end
...
function divides(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem)
  ...
  z = parent(a)()
  d = ccall((:fq_nmod_mpoly_divides, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, a, b, a.parent)
  return isone(d), z
end
...
function Base.div(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem)
  check_parent(a, b)
  q = parent(a)()
  ccall((:fq_nmod_mpoly_div, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), q, a, b, a.parent)
  return q
end
...
function Base.divrem(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem)
  ...
  r = parent(a)()
  ccall(
    (:fq_nmod_mpoly_divrem, libflint),
    Nothing,
    (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}),
    q,
    r,
    a,
    b,
...
function Base.divrem(a::fqPolyRepMPolyRingElem, b::Vector{fqPolyRepMPolyRingElem})
  ...
  r = parent(a)()
  ccall(
    (:fq_nmod_mpoly_divrem_ideal, libflint),
    Nothing,
    (Ptr{Ref{fqPolyRepMPolyRingElem}}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ptr{Ref{fqPolyRepMPolyRingElem}}, Int, Ref{fqPolyRepMPolyRing}),
    q,
    r,
    a,
    b,
...
function derivative(a::fqPolyRepMPolyRingElem, i::Int)
  ...
  !(1 <= i <= n) && error("Index must be between 1 and $n")
  z = parent(a)()
  ccall((:fq_nmod_mpoly_derivative, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), z, a, i - 1, parent(a))
  return z
end
...
function evaluate(a::fqPolyRepMPolyRingElem, b::Vector{fqPolyRepFieldElem})
  ...
  z = base_ring(parent(a))()
  ccall((:fq_nmod_mpoly_evaluate_all_fq_nmod, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepMPolyRingElem}, Ptr{Ref{fqPolyRepFieldElem}}, Ref{fqPolyRepMPolyRing}), z, a, b, parent(a))
  return z
end
...
function evaluate(a::fqPolyRepMPolyRingElem, bs::Vector{fqPolyRepMPolyRingElem})
  ...
  c = S()
  fl = ccall(
    (:fq_nmod_mpoly_compose_fq_nmod_mpoly, libflint),
    Cint,
    (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ptr{Ref{fqPolyRepMPolyRingElem}}, Ref{fqPolyRepMPolyRing}, Ref{fqPolyRepMPolyRing}),
    c,
    a,
    bs,
    R,
...
function evaluate(a::fqPolyRepMPolyRingElem, bs::Vector{fqPolyRepPolyRingElem})
  ...
  c = S()
  fl = ccall((:fq_nmod_mpoly_compose_fq_nmod_poly, libflint), Cint, (Ref{fqPolyRepPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ptr{Ref{fqPolyRepPolyRingElem}}, Ref{fqPolyRepMPolyRing}), c, a, bs, R)
  fl == 0 && error("Something wrong in evaluation.")
  return c
end
...
function zero!(a::fqPolyRepMPolyRingElem)
  ccall((:fq_nmod_mpoly_zero, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, a.parent)
  return a
end

function add!(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem, c::fqPolyRepMPolyRingElem)
  ccall((:fq_nmod_mpoly_add, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, b, c, a.parent)
  return a
end

function addeq!(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem)
  ccall((:fq_nmod_mpoly_add, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, a, b, a.parent)
  return a
end

function mul!(a::fqPolyRepMPolyRingElem, b::fqPolyRepMPolyRingElem, c::fqPolyRepMPolyRingElem)
  ccall((:fq_nmod_mpoly_mul, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, b, c, a.parent)
  return a
end
...
function setcoeff!(a::fqPolyRepMPolyRingElem, n::Int, c::fqPolyRepFieldElem)
  if n > length(a)
    ccall((:fq_nmod_mpoly_resize, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), a, n, a.parent)
  end
  ccall((:fq_nmod_mpoly_set_term_coeff_fq_nmod, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepMPolyRing}), a, n - 1, c, a.parent)
  return a
end
...
function combine_like_terms!(a::fqPolyRepMPolyRingElem)
  ccall((:fq_nmod_mpoly_combine_like_terms, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, a.parent)
  return a
end
...
function exponent_vector_fits(::Type{Int}, a::fqPolyRepMPolyRingElem, i::Int)
  b = ccall((:fq_nmod_mpoly_term_exp_fits_si, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), a, i - 1, a.parent)
  return Bool(b)
end

function exponent_vector_fits(::Type{UInt}, a::fqPolyRepMPolyRingElem, i::Int)
  b = ccall((:fq_nmod_mpoly_term_exp_fits_ui, libflint), Cint, (Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), a, i - 1, a.parent)
  return Bool(b)
end

function exponent_vector!(z::Vector{Int}, a::fqPolyRepMPolyRingElem, i::Int)
  ccall((:fq_nmod_mpoly_get_term_exp_si, libflint), Nothing, (Ptr{Int}, Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), z, a, i - 1, parent(a))
  return z
end

function exponent_vector!(z::Vector{UInt}, a::fqPolyRepMPolyRingElem, i::Int)
  ccall((:fq_nmod_mpoly_get_term_exp_ui, libflint), Nothing, (Ptr{UInt}, Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), z, a, i - 1, parent(a))
  return z
end

function exponent_vector!(z::Vector{ZZRingElem}, a::fqPolyRepMPolyRingElem, i::Int)
  ccall((:fq_nmod_mpoly_get_term_exp_fmpz, libflint), Nothing, (Ptr{Ref{ZZRingElem}}, Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), z, a, i - 1, parent(a))
  return z
end
...
function set_exponent_vector!(a::fqPolyRepMPolyRingElem, n::Int, exps::Vector{UInt})
  ...
  ccall((:fq_nmod_mpoly_set_term_exp_ui, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Int, Ptr{UInt}, Ref{fqPolyRepMPolyRing}), a, n - 1, exps, parent(a))
  return a
end
...
function set_exponent_vector!(a::fqPolyRepMPolyRingElem, n::Int, exps::Vector{Int})
  ...
  ccall((:fq_nmod_mpoly_set_term_exp_ui, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Int, Ptr{Int}, Ref{fqPolyRepMPolyRing}), a, n - 1, exps, parent(a))
  return a
end
...
function set_exponent_vector!(a::fqPolyRepMPolyRingElem, n::Int, exps::Vector{ZZRingElem})
  ...
  ccall((:fq_nmod_mpoly_set_term_exp_fmpz, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Int, Ptr{ZZRingElem}, Ref{fqPolyRepMPolyRing}), a, n - 1, exps, parent(a))
  return a
end
...
function exponent(a::fqPolyRepMPolyRingElem, i::Int, j::Int)
  ...
  return ccall((:fq_nmod_mpoly_get_term_var_exp_ui, libflint), Int, (Ref{fqPolyRepMPolyRingElem}, Int, Int, Ref{fqPolyRepMPolyRing}), a, i - 1, j - 1, a.parent)
end
...
function coeff(a::fqPolyRepMPolyRingElem, exps::Vector{UInt})
  z = base_ring(parent(a))()
  ccall((:fq_nmod_mpoly_get_coeff_fq_nmod_ui, libflint), UInt, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepMPolyRingElem}, Ptr{UInt}, Ref{fqPolyRepMPolyRing}), z, a, exps, parent(a))
  return z
end
...
function coeff(a::fqPolyRepMPolyRingElem, exps::Vector{Int})
  z = base_ring(parent(a))()
  ccall((:fq_nmod_mpoly_get_coeff_fq_nmod_ui, libflint), UInt, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepMPolyRingElem}, Ptr{Int}, Ref{fqPolyRepMPolyRing}), z, a, exps, parent(a))
  return z
end
...
function setcoeff!(a::fqPolyRepMPolyRingElem, exps::Vector{Int}, b::fqPolyRepFieldElem)
  ccall((:fq_nmod_mpoly_set_coeff_fq_nmod_ui, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, UInt, Ptr{Int}, Ref{fqPolyRepMPolyRing}), a, b, exps, parent(a))
  return a
end

# Set the coefficient of the term with the given exponent vector to the
# given integer. Removal of a zero term is performed.
setcoeff!(a::fqPolyRepMPolyRingElem, exps::Vector{Int}, b::Union{Integer,zzModRingElem}) = setcoeff!(a, exps, base_ring(parent(a))(b))
...
function sort_terms!(a::fqPolyRepMPolyRingElem)
  ccall((:fq_nmod_mpoly_sort_terms, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, a.parent)
  return a
end
...
function term(a::fqPolyRepMPolyRingElem, i::Int)
  z = parent(a)()
  ccall((:fq_nmod_mpoly_get_term, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), z, a, i - 1, a.parent)
  return z
end
...
function monomial(a::fqPolyRepMPolyRingElem, i::Int)
  z = parent(a)()
  ccall((:fq_nmod_mpoly_get_term_monomial, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), z, a, i - 1, a.parent)
  return z
end
...
function monomial!(m::fqPolyRepMPolyRingElem, a::fqPolyRepMPolyRingElem, i::Int)
  ccall((:fq_nmod_mpoly_get_term_monomial, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), m, a, i - 1, a.parent)
  return m
end
...
function _push_term!(z::fqPolyRepMPolyRingElem, c::fqPolyRepFieldElem, exp::Vector{Int})
  ccall((:fq_nmod_mpoly_push_term_fq_nmod_ui, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepFieldElem}, Ptr{UInt}, Ref{fqPolyRepMPolyRing}), z, c, exp, parent(z))
  return z
end
...
function push_term!(M::MPolyBuildCtx{fqPolyRepMPolyRingElem}, c::RingElement, expv::Vector{Int})
...
function finish(M::MPolyBuildCtx{fqPolyRepMPolyRingElem})
  ...
  R = parent(res)
  M.poly = zero(R)
  ccall((:fq_nmod_mpoly_sort_terms, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), res, R)
  ccall((:fq_nmod_mpoly_combine_like_terms, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), res, R)
  return res
end

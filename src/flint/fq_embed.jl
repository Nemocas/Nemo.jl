...
function linear_factor(x::FqPolyRepPolyRingElem)
  y = parent(x)()
  ccall((:fq_poly_factor_split_single, libflint), Nothing, (Ref{FqPolyRepPolyRingElem}, Ref{FqPolyRepPolyRingElem}, Ref{FqPolyRepField}), y, x, base_ring(x))
  return y
end
...
function embed_gens(k::FqPolyRepField, K::FqPolyRepField)
  ...
  ccall((:fq_embed_gens, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FpPolyRingElem}, Ref{FqPolyRepField}, Ref{FqPolyRepField}), a, b, P, k, K)
...
function setcoeff!(x::FqPolyRepFieldElem, j::Int, c::ZZRingElem)
  ccall((:fmpz_poly_set_coeff_fmpz, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Int, Ref{ZZRingElem}), x, j, c)
end

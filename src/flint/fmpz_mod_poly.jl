...
function coeff(x::T, n::Int) where {T<:Zmodn_fmpz_poly}
  ...
  z = ZZRingElem()
  ccall((:fmpz_mod_poly_get_coeff_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{T}, Int, Ref{fmpz_mod_ctx_struct}), z, x, n, x.parent.base_ring.ninv)
...
is_gen(a::Zmodn_fmpz_poly) = (degree(a) == 1 && iszero(coeff(a, 0)) && isone(coeff(a, 1)))
...
function -(x::T) where {T<:Zmodn_fmpz_poly}
  z = parent(x)()
  ccall((:fmpz_mod_poly_neg, libflint), Nothing, (Ref{T}, Ref{T}, Ref{fmpz_mod_ctx_struct}), z, x, x.parent.base_ring.ninv)
  return z
end
...
function +(x::T, y::T) where {T<:Zmodn_fmpz_poly}
  check_parent(x, y)
  z = parent(x)()
  ccall((:fmpz_mod_poly_add, libflint), Nothing, (Ref{T}, Ref{T}, Ref{T}, Ref{fmpz_mod_ctx_struct}), z, x, y, x.parent.base_ring.ninv)
  return z
end
...
function -(x::T, y::T) where {T<:Zmodn_fmpz_poly}
  check_parent(x, y)
  z = parent(x)()
  ccall((:fmpz_mod_poly_sub, libflint), Nothing, (Ref{T}, Ref{T}, Ref{T}, Ref{fmpz_mod_ctx_struct}), z, x, y, x.parent.base_ring.ninv)
  return z
end
...
function *(x::T, y::T) where {T<:Zmodn_fmpz_poly}
  check_parent(x, y)
  z = parent(x)()
  ccall((:fmpz_mod_poly_mul, libflint), Nothing, (Ref{T}, Ref{T}, Ref{T}, Ref{fmpz_mod_ctx_struct}), z, x, y, x.parent.base_ring.ninv)
  return z
end
...
function *(x::ZZModPolyRingElem, y::ZZRingElem)
  z = parent(x)()
  ccall((:fmpz_mod_poly_scalar_mul_fmpz, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, x, y, x.parent.base_ring.ninv)
  return z
end
...
function +(x::ZZModPolyRingElem, y::Int)
  z = parent(x)()
  ccall((:fmpz_mod_poly_add_si, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, x, y, x.parent.base_ring.ninv)
  return z
end
...
function +(x::ZZModPolyRingElem, y::ZZRingElem)
  z = parent(x)()
  ccall((:fmpz_mod_poly_add_fmpz, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, x, y, x.parent.base_ring.ninv)
  return z
end
...
function -(x::ZZModPolyRingElem, y::Int)
  z = parent(x)()
  ccall((:fmpz_mod_poly_sub_si, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, x, y, x.parent.base_ring.ninv)
  return z
end

function -(x::Int, y::ZZModPolyRingElem)
  z = parent(y)()
  ccall((:fmpz_mod_poly_si_sub, libflint), Nothing, (Ref{ZZModPolyRingElem}, Int, Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}), z, x, y, y.parent.base_ring.ninv)
  return z
end

function -(x::ZZModPolyRingElem, y::ZZRingElem)
  z = parent(x)()
  ccall((:fmpz_mod_poly_sub_fmpz, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, x, y, x.parent.base_ring.ninv)
  return z
end

function -(x::ZZRingElem, y::ZZModPolyRingElem)
  z = parent(y)()
  ccall((:fmpz_mod_poly_fmpz_sub, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{ZZRingElem}, Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}), z, x, y, y.parent.base_ring.ninv)
  return z
end
...
function ^(x::T, y::Int) where {T<:Zmodn_fmpz_poly}
  ...
  z = parent(x)()
  ccall((:fmpz_mod_poly_pow, libflint), Nothing, (Ref{T}, Ref{T}, UInt, Ref{fmpz_mod_ctx_struct}), z, x, y, x.parent.base_ring.ninv)
  return z
end
...
function ==(x::T, y::T) where {T<:Zmodn_fmpz_poly}
  check_parent(x, y)
  return Bool(ccall((:fmpz_mod_poly_equal, libflint), Cint, (Ref{T}, Ref{T}, Ref{fmpz_mod_ctx_struct}), x, y, x.parent.base_ring.ninv))
end
...
function ==(x::ZZModPolyRingElem, y::ZZModRingElem)
  ...
  elseif length(x) == 1
    u = ZZRingElem()
    ccall((:fmpz_mod_poly_get_coeff_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZModPolyRingElem}, Int, Ref{fmpz_mod_ctx_struct}), u, x, 0, x.parent.base_ring.ninv)
    return u == y
  else
    return iszero(y)
  end
...
function truncate(a::T, n::Int) where {T<:Zmodn_fmpz_poly}
  ...
  ccall((:fmpz_mod_poly_truncate, libflint), Nothing, (Ref{T}, Int, Ref{fmpz_mod_ctx_struct}), z, n, z.parent.base_ring.ninv)
  return z
end
...
function mullow(x::T, y::T, n::Int) where {T<:Zmodn_fmpz_poly}
  ...
  z = parent(x)()
  ccall((:fmpz_mod_poly_mullow, libflint), Nothing, (Ref{T}, Ref{T}, Ref{T}, Int, Ref{fmpz_mod_ctx_struct}), z, x, y, n, x.parent.base_ring.ninv)
  return z
end
...
function reverse(x::T, len::Int) where {T<:Zmodn_fmpz_poly}
  ...
  z = parent(x)()
  ccall((:fmpz_mod_poly_reverse, libflint), Nothing, (Ref{T}, Ref{T}, Int, Ref{fmpz_mod_ctx_struct}), z, x, len, x.parent.base_ring.ninv)
  return z
end
...
function shift_left(x::T, len::Int) where {T<:Zmodn_fmpz_poly}
  ...
  z = parent(x)()
  ccall((:fmpz_mod_poly_shift_left, libflint), Nothing, (Ref{T}, Ref{T}, Int, Ref{fmpz_mod_ctx_struct}), z, x, len, x.parent.base_ring.ninv)
  return z
end
...
function shift_right(x::T, len::Int) where {T<:Zmodn_fmpz_poly}
  len < 0 && throw(DomainError(len, "Shift must be non-negative"))
  z = parent(x)()
  ccall((:fmpz_mod_poly_shift_right, libflint), Nothing, (Ref{T}, Ref{T}, Int, Ref{fmpz_mod_ctx_struct}), z, x, len, x.parent.base_ring.ninv)
  return z
end
...
function divexact(x::T, y::T; check::Bool=true) where {T<:Zmodn_fmpz_poly}
  ...
  q = parent(x)()
  r = parent(x)()
  ccall((:fmpz_mod_poly_divrem_f, libflint), Nothing, (Ref{ZZRingElem}, Ref{T}, Ref{T}, Ref{T}, Ref{T}, Ref{fmpz_mod_ctx_struct}), d, q, r, x, y, x.parent.base_ring.ninv)
...
function divexact(x::ZZModPolyRingElem, y::ZZModRingElem; check::Bool=true)
  ...
  iszero(y) && throw(DivideError())
  q = parent(x)()
  ccall((:fmpz_mod_poly_scalar_div_fmpz, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), q, x, y.data, x.parent.base_ring.ninv)
  return q
end
...
function divexact(x::T, y::ZZRingElem; check::Bool=true) where {T<:Zmodn_fmpz_poly}
  iszero(y) && throw(DivideError())
  q = parent(x)()
  ccall((:fmpz_mod_poly_scalar_div_fmpz, libflint), Nothing, (Ref{T}, Ref{T}, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), q, x, y, x.parent.base_ring.ninv)
  return q
end
...
function divexact(x::T, y::Int; check::Bool=true) where {T<:Zmodn_fmpz_poly}
  ...
  q = parent(x)()
  ccall((:fmpz_mod_poly_scalar_div_fmpz, libflint), Nothing, (Ref{T}, Ref{T}, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), q, x, ZZRingElem(y), x.parent.base_ring.ninv)
  return q
end
...
function AbstractAlgebra.mat22_mul_prefers_classical(
  a11::ZZModPolyRingElem, a12::ZZModPolyRingElem, a21::ZZModPolyRingElem, a22::ZZModPolyRingElem, b11::ZZModPolyRingElem, b12::ZZModPolyRingElem, b21::ZZModPolyRingElem, b22::ZZModPolyRingElem
)
...
function AbstractAlgebra.gcd_basecase(x::ZZModPolyRingElem, y::ZZModPolyRingElem)
  ...
  f = ZZRingElem()
  ccall(
    (:fmpz_mod_poly_gcd_euclidean_f, libflint),
    Nothing,
    (Ref{ZZRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}),
    f,
    z,
    x,
    y,
    x.parent.base_ring.ninv,
  )
...
function AbstractAlgebra.gcdx_basecase(x::ZZModPolyRingElem, y::ZZModPolyRingElem)
  ...
  f = ZZRingElem()
  ccall(
    (:fmpz_mod_poly_xgcd_euclidean_f, libflint),
    Nothing,
    (Ref{ZZRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}),
    f,
    g,
    s,
    t,
...
function AbstractAlgebra.gcdinv_basecase(x::ZZModPolyRingElem, y::ZZModPolyRingElem)
  ...
  f = ZZRingElem()
  ccall(
    (:fmpz_mod_poly_gcdinv_euclidean_f, libflint),
    Nothing,
    (Ref{ZZRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}),
    f,
    g,
    s,
    x,
...
function invmod(x::T, y::T) where {T<:Zmodn_fmpz_poly}
  ...
  z = parent(x)()
  r = ccall((:fmpz_mod_poly_invmod, libflint), Cint, (Ref{T}, Ref{T}, Ref{T}, Ref{fmpz_mod_ctx_struct}), z, x, y, x.parent.base_ring.ninv)
...
function mulmod(x::T, y::T, z::T) where {T<:Zmodn_fmpz_poly}
  ...
  check_parent(y, z)
  w = parent(x)()
  ccall((:fmpz_mod_poly_mulmod, libflint), Nothing, (Ref{T}, Ref{T}, Ref{T}, Ref{T}, Ref{fmpz_mod_ctx_struct}), w, x, y, z, x.parent.base_ring.ninv)
  return w
end
...
function powermod(x::T, e::Int, y::T) where {T<:Zmodn_fmpz_poly}
  ...
  ccall((:fmpz_mod_poly_powmod_ui_binexp, libflint), Nothing, (Ref{T}, Ref{T}, UInt, Ref{T}, Ref{fmpz_mod_ctx_struct}), z, x, e, y, x.parent.base_ring.ninv)
...
function powermod(x::T, e::ZZRingElem, y::T) where {T<:Zmodn_fmpz_poly}
  ...
  ccall((:fmpz_mod_poly_powmod_fmpz_binexp, libflint), Nothing, (Ref{T}, Ref{T}, Ref{ZZRingElem}, Ref{T}, Ref{fmpz_mod_ctx_struct}), z, x, e, y, x.parent.base_ring.ninv)
  return z
end
...
function resultant(x::T, y::T) where {T<:Zmodn_fmpz_poly}
  ...
  r = ZZRingElem()
  ccall((:fmpz_mod_poly_resultant, libflint), Nothing, (Ref{ZZRingElem}, Ref{T}, Ref{T}, Ref{fmpz_mod_ctx_struct}), r, x, y, x.parent.base_ring.ninv)
...
function evaluate(x::ZZModPolyRingElem, y::ZZModRingElem)
  base_ring(x) != parent(y) && error("Elements must have same parent")
  z = ZZRingElem()
  ccall((:fmpz_mod_poly_evaluate_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZModPolyRingElem}, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, x, y.data, x.parent.base_ring.ninv)
  return parent(y)(z)
end
...
function derivative(x::T) where {T<:Zmodn_fmpz_poly}
  z = parent(x)()
  ccall((:fmpz_mod_poly_derivative, libflint), Nothing, (Ref{T}, Ref{T}, Ref{fmpz_mod_ctx_struct}), z, x, x.parent.base_ring.ninv)
  return z
end
...
function AbstractAlgebra._compose_right(x::T, y::T) where {T<:Zmodn_fmpz_poly}
  check_parent(x, y)
  z = parent(x)()
  ccall((:fmpz_mod_poly_compose, libflint), Nothing, (Ref{T}, Ref{T}, Ref{T}, Ref{fmpz_mod_ctx_struct}), z, x, y, x.parent.base_ring.ninv)
  return z
end
...
function lift(R::ZZPolyRing, y::ZZModPolyRingElem)
  z = ZZPolyRingElem()
  ccall((:fmpz_mod_poly_get_fmpz_poly, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}), z, y, y.parent.base_ring.ninv)
  z.parent = R
  return z
end
...
function is_irreducible(x::ZZModPolyRingElem)
  ...
  return Bool(ccall((:fmpz_mod_poly_is_irreducible, libflint), Cint, (Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}), x, x.parent.base_ring.ninv))
end
...
function is_squarefree(x::ZZModPolyRingElem)
  ...
  return Bool(ccall((:fmpz_mod_poly_is_squarefree, libflint), Cint, (Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}), x, x.parent.base_ring.ninv))
end
...
function _factor(x::ZZModPolyRingElem)
  ...
  ccall((:fmpz_mod_poly_factor, libflint), UInt, (Ref{fmpz_mod_poly_factor}, Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}), fac, x, n)
  res = Dict{ZZModPolyRingElem,Int}()
  for i in 1:(fac.num)
    f = parent(x)()
    ccall((:fmpz_mod_poly_factor_get_fmpz_mod_poly, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{fmpz_mod_poly_factor}, Int, Ref{fmpz_mod_ctx_struct}), f, fac, i - 1, n)
...
function _factor_squarefree(x::ZZModPolyRingElem)
  n = x.parent.base_ring.ninv
  fac = fmpz_mod_poly_factor(n)
  ccall((:fmpz_mod_poly_factor_squarefree, libflint), UInt, (Ref{fmpz_mod_poly_factor}, Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}), fac, x, n)
  res = Dict{ZZModPolyRingElem,Int}()
  for i in 1:(fac.num)
    f = parent(x)()
    ccall((:fmpz_mod_poly_factor_get_fmpz_mod_poly, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{fmpz_mod_poly_factor}, Int, Ref{fmpz_mod_ctx_struct}), f, fac, i - 1, n)
...
function factor_distinct_deg(x::ZZModPolyRingElem)
  ...
  n = x.parent.base_ring.ninv
  fac = fmpz_mod_poly_factor(n)
  ccall((:fmpz_mod_poly_factor_distinct_deg, libflint), UInt, (Ref{fmpz_mod_poly_factor}, Ref{ZZModPolyRingElem}, Ptr{Ptr{Int}}, Ref{fmpz_mod_ctx_struct}), fac, x, degss, n)
...
function roots(a::ZZModPolyRingElem)
  ...
  if is_probable_prime(n.n)
    ccall((:fmpz_mod_poly_roots, libflint), UInt, (Ref{fmpz_mod_poly_factor}, Ref{ZZModPolyRingElem}, Cint, Ref{fmpz_mod_ctx_struct}), fac, a, 0, n)
  else
    nfac = fmpz_factor()
    ccall((:fmpz_factor, libflint), Nothing, (Ref{fmpz_factor}, Ref{ZZRingElem}), nfac, R.base_ring.n)
    ccall((:fmpz_mod_poly_roots_factored, libflint), UInt, (Ref{fmpz_mod_poly_factor}, Ref{ZZModPolyRingElem}, Cint, Ref{fmpz_factor}, Ref{fmpz_mod_ctx_struct}), fac, a, 0, nfac, n)
  end
  f = R()
  res = ZZModRingElem[]
  for i in 1:(fac.num)
...
function zero!(x::T) where {T<:Zmodn_fmpz_poly}
  ccall((:fmpz_mod_poly_zero, libflint), Nothing, (Ref{T}, Ref{fmpz_mod_ctx_struct}), x, x.parent.base_ring.ninv)
  return x
end

function fit!(x::T, n::Int) where {T<:Zmodn_fmpz_poly}
  ccall((:fmpz_mod_poly_fit_length, libflint), Nothing, (Ref{T}, Int, Ref{fmpz_mod_ctx_struct}), x, n, x.parent.base_ring.ninv)
  return nothing
end

function setcoeff!(x::T, n::Int, y::UInt) where {T<:Zmodn_fmpz_poly}
  ccall((:fmpz_mod_poly_set_coeff_ui, libflint), Nothing, (Ref{T}, Int, UInt, Ref{fmpz_mod_ctx_struct}), x, n, y, x.parent.base_ring.ninv)
  return x
end

function setcoeff!(x::T, n::Int, y::Int) where {T<:Zmodn_fmpz_poly}
  ccall((:fmpz_mod_poly_set_coeff_si, libflint), Nothing, (Ref{T}, Int, UInt, Ref{fmpz_mod_ctx_struct}), x, n, y, x.parent.base_ring.ninv)
  return x
end

function setcoeff!(x::T, n::Int, y::ZZRingElem) where {T<:Zmodn_fmpz_poly}
  ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{T}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), x, n, y, x.parent.base_ring.ninv)
  return x
end
...
function addeq!(z::T, y::T) where {T<:Zmodn_fmpz_poly}
  ccall((:fmpz_mod_poly_add, libflint), Nothing, (Ref{T}, Ref{T}, Ref{T}, Ref{fmpz_mod_ctx_struct}), z, z, y, z.parent.base_ring.ninv)
  return z
end

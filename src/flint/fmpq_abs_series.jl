...
function normalise(a::QQAbsPowerSeriesRingElem, len::Int)
  if len > 0
    c = QQFieldElem()
    ccall((:fmpq_poly_get_coeff_fmpq, libflint), Nothing, (Ref{QQFieldElem}, Ref{QQAbsPowerSeriesRingElem}, Int), c, a, len - 1)
  end
...
function coeff(x::QQAbsPowerSeriesRingElem, n::Int)
  ...
  z = QQFieldElem()
  ccall((:fmpq_poly_get_coeff_fmpq, libflint), Nothing, (Ref{QQFieldElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, x, n)
  return z
end
...
function is_gen(a::QQAbsPowerSeriesRingElem)
  return precision(a) == 0 || ccall((:fmpq_poly_is_gen, libflint), Bool, (Ref{QQAbsPowerSeriesRingElem},), a)
end
...
function isone(a::QQAbsPowerSeriesRingElem)
  return precision(a) == 0 || ccall((:fmpq_poly_is_one, libflint), Bool, (Ref{QQAbsPowerSeriesRingElem},), a)
end
...
function similar(f::AbsPowerSeriesRingElem, R::QQField, max_prec::Int, s::Symbol=var(parent(f)); cached::Bool=true)
  z = QQAbsPowerSeriesRingElem()
  if base_ring(f) === R && s == var(parent(f)) && f isa QQAbsPowerSeriesRingElem && max_precision(parent(f)) == max_prec
...
function abs_series(R::QQField, arr::Vector{T}, len::Int, prec::Int, var::VarName=:x; max_precision::Int=prec, cached::Bool=true) where {T}
...
function -(x::QQAbsPowerSeriesRingElem)
  z = parent(x)()
  ccall((:fmpq_poly_neg, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}), z, x)
  z.prec = x.prec
  return z
end
...
function +(a::QQAbsPowerSeriesRingElem, b::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = prec
  ccall((:fmpq_poly_add_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, b, lenz)
  return z
end
...
function -(a::QQAbsPowerSeriesRingElem, b::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = prec
  ccall((:fmpq_poly_sub_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, b, lenz)
  return z
end
...
function *(a::QQAbsPowerSeriesRingElem, b::QQAbsPowerSeriesRingElem)
  ...
  ccall((:fmpq_poly_mullow, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, b, lenz)
  return z
end
...
function *(x::Int, y::QQAbsPowerSeriesRingElem)
  z = parent(y)()
  z.prec = y.prec
  ccall((:fmpq_poly_scalar_mul_si, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, y, x)
  return z
end
...
function *(x::ZZRingElem, y::QQAbsPowerSeriesRingElem)
  z = parent(y)()
  z.prec = y.prec
  ccall((:fmpq_poly_scalar_mul_fmpz, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Ref{ZZRingElem}), z, y, x)
  return z
end
...
function *(x::QQFieldElem, y::QQAbsPowerSeriesRingElem)
  z = parent(y)()
  z.prec = y.prec
  ccall((:fmpq_poly_scalar_mul_fmpq, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Ref{QQFieldElem}), z, y, x)
  return z
end
...
function shift_left(x::QQAbsPowerSeriesRingElem, len::Int)
  ...
  ccall((:fmpq_poly_shift_left, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, x, len)
  ccall((:fmpq_poly_set_trunc, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, z, zlen)
  return z
end
...
function shift_right(x::QQAbsPowerSeriesRingElem, len::Int)
  ...
  if len >= xlen
    ...
    z.prec = x.prec - len
    ccall((:fmpq_poly_shift_right, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, x, len)
  end
  return z
end
...
function truncate(x::QQAbsPowerSeriesRingElem, prec::Int)
  ...
  z = parent(x)()
  z.prec = prec
  ccall((:fmpq_poly_set_trunc, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, x, prec)
  return z
end
...
function ==(x::QQAbsPowerSeriesRingElem, y::QQAbsPowerSeriesRingElem)
  ...
  return Bool(ccall((:fmpq_poly_equal_trunc, libflint), Cint, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), x, y, n))
end
...
function isequal(x::QQAbsPowerSeriesRingElem, y::QQAbsPowerSeriesRingElem)
  ...
  return Bool(ccall((:fmpq_poly_equal, libflint), Cint, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}), x, y))
end
...
function divexact(x::QQAbsPowerSeriesRingElem, y::QQAbsPowerSeriesRingElem; check::Bool=true)
  ...
  z = parent(x)()
  z.prec = prec
  ccall((:fmpq_poly_div_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, x, y, prec)
  return z
end
...
function divexact(x::QQAbsPowerSeriesRingElem, y::Int; check::Bool=true)
  ...
  z = parent(x)()
  z.prec = x.prec
  ccall((:fmpq_poly_scalar_div_si, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, x, y)
  return z
end
...
function divexact(x::QQAbsPowerSeriesRingElem, y::ZZRingElem; check::Bool=true)
  ...
  z = parent(x)()
  z.prec = x.prec
  ccall((:fmpq_poly_scalar_div_fmpz, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Ref{ZZRingElem}), z, x, y)
  return z
end
...
function divexact(x::QQAbsPowerSeriesRingElem, y::QQFieldElem; check::Bool=true)
  ...
  z = parent(x)()
  z.prec = x.prec
  ccall((:fmpq_poly_scalar_div_fmpq, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Ref{QQFieldElem}), z, x, y)
  return z
end
...
function inv(a::QQAbsPowerSeriesRingElem)
  ...
  ainv = parent(a)()
  ainv.prec = a.prec
  ccall((:fmpq_poly_inv_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), ainv, a, a.prec)
  return ainv
end
...
function Base.exp(a::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = a.prec
  ccall((:fmpq_poly_exp_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, a.prec)
  return z
end
...
function log(a::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = a.prec
  ccall((:fmpq_poly_log_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, a.prec)
  return z
end
...
function tan(a::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = a.prec
  ccall((:fmpq_poly_tan_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, a.prec)
  return z
end
...
function tanh(a::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = a.prec
  ccall((:fmpq_poly_tanh_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, a.prec)
  return z
end
...
function sin(a::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = a.prec
  ccall((:fmpq_poly_sin_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, a.prec)
  return z
end
...
function sinh(a::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = a.prec
  ccall((:fmpq_poly_sinh_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, a.prec)
  return z
end
...
function cos(a::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = a.prec
  ccall((:fmpq_poly_cos_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, a.prec)
  return z
end
...
function cosh(a::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = a.prec
  ccall((:fmpq_poly_cosh_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, a.prec)
  return z
end
...
function asin(a::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = a.prec
  ccall((:fmpq_poly_asin_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, a.prec)
  return z
end
...
function asinh(a::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = a.prec
  ccall((:fmpq_poly_asinh_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, a.prec)
  return z
end
...
function atan(a::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = a.prec
  ccall((:fmpq_poly_atan_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, a.prec)
  return z
end
...
function atanh(a::QQAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = a.prec
  ccall((:fmpq_poly_atanh_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, a.prec)
  return z
end
...
function Base.sqrt(a::QQAbsPowerSeriesRingElem; check::Bool=true)
  ...
  a = divexact(a, c)
  z.prec = a.prec - div(v, 2)
  ccall((:fmpq_poly_sqrt_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), z, a, a.prec)
  if !isone(s)
    z *= s
  end
  if !iszero(v)
...
function zero!(z::QQAbsPowerSeriesRingElem)
  ccall((:fmpq_poly_zero, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem},), z)
  z.prec = parent(z).prec_max
  return z
end

function fit!(z::QQAbsPowerSeriesRingElem, n::Int)
  ccall((:fmpq_poly_fit_length, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Int), z, n)
  return nothing
end

function setcoeff!(z::QQAbsPowerSeriesRingElem, n::Int, x::QQFieldElem)
  ccall((:fmpq_poly_set_coeff_fmpq, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Int, Ref{QQFieldElem}), z, n, x)
  return z
end
...
function addeq!(a::QQAbsPowerSeriesRingElem, b::QQAbsPowerSeriesRingElem)
  ...
  lenz = max(lena, lenb)
  a.prec = prec
  ccall((:fmpq_poly_add_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), a, a, b, lenz)
  return a
end
...
function add!(c::QQAbsPowerSeriesRingElem, a::QQAbsPowerSeriesRingElem, b::QQAbsPowerSeriesRingElem)
  ...
  lenc = max(lena, lenb)
  c.prec = prec
  ccall((:fmpq_poly_add_series, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}, Int), c, a, b, lenc)
  return c
end

function set_length!(a::QQAbsPowerSeriesRingElem, n::Int)
  ccall((:_fmpq_poly_set_length, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Int), a, n)
  return a
end

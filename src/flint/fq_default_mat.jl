...
function getindex!(v::FqFieldElem, a::FqMatrix, i::Int, j::Int)
  ...
  ccall((:fq_default_mat_entry, libflint), Ptr{FqFieldElem}, (Ref{FqFieldElem}, Ref{FqMatrix}, Int, Int, Ref{FqField}), v, a, i - 1, j - 1, base_ring(a))
  return v
end
...
@inline function getindex(a::FqMatrix, i::Int, j::Int)
  @boundscheck Generic._checkbounds(a, i, j)
  z = base_ring(a)()
  ccall((:fq_default_mat_entry, libflint), Ptr{FqFieldElem}, (Ref{FqFieldElem}, Ref{FqMatrix}, Int, Int, Ref{FqField}), z, a, i - 1, j - 1, base_ring(a))
  return z
end

@inline function setindex!(a::FqMatrix, u::FqFieldElem, i::Int, j::Int)
  @boundscheck Generic._checkbounds(a, i, j)
  ccall((:fq_default_mat_entry_set, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{FqFieldElem}, Ref{FqField}), a, i - 1, j - 1, u, base_ring(a))
  nothing
end

@inline function setindex!(a::FqMatrix, u::ZZRingElem, i::Int, j::Int)
  @boundscheck Generic._checkbounds(a, i, j)
  ccall((:fq_default_mat_entry_set_fmpz, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{ZZRingElem}, Ref{FqField}), a, i - 1, j - 1, u, base_ring(a))
  nothing
end
...
function setindex!(a::FqMatrix, b::FqMatrix, r::UnitRange{Int64}, c::UnitRange{Int64})
  ...
  A = view(a, r, c)
  ccall((:fq_default_mat_set, libflint), Nothing, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), A, b, base_ring(a))
end

function deepcopy_internal(a::FqMatrix, dict::IdDict)
  z = FqMatrix(nrows(a), ncols(a), base_ring(a))
  ccall((:fq_default_mat_set, libflint), Nothing, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), z, a, base_ring(a))
  return z
end

function number_of_rows(a::FqMatrix)
  return ccall((:fq_default_mat_nrows, libflint), Int, (Ref{FqMatrix}, Ref{FqField}), a, base_ring(a))
end

function number_of_columns(a::FqMatrix)
  return ccall((:fq_default_mat_ncols, libflint), Int, (Ref{FqMatrix}, Ref{FqField}), a, base_ring(a))
end
...
function iszero(a::FqMatrix)
  r = ccall((:fq_default_mat_is_zero, libflint), Cint, (Ref{FqMatrix}, Ref{FqField}), a, base_ring(a))
  return Bool(r)
end
...
function ==(a::FqMatrix, b::FqMatrix)
  ...
  r = ccall((:fq_default_mat_equal, libflint), Cint, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), a, b, base_ring(a))
  return Bool(r)
end
...
function swap_rows!(x::FqMatrix, i::Int, j::Int)
  ccall((:fq_default_mat_swap_rows, libflint), Nothing, (Ref{FqMatrix}, Ptr{Nothing}, Int, Int, Ref{FqField}), x, C_NULL, i - 1, j - 1, base_ring(x))
  return x
end
...
function swap_cols!(x::FqMatrix, i::Int, j::Int)
  ccall((:fq_default_mat_swap_cols, libflint), Nothing, (Ref{FqMatrix}, Ptr{Nothing}, Int, Int, Ref{FqField}), x, C_NULL, i - 1, j - 1, base_ring(x))
  return x
end
...
function reverse_rows!(x::FqMatrix)
  ccall((:fq_default_mat_invert_rows, libflint), Nothing, (Ref{FqMatrix}, Ptr{Nothing}, Ref{FqField}), x, C_NULL, base_ring(x))
  return x
end
...
function reverse_cols!(x::FqMatrix)
  ccall((:fq_default_mat_invert_cols, libflint), Nothing, (Ref{FqMatrix}, Ptr{Nothing}, Ref{FqField}), x, C_NULL, base_ring(x))
  return x
end
...
function -(x::FqMatrix)
  z = similar(x)
  ccall((:fq_default_mat_neg, libflint), Nothing, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), z, x, base_ring(x))
  return z
end
...
function +(x::FqMatrix, y::FqMatrix)
  check_parent(x, y)
  z = similar(x)
  ccall((:fq_default_mat_add, libflint), Nothing, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), z, x, y, base_ring(x))
  return z
end
...
function -(x::FqMatrix, y::FqMatrix)
  check_parent(x, y)
  z = similar(x)
  ccall((:fq_default_mat_sub, libflint), Nothing, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), z, x, y, base_ring(x))
...
function *(x::FqMatrix, y::FqMatrix)
  ...
  ccall((:fq_default_mat_mul, libflint), Nothing, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), z, x, y, base_ring(x))
  return z
end
...
function mul!(a::FqMatrix, b::FqMatrix, c::FqMatrix)
  ccall((:fq_default_mat_mul, libflint), Nothing, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), a, b, c, base_ring(a))
  return a
end

function add!(a::FqMatrix, b::FqMatrix, c::FqMatrix)
  ccall((:fq_default_mat_add, libflint), Nothing, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), a, b, c, base_ring(a))
  return a
end

function zero!(a::FqMatrix)
  ccall((:fq_default_mat_zero, libflint), Nothing, (Ref{FqMatrix}, Ref{FqField}), a, base_ring(a))
  return a
end
...
function Generic.add_one!(a::FqMatrix, i::Int, j::Int)
  ...
  GC.@preserve a begin
    ...
    ccall((:fq_default_neg, libflint), Nothing, (Ptr{FqFieldElem}, Ptr{FqFieldElem}, Ref{FqField}), x, x, F)
    ccall((:fq_default_sub_one, libflint), Nothing, (Ptr{FqFieldElem}, Ptr{FqFieldElem}, Ref{FqField}), x, x, F)
    ccall((:fq_default_neg, libflint), Nothing, (Ptr{FqFieldElem}, Ptr{FqFieldElem}, Ref{FqField}), x, x, F)
  end
  return a
end
...
function rref(a::FqMatrix)
  z = similar(a)
  r = ccall((:fq_default_mat_rref, libflint), Int, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), z, a, base_ring(a))
  return r, z
end

function rref!(a::FqMatrix)
  r = ccall((:fq_default_mat_rref, libflint), Int, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), a, a, base_ring(a))
  return r
end
...
function inv(a::FqMatrix)
  ...
  z = similar(a)
  r = ccall((:fq_default_mat_inv, libflint), Int, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), z, a, base_ring(a))
...
function Solve._can_solve_internal_no_check(A::FqMatrix, b::FqMatrix, task::Symbol; side::Symbol=:left)
  ...
  fl = ccall((:fq_default_mat_can_solve, libflint), Cint, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), x, A, b, base_ring(A))
...
function _solve_tril_right_flint!(x::FqMatrix, L::FqMatrix, B::FqMatrix, unit::Bool)
  ccall((:fq_default_mat_solve_tril, libflint), Nothing, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqMatrix}, Cint, Ref{FqField}), x, L, B, Cint(unit), base_ring(L))
  return nothing
end

function _solve_triu_right_flint!(x::FqMatrix, U::FqMatrix, B::FqMatrix, unit::Bool)
  ccall((:fq_default_mat_solve_triu, libflint), Nothing, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqMatrix}, Cint, Ref{FqField}), x, U, B, Cint(unit), base_ring(U))
  return nothing
end
...
function lu!(P::Generic.Perm, x::FqMatrix)
  ...
  rank = Int(ccall((:fq_default_mat_lu, libflint), Cint, (Ptr{Int}, Ref{FqMatrix}, Cint, Ref{FqField}), P.d, x, 0, base_ring(x)))
...
function Base.view(x::FqMatrix, r1::Int, c1::Int, r2::Int, c2::Int)
  ...
  z.view_parent = x
  ccall((:fq_default_mat_window_init, libflint), Nothing, (Ref{FqMatrix}, Ref{FqMatrix}, Int, Int, Int, Int, Ref{FqField}), z, x, r1 - 1, c1 - 1, r2, c2, base_ring(x))
...
function _fq_default_mat_window_clear_fn(a::FqMatrix)
  ccall((:fq_default_mat_window_clear, libflint), Nothing, (Ref{FqMatrix}, Ref{FqField}), a, base_ring(a))
end
...
function hcat(x::FqMatrix, y::FqMatrix)
  ...
  ccall((:fq_default_mat_concat_horizontal, libflint), Nothing, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), z, x, y, base_ring(x))
  return z
end
...
function vcat(x::FqMatrix, y::FqMatrix)
  ...
  ccall((:fq_default_mat_concat_vertical, libflint), Nothing, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), z, x, y, base_ring(x))
  return z
end
...
function charpoly(R::FqPolyRing, a::FqMatrix)
  ...
  p = R()
  ccall((:fq_default_mat_charpoly, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{FqMatrix}, Ref{FqField}), p, a, base_ring(a))
  return p
end
...
function charpoly_danivlesky!(R::FqPolyRing, a::FqMatrix)
  ...
  base_ring(R) != base_ring(a) && error("Must have common base ring")
  p = R()
  ccall((:fq_default_mat_charpoly_danilevsky, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{FqMatrix}, Ref{FqField}), p, a, base_ring(a))
  return p
end
...
function minpoly(R::FqPolyRing, a::FqMatrix)
  ...
  m = deepcopy(a)
  p = R()
  ccall((:fq_default_mat_minpoly, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{FqMatrix}, Ref{FqField}), p, m, base_ring(a))
  return p
end
...
function (a::FqMatrixSpace)(b::Union{zzModMatrix,fpMatrix})
  characteristic(base_ring(b)) != characteristic(base_ring(a)) && error("Incompatible characteristic")
  (ncols(a) != ncols(b) || nrows(a) != nrows(b)) && error("Dimensions do not fit")
  return FqMatrix(b, base_ring(a))
end
...
function fq_default_mat_entry_ptr(a::FqMatrix, i, j)
  ...
  if t == _FQ_DEFAULT_FQ_ZECH
    pptr = ccall((:fq_zech_mat_entry, libflint), Ptr{FqFieldElem}, (Ptr{Cvoid}, Int, Int), ptr, i - 1, j - 1)
  elseif t == _FQ_DEFAULT_FQ_NMOD
    pptr = ccall((:fq_nmod_mat_entry, libflint), Ptr{FqFieldElem}, (Ptr{Cvoid}, Int, Int), ptr, i - 1, j - 1)
  elseif t == _FQ_DEFAULT_FQ
    pptr = ccall((:fq_mat_entry, libflint), Ptr{FqFieldElem}, (Ptr{Cvoid}, Int, Int), ptr, i - 1, j - 1)
  elseif t == _FQ_DEFAULT_NMOD
    pptr = ccall((:nmod_mat_entry_ptr, libflint), Ptr{FqFieldElem}, (Ptr{Cvoid}, Int, Int), ptr, i - 1, j - 1)
  else#if t == _FQ_DEFAULT_FMPZ_NMOD
    pptr = ccall((:fmpz_mod_mat_entry, libflint), Ptr{FqFieldElem}, (Ptr{Cvoid}, Int, Int), ptr, i - 1, j - 1)
  end
  return pptr
end
...
function nullspace(M::FqMatrix)
  ...
  nullity = ccall((:fq_default_mat_nullspace, libflint), Int, (Ref{FqMatrix}, Ref{FqMatrix}, Ref{FqField}), N, M, base_ring(M))

...
function _checkrange_or_empty(l::Int, start::Int, stop::Int)
  (stop < start) || (Generic._checkbounds(l, start) && Generic._checkbounds(l, stop))
end

function Base.view(x::ZZMatrix, r1::Int, c1::Int, r2::Int, c2::Int)
  _checkrange_or_empty(nrows(x), r1, r2) || Base.throw_boundserror(x, (r1:r2, c1:c2))

  _checkrange_or_empty(ncols(x), c1, c2) || Base.throw_boundserror(x, (r1:r2, c1:c2))
  ...
  b = ZZMatrix()
  b.view_parent = x
  ccall((:fmpz_mat_window_init, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Int, Int, Int, Int), b, x, r1 - 1, c1 - 1, r2, c2)
...
function Base.reshape(x::ZZMatrix, r::Int, c::Int)
  ...
  b = ZZMatrix()
  b.view_parent = x
  ccall((:fmpz_mat_window_init, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Int, Int, Int, Int), b, x, 0, 0, r, c)
  finalizer(_fmpz_mat_window_clear_fn, b)
  return b
end
...
function getindex!(v::ZZRingElem, a::ZZMatrix, r::Int, c::Int)
  GC.@preserve a begin
    z = ccall((:fmpz_mat_entry, libflint), Ptr{ZZRingElem}, (Ref{ZZMatrix}, Int, Int), a, r - 1, c - 1)
...
function setindex!(a::ZZMatrix, b::ZZMatrix, r::UnitRange{Int64}, c::UnitRange{Int64})
  ...
  A = view(a, r, c)
  ccall((:fmpz_mat_set, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}), A, b)
end
...
iszero(a::ZZMatrix) = ccall((:fmpz_mat_is_zero, libflint), Bool, (Ref{ZZMatrix},), a)

isone(a::ZZMatrix) = ccall((:fmpz_mat_is_one, libflint), Bool, (Ref{ZZMatrix},), a)
...
function -(x::ZZMatrix)
  z = similar(x)
  ccall((:fmpz_mat_neg, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}), z, x)
  return z
end
...
function transpose(x::ZZMatrix)
  ...
  ccall((:fmpz_mat_transpose, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}), z, x)
  return z
end

function transpose!(A::ZZMatrix, B::ZZMatrix)
  ccall((:fmpz_mat_transpose, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}), A, B)
  return A
end
...
function swap_rows!(x::ZZMatrix, i::Int, j::Int)
  ccall((:fmpz_mat_swap_rows, libflint), Nothing, (Ref{ZZMatrix}, Ptr{Nothing}, Int, Int), x, C_NULL, i - 1, j - 1)
  return x
end
...
function swap_cols!(x::ZZMatrix, i::Int, j::Int)
  ccall((:fmpz_mat_swap_cols, libflint), Nothing, (Ref{ZZMatrix}, Ptr{Nothing}, Int, Int), x, C_NULL, i - 1, j - 1)
  return x
end
...
function reverse_rows!(x::ZZMatrix)
  ccall((:fmpz_mat_invert_rows, libflint), Nothing, (Ref{ZZMatrix}, Ptr{Nothing}), x, C_NULL)
  return x
end
...
function reverse_cols!(x::ZZMatrix)
  ccall((:fmpz_mat_invert_cols, libflint), Nothing, (Ref{ZZMatrix}, Ptr{Nothing}), x, C_NULL)
  return x
end
...
function +(x::ZZMatrix, y::ZZMatrix)
  check_parent(x, y)
  z = similar(x)
  ccall((:fmpz_mat_add, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZMatrix}), z, x, y)
  return z
end
...
function -(x::ZZMatrix, y::ZZMatrix)
  check_parent(x, y)
  z = similar(x)
  ccall((:fmpz_mat_sub, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZMatrix}), z, x, y)
  return z
end
...
function *(x::ZZMatrix, y::ZZMatrix)
  ...
  ccall((:fmpz_mat_mul, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZMatrix}), z, x, y)
  return z
end
...
function *(x::Int, y::ZZMatrix)
  z = similar(y)
  ccall((:fmpz_mat_scalar_mul_si, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Int), z, y, x)
  return z
end

function *(x::ZZRingElem, y::ZZMatrix)
  z = similar(y)
  ccall((:fmpz_mat_scalar_mul_fmpz, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZRingElem}), z, y, x)
  return z
end
...
function +(x::ZZMatrix, y::Integer)
  z = deepcopy(x)
  for i in 1:min(nrows(x), ncols(x))
    z[i, i] += y
  end
  return z
end
...
function -(x::Integer, y::ZZMatrix)
  z = -y
  for i in 1:min(nrows(y), ncols(y))
    z[i, i] += x
  end
  return z
end
...
function <<(x::ZZMatrix, y::Int)
  ...
  z = similar(x)
  ccall((:fmpz_mat_scalar_mul_2exp, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Int), z, x, y)
  return z
end
...
function >>(x::ZZMatrix, y::Int)
  y < 0 && throw(DomainError(y, "Exponent must be non-negative"))
  z = similar(x)
  ccall((:fmpz_mat_scalar_tdiv_q_2exp, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Int), z, x, y)
  return z
end
...
function ^(x::ZZMatrix, y::Int)
  ...
  z = similar(x)
  ccall((:fmpz_mat_pow, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Int), z, x, y)
  return z
end
...
function ==(x::ZZMatrix, y::ZZMatrix)
  ...
  b && ccall((:fmpz_mat_equal, libflint), Bool, (Ref{ZZMatrix}, Ref{ZZMatrix}), x, y)
end
...
function inv(x::ZZMatrix)
  ...
  z = similar(x)
  d = ZZRingElem()
  ccall((:fmpz_mat_inv, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZRingElem}, Ref{ZZMatrix}), z, d, x)
  if isone(d)
    return z
  end
  if d == -1
...
function divexact(x::ZZMatrix, y::Int; check::Bool=true)
  z = similar(x)
  ccall((:fmpz_mat_scalar_divexact_si, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Int), z, x, y)
  return z
end

function divexact(x::ZZMatrix, y::ZZRingElem; check::Bool=true)
  z = similar(x)
  ccall((:fmpz_mat_scalar_divexact_fmpz, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZRingElem}), z, x, y)
  return z
end
...
function kronecker_product(x::ZZMatrix, y::ZZMatrix)
  ...
  ccall((:fmpz_mat_kronecker_product, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZMatrix}), z, x, y)
  return z
end
...
function reduce_mod(x::ZZMatrix, y::ZZRingElem)
  z = similar(x)
  ccall((:fmpz_mat_scalar_mod_fmpz, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZRingElem}), z, x, y)
  return z
end
...
function fflu(x::ZZMatrix, P=SymmetricGroup(nrows(x)))
  ...
  r = ccall((:fmpz_mat_fflu, libflint), Int, (Ref{ZZMatrix}, Ref{ZZRingElem}, Ptr{Int}, Ref{ZZMatrix}, Int), U, d, p.d, x, 0)
...
function charpoly(R::ZZPolyRing, x::ZZMatrix)
  ...
  z = R()
  ccall((:fmpz_mat_charpoly, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZMatrix}), z, x)
  return z
end
...
function minpoly(R::ZZPolyRing, x::ZZMatrix)
  nrows(x) != ncols(x) && error("Non-square")
  z = R()
  ccall((:fmpz_mat_minpoly, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZMatrix}), z, x)
  return z
end
...
function det(x::ZZMatrix)
  ...
  z = ZZRingElem()
  ccall((:fmpz_mat_det, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZMatrix}), z, x)
  return z
end
...
function det_divisor(x::ZZMatrix)
  nrows(x) != ncols(x) && error("Non-square matrix")
  z = ZZRingElem()
  ccall((:fmpz_mat_det_divisor, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZMatrix}), z, x)
  return z
end
...
function det_given_divisor(x::ZZMatrix, d::ZZRingElem, proved=true)
  nrows(x) != ncols(x) && error("Non-square")
  z = ZZRingElem()
  ccall((:fmpz_mat_det_modular_given_divisor, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZMatrix}, Ref{ZZRingElem}, Cint), z, x, d, proved)
  return z
end
...
function gram(x::ZZMatrix)
  ...
  ccall((:fmpz_mat_gram, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}), z, x)
  return z
end
...
function hadamard(R::ZZMatrixSpace)
  ...
  z = R()
  success = ccall((:fmpz_mat_hadamard, libflint), Bool, (Ref{ZZMatrix},), z)
...
function is_hadamard(x::ZZMatrix)
  return ccall((:fmpz_mat_is_hadamard, libflint), Bool, (Ref{ZZMatrix},), x)
end
...
function __hnf(x)
  z = similar(x)
  ccall((:fmpz_mat_hnf, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}), z, x)
  return z
end
...
function __hnf_with_transform(x::ZZMatrix)
  ...
  ccall((:fmpz_mat_hnf_transform, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZMatrix}), z, u, x)
  return z, u
end
...
function hnf_modular(x::ZZMatrix, d::ZZRingElem)
  z = similar(x)
  ccall((:fmpz_mat_hnf_modular, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZRingElem}), z, x, d)
  return z
end
...
function hnf_modular_eldiv(x::ZZMatrix, d::ZZRingElem)
  (nrows(x) < ncols(x)) && error("Matrix must have at least as many rows as columns")
  z = deepcopy(x)
  ccall((:fmpz_mat_hnf_modular_eldiv, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZRingElem}), z, d)
  return z
end
...
function is_hnf(x::ZZMatrix)
  return ccall((:fmpz_mat_is_in_hnf, libflint), Bool, (Ref{ZZMatrix},), x)
end
...
mutable struct LLLContext
  ...
  function LLLContext(delta::Float64, eta::Float64, rep::Symbol=:zbasis, gram::Symbol=:approx)
    rt = rep == :zbasis ? 1 : 0
    gt = gram == :approx ? 0 : 1
...
function lll_with_transform(x::ZZMatrix, ctx::LLLContext=LLLContext(0.99, 0.51))
  ...
  ccall((:fmpz_lll, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{LLLContext}), z, u, ctx)
  return z, u
end
...
function lll!(x::ZZMatrix, ctx::LLLContext=LLLContext(0.99, 0.51))
  ...
  ccall((:fmpz_lll, libflint), Nothing, (Ref{ZZMatrix}, Ptr{nothing}, Ref{LLLContext}), x, C_NULL, ctx)
  return x
end
...
function lll_with_removal_transform(x::ZZMatrix, b::ZZRingElem, ctx::LLLContext=LLLContext(0.99, 0.51))
  ...
  d = Int(ccall((:fmpz_lll_with_removal, libflint), Cint, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZRingElem}, Ref{LLLContext}), z, u, b, ctx))
  return d, z, u
end
...
function lll_with_removal(x::ZZMatrix, b::ZZRingElem, ctx::LLLContext=LLLContext(0.99, 0.51))
  z = deepcopy(x)
  d = Int(ccall((:fmpz_lll_with_removal, libflint), Cint, (Ref{ZZMatrix}, Ptr{Nothing}, Ref{ZZRingElem}, Ref{LLLContext}), z, C_NULL, b, ctx))
  return d, z
end
...
function nullspace_right_rational(x::ZZMatrix)
  ...
  rank = ccall((:fmpz_mat_nullspace, libflint), Int, (Ref{ZZMatrix}, Ref{ZZMatrix}), u, x)
  return rank, u
end
...
function rank(x::ZZMatrix)
  return ccall((:fmpz_mat_rank, libflint), Int, (Ref{ZZMatrix},), x)
end
...
function rref(x::ZZMatrix)
  z = similar(x)
  d = ZZRingElem()
  r = ccall((:fmpz_mat_rref, libflint), Int, (Ref{ZZMatrix}, Ref{ZZRingElem}, Ref{ZZMatrix}), z, d, x)
  return r, z, d
end
...
function snf(x::ZZMatrix)
  z = similar(x)
  ccall((:fmpz_mat_snf, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}), z, x)
  return z
end
...
function snf_diagonal(x::ZZMatrix)
  z = similar(x)
  ccall((:fmpz_mat_snf_diagonal, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}), z, x)
  return z
end
...
function is_snf(x::ZZMatrix)
  return ccall((:fmpz_mat_is_in_snf, libflint), Bool, (Ref{ZZMatrix},), x)
end
...
function Base.cat(A::ZZMatrix...; dims)
  ...
  X = zero_matrix(ZZ, sum(nrows(x) for x in A), sum(ncols(x) for x in A))
...
function _solve_rational(a::ZZMatrix, b::ZZMatrix)
  ...
  z = similar(b)
  d = ZZRingElem()
  nonsing = ccall((:fmpz_mat_solve, libflint), Bool, (Ref{ZZMatrix}, Ref{ZZRingElem}, Ref{ZZMatrix}, Ref{ZZMatrix}), z, d, a, b)
...
function _solve_dixon(a::ZZMatrix, b::ZZMatrix)
  ...
  z = similar(b)
  d = ZZRingElem()
  nonsing = ccall((:fmpz_mat_solve_dixon, libflint), Bool, (Ref{ZZMatrix}, Ref{ZZRingElem}, Ref{ZZMatrix}, Ref{ZZMatrix}), z, d, a, b)
  ...
  GC.@preserve X b tmp begin
    for i in 1:m
      ...
      for j in 1:n
        ...
        ccall((:fmpz_sub, Nemo.libflint), Cvoid, (Ref{ZZRingElem}, Ptr{ZZRingElem}, Ref{ZZRingElem}), s, mat_entry_ptr(b, i, j), s)
        ccall((:fmpz_divexact, Nemo.libflint), Cvoid, (Ptr{ZZRingElem}, Ref{ZZRingElem}, Ptr{ZZRingElem}), mat_entry_ptr(tmp, 1, j), s, mat_entry_ptr(U, j, j))
      end
      tmp_p = mat_entry_ptr(tmp, 1, 1)
      X_p = mat_entry_ptr(X, i, 1)
      for j in 1:n
...
function tr(x::ZZMatrix)
  ...
  d = ZZRingElem()
  ccall((:fmpz_mat_trace, libflint), Int, (Ref{ZZRingElem}, Ref{ZZMatrix}), d, x)
  return d
end
...
function content(x::ZZMatrix)
  d = ZZRingElem()
  ccall((:fmpz_mat_content, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZMatrix}), d, x)
  return d
end
...
function hcat(a::ZZMatrix, b::ZZMatrix)
  ...
  ccall((:fmpz_mat_concat_horizontal, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZMatrix}), c, a, b)
  return c
end
...
function vcat(a::ZZMatrix, b::ZZMatrix)
  ...
  ccall((:fmpz_mat_concat_vertical, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZMatrix}), c, a, b)
  return c
end
...
function mul!(z::ZZMatrix, x::ZZMatrix, y::ZZMatrix, fl::Bool=false)
  if fl
    n = similar(z)
    ccall((:fmpz_mat_mul, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZMatrix}), n, x, y)
    add!(z, z, n)
  else
    ccall((:fmpz_mat_mul, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZMatrix}), z, x, y)
  end
...
function mul!(y::ZZMatrix, x::Int)
  ccall((:fmpz_mat_scalar_mul_si, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Int), y, y, x)
  return y
end

function mul!(y::ZZMatrix, x::ZZRingElem)
  ccall((:fmpz_mat_scalar_mul_fmpz, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZRingElem}), y, y, x)
  return y
end

function addmul!(z::ZZMatrix, y::ZZMatrix, x::ZZRingElem)
  ccall((:fmpz_mat_scalar_addmul_fmpz, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZRingElem}), z, y, x)
  return z
end

function addmul!(z::ZZMatrix, y::ZZMatrix, x::Int)
  ccall((:fmpz_mat_scalar_addmul_si, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Int), z, y, x)
  return z
end

function addeq!(z::ZZMatrix, x::ZZMatrix)
  ccall((:fmpz_mat_add, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}, Ref{ZZMatrix}), z, z, x)
  return z
end

function zero!(z::ZZMatrix)
  ccall((:fmpz_mat_zero, libflint), Nothing, (Ref{ZZMatrix},), z)
  return z
end

function mul!(z::Vector{ZZRingElem}, a::ZZMatrix, b::Vector{ZZRingElem})
  ccall((:fmpz_mat_mul_fmpz_vec_ptr, libflint), Nothing, (Ptr{Ref{ZZRingElem}}, Ref{ZZMatrix}, Ptr{Ref{ZZRingElem}}, Int), z, a, b, length(b))
  return z
end

function mul!(z::Vector{ZZRingElem}, a::Vector{ZZRingElem}, b::ZZMatrix)
  ccall((:fmpz_mat_fmpz_vec_mul_ptr, libflint), Nothing, (Ptr{Ref{ZZRingElem}}, Ptr{Ref{ZZRingElem}}, Int, Ref{ZZMatrix}), z, a, length(a), b)
  return z
end
...
function Generic.add_one!(a::ZZMatrix, i::Int, j::Int)
  ...
  GC.@preserve a begin
    x = mat_entry_ptr(a, i, j)
    ccall((:fmpz_add_si, libflint), Nothing, (Ptr{ZZRingElem}, Ptr{ZZRingElem}, Int), x, x, 1)
  end
  return a
end
...
@inline mat_entry_ptr(A::ZZMatrix, i::Int, j::Int) = ccall((:fmpz_mat_entry, libflint), Ptr{ZZRingElem}, (Ref{ZZMatrix}, Int, Int), A, i - 1, j - 1)

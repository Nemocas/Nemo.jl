...
function ==(x::fpPolyRingElem, y::fpFieldElem)
  ...
  if length(x) > 1
    return false
  elseif length(x) == 1
    u = ccall((:nmod_poly_get_coeff_ui, libflint), UInt, (Ref{fpPolyRingElem}, Int), x, 0)
    return u == y
  else
    return iszero(y)
  end
...
function divexact(x::fpPolyRingElem, y::fpPolyRingElem; check::Bool=true)
  ...
  z = parent(x)()
  ccall((:nmod_poly_div, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{fpPolyRingElem}, Ref{fpPolyRingElem}), z, x, y)
  return z
end
...
function Base.divrem(x::fpPolyRingElem, y::fpPolyRingElem)
  ...
  q = parent(x)()
  r = parent(x)()
  ccall((:nmod_poly_divrem, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{fpPolyRingElem}, Ref{fpPolyRingElem}, Ref{fpPolyRingElem}), q, r, x, y)
  return q, r
end
...
function Base.div(x::fpPolyRingElem, y::fpPolyRingElem)
  ...
  iszero(y) && throw(DivideError())
  q = parent(x)()
  ccall((:nmod_poly_div, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{fpPolyRingElem}, Ref{fpPolyRingElem}), q, x, y)
  return q
end
...
function rem(x::fpPolyRingElem, y::fpPolyRingElem)
  ...
  iszero(y) && throw(DivideError())
  z = parent(x)()
  ccall((:nmod_poly_rem, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{fpPolyRingElem}, Ref{fpPolyRingElem}), z, x, y)
  return z
end
...
function gcd(x::fpPolyRingElem, y::fpPolyRingElem)
  check_parent(x, y)
  z = parent(x)()
  ccall((:nmod_poly_gcd, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{fpPolyRingElem}, Ref{fpPolyRingElem}), z, x, y)
  return z
end
...
function gcdx(x::fpPolyRingElem, y::fpPolyRingElem)
  ...
  s = parent(x)()
  t = parent(x)()
  ccall((:nmod_poly_xgcd, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{fpPolyRingElem}, Ref{fpPolyRingElem}, Ref{fpPolyRingElem}, Ref{fpPolyRingElem}), g, s, t, x, y)
  return g, s, t
end
...
function gcdinv(x::fpPolyRingElem, y::fpPolyRingElem)
  ...
  g = parent(x)()
  s = parent(x)()
  ccall((:nmod_poly_gcdinv, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{fpPolyRingElem}, Ref{fpPolyRingElem}, Ref{fpPolyRingElem}), g, s, x, y)
  return g, s
end
...
function resultant(x::fpPolyRingElem, y::fpPolyRingElem, check::Bool=true)
  ...
  r = ccall((:nmod_poly_resultant, libflint), UInt, (Ref{fpPolyRingElem}, Ref{fpPolyRingElem}), x, y)
...
function evaluate(x::fpPolyRingElem, y::fpFieldElem)
  base_ring(x) != parent(y) && error("Elements must have same parent")
  z = ccall((:nmod_poly_evaluate_nmod, libflint), UInt, (Ref{fpPolyRingElem}, UInt), x, y.data)
  return parent(y)(z)
end
...
function interpolate(R::fpPolyRing, x::Vector{fpFieldElem}, y::Vector{fpFieldElem})
  z = R()
  ...
  ccall((:nmod_poly_interpolate_nmod_vec, libflint), Nothing, (Ref{fpPolyRingElem}, Ptr{UInt}, Ptr{UInt}, Int), z, ax, ay, length(x))
  return z
end
...
function lift(R::ZZPolyRing, y::fpPolyRingElem)
  z = ZZPolyRingElem()
  ccall((:fmpz_poly_set_nmod_poly_unsigned, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{fpPolyRingElem}), z, y)
  z.parent = R
  return z
end
...
function is_irreducible(x::fpPolyRingElem)
  return Bool(ccall((:nmod_poly_is_irreducible, libflint), Int32, (Ref{fpPolyRingElem},), x))
end
...
function is_squarefree(x::fpPolyRingElem)
  return Bool(ccall((:nmod_poly_is_squarefree, libflint), Int32, (Ref{fpPolyRingElem},), x))
end
...
function sqrt(x::fpPolyRingElem; check::Bool=true)
  R = parent(x)
  s = R()
  flag = Bool(ccall((:nmod_poly_sqrt, libflint), Cint, (Ref{fpPolyRingElem}, Ref{fpPolyRingElem}), s, x))
...
function _factor(x::fpPolyRingElem)
  ...
  z = ccall((:nmod_poly_factor, libflint), UInt, (Ref{gfp_poly_factor}, Ref{fpPolyRingElem}), fac, x)
  res = Dict{fpPolyRingElem,Int}()
  for i in 1:(fac.num)
    f = parent(x)()
    ccall((:nmod_poly_factor_get_poly, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{gfp_poly_factor}, Int), f, fac, i - 1)
...
function _factor_squarefree(x::fpPolyRingElem)
  fac = gfp_poly_factor(x.mod_n)
  ccall((:nmod_poly_factor_squarefree, libflint), UInt, (Ref{gfp_poly_factor}, Ref{fpPolyRingElem}), fac, x)
  res = Dict{fpPolyRingElem,Int}()
  for i in 1:(fac.num)
    f = parent(x)()
    ccall((:nmod_poly_factor_get_poly, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{gfp_poly_factor}, Int), f, fac, i - 1)
...
function factor_distinct_deg(x::fpPolyRingElem)
  ...
  degss = [pointer(degs)]
  fac = gfp_poly_factor(x.mod_n)
  ccall((:nmod_poly_factor_distinct_deg, libflint), UInt, (Ref{gfp_poly_factor}, Ref{fpPolyRingElem}, Ptr{Ptr{Int}}), fac, x, degss)
...
function roots(a::fpPolyRingElem)
  ...
  ccall((:nmod_poly_roots, libflint), UInt, (Ref{nmod_poly_factor}, Ref{fpPolyRingElem}, Cint), fac, a, 0)
  f = R()
  res = fpFieldElem[]
  for i in 1:(fac.num)
    ccall((:nmod_poly_factor_get_poly, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{nmod_poly_factor}, Int), f, fac, i - 1)
...
function remove(z::fpPolyRingElem, p::fpPolyRingElem)
  ...
  z = deepcopy(z)
  v = ccall((:nmod_poly_remove, libflint), Int, (Ref{fpPolyRingElem}, Ref{fpPolyRingElem}), z, p)
  return v, z
end

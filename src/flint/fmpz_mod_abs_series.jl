...
for (etype, rtype, ctype, mtype, brtype, flint_fn) in (
  ...
  @eval begin
    ...
    function normalise(a::($etype), len::Int)
      ...
      if len > 0
        c = ZZRingElem()
        ccall(($(flint_fn * "_get_coeff_fmpz"), libflint), Nothing, (Ref{ZZRingElem}, Ref{($etype)}, Int, Ref{($ctype)}), c, a, len - 1, p)
      end
    ...
    function is_gen(a::($etype))
      return precision(a) == 0 || Bool(ccall(($(flint_fn * "_is_gen"), libflint), Cint, (Ref{($etype)}, Ref{($ctype)}), a, a.parent.base_ring.ninv))
    end
    ...
    function isone(a::($etype))
      return precision(a) == 0 || Bool(ccall(($(flint_fn * "_is_one"), libflint), Cint, (Ref{($etype)}, Ref{($ctype)}), a, a.parent.base_ring.ninv))
    end
    ...
    function similar(f::AbsPowerSeriesRingElem, R::($brtype), max_prec::Int, s::Symbol=var(parent(f)); cached::Bool=true)
    ...
    function abs_series(R::($brtype), arr::Vector{T}, len::Int, prec::Int, var::VarName=:x; max_precision::Int=prec, cached::Bool=true) where {T}
    ...
    function +(a::($etype), b::($etype))
      ...
      z = parent(a)()
      z.prec = prec
      ccall(($(flint_fn * "_add_series"), libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Int, Ref{($ctype)}), z, a, b, lenz, a.parent.base_ring.ninv)
      return z
    end
    ...
    function -(a::($etype), b::($etype))
      ...
      z = parent(a)()
      z.prec = prec
      ccall(($(flint_fn * "_sub_series"), libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Int, Ref{($ctype)}), z, a, b, lenz, a.parent.base_ring.ninv)
      return z
    end
    ...
    *(x::($etype), y::Integer) = y * x
    ...
    function shift_left(x::($etype), len::Int)
      ...
      ccall(($(flint_fn * "_shift_left"), libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Int, Ref{($ctype)}), z, x, len, p)
      ccall(($(flint_fn * "_set_trunc"), libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Int, Ref{($ctype)}), z, z, zlen, p)
      return z
    end
    ...
    function shift_right(x::($etype), len::Int)
      ...
      if len >= xlen
        ...
        z.prec = x.prec - len
        ccall(($(flint_fn * "_shift_right"), libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Int, Ref{($ctype)}), z, x, len, x.parent.base_ring.ninv)
      end
      return z
    end
    ...
    function truncate(x::($etype), prec::Int)
      ...
      z = parent(x)()
      z.prec = prec
      ccall(($(flint_fn * "_set_trunc"), libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Int, Ref{($ctype)}), z, x, prec, x.parent.base_ring.ninv)
      return z
    end
    ...
    function ^(a::($etype), b::Int)
      ...
      elseif b == 0
        ...
        ccall(($(flint_fn * "_pow_trunc"), libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, UInt, Int, Ref{($ctype)}), z, a, b, z.prec, a.parent.base_ring.ninv)
      end
      return z
    end
    ...
    function ==(x::($etype), y::($etype))
      ...
      return Bool(ccall(($(flint_fn * "_equal_trunc"), libflint), Cint, (Ref{($etype)}, Ref{($etype)}, Int, Ref{($ctype)}), x, y, n, x.parent.base_ring.ninv))
    end
    ...
    function ==(x::($etype), y::$(mtype))
      ...
      elseif length(x) == 1
        ...
        return ccall((:fmpz_equal, libflint), Bool, (Ref{ZZRingElem}, Ref{ZZRingElem}), z, y)
      else
    ...
    function divexact(x::($etype), y::$(mtype); check::Bool=true)
      ...
      z = parent(x)()
      z.prec = x.prec
      ccall(($(flint_fn * "_scalar_div_fmpz"), libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{ZZRingElem}, Ref{($ctype)}), z, x, data(y), x.parent.base_ring.ninv)
      return z
    end
    ...
    function divexact(x::($etype), y::ZZRingElem; check::Bool=true)
      ...
      z.prec = x.prec
      r = mod(y, modulus(x))
      ccall(($(flint_fn * "_scalar_div_fmpz"), libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{ZZRingElem}, Ref{($ctype)}), z, x, y, x.parent.base_ring.ninv)
      return z
    end
    ...
    function zero!(z::($etype))
      ccall(($(flint_fn * "_zero"), libflint), Nothing, (Ref{($etype)}, Ref{($ctype)}), z, z.parent.base_ring.ninv)
      z.prec = parent(z).prec_max
      return z
    end

    function fit!(z::($etype), n::Int)
      ccall(($(flint_fn * "_fit_length"), libflint), Nothing, (Ref{($etype)}, Int, Ref{($ctype)}), z, n, z.parent.base_ring.ninv)
      return nothing
    end
    ...
    function addeq!(a::($etype), b::($etype))
      ...
      lenz = max(lena, lenb)
      a.prec = prec
      ccall(($(flint_fn * "_add_series"), libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Int, Ref{($ctype)}), a, a, b, lenz, a.parent.base_ring.ninv)
      return a
    end
    ...
    function add!(c::($etype), a::($etype), b::($etype))
      ...
      lenc = max(lena, lenb)
      c.prec = prec
      ccall(($(flint_fn * "_add_series"), libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Int, Ref{($ctype)}), c, a, b, lenc, a.parent.base_ring.ninv)
      return c
    end
...
function sqrt_classical(a::FpAbsPowerSeriesRingElem; check::Bool=true)
  ...
  a = divexact(a, c)
  z.prec = a.prec - div(v, 2)
  ccall((:fmpz_mod_poly_sqrt_series, libflint), Nothing, (Ref{FpAbsPowerSeriesRingElem}, Ref{FpAbsPowerSeriesRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, a, a.prec, a.parent.base_ring.ninv)
  if !isone(s)
    z *= s
  end
  if !iszero(v)

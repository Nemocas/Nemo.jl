...
function check_parent(a::QadicFieldElem, b::QadicFieldElem)
  parent(a) != parent(b) && error("Incompatible qadic rings in qadic operation")
end
...
function _prime(R::QadicField, n::Int=1)
  z = ZZRingElem()
  ccall((:padic_ctx_pow_ui, libflint), Nothing, (Ref{ZZRingElem}, UInt, Ref{QadicField}), z, n, R)
  return z
end
...
function Base.deepcopy_internal(a::QadicFieldElem, dict::IdDict{Any,Any})
  z = parent(a)()
  z.N = a.N
  ccall((:qadic_set, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicField}), z, a, parent(a))
  return z
end

function Base.hash(a::QadicFieldElem, h::UInt)
  return xor(hash(lift(QQPolyRing(QQ, :x), a), h), xor(hash([prime(parent(a)), degree(parent(a))], h), h))
end
...
function prime(R::QadicField)
  z = ZZRingElem()
  ccall((:padic_ctx_pow_ui, libflint), Nothing, (Ref{ZZRingElem}, UInt, Ref{QadicField}), z, 1, R)
  return z
end
...
function lift(R::QQPolyRing, a::QadicFieldElem)
  ctx = parent(a)
  r = R()
  ccall((:padic_poly_get_fmpq_poly, libflint), Nothing, (Ref{QQPolyRingElem}, Ref{QadicFieldElem}, Ref{QadicField}), r, a, ctx)
  return r
end
...
function lift(R::ZZPolyRing, a::QadicFieldElem)
  ctx = parent(a)
  r = R()
  res = Bool(ccall((:padic_poly_get_fmpz_poly, libflint), Cint, (Ref{ZZPolyRingElem}, Ref{QadicFieldElem}, Ref{QadicField}), r, a, ctx))
...
iszero(a::QadicFieldElem) = Bool(ccall((:qadic_is_zero, libflint), Cint, (Ref{QadicFieldElem},), a))

isone(a::QadicFieldElem) = Bool(ccall((:qadic_is_one, libflint), Cint, (Ref{QadicFieldElem},), a))

is_unit(a::QadicFieldElem) = !Bool(ccall((:qadic_is_zero, libflint), Cint, (Ref{QadicFieldElem},), a))
...
function expressify(b::QadicFieldElem, x=var(parent(b)); context=nothing)
  ...
  for i in degree(parent(b)):-1:0
    ccall((:padic_poly_get_coeff_padic, libflint), Nothing, (Ref{PadicFieldElem}, Ref{QadicFieldElem}, Int, Ref{QadicField}), c, b, i, parent(b))
...
function -(x::QadicFieldElem)
  ...
  ccall((:qadic_neg, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicField}), z, x, ctx)
  z.parent = ctx
  return z
end
...
function +(x::QadicFieldElem, y::QadicFieldElem)
  ...
  z.parent = ctx
  ccall((:qadic_add, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicField}), z, x, y, ctx)
  return z
end
...
function -(x::QadicFieldElem, y::QadicFieldElem)
  ...
  z = QadicFieldElem(min(x.N, y.N))
  z.parent = ctx
  ccall((:qadic_sub, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicField}), z, x, y, ctx)
  return z
end
...
function *(x::QadicFieldElem, y::QadicFieldElem)
  ...
  z.parent = ctx
  ccall((:qadic_mul, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicField}), z, x, y, ctx)
  return z
end
...
function ==(a::QadicFieldElem, b::QadicFieldElem)
  ...
  ccall((:qadic_sub, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicField}), z, a, b, ctx)
  return Bool(ccall((:qadic_is_zero, libflint), Cint, (Ref{QadicFieldElem},), z))
end
...
function ^(a::QadicFieldElem, n::ZZRingElem)
  ...
  z.parent = ctx
  ccall((:qadic_pow, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{ZZRingElem}, Ref{QadicField}), z, a, n, ctx)
  return z
end
...
function inv(a::QadicFieldElem)
  ...
  z.parent = ctx
  ccall((:qadic_inv, libflint), Cint, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicField}), z, a, ctx)
  return z
end
...
function Base.sqrt(a::QadicFieldElem; check::Bool=true)
  ...
  z.parent = ctx
  res = Bool(ccall((:qadic_sqrt, libflint), Cint, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicField}), z, a, ctx))
...
function Base.exp(a::QadicFieldElem)
  ...
  z.parent = ctx
  res = Bool(ccall((:qadic_exp, libflint), Cint, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicField}), z, a, ctx))
...
function log(a::QadicFieldElem)
  ...
  z = QadicFieldElem(a.N)
  z.parent = ctx
  res = Bool(ccall((:qadic_log, libflint), Cint, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicField}), z, a, ctx))
...
function teichmuller(a::QadicFieldElem)
  ...
  z = QadicFieldElem(a.N)
  z.parent = ctx
  ccall((:qadic_teichmuller, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicField}), z, a, ctx)
  return z
end
...
function frobenius(a::QadicFieldElem, e::Int=1)
  ...
  z = QadicFieldElem(a.N)
  z.parent = ctx
  ccall((:qadic_frobenius, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Int, Ref{QadicField}), z, a, e, ctx)
  return z
end
...
function zero!(z::QadicFieldElem)
  ...
  ctx = parent(z)
  ccall((:qadic_zero, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QadicField}), z, ctx)
  return z
end
...
function addeq!(x::QadicFieldElem, y::QadicFieldElem)
  x.N = min(x.N, y.N)
  ctx = parent(x)
  ccall((:qadic_add, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicFieldElem}, Ref{QadicField}), x, x, y, ctx)
  return x
end
...
function gen(R::QadicField)
  if degree(R) == 1
    ...
    a = ZZRingElem()
    GC.@preserve R begin
      ccall((:fmpz_set, libflint), Nothing, (Ref{ZZRingElem}, Ptr{ZZRingElem}), a, reinterpret(Ptr{ZZRingElem}, R.a))
    end
    return R(-a)
  end

  z = QadicFieldElem(R.prec_max)
  ccall((:qadic_gen, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QadicField}), z, R)
  z.parent = R
  return z
end
...
function (R::QadicField)(a::UInt)
  ...
  ccall((:qadic_set_ui, libflint), Nothing, (Ref{QadicFieldElem}, UInt, Ref{QadicField}), z, a, R)
  z.parent = R
  return z
end
...
function (R::QadicField)(a::Int)
  ...
  v = valuation(a, prime(R))
  z = QadicFieldElem(R.prec_max + v)
  ccall((:padic_poly_set_si, libflint), Nothing, (Ref{QadicFieldElem}, Int, Ref{QadicField}), z, a, R)
  z.parent = R
  return z
end
...
function (R::QadicField)(n::ZZRingElem)
  ...
  ccall((:padic_poly_set_fmpz, libflint), Nothing, (Ref{QadicFieldElem}, Ref{ZZRingElem}, Ref{QadicField}), z, n, R)
  z.parent = R
  return z
end
...
function (R::QadicField)(n::QQFieldElem)
  ...
  z = QadicFieldElem(N + R.prec_max)
  ccall((:padic_poly_set_fmpq, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QQFieldElem}, Ref{QadicField}), z, n, R)
  z.parent = R
  return z
end
...
function (R::QadicField)(n::ZZPolyRingElem, pr::Int=R.prec_max)
  z = QadicFieldElem(pr)
  ccall((:qadic_set_fmpz_poly, libflint), Nothing, (Ref{QadicFieldElem}, Ref{ZZPolyRingElem}, Ref{QadicField}), z, n, R)
  z.parent = R
  return z
end
...
function (R::QadicField)(n::QQPolyRingElem)
  ...
  z = QadicFieldElem(N + R.prec_max)
  ccall((:padic_poly_set_fmpq_poly, libflint), Nothing, (Ref{QadicFieldElem}, Ref{QQPolyRingElem}, Ref{QadicField}), z, n, R)
  z.parent = R
  return z
end

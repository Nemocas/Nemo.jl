...
function *(x::FpFieldElem, y::FpFieldElem)
  ...
  R = parent(x)
  d = ZZRingElem()
  ccall((:fmpz_mod_mul, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), d, x.data, y.data, R.ninv)
  return FpFieldElem(d, R)
end
...
function ^(x::FpFieldElem, y::Int)
  ...
  d = ZZRingElem()
  ccall((:fmpz_mod_pow_ui, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, UInt, Ref{fmpz_mod_ctx_struct}), d, x.data, y, R.ninv)
  return FpFieldElem(d, R)
end
...
function ^(x::FpFieldElem, y::ZZRingElem)
  R = parent(x)
  z = R()
  if 0 == ccall((:fmpz_mod_pow_fmpz, libflint), Cint, (Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z.data, x.data, y, R.ninv)
    if iszero(x)
      throw(DivideError())
    else
...
function inv(x::FpFieldElem)
  ...
  s = ZZRingElem()
  g = ZZRingElem()
  ccall((:fmpz_gcdinv, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}), g, s, x.data, R.n)
...
function Base.sqrt(a::FpFieldElem; check::Bool=true)
  ...
  z = ZZRingElem()
  flag = ccall((:fmpz_sqrtmod, libflint), Bool, (Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}), z, a.data, R.n)
...
function is_square(a::FpFieldElem)
  ...
  r = ccall((:fmpz_jacobi, libflint), Cint, (Ref{ZZRingElem}, Ref{ZZRingElem}), a.data, R.n)
  return isone(r)
end
...
function is_square_with_sqrt(a::FpFieldElem)
  ...
  z = ZZRingElem()
  r = ccall((:fmpz_sqrtmod, libflint), Cint, (Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}), z, a.data, R.n)
  if iszero(r)
    return false, zero(R)
  end
...
function zero!(z::FpFieldElem)
  ccall((:fmpz_set_ui, libflint), Nothing, (Ref{ZZRingElem}, UInt), z.data, UInt(0))
  return z
end

function mul!(z::FpFieldElem, x::FpFieldElem, y::FpFieldElem)
  R = parent(z)
  ccall((:fmpz_mod_mul, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z.data, x.data, y.data, R.ninv)
  return z
end

function addeq!(z::FpFieldElem, x::FpFieldElem)
  R = parent(z)
  ccall((:fmpz_mod_add, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z.data, z.data, x.data, R.ninv)
  return z
end

function add!(z::FpFieldElem, x::FpFieldElem, y::FpFieldElem)
  R = parent(z)
  ccall((:fmpz_mod_add, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z.data, x.data, y.data, R.ninv)
  return z
end
...
Random.Sampler(::Type{RNG}, R::FpField, n::Random.Repetition) where {RNG<:AbstractRNG} = Random.SamplerSimple(R, Random.Sampler(RNG, BigInt(0):(BigInt(R.n) - 1), n))
...
rand(rng::AbstractRNG, sp::SamplerTrivial{<:Make2{FpFieldElem,FpField,<:AbstractArray{<:IntegerUnion}}}) = sp[][1](rand(rng, sp[][2]))
...
function (R::FpField)(a::ZZRingElem)
  d = ZZRingElem()
  ccall((:fmpz_mod, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}), d, a, R.n)
  return FpFieldElem(d, R)
end

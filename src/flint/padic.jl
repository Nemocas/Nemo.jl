...
function check_parent(a::PadicFieldElem, b::PadicFieldElem)
  parent(a) != parent(b) && error("Incompatible padic rings in padic operation")
end
...
function Base.deepcopy_internal(a::PadicFieldElem, dict::IdDict)
  ...
  ccall((:padic_set, libflint), Nothing, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), z, a, parent(a))
  return z
end
...
function prime(R::PadicField)
  z = ZZRingElem()
  ccall((:padic_ctx_pow_ui, libflint), Nothing, (Ref{ZZRingElem}, Int, Ref{PadicField}), z, 1, R)
  return z
end
...
function lift(R::QQField, a::PadicFieldElem)
  ctx = parent(a)
  r = QQFieldElem()
  ccall((:padic_get_fmpq, libflint), Nothing, (Ref{QQFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), r, a, ctx)
  return r
end
...
function lift(R::ZZRing, a::PadicFieldElem)
  ctx = parent(a)
  r = ZZRingElem()
  ccall((:padic_get_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{PadicFieldElem}, Ref{PadicField}), r, a, ctx)
  return r
end
...
iszero(a::PadicFieldElem) = Bool(ccall((:padic_is_zero, libflint), Cint, (Ref{PadicFieldElem},), a))

isone(a::PadicFieldElem) = Bool(ccall((:padic_is_one, libflint), Cint, (Ref{PadicFieldElem},), a))

is_unit(a::PadicFieldElem) = !Bool(ccall((:padic_is_zero, libflint), Cint, (Ref{PadicFieldElem},), a))
...
function -(x::PadicFieldElem)
  ...
  ccall((:padic_neg, libflint), Nothing, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), z, x, ctx)
  z.parent = ctx
  return z
end
...
function +(x::PadicFieldElem, y::PadicFieldElem)
  ...
  z.parent = ctx
  ccall((:padic_add, libflint), Nothing, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), z, x, y, ctx)
  return z
end
...
function -(x::PadicFieldElem, y::PadicFieldElem)
  ...
  z = PadicFieldElem(min(x.N, y.N))
  z.parent = ctx
  ccall((:padic_sub, libflint), Nothing, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), z, x, y, ctx)
  return z
end
...
function *(x::PadicFieldElem, y::PadicFieldElem)
  ...
  z.parent = ctx
  ccall((:padic_mul, libflint), Nothing, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), z, x, y, ctx)
  return z
end
...
function ==(a::PadicFieldElem, b::PadicFieldElem)
  ...
  ccall((:padic_sub, libflint), Nothing, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), z, a, b, ctx)
  return Bool(ccall((:padic_is_zero, libflint), Cint, (Ref{PadicFieldElem},), z))
end
...
function ^(a::PadicFieldElem, n::Int)
  ...
  z.parent = ctx
  ccall((:padic_pow_si, libflint), Nothing, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Int, Ref{PadicField}), z, a, n, ctx)
  return z
end
...
function divexact(a::PadicFieldElem, b::PadicFieldElem; check::Bool=true)
  ...
  z.parent = ctx
  ccall((:padic_div, libflint), Cint, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), z, a, b, ctx)
  return z
end
...
function inv(a::PadicFieldElem)
  ...
  z.parent = ctx
  ccall((:padic_inv, libflint), Cint, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), z, a, ctx)
  return z
end
...
function Base.sqrt(a::PadicFieldElem; check::Bool=true)
  ...
  z.parent = ctx
  res = Bool(ccall((:padic_sqrt, libflint), Cint, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), z, a, ctx))
...
function is_square(a::PadicFieldElem)
  ...
  R = parent(a)
  u = ZZRingElem()
  ccall((:padic_get_unit, libflint), Nothing, (Ref{ZZRingElem}, Ref{PadicFieldElem}), u, a)
  p = prime(R)
  if p == 2
    umod = mod(u, 8)
    return umod == 1
...
function Base.exp(a::PadicFieldElem)
  ...
  z.parent = ctx
  res = Bool(ccall((:padic_exp, libflint), Cint, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), z, a, ctx))
...
function log(a::PadicFieldElem)
  ...
  res = Bool(ccall((:padic_log, libflint), Cint, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), z, a, ctx))
...
function teichmuller(a::PadicFieldElem)
  ...
  z = PadicFieldElem(a.N)
  z.parent = ctx
  ccall((:padic_teichmuller, libflint), Nothing, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), z, a, ctx)
  return z
end
...
function zero!(z::PadicFieldElem)
  ...
  ctx = parent(z)
  ccall((:padic_zero, libflint), Nothing, (Ref{PadicFieldElem}, Ref{PadicField}), z, ctx)
  return z
end
...
function addeq!(x::PadicFieldElem, y::PadicFieldElem)
  x.N = min(x.N, y.N)
  ctx = parent(x)
  ccall((:padic_add, libflint), Nothing, (Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicFieldElem}, Ref{PadicField}), x, x, y, ctx)
  return x
end
...
function (R::PadicField)(n::ZZRingElem)
  ...
  ccall((:padic_set_fmpz, libflint), Nothing, (Ref{PadicFieldElem}, Ref{ZZRingElem}, Ref{PadicField}), z, n, R)
  z.parent = R
  return z
end
...
function (R::PadicField)(n::QQFieldElem)
  ...
  z = PadicFieldElem(N + R.prec_max)
  ccall((:padic_set_fmpq, libflint), Nothing, (Ref{PadicFieldElem}, Ref{QQFieldElem}, Ref{PadicField}), z, n, R)
  z.parent = R
  return z
end

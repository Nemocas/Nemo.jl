...
function linear_factor(x::fqPolyRepPolyRingElem)
  y = parent(x)()
  ccall((:fq_nmod_poly_factor_split_single, libflint), Nothing, (Ref{fqPolyRepPolyRingElem}, Ref{fqPolyRepPolyRingElem}, Ref{fqPolyRepField}), y, x, base_ring(x))
  return y
end
...
function embed_gens(k::fqPolyRepField, K::fqPolyRepField)
  ...
  ccall((:fq_nmod_embed_gens, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepFieldElem}, Ref{fpPolyRingElem}, Ref{fqPolyRepField}, Ref{fqPolyRepField}), a, b, P, k, K)
...
function embed_matrices(k::fqPolyRepField, K::fqPolyRepField)
  ...
  ccall(
    (:fq_nmod_embed_matrices, libflint),
    Nothing,
...
function setcoeff!(x::fqPolyRepFieldElem, j::Int, c::Int)
  ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Int, UInt), x, j, c)
end

...
function getindex!(v::FqPolyRepFieldElem, a::FqPolyRepMatrix, i::Int, j::Int)
  ...
  GC.@preserve a begin
    z = ccall((:fq_mat_entry, libflint), Ptr{FqPolyRepFieldElem}, (Ref{FqPolyRepMatrix}, Int, Int), a, i - 1, j - 1)
...
@inline function getindex(a::FqPolyRepMatrix, i::Int, j::Int)
  @boundscheck Generic._checkbounds(a, i, j)
  GC.@preserve a begin
    el = ccall((:fq_mat_entry, libflint), Ptr{FqPolyRepFieldElem}, (Ref{FqPolyRepMatrix}, Int, Int), a, i - 1, j - 1)
    z = base_ring(a)()
...
@inline function setindex!(a::FqPolyRepMatrix, u::FqPolyRepFieldElem, i::Int, j::Int)
  @boundscheck Generic._checkbounds(a, i, j)
  ccall((:fq_mat_entry_set, libflint), Nothing, (Ref{FqPolyRepMatrix}, Int, Int, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), a, i - 1, j - 1, u, base_ring(a))
end
...
@inline function setindex!(a::FqPolyRepMatrix, u::ZZRingElem, i::Int, j::Int)
  ...
  GC.@preserve a begin
    el = ccall((:fq_mat_entry, libflint), Ptr{FqPolyRepFieldElem}, (Ref{FqPolyRepMatrix}, Int, Int), a, i - 1, j - 1)
    ccall((:fq_set_fmpz, libflint), Nothing, (Ptr{FqPolyRepFieldElem}, Ref{ZZRingElem}, Ref{FqPolyRepField}), el, u, base_ring(a))
  end
end
...
function setindex!(a::FqPolyRepMatrix, b::FqPolyRepMatrix, r::UnitRange{Int64}, c::UnitRange{Int64})
  ...
  A = view(a, r, c)
  ccall((:fq_mat_set, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), A, b, base_ring(A))
end

function deepcopy_internal(a::FqPolyRepMatrix, dict::IdDict)
  z = FqPolyRepMatrix(nrows(a), ncols(a), base_ring(a))
  ccall((:fq_mat_set, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), z, a, base_ring(a))
  return z
end
...
function iszero(a::FqPolyRepMatrix)
  r = ccall((:fq_mat_is_zero, libflint), Cint, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), a, base_ring(a))
  return Bool(r)
end
...
function ==(a::FqPolyRepMatrix, b::FqPolyRepMatrix)
  ...
  r = ccall((:fq_mat_equal, libflint), Cint, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), a, b, base_ring(a))
  return Bool(r)
end
...
function swap_rows!(x::FqPolyRepMatrix, i::Int, j::Int)
  ccall((:fq_mat_swap_rows, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ptr{Nothing}, Int, Int, Ref{FqPolyRepField}), x, C_NULL, i - 1, j - 1, base_ring(x))
  return x
end
...
function swap_cols!(x::FqPolyRepMatrix, i::Int, j::Int)
  ccall((:fq_mat_swap_cols, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ptr{Nothing}, Int, Int, Ref{FqPolyRepField}), x, C_NULL, i - 1, j - 1, base_ring(x))
  return x
end
...
function reverse_rows!(x::FqPolyRepMatrix)
  ccall((:fq_mat_invert_rows, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ptr{Nothing}, Ref{FqPolyRepField}), x, C_NULL, base_ring(x))
  return x
end
...
function reverse_cols!(x::FqPolyRepMatrix)
  ccall((:fq_mat_invert_cols, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ptr{Nothing}, Ref{FqPolyRepField}), x, C_NULL, base_ring(x))
  return x
end
...
function -(x::FqPolyRepMatrix)
  z = similar(x)
  ccall((:fq_mat_neg, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), z, x, base_ring(x))
  return z
end
...
function +(x::FqPolyRepMatrix, y::FqPolyRepMatrix)
  check_parent(x, y)
  z = similar(x)
  ccall((:fq_mat_add, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), z, x, y, base_ring(x))
  return z
end
...
function -(x::FqPolyRepMatrix, y::FqPolyRepMatrix)
  check_parent(x, y)
  z = similar(x)
  ccall((:fq_mat_sub, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), z, x, y, base_ring(x))
...
function *(x::FqPolyRepMatrix, y::FqPolyRepMatrix)
  ...
  ccall((:fq_mat_mul, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), z, x, y, base_ring(x))
  return z
end
...
function mul!(a::FqPolyRepMatrix, b::FqPolyRepMatrix, c::FqPolyRepMatrix)
  ccall((:fq_mat_mul, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), a, b, c, base_ring(a))
  return a
end

function add!(a::FqPolyRepMatrix, b::FqPolyRepMatrix, c::FqPolyRepMatrix)
  ccall((:fq_mat_add, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), a, b, c, base_ring(a))
  return a
end

function zero!(a::FqPolyRepMatrix)
  ccall((:fq_mat_zero, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), a, base_ring(a))
  return a
end

function mul!(z::Vector{FqPolyRepFieldElem}, a::FqPolyRepMatrix, b::Vector{FqPolyRepFieldElem})
  ccall((:fq_mat_mul_vec_ptr, libflint), Nothing, (Ptr{Ref{FqPolyRepFieldElem}}, Ref{FqPolyRepMatrix}, Ptr{Ref{FqPolyRepFieldElem}}, Int, Ref{FqPolyRepField}), z, a, b, length(b), base_ring(a))
  return z
end

function mul!(z::Vector{FqPolyRepFieldElem}, a::Vector{FqPolyRepFieldElem}, b::FqPolyRepMatrix)
  ccall((:fq_mat_vec_mul_ptr, libflint), Nothing, (Ptr{Ref{FqPolyRepFieldElem}}, Ptr{Ref{FqPolyRepFieldElem}}, Int, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), z, a, length(a), b, base_ring(b))
  return z
end
...
function Generic.add_one!(a::FqPolyRepMatrix, i::Int, j::Int)
  ...
  GC.@preserve a begin
    ...
    ccall((:fq_neg, libflint), Nothing, (Ptr{FqPolyRepFieldElem}, Ptr{FqPolyRepFieldElem}, Ref{FqPolyRepField}), x, x, F)
    ccall((:fq_sub_one, libflint), Nothing, (Ptr{FqPolyRepFieldElem}, Ptr{FqPolyRepFieldElem}, Ref{FqPolyRepField}), x, x, F)
    ccall((:fq_neg, libflint), Nothing, (Ptr{FqPolyRepFieldElem}, Ptr{FqPolyRepFieldElem}, Ref{FqPolyRepField}), x, x, F)
  end
  return a
end
...
function rref(a::FqPolyRepMatrix)
  z = similar(a)
  r = ccall((:fq_mat_rref, libflint), Int, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), z, a, base_ring(a))
  return r, z
end

function rref!(a::FqPolyRepMatrix)
  r = ccall((:fq_mat_rref, libflint), Int, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), a, a, base_ring(a))
  return r
end
...
function inv(a::FqPolyRepMatrix)
  !is_square(a) && error("Matrix must be a square matrix")
  z = similar(a)
  r = ccall((:fq_mat_inv, libflint), Int, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), z, a, base_ring(a))
...
function Solve._can_solve_internal_no_check(A::FqPolyRepMatrix, b::FqPolyRepMatrix, task::Symbol; side::Symbol=:left)
  ...
  fl = ccall((:fq_mat_can_solve, libflint), Cint, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), x, A, b, base_ring(A))
...
function _solve_tril_right_flint!(x::FqPolyRepMatrix, L::FqPolyRepMatrix, B::FqPolyRepMatrix, unit::Bool)
  ccall((:fq_mat_solve_tril, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Cint, Ref{FqPolyRepField}), x, L, B, Cint(unit), base_ring(L))
  return nothing
end

function _solve_triu_right_flint!(x::FqPolyRepMatrix, U::FqPolyRepMatrix, B::FqPolyRepMatrix, unit::Bool)
  ccall((:fq_mat_solve_triu, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Cint, Ref{FqPolyRepField}), x, U, B, Cint(unit), base_ring(U))
  return nothing
end
...
function lu!(P::Generic.Perm, x::FqPolyRepMatrix)
  ...
  rank = Int(ccall((:fq_mat_lu, libflint), Cint, (Ptr{Int}, Ref{FqPolyRepMatrix}, Cint, Ref{FqPolyRepField}), P.d, x, 0, base_ring(x)))
...
function Base.view(x::FqPolyRepMatrix, r1::Int, c1::Int, r2::Int, c2::Int)
  ...
  z.view_parent = x
  ccall((:fq_mat_window_init, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Int, Int, Int, Int, Ref{FqPolyRepField}), z, x, r1 - 1, c1 - 1, r2, c2, base_ring(x))
...
function _fq_mat_window_clear_fn(a::FqPolyRepMatrix)
  ccall((:fq_mat_window_clear, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), a, base_ring(a))
end
...
function hcat(x::FqPolyRepMatrix, y::FqPolyRepMatrix)
  ...
  ccall((:fq_mat_concat_horizontal, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), z, x, y, base_ring(x))
  return z
end
...
function vcat(x::FqPolyRepMatrix, y::FqPolyRepMatrix)
  ...
  ccall((:fq_mat_concat_vertical, libflint), Nothing, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), z, x, y, base_ring(x))
  return z
end
...
function charpoly(R::FqPolyRepPolyRing, a::FqPolyRepMatrix)
  ...
  p = R()
  ccall((:fq_mat_charpoly, libflint), Nothing, (Ref{FqPolyRepPolyRingElem}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), p, a, base_ring(a))
  return p
end
...
function charpoly_danivlesky!(R::FqPolyRepPolyRing, a::FqPolyRepMatrix)
  ...
  base_ring(R) != base_ring(a) && error("Must have common base ring")
  p = R()
  ccall((:fq_mat_charpoly_danilevsky, libflint), Nothing, (Ref{FqPolyRepPolyRingElem}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), p, a, base_ring(a))
  return p
end
...
function minpoly(R::FqPolyRepPolyRing, a::FqPolyRepMatrix)
  ...
  m = deepcopy(a)
  p = R()
  ccall((:fq_mat_minpoly, libflint), Nothing, (Ref{FqPolyRepPolyRingElem}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), p, m, base_ring(a))
  return p
end
...
function nullspace(M::FqPolyRepMatrix)
  ...
  nullity = ccall((:fq_mat_nullspace, libflint), Int, (Ref{FqPolyRepMatrix}, Ref{FqPolyRepMatrix}, Ref{FqPolyRepField}), N, M, base_ring(M))
...
@inline mat_entry_ptr(A::FqPolyRepMatrix, i::Int, j::Int) = ccall((:fq_mat_entry, libflint), Ptr{FqPolyRepFieldElem}, (Ref{FqPolyRepMatrix}, Int, Int), A, i - 1, j - 1)

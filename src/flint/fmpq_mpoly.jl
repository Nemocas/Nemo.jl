...
function check_parent(a::QQMPolyRingElem, b::QQMPolyRingElem)
  parent(a) != parent(b) && error("Incompatible polynomial rings in polynomial operation")
end

number_of_variables(a::QQMPolyRing) = ccall((:fmpq_mpoly_ctx_nvars, libflint), Int, (Ref{QQMPolyRing},), a)
...
function gens(R::QQMPolyRing)
  ...
  for i in 1:(R.nvars)
    z = R()
    ccall((:fmpq_mpoly_gen, libflint), Nothing, (Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), z, i - 1, R)
    A[i] = z
  end
  return A
end
...
function is_gen(a::QQMPolyRingElem, i::Int)
  ...
  (i <= 0 || i > n) && error("Index must be between 1 and $n")
  R = parent(a)
  return Bool(ccall((:fmpq_mpoly_is_gen, libflint), Cint, (Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), a, i - 1, a.parent))
end
...
function deepcopy_internal(a::QQMPolyRingElem, dict::IdDict)
  z = parent(a)()
  ccall((:fmpq_mpoly_set, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, a, a.parent)
  return z
end
...
function one(R::QQMPolyRing)
  z = R()
  ccall((:fmpq_mpoly_one, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, R)
  return z
end

function zero(R::QQMPolyRing)
  z = R()
  ccall((:fmpq_mpoly_zero, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, R)
  return z
end

function isone(a::QQMPolyRingElem)
  b = ccall((:fmpq_mpoly_is_one, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, a.parent)
  return Bool(b)
end

function iszero(a::QQMPolyRingElem)
  b = ccall((:fmpq_mpoly_is_zero, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, a.parent)
  return Bool(b)
end
...
function is_constant(a::QQMPolyRingElem)
  b = ccall((:fmpq_mpoly_is_fmpq, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, parent(a))
  return Bool(b)
end

function content(a::QQMPolyRingElem)
  c = QQFieldElem()
  ccall((:fmpq_mpoly_content, libflint), Nothing, (Ref{QQFieldElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), c, a, parent(a))
  return c
end

function denominator(a::QQMPolyRingElem)
  c = ZZRingElem()
  ccall((:fmpq_mpoly_get_denominator, libflint), Nothing, (Ref{ZZRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), c, a, parent(a))
  return c
end
...
function coeff(a::QQMPolyRingElem, i::Int)
  ...
  ccall((:fmpq_mpoly_get_term_coeff_fmpq, libflint), Nothing, (Ref{QQFieldElem}, Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), z, a, i - 1, a.parent)
  return z
end
...
function coeff(a::QQMPolyRingElem, b::QQMPolyRingElem)
  ...
  z = QQFieldElem()
  ccall((:fmpq_mpoly_get_coeff_fmpq_monomial, libflint), Nothing, (Ref{QQFieldElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, a, b, parent(a))
  return z
end
...
function degree(a::QQMPolyRingElem, i::Int)
  ...
  if degrees_fit_int(a)
    d = ccall((:fmpq_mpoly_degree_si, libflint), Int, (Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), a, i - 1, a.parent)
    return d
  else
...
function degree_fmpz(a::QQMPolyRingElem, i::Int)
  ...
  (i <= 0 || i > n) && error("Index must be between 1 and $n")
  d = ZZRingElem()
  ccall((:fmpq_mpoly_degree_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), d, a, i - 1, a.parent)
  return d
end

# Return true if degrees fit into an Int
function degrees_fit_int(a::QQMPolyRingElem)
  b = ccall((:fmpq_mpoly_degrees_fit_si, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, a.parent)
  return Bool(b)
end
...
function degrees(a::QQMPolyRingElem)
  ...
  ccall((:fmpq_mpoly_degrees_si, libflint), Nothing, (Ptr{Int}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), degs, a, a.parent)
  return degs
end
...
function degrees_fmpz(a::QQMPolyRingElem)
  ...
  ccall((:fmpq_mpoly_degrees_fmpz, libflint), Nothing, (Ptr{Ref{ZZRingElem}}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), degs, a, a.parent)
  return degs
end

# Return true if degree fits into an Int
function total_degree_fits_int(a::QQMPolyRingElem)
  b = ccall((:fmpq_mpoly_total_degree_fits_si, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, a.parent)
  return Bool(b)
end
...
function total_degree(a::QQMPolyRingElem)
  ...
  d = ccall((:fmpq_mpoly_total_degree_si, libflint), Int, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, a.parent)
  return d
end
...
function total_degree_fmpz(a::QQMPolyRingElem)
  d = ZZRingElem()
  ccall((:fmpq_mpoly_total_degree_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), d, a, a.parent)
  return d
end
...
function coeff(a::QQMPolyRingElem, vars::Vector{Int}, exps::Vector{Int})
  ...
  ccall((:fmpq_mpoly_get_coeff_vars_ui, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ptr{Int}, Ptr{Int}, Int, Ref{QQMPolyRing}), z, a, vars, exps, length(vars), a.parent)
  return z
end
...
function -(a::QQMPolyRingElem)
  z = parent(a)()
  ccall((:fmpq_mpoly_neg, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, a, a.parent)
  return z
end
...
function +(a::QQMPolyRingElem, b::QQMPolyRingElem)
  check_parent(a, b)
  z = parent(a)()
  ccall((:fmpq_mpoly_add, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, a, b, a.parent)
  return z
end
...
function -(a::QQMPolyRingElem, b::QQMPolyRingElem)
  check_parent(a, b)
  z = parent(a)()
  ccall((:fmpq_mpoly_sub, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, a, b, a.parent)
  return z
end
...
function *(a::QQMPolyRingElem, b::QQMPolyRingElem)
  check_parent(a, b)
  z = parent(a)()
  ccall((:fmpq_mpoly_mul, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, a, b, a.parent)
  return z
end
...
for (jT, cN, cT) in ((QQFieldElem, :fmpq, Ref{QQFieldElem}), (ZZRingElem, :fmpz, Ref{ZZRingElem}), (Int, :si, Int))
  @eval begin
    function +(a::QQMPolyRingElem, b::($jT))
      z = parent(a)()
      ccall(($(string(:fmpq_mpoly_add_, cN)), libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, ($cT), Ref{QQMPolyRing}), z, a, b, parent(a))
      return z
    end
    ...
    function -(a::QQMPolyRingElem, b::($jT))
      z = parent(a)()
      ccall(($(string(:fmpq_mpoly_sub_, cN)), libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, ($cT), Ref{QQMPolyRing}), z, a, b, parent(a))
      return z
    end
    ...
    function *(a::QQMPolyRingElem, b::($jT))
      z = parent(a)()
      ccall(($(string(:fmpq_mpoly_scalar_mul_, cN)), libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, ($cT), Ref{QQMPolyRing}), z, a, b, parent(a))
      return z
    end
    ...
    *(a::($jT), b::QQMPolyRingElem) = b * a
    ...
    function divexact(a::QQMPolyRingElem, b::($jT); check::Bool=true)
      z = parent(a)()
      ccall(($(string(:fmpq_mpoly_scalar_div_, cN)), libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, ($cT), Ref{QQMPolyRing}), z, a, b, parent(a))
      return z
    end
...
function ^(a::QQMPolyRingElem, b::Int)
  ...
  z = parent(a)()
  ccall((:fmpq_mpoly_pow_ui, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), z, a, b, parent(a))
  return z
end
...
function ^(a::QQMPolyRingElem, b::ZZRingElem)
  b < 0 && throw(DomainError(b, "Exponent must be non-negative"))
  z = parent(a)()
  ccall((:fmpq_mpoly_pow_fmpz, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{ZZRingElem}, Ref{QQMPolyRing}), z, a, b, parent(a))
  return z
end
...
function gcd(a::QQMPolyRingElem, b::QQMPolyRingElem)
  check_parent(a, b)
  z = parent(a)()
  r = ccall((:fmpq_mpoly_gcd, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, a, b, a.parent)
...
function gcd_with_cofactors(a::QQMPolyRingElem, b::QQMPolyRingElem)
  ...
  bbar = parent(a)()
  r = ccall(
    (:fmpq_mpoly_gcd_cofactors, Nemo.libflint),
    Cint,
    (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}),
    z,
    abar,
    bbar,
    a,
...
function (::Type{Fac{QQMPolyRingElem}})(fac::fmpq_mpoly_factor, preserve_input::Bool=true)
  ...
  for i in 0:(fac.num - 1)
    f = R()
    if preserve_input
      ccall((:fmpq_mpoly_factor_get_base, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{fmpq_mpoly_factor}, Int, Ref{QQMPolyRing}), f, fac, i, R)
    else
      ccall((:fmpq_mpoly_factor_swap_base, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{fmpq_mpoly_factor}, Int, Ref{QQMPolyRing}), f, fac, i, R)
    end
    F.fac[f] = ccall((:fmpq_mpoly_factor_get_exp_si, libflint), Int, (Ref{fmpq_mpoly_factor}, Int, Ref{QQMPolyRing}), fac, i, R)
  end
  c = QQFieldElem()
  ccall((:fmpq_mpoly_factor_get_constant_fmpq, libflint), Nothing, (Ref{QQFieldElem}, Ref{fmpq_mpoly_factor}), c, fac)
  F.unit = R(c)
  return F
end
...
function factor(a::QQMPolyRingElem)
  ...
  ok = ccall((:fmpq_mpoly_factor, libflint), Cint, (Ref{fmpq_mpoly_factor}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), fac, a, R)
...
function factor_squarefree(a::QQMPolyRingElem)
  ...
  R = parent(a)
  fac = fmpq_mpoly_factor(R)
  ok = ccall((:fmpq_mpoly_factor_squarefree, libflint), Cint, (Ref{fmpq_mpoly_factor}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), fac, a, R)
  ok == 0 && error("unable to compute factorization")
  return Fac{QQMPolyRingElem}(fac, false)
end
...
function is_square(a::QQMPolyRingElem)
  return Bool(ccall((:fmpq_mpoly_is_square, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, a.parent))
end

function is_square_with_sqrt(a::QQMPolyRingElem)
  q = parent(a)()
  flag = ccall((:fmpq_mpoly_sqrt, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), q, a, a.parent)
  return (Bool(flag), q)
end
...
function ==(a::QQMPolyRingElem, b::QQMPolyRingElem)
  check_parent(a, b)
  return Bool(ccall((:fmpq_mpoly_equal, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, b, a.parent))
end

function Base.isless(a::QQMPolyRingElem, b::QQMPolyRingElem)
  (!is_monomial(a) || !is_monomial(b)) && error("Not monomials in comparison")
  return ccall((:fmpq_mpoly_cmp, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, b, a.parent) < 0
end
...
function ==(a::QQMPolyRingElem, b::QQFieldElem)
  return Bool(ccall((:fmpq_mpoly_equal_fmpq, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{QQFieldElem}, Ref{QQMPolyRing}), a, b, a.parent))
end

==(a::QQFieldElem, b::QQMPolyRingElem) = b == a

function ==(a::QQMPolyRingElem, b::ZZRingElem)
  return Bool(ccall((:fmpq_mpoly_equal_fmpz, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{ZZRingElem}, Ref{QQMPolyRing}), a, b, a.parent))
end

==(a::ZZRingElem, b::QQMPolyRingElem) = b == a

function ==(a::QQMPolyRingElem, b::Int)
  return Bool(ccall((:fmpq_mpoly_equal_si, libflint), Cint, (Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), a, b, a.parent))
end
...
function divides(a::QQMPolyRingElem, b::QQMPolyRingElem)
  ...
  z = parent(a)()
  d = ccall((:fmpq_mpoly_divides, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, a, b, a.parent)
  return isone(d), z
end
...
function Base.div(a::QQMPolyRingElem, b::QQMPolyRingElem)
  check_parent(a, b)
  q = parent(a)()
  ccall((:fmpq_mpoly_div, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), q, a, b, a.parent)
  return q
end
...
function Base.divrem(a::QQMPolyRingElem, b::QQMPolyRingElem)
  ...
  q = parent(a)()
  r = parent(a)()
  ccall((:fmpq_mpoly_divrem, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), q, r, a, b, a.parent)
  return q, r
end
...
function Base.divrem(a::QQMPolyRingElem, b::Vector{QQMPolyRingElem})
  ...
  r = parent(a)()
  ccall(
    (:fmpq_mpoly_divrem_ideal, libflint), Nothing, (Ptr{Ref{QQMPolyRingElem}}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ptr{Ref{QQMPolyRingElem}}, Int, Ref{QQMPolyRing}), q, r, a, b, len, a.parent
  )
  return q, r
end
...
function derivative(a::QQMPolyRingElem, i::Int)
  ...
  (i <= 0 || i > n) && error("Index must be between 1 and $n")
  z = parent(a)()
  ccall((:fmpq_mpoly_derivative, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), z, a, i - 1, parent(a))
  return z
end
...
function integral(a::QQMPolyRingElem, i::Int)
  ...
  (i <= 0 || i > n) && error("Index must be between 1 and $n")
  z = parent(a)()
  ccall((:fmpq_mpoly_integral, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), z, a, i - 1, parent(a))
  return z
end
...
function evaluate(a::QQMPolyRingElem, b::Vector{QQFieldElem})
  ...
  z = QQFieldElem()
  GC.@preserve b ccall((:fmpq_mpoly_evaluate_all_fmpq, libflint), Nothing, (Ref{QQFieldElem}, Ref{QQMPolyRingElem}, Ptr{QQFieldElem}, Ref{QQMPolyRing}), z, a, b, parent(a))
  return z
end
...
function (a::QQMPolyRingElem)(vals::Union{NCRingElem,RingElement}...)
  ...
  for j in 1:length(vals)
    W = typeof(vals[j])
    if ((W <: Integer && W != BigInt) || (W <: Rational && W != Rational{BigInt}))
      c = c * zero(W)
      U[j] = parent(c)
    else
      U[j] = parent(vals[j])
...
function evaluate(a::QQMPolyRingElem, bs::Vector{QQMPolyRingElem})
  ...
  length(bs) != nvars(R) && error("Number of variables does not match number of values")

  c = S()
  fl = ccall((:fmpq_mpoly_compose_fmpq_mpoly, libflint), Cint, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ptr{Ref{QQMPolyRingElem}}, Ref{QQMPolyRing}, Ref{QQMPolyRing}), c, a, bs, R, S)
...
function evaluate(a::QQMPolyRingElem, bs::Vector{QQPolyRingElem})
  ...
  c = S()
  fl = ccall((:fmpq_mpoly_compose_fmpq_poly, libflint), Cint, (Ref{QQPolyRingElem}, Ref{QQMPolyRingElem}, Ptr{Ref{QQPolyRingElem}}, Ref{QQMPolyRing}), c, a, bs, R)
  fl == 0 && error("Something wrong in evaluation.")
  return c
end
...
function zero!(a::QQMPolyRingElem)
  ccall((:fmpq_mpoly_zero, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, a.parent)
  return a
end

function add!(a::QQMPolyRingElem, b::QQMPolyRingElem, c::QQMPolyRingElem)
  ccall((:fmpq_mpoly_add, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, b, c, a.parent)
  return a
end

function addeq!(a::QQMPolyRingElem, b::QQMPolyRingElem)
  ccall((:fmpq_mpoly_add, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, a, b, a.parent)
  return a
end

function mul!(a::QQMPolyRingElem, b::QQMPolyRingElem, c::QQMPolyRingElem)
  ccall((:fmpq_mpoly_mul, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, b, c, a.parent)
  return a
end
...
function setcoeff!(a::QQMPolyRingElem, n::Int, c::QQFieldElem)
  if n > length(a)
    ccall((:fmpq_mpoly_resize, libflint), Nothing, (Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), a, n, a.parent)
  end
  ccall((:fmpq_mpoly_set_term_coeff_fmpq, libflint), Nothing, (Ref{QQMPolyRingElem}, Int, Ref{QQFieldElem}, Ref{QQMPolyRing}), a, n - 1, c, a.parent)
  return a
end
...
# Set the i-th coefficient of a to c. If zero coefficients are inserted, they
# must be removed with combine_like_terms!
setcoeff!(a::QQMPolyRingElem, i::Int, c::Rational{<:Integer}) = setcoeff!(a, i, QQFieldElem(c))
...
function combine_like_terms!(a::QQMPolyRingElem)
  ccall((:fmpq_mpoly_combine_like_terms, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, a.parent)
  return a
end
...
function exponent_vector_fits(::Type{Int}, a::QQMPolyRingElem, i::Int)
  b = ccall((:fmpq_mpoly_term_exp_fits_si, libflint), Cint, (Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), a, i - 1, a.parent)
  return Bool(b)
end

function exponent_vector_fits(::Type{UInt}, a::QQMPolyRingElem, i::Int)
  b = ccall((:fmpq_mpoly_term_exp_fits_ui, libflint), Cint, (Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), a, i - 1, a.parent)
  return Bool(b)
end

function exponent_vector!(z::Vector{Int}, a::QQMPolyRingElem, i::Int)
  ccall((:fmpq_mpoly_get_term_exp_si, libflint), Nothing, (Ptr{Int}, Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), z, a, i - 1, parent(a))
  return z
end

function exponent_vector!(z::Vector{UInt}, a::QQMPolyRingElem, i::Int)
  ccall((:fmpq_mpoly_get_term_exp_ui, libflint), Nothing, (Ptr{UInt}, Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), z, a, i - 1, parent(a))
  return z
end

function exponent_vector!(z::Vector{ZZRingElem}, a::QQMPolyRingElem, i::Int)
  ccall((:fmpq_mpoly_get_term_exp_fmpz, libflint), Nothing, (Ptr{Ref{ZZRingElem}}, Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), z, a, i - 1, parent(a))
  return z
end
...
function set_exponent_vector!(a::QQMPolyRingElem, n::Int, exps::Vector{UInt})
  ...
  ccall((:fmpq_mpoly_set_term_exp_ui, libflint), Nothing, (Ref{QQMPolyRingElem}, Int, Ptr{UInt}, Ref{QQMPolyRing}), a, n - 1, exps, parent(a))
  return a
end
...
function set_exponent_vector!(a::QQMPolyRingElem, n::Int, exps::Vector{Int})
  ...
  ccall((:fmpq_mpoly_set_term_exp_ui, libflint), Nothing, (Ref{QQMPolyRingElem}, Int, Ptr{Int}, Ref{QQMPolyRing}), a, n - 1, exps, parent(a))
  return a
end
...
function set_exponent_vector!(a::QQMPolyRingElem, n::Int, exps::Vector{ZZRingElem})
  ...
  GC.@preserve exps ccall((:fmpq_mpoly_set_term_exp_fmpz, libflint), Nothing, (Ref{QQMPolyRingElem}, Int, Ptr{ZZRingElem}, Ref{QQMPolyRing}), a, n - 1, exps, parent(a))
  return a
end
...
function exponent(a::QQMPolyRingElem, i::Int, j::Int)
  ...
  return ccall((:fmpq_mpoly_get_term_var_exp_ui, libflint), Int, (Ref{QQMPolyRingElem}, Int, Int, Ref{QQMPolyRing}), a, i - 1, j - 1, a.parent)
end
...
function coeff(a::QQMPolyRingElem, exps::Vector{UInt})
  z = QQFieldElem()
  ccall((:fmpq_mpoly_get_coeff_fmpq_ui, libflint), Nothing, (Ref{QQFieldElem}, Ref{QQMPolyRingElem}, Ptr{UInt}, Ref{QQMPolyRing}), z, a, exps, parent(a))
  return z
end
...
function coeff(a::QQMPolyRingElem, exps::Vector{Int})
  z = QQFieldElem()
  ccall((:fmpq_mpoly_get_coeff_fmpq_ui, libflint), Nothing, (Ref{QQFieldElem}, Ref{QQMPolyRingElem}, Ptr{Int}, Ref{QQMPolyRing}), z, a, exps, parent(a))
  return z
end
...
function setcoeff!(a::QQMPolyRingElem, exps::Vector{UInt}, b::QQFieldElem)
  ccall((:fmpq_mpoly_set_coeff_fmpq_ui, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQFieldElem}, Ptr{UInt}, Ref{QQMPolyRing}), a, b, exps, parent(a))
  return a
end
...
function setcoeff!(a::QQMPolyRingElem, exps::Vector{Int}, b::QQFieldElem)
  ccall((:fmpq_mpoly_set_coeff_fmpq_ui, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQFieldElem}, Ptr{Int}, Ref{QQMPolyRing}), a, b, exps, parent(a))
  return a
end

# Set the coefficient of the term with the given exponent vector to the
# given integer. Removal of a zero term is performed.
setcoeff!(a::QQMPolyRingElem, exps::Vector{Int}, b::Rational{<:Integer}) = setcoeff!(a, exps, QQFieldElem(b))

# Set the coefficient of the term with the given exponent vector to the
# given ZZRingElem. Removal of a zero term is performed.
setcoeff!(a::QQMPolyRingElem, exps::Vector{Int}, b::ZZRingElem) = setcoeff!(a, exps, QQFieldElem(b))

# Set the coefficient of the term with the given exponent vector to the
# given integer. Removal of a zero term is performed.
setcoeff!(a::QQMPolyRingElem, exps::Vector{Int}, b::Integer) = setcoeff!(a, exps, QQFieldElem(b))
...
function sort_terms!(a::QQMPolyRingElem)
  ccall((:fmpq_mpoly_sort_terms, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, a.parent)
  return a
end
...
function term(a::QQMPolyRingElem, i::Int)
  ...
  n = length(a)
  (i < 1 || i > n) && error("Index must be between 1 and $(length(a))")
  ccall((:fmpq_mpoly_get_term, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), z, a, i - 1, a.parent)
  return z
end
...
function monomial(a::QQMPolyRingElem, i::Int)
  ...
  n = length(a)
  (i < 1 || i > n) && error("Index must be between 1 and $(length(a))")
  ccall((:fmpq_mpoly_get_term_monomial, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), z, a, i - 1, a.parent)
  return z
end
...
function monomial!(m::QQMPolyRingElem, a::QQMPolyRingElem, i::Int)
  ccall((:fmpq_mpoly_get_term_monomial, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), m, a, i - 1, a.parent)
  return m
end
...
function _push_term!(z::QQMPolyRingElem, c::QQFieldElem, exp::Vector{Int})
  ccall((:fmpq_mpoly_push_term_fmpq_ui, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQFieldElem}, Ptr{UInt}, Ref{QQMPolyRing}), z, c, exp, parent(z))
  return z
end

function _push_term!(z::QQMPolyRingElem, c::ZZRingElem, exp::Vector{Int})
  ccall((:fmpq_mpoly_push_term_fmpz_ui, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{ZZRingElem}, Ptr{UInt}, Ref{QQMPolyRing}), z, c, exp, parent(z))
  return z
end

function _push_term!(z::QQMPolyRingElem, c::Int, exp::Vector{Int})
  ccall((:fmpq_mpoly_push_term_si_ui, libflint), Nothing, (Ref{QQMPolyRingElem}, Int, Ptr{UInt}, Ref{QQMPolyRing}), z, c, exp, parent(z))
  return z
end

function _push_term!(z::QQMPolyRingElem, c::UInt, exp::Vector{Int})
  ccall((:fmpq_mpoly_push_term_ui_ui, libflint), Nothing, (Ref{QQMPolyRingElem}, UInt, Ptr{UInt}, Ref{QQMPolyRing}), z, c, exp, parent(z))
  return z
end

function push_term!(M::MPolyBuildCtx{QQMPolyRingElem}, c::Union{ZZRingElem,QQFieldElem,Int,UInt}, expv::Vector{Int})
...
function push_term!(M::MPolyBuildCtx{QQMPolyRingElem}, c::RingElement, expv::Vector{Int})
...
function finish(M::MPolyBuildCtx{QQMPolyRingElem})
  ...
  R = parent(res)
  M.poly = zero(R)
  ccall((:fmpq_mpoly_sort_terms, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), res, R)
  ccall((:fmpq_mpoly_combine_like_terms, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), res, R)
  return res
end

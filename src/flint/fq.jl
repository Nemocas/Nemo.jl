...
function Base.hash(a::FqPolyRepFieldElem, h::UInt)
  ...
  for i in 0:(degree(parent(a)) - 1)
    ccall((:fmpz_poly_get_coeff_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{FqPolyRepFieldElem}, Int), z, a, i)
...
iszero(a::FqPolyRepFieldElem) = ccall((:fq_is_zero, libflint), Bool, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), a, a.parent)

isone(a::FqPolyRepFieldElem) = ccall((:fq_is_one, libflint), Bool, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), a, a.parent)
...
is_unit(a::FqPolyRepFieldElem) = ccall((:fq_is_invertible, libflint), Bool, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), a, a.parent)

function characteristic(a::FqPolyRepField)
  d = ZZRingElem()
  ccall((:__fq_ctx_prime, libflint), Nothing, (Ref{ZZRingElem}, Ref{FqPolyRepField}), d, a)
  return d
end

function order(a::FqPolyRepField)
  d = ZZRingElem()
  ccall((:fq_ctx_order, libflint), Nothing, (Ref{ZZRingElem}, Ref{FqPolyRepField}), d, a)
  return d
end
...
function -(x::FqPolyRepFieldElem)
  z = parent(x)()
  ccall((:fq_neg, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, x, x.parent)
  return z
end
...
function +(x::FqPolyRepFieldElem, y::FqPolyRepFieldElem)
  check_parent(x, y)
  z = parent(y)()
  ccall((:fq_add, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, x, y, y.parent)
  return z
end
...
function -(x::FqPolyRepFieldElem, y::FqPolyRepFieldElem)
  check_parent(x, y)
  z = parent(y)()
  ccall((:fq_sub, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, x, y, y.parent)
  return z
end
...
function *(x::FqPolyRepFieldElem, y::FqPolyRepFieldElem)
  check_parent(x, y)
  z = parent(y)()
  ccall((:fq_mul, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, x, y, y.parent)
  return z
end
...
function *(x::Int, y::FqPolyRepFieldElem)
  z = parent(y)()
  ccall((:fq_mul_si, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Int, Ref{FqPolyRepField}), z, y, x, y.parent)
  return z
end
...
function *(x::ZZRingElem, y::FqPolyRepFieldElem)
  z = parent(y)()
  ccall((:fq_mul_fmpz, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{ZZRingElem}, Ref{FqPolyRepField}), z, y, x, y.parent)
  return z
end
...
function ^(x::FqPolyRepFieldElem, y::Int)
  ...
  z = parent(x)()
  ccall((:fq_pow_ui, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Int, Ref{FqPolyRepField}), z, x, y, x.parent)
  return z
end
...
function ^(x::FqPolyRepFieldElem, y::ZZRingElem)
  ...
  z = parent(x)()
  ccall((:fq_pow, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{ZZRingElem}, Ref{FqPolyRepField}), z, x, y, x.parent)
  return z
end
...
function ==(x::FqPolyRepFieldElem, y::FqPolyRepFieldElem)
  check_parent(x, y)
  ccall((:fq_equal, libflint), Bool, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), x, y, y.parent)
end
...
function divexact(x::FqPolyRepFieldElem, y::FqPolyRepFieldElem; check::Bool=true)
  ...
  z = parent(y)()
  ccall((:fq_div, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, x, y, y.parent)
  return z
end
...
function inv(x::FqPolyRepFieldElem)
  ...
  z = parent(x)()
  ccall((:fq_inv, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, x, x.parent)
  return z
end
...
function sqrt(x::FqPolyRepFieldElem; check::Bool=true)
  z = parent(x)()
  res = Bool(ccall((:fq_sqrt, libflint), Cint, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, x, x.parent))
  check && !res && error("Not a square")
  return z
end

function is_square(x::FqPolyRepFieldElem)
  return Bool(ccall((:fq_is_square, libflint), Cint, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), x, x.parent))
end

function is_square_with_sqrt(x::FqPolyRepFieldElem)
  z = parent(x)()
  flag = ccall((:fq_sqrt, libflint), Cint, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, x, x.parent)
  return (Bool(flag), z)
end
...
function pth_root(x::FqPolyRepFieldElem)
  z = parent(x)()
  ccall((:fq_pth_root, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, x, x.parent)
  return z
end
...
function tr(x::FqPolyRepFieldElem)
  z = ZZRingElem()
  ccall((:fq_trace, libflint), Nothing, (Ref{ZZRingElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, x, x.parent)
  return parent(x)(z)
end
...
function norm(x::FqPolyRepFieldElem)
  z = ZZRingElem()
  ccall((:fq_norm, libflint), Nothing, (Ref{ZZRingElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, x, x.parent)
  return parent(x)(z)
end
...
function frobenius(x::FqPolyRepFieldElem, n=1)
  z = parent(x)()
  ccall((:fq_frobenius, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Int, Ref{FqPolyRepField}), z, x, n, x.parent)
  return z
end
...
function lift(R::FpPolyRing, x::FqPolyRepFieldElem)
  c = R()
  ccall((:fq_get_fmpz_mod_poly, libflint), Nothing, (Ref{FpPolyRingElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), c, x, parent(x))
  return c
end
...
function zero!(z::FqPolyRepFieldElem)
  ccall((:fq_zero, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, z.parent)
  return z
end
...
function addeq!(z::FqPolyRepFieldElem, x::FqPolyRepFieldElem)
  ccall((:fq_add, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, z, x, x.parent)
  return z
end

function add!(z::FqPolyRepFieldElem, x::FqPolyRepFieldElem, y::FqPolyRepFieldElem)
  ccall((:fq_add, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, x, y, x.parent)
  return z
end
...
function modulus(k::FqPolyRepField, var::VarName=:T)
  ...
  P = ccall((:fq_ctx_modulus, libflint), Ref{FpPolyRingElem}, (Ref{FqPolyRepField},), k)
  ccall((:fmpz_mod_poly_set, libflint), Nothing, (Ref{FpPolyRingElem}, Ref{FpPolyRingElem}, Ref{FpField}), Q, P, base_ring(Q))

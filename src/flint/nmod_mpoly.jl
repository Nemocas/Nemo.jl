...
for (etype, rtype, ftype, ctype, utype) in
    ((zzModMPolyRingElem, zzModMPolyRing, nmod_mpoly_factor, zzModRingElem, zzModPolyRingElem), (fpMPolyRingElem, fpMPolyRing, gfp_mpoly_factor, fpFieldElem, fpPolyRingElem))
  @eval begin
    ...
    function gens(R::($rtype))
      ...
      for i in 1:(R.nvars)
        z = R()
        ccall((:nmod_mpoly_gen, libflint), Nothing, (Ref{($etype)}, Int, Ref{($rtype)}), z, i - 1, R)
        A[i] = z
      end
      return A
    end
    ...
    function is_gen(a::($etype), i::Int)
      n = nvars(parent(a))
      (i <= 0 || i > n) && error("Index must be between 1 and $n")
      return Bool(ccall((:nmod_mpoly_is_gen, libflint), Cint, (Ref{($etype)}, Int, Ref{($rtype)}), a, i - 1, parent(a)))
    end

    function is_gen(a::($etype))
      return Bool(ccall((:nmod_mpoly_is_gen, libflint), Cint, (Ref{($etype)}, Int, Ref{($rtype)}), a, -1, parent(a)))
    end

    function deepcopy_internal(a::($etype), dict::IdDict)
      z = parent(a)()
      ccall((:nmod_mpoly_set, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), z, a, parent(a))
      return z
    end
    ...
    function one(R::($rtype))
      z = R()
      ccall((:nmod_mpoly_one, libflint), Nothing, (Ref{($etype)}, Ref{($rtype)}), z, R)
      return z
    end

    function zero(R::($rtype))
      z = R()
      ccall((:nmod_mpoly_zero, libflint), Nothing, (Ref{($etype)}, Ref{($rtype)}), z, R)
      return z
    end

    function isone(a::($etype))
      return Bool(ccall((:nmod_mpoly_is_one, libflint), Cint, (Ref{($etype)}, Ref{($rtype)}), a, parent(a)))
    end

    function iszero(a::($etype))
      return Bool(ccall((:nmod_mpoly_is_zero, libflint), Cint, (Ref{($etype)}, Ref{($rtype)}), a, parent(a)))
    end
    ...
    function is_constant(a::($etype))
      return Bool(ccall((:nmod_mpoly_is_ui, libflint), Cint, (Ref{($etype)}, Ref{($rtype)}), a, parent(a)))
    end
    ...
    function coeff(a::($etype), i::Int)
      ...
      z = ccall((:nmod_mpoly_get_term_coeff_ui, libflint), UInt, (Ref{($etype)}, Int, Ref{($rtype)}), a, i - 1, parent(a))
    ...
    function coeff(a::($etype), b::($etype))
      ...
      z = ccall((:nmod_mpoly_get_coeff_ui_monomial, libflint), UInt, (Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), a, b, parent(a))
      return base_ring(parent(a))(z)
    end
    ...
    function degree(a::($etype), i::Int)
      ...
      if degrees_fit_int(a)
        d = ccall((:nmod_mpoly_degree_si, libflint), Int, (Ref{($etype)}, Int, Ref{($rtype)}), a, i - 1, parent(a))
      else
    ...
    function degree_fmpz(a::($etype), i::Int)
      ...
      (i <= 0 || i > n) && error("Index must be between 1 and $n")
      d = ZZRingElem()
      ccall((:nmod_mpoly_degree_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{($etype)}, Int, Ref{($rtype)}), d, a, i - 1, parent(a))
      return d
    end

    # Return true if degrees fit into an Int
    function degrees_fit_int(a::($etype))
      return Bool(ccall((:nmod_mpoly_degrees_fit_si, libflint), Cint, (Ref{($etype)}, Ref{($rtype)}), a, parent(a)))
    end
    ...
    function degrees(a::($etype))
      ...
      ccall((:nmod_mpoly_degrees_si, libflint), Nothing, (Ptr{Int}, Ref{($etype)}, Ref{($rtype)}), degs, a, parent(a))
      return degs
    end
    ...
    function degrees_fmpz(a::($etype))
      ...
      ccall((:nmod_mpoly_degrees_fmpz, libflint), Nothing, (Ptr{Ref{ZZRingElem}}, Ref{($etype)}, Ref{($rtype)}), degs, a, parent(a))
      return degs
    end

    # Return true if degree fits into an Int
    function total_degree_fits_int(a::($etype))
      return Bool(ccall((:nmod_mpoly_total_degree_fits_si, libflint), Cint, (Ref{($etype)}, Ref{($rtype)}), a, parent(a)))
    end
    ...
    function total_degree(a::($etype))
      ...
      d = ccall((:nmod_mpoly_total_degree_si, libflint), Int, (Ref{($etype)}, Ref{($rtype)}), a, a.parent)
      return d
    end
    ...
    function total_degree_fmpz(a::($etype))
      d = ZZRingElem()
      ccall((:nmod_mpoly_total_degree_fmpz, libflint), Nothing, (Ref{ZZRingElem}, Ref{($etype)}, Ref{($rtype)}), d, a, parent(a))
      return d
    end
    ...
    function coeff(a::($etype), vars::Vector{Int}, exps::Vector{Int})
      ...
      ccall((:nmod_mpoly_get_coeff_vars_ui, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ptr{Int}, Ptr{Int}, Int, Ref{($rtype)}), z, a, vars, exps, length(vars), parent(a))
      return z
    end
    ...
    function -(a::($etype))
      z = parent(a)()
      ccall((:nmod_mpoly_neg, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), z, a, parent(a))
      return z
    end
    ...
    function +(a::($etype), b::($etype))
      check_parent(a, b)
      z = parent(a)()
      ccall((:nmod_mpoly_add, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), z, a, b, parent(a))
      return z
    end
    ...
    function -(a::($etype), b::($etype))
      check_parent(a, b)
      z = parent(a)()
      ccall((:nmod_mpoly_sub, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), z, a, b, parent(a))
      return z
    end
    ...
    function *(a::($etype), b::($etype))
      check_parent(a, b)
      z = parent(a)()
      ccall((:nmod_mpoly_mul, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), z, a, b, parent(a))
      return z
    end
    ...
    function +(a::($etype), b::UInt)
      z = parent(a)()
      ccall((:nmod_mpoly_add_ui, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, UInt, Ref{($rtype)}), z, a, b, parent(a))
      return z
    end
    ...
    function -(a::($etype), b::UInt)
      z = parent(a)()
      ccall((:nmod_mpoly_sub_ui, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, UInt, Ref{($rtype)}), z, a, b, parent(a))
      return z
    end
    ...
    function -(b::UInt, a::($etype))
      z = parent(a)()
      ccall((:nmod_mpoly_sub_ui, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, UInt, Ref{($rtype)}), z, a, b, parent(a))
      ccall((:nmod_mpoly_neg, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), z, z, parent(a))
      return z
    end
    ...
    function *(a::($etype), b::UInt)
      z = parent(a)()
      ccall((:nmod_mpoly_scalar_mul_ui, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, UInt, Ref{($rtype)}), z, a, b, parent(a))
      return z
    end
    ...
    *(a::($etype), b::Integer) = a * base_ring(parent(a))(b)
    ...
    function ^(a::($etype), b::Int)
      ...
      z = parent(a)()
      ccall((:nmod_mpoly_pow_ui, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, UInt, Ref{($rtype)}), z, a, UInt(b), parent(a))
      return z
    end
    ...
    function ^(a::($etype), b::ZZRingElem)
      b < 0 && throw(DomainError(b, "Exponent must be non-negative"))
      z = parent(a)()
      ok = ccall((:nmod_mpoly_pow_fmpz, libflint), Cint, (Ref{($etype)}, Ref{($etype)}, Ref{ZZRingElem}, Ref{($rtype)}), z, a, b, parent(a))
    ...
    function gcd(a::($etype), b::($etype))
      check_parent(a, b)
      z = parent(a)()
      r = ccall((:nmod_mpoly_gcd, libflint), Cint, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), z, a, b, a.parent)
    ...
    function gcd_with_cofactors(a::($etype), b::($etype))
      ...
      abar = parent(a)()
      bbar = parent(a)()
      r = ccall((:nmod_mpoly_gcd_cofactors, libflint), Cint, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), z, abar, bbar, a, b, a.parent)
      r == 0 && error("Unable to compute gcd")
      return z, abar, bbar
    end
    ...
    function (::Type{Fac{($etype)}})(fac::($ftype), preserve_input::Bool=true)
      ...
      for i in 0:(fac.num - 1)
        f = R()
        if preserve_input
          ccall((:nmod_mpoly_factor_get_base, libflint), Nothing, (Ref{($etype)}, Ref{($ftype)}, Int, Ref{($rtype)}), f, fac, i, R)
        else
          ccall((:nmod_mpoly_factor_swap_base, libflint), Nothing, (Ref{($etype)}, Ref{($ftype)}, Int, Ref{($rtype)}), f, fac, i, R)
        end
        F.fac[f] = ccall((:nmod_mpoly_factor_get_exp_si, libflint), Int, (Ref{($ftype)}, Int, Ref{($rtype)}), fac, i, R)
      end
      c = ccall((:nmod_mpoly_factor_get_constant_ui, libflint), UInt, (Ref{($ftype)},), fac)
      F.unit = R(c)
      return F
    end
    ...
    function factor(a::($etype))
      ...
      R = parent(a)
      fac = ($ftype)(R)
      ok = ccall((:nmod_mpoly_factor, libflint), Cint, (Ref{($ftype)}, Ref{($etype)}, Ref{($rtype)}), fac, a, R)
    ...
    function factor_squarefree(a::($etype))
      ...
      R = parent(a)
      fac = ($ftype)(R)
      ok = ccall((:nmod_mpoly_factor_squarefree, libflint), Cint, (Ref{($ftype)}, Ref{($etype)}, Ref{($rtype)}), fac, a, R)
      !isone(ok) && error("unable to compute factorization")
      return Fac{($etype)}(fac, false)
    end
    ...
    function is_square(a::($etype))
      return Bool(ccall((:nmod_mpoly_is_square, libflint), Cint, (Ref{($etype)}, Ref{($rtype)}), a, a.parent))
    end

    function is_square_with_sqrt(a::($etype))
      q = parent(a)()
      flag = ccall((:nmod_mpoly_sqrt, libflint), Cint, (Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), q, a, a.parent)
      return (Bool(flag), q)
    end
    ...
    function ==(a::($etype), b::($etype))
      check_parent(a, b)
      return Bool(ccall((:nmod_mpoly_equal, libflint), Cint, (Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), a, b, a.parent))
    end

    function Base.isless(a::($etype), b::($etype))
      (!is_monomial(a) || !is_monomial(b)) && error("Not monomials in comparison")
      return ccall((:nmod_mpoly_cmp, libflint), Cint, (Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), a, b, a.parent) < 0
    end
    ...
    function ==(a::($etype), b::($ctype))
      return Bool(ccall((:nmod_mpoly_equal_ui, libflint), Cint, (Ref{($etype)}, UInt, Ref{($rtype)}), a, b.data, a.parent))
    end

    ==(a::($ctype), b::($etype)) = b == a

    function ==(a::($etype), b::UInt)
      return Bool(ccall((:nmod_mpoly_equal_ui, libflint), Cint, (Ref{($etype)}, UInt, Ref{($rtype)}), a, b, parent(a)))
    end
    ...
    function divides(a::($etype), b::($etype))
      ...
      z = parent(a)()
      d = ccall((:nmod_mpoly_divides, libflint), Cint, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), z, a, b, parent(a))
      return isone(d), z
    end
    ...
    function Base.div(a::($etype), b::($etype))
      check_parent(a, b)
      q = parent(a)()
      ccall((:nmod_mpoly_div, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), q, a, b, parent(a))
      return q
    end
    ...
    function Base.divrem(a::($etype), b::($etype))
      ...
      q = parent(a)()
      r = parent(a)()
      ccall((:nmod_mpoly_divrem, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), q, r, a, b, parent(a))
      return q, r
    end
    ...
    function Base.divrem(a::($etype), b::Vector{($etype)})
      ...
      r = parent(a)()
      ccall((:nmod_mpoly_divrem_ideal, libflint), Nothing, (Ptr{Ref{($etype)}}, Ref{($etype)}, Ref{($etype)}, Ptr{Ref{($etype)}}, Int, Ref{($rtype)}), q, r, a, b, len, parent(a))
      return q, r
    end
    ...
    function derivative(a::($etype), i::Int)
      ...
      (i <= 0 || i > n) && error("Index must be between 1 and $n")
      z = parent(a)()
      ccall((:nmod_mpoly_derivative, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Int, Ref{($rtype)}), z, a, i - 1, parent(a))
      return z
    end
    ...
    function evaluate(a::($etype), b::Vector{$ctype})
      ...
      z = ccall((:nmod_mpoly_evaluate_all_ui, libflint), UInt, (Ref{($etype)}, Ptr{UInt}, Ref{($rtype)}), a, b2, parent(a))
      return base_ring(parent(a))(z)
    end
    ...
    function evaluate(a::$(etype), bs::Vector{$etype})
      ...
      c = S()
      fl = ccall((:nmod_mpoly_compose_nmod_mpoly, libflint), Cint, (Ref{$etype}, Ref{$etype}, Ptr{Ref{$etype}}, Ref{$rtype}, Ref{$rtype}), c, a, bs, R, S)
    ...
    function evaluate(a::($etype), bs::Vector{$utype})
      ...
      c = S()
      fl = ccall((:nmod_mpoly_compose_nmod_poly, libflint), Cint, (Ref{$utype}, Ref{$etype}, Ptr{Ref{$utype}}, Ref{$rtype}), c, a, bs, R)
      fl == 0 && error("Something wrong in evaluation.")
      return c
    end
    ...
    function zero!(a::($etype))
      ccall((:nmod_mpoly_zero, libflint), Nothing, (Ref{($etype)}, Ref{($rtype)}), a, parent(a))
      return a
    end

    function add!(a::($etype), b::($etype), c::($etype))
      ccall((:nmod_mpoly_add, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), a, b, c, parent(a))
      return a
    end

    function addeq!(a::($etype), b::($etype))
      ccall((:nmod_mpoly_add, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), a, a, b, parent(a))
      return a
    end

    function mul!(a::($etype), b::($etype), c::($etype))
      ccall((:nmod_mpoly_mul, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Ref{($etype)}, Ref{($rtype)}), a, b, c, parent(a))
      return a
    end
    ...
    function setcoeff!(a::($etype), n::Int, c::($ctype))
      if n > length(a)
        ccall((:nmod_mpoly_resize, libflint), Nothing, (Ref{($etype)}, Int, Ref{($rtype)}), a, n, a.parent)
      end
      ccall((:nmod_mpoly_set_term_coeff_ui, libflint), Nothing, (Ref{($etype)}, Int, UInt, Ref{($rtype)}), a, n - 1, c.data, a.parent)
      return a
    end
    ...
    function combine_like_terms!(a::($etype))
      ccall((:nmod_mpoly_combine_like_terms, libflint), Nothing, (Ref{($etype)}, Ref{($rtype)}), a, a.parent)
      return a
    end
    ...
    function exponent_vector_fits(::Type{Int}, a::($etype), i::Int)
      b = ccall((:nmod_mpoly_term_exp_fits_si, libflint), Cint, (Ref{($etype)}, Int, Ref{($rtype)}), a, i - 1, parent(a))
      return Bool(b)
    end

    function exponent_vector_fits(::Type{UInt}, a::($etype), i::Int)
      b = ccall((:nmod_mpoly_term_exp_fits_ui, libflint), Cint, (Ref{($etype)}, Int, Ref{($rtype)}), a, i - 1, parent(a))
      return Bool(b)
    end

    function exponent_vector!(z::Vector{Int}, a::($etype), i::Int)
      ccall((:nmod_mpoly_get_term_exp_si, libflint), Nothing, (Ptr{Int}, Ref{($etype)}, Int, Ref{($rtype)}), z, a, i - 1, parent(a))
      return z
    end

    function exponent_vector!(z::Vector{UInt}, a::($etype), i::Int)
      ccall((:nmod_mpoly_get_term_exp_ui, libflint), Nothing, (Ptr{UInt}, Ref{($etype)}, Int, Ref{($rtype)}), z, a, i - 1, parent(a))
      return z
    end

    function exponent_vector!(z::Vector{ZZRingElem}, a::($etype), i::Int)
      ccall((:nmod_mpoly_get_term_exp_fmpz, libflint), Nothing, (Ptr{Ref{ZZRingElem}}, Ref{($etype)}, Int, Ref{($rtype)}), z, a, i - 1, parent(a))
      return z
    end
    ...
    function set_exponent_vector!(a::($etype), n::Int, exps::Vector{UInt})
      ...
      ccall((:nmod_mpoly_set_term_exp_ui, libflint), Nothing, (Ref{($etype)}, Int, Ptr{UInt}, Ref{($rtype)}), a, n - 1, exps, parent(a))
      return a
    end
    ...
    function set_exponent_vector!(a::($etype), n::Int, exps::Vector{Int})
      if n > length(a)
        ccall((:nmod_mpoly_resize, libflint), Nothing, (Ref{($etype)}, Int, Ref{($rtype)}), a, n, parent(a))
      end
      ccall((:nmod_mpoly_set_term_exp_ui, libflint), Nothing, (Ref{($etype)}, Int, Ptr{Int}, Ref{($rtype)}), a, n - 1, exps, parent(a))
      return a
    end
    ...
    function set_exponent_vector!(a::($etype), n::Int, exps::Vector{ZZRingElem})
      ...
      ccall((:nmod_mpoly_set_term_exp_fmpz, libflint), Nothing, (Ref{($etype)}, Int, Ptr{ZZRingElem}, Ref{($rtype)}), a, n - 1, exps, parent(a))
      return a
    end
    ...
    function exponent(a::($etype), i::Int, j::Int)
      ...
      return ccall((:nmod_mpoly_get_term_var_exp_ui, libflint), Int, (Ref{($etype)}, Int, Int, Ref{($rtype)}), a, i - 1, j - 1, parent(a))
    end
    ...
    function coeff(a::($etype), exps::Vector{UInt})
      z = ccall((:nmod_mpoly_get_coeff_ui_ui, libflint), UInt, (Ref{($etype)}, Ptr{UInt}, Ref{($rtype)}), a, exps, parent(a))
      return base_ring(parent(a))(z)
    end
    ...
    function coeff(a::($etype), exps::Vector{Int})
      z = ccall((:nmod_mpoly_get_coeff_ui_ui, libflint), UInt, (Ref{($etype)}, Ptr{Int}, Ref{($rtype)}), a, exps, parent(a))
      return base_ring(parent(a))(z)
    end
    ...
    function setcoeff!(a::($etype), exps::Vector{UInt}, b::($ctype))
      ccall((:nmod_mpoly_set_coeff_ui_ui, libflint), Nothing, (Ref{($etype)}, UInt, Ptr{UInt}, Ref{($rtype)}), a, b.data, exps, parent(a))
      return a
    end
    ...
    function setcoeff!(a::($etype), exps::Vector{Int}, b::($ctype))
      ccall((:nmod_mpoly_set_coeff_ui_ui, libflint), Nothing, (Ref{($etype)}, UInt, Ptr{Int}, Ref{($rtype)}), a, b.data, exps, parent(a))
      return a
    end
    ...
    function sort_terms!(a::($etype))
      ccall((:nmod_mpoly_sort_terms, libflint), Nothing, (Ref{($etype)}, Ref{($rtype)}), a, parent(a))
      return a
    end
    ...
    function term(a::($etype), i::Int)
      z = parent(a)()
      ccall((:nmod_mpoly_get_term, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Int, Ref{($rtype)}), z, a, i - 1, parent(a))
      return z
    end
    ...
    function monomial(a::($etype), i::Int)
      z = parent(a)()
      ccall((:nmod_mpoly_get_term_monomial, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Int, Ref{($rtype)}), z, a, i - 1, a.parent)
      return z
    end

    # Sets the given polynomial m to the i-th monomial of the polynomial
    function monomial!(m::($etype), a::($etype), i::Int)
      ccall((:nmod_mpoly_get_term_monomial, libflint), Nothing, (Ref{($etype)}, Ref{($etype)}, Int, Ref{($rtype)}), m, a, i - 1, a.parent)
      return m
    end
    ...
    function _push_term!(z::($etype), c::($ctype), exp::Vector{Int})
      ccall((:nmod_mpoly_push_term_ui_ui, libflint), Nothing, (Ref{$etype}, UInt, Ptr{UInt}, Ref{$rtype}), z, c.data, exp, parent(z))
      return z
    end
    ...
    function push_term!(M::MPolyBuildCtx{$etype}, c::RingElement, expv::Vector{Int})
    ...
    function finish(M::MPolyBuildCtx{$etype})
      ...
      R = parent(res)
      M.poly = zero(R)
      ccall((:nmod_mpoly_sort_terms, libflint), Nothing, (Ref{$etype}, Ref{$rtype}), res, R)
      ccall((:nmod_mpoly_combine_like_terms, libflint), Nothing, (Ref{$etype}, Ref{$rtype}), res, R)
      return res
    end

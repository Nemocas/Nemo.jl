...
function getindex!(v::fqPolyRepFieldElem, a::fqPolyRepMatrix, i::Int, j::Int)
  ...
  GC.@preserve a begin
    z = ccall((:fq_nmod_mat_entry, libflint), Ptr{fqPolyRepFieldElem}, (Ref{fqPolyRepMatrix}, Int, Int), a, i - 1, j - 1)
...
@inline function getindex(a::fqPolyRepMatrix, i::Int, j::Int)
  @boundscheck Generic._checkbounds(a, i, j)
  GC.@preserve a begin
    el = ccall((:fq_nmod_mat_entry, libflint), Ptr{fqPolyRepFieldElem}, (Ref{fqPolyRepMatrix}, Int, Int), a, i - 1, j - 1)
    z = base_ring(a)()
...
@inline function setindex!(a::fqPolyRepMatrix, u::fqPolyRepFieldElem, i::Int, j::Int)
  @boundscheck Generic._checkbounds(a, i, j)
  ccall((:fq_nmod_mat_entry_set, libflint), Nothing, (Ref{fqPolyRepMatrix}, Int, Int, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), a, i - 1, j - 1, u, base_ring(a))
end
...
@inline function setindex!(a::fqPolyRepMatrix, u::ZZRingElem, i::Int, j::Int)
  ...
  GC.@preserve a begin
    el = ccall((:fq_nmod_mat_entry, libflint), Ptr{fqPolyRepFieldElem}, (Ref{fqPolyRepMatrix}, Int, Int), a, i - 1, j - 1)
    ccall((:fq_nmod_set_fmpz, libflint), Nothing, (Ptr{fqPolyRepFieldElem}, Ref{ZZRingElem}, Ref{fqPolyRepField}), el, u, base_ring(a))
  end
end
...
function setindex!(a::fqPolyRepMatrix, b::fqPolyRepMatrix, r::UnitRange{Int64}, c::UnitRange{Int64})
  ...
  A = view(a, r, c)
  ccall((:fq_nmod_mat_set, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), A, b, base_ring(A))
end

function deepcopy_internal(a::fqPolyRepMatrix, dict::IdDict)
  z = fqPolyRepMatrix(nrows(a), ncols(a), base_ring(a))
  ccall((:fq_nmod_mat_set, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), z, a, base_ring(a))
  return z
end
...
function iszero(a::fqPolyRepMatrix)
  r = ccall((:fq_nmod_mat_is_zero, libflint), Cint, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), a, base_ring(a))
  return Bool(r)
end
...
function ==(a::fqPolyRepMatrix, b::fqPolyRepMatrix)
  ...
  r = ccall((:fq_nmod_mat_equal, libflint), Cint, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), a, b, base_ring(a))
  return Bool(r)
end
...
function swap_rows!(x::fqPolyRepMatrix, i::Int, j::Int)
  ccall((:fq_nmod_mat_swap_rows, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ptr{Nothing}, Int, Int, Ref{fqPolyRepField}), x, C_NULL, i - 1, j - 1, base_ring(x))
  return x
end
...
function swap_cols!(x::fqPolyRepMatrix, i::Int, j::Int)
  ccall((:fq_nmod_mat_swap_cols, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ptr{Nothing}, Int, Int, Ref{fqPolyRepField}), x, C_NULL, i - 1, j - 1, base_ring(x))
  return x
end
...
function reverse_rows!(x::fqPolyRepMatrix)
  ccall((:fq_nmod_mat_invert_rows, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ptr{Nothing}, Ref{fqPolyRepField}), x, C_NULL, base_ring(x))
  return x
end
...
function reverse_cols!(x::fqPolyRepMatrix)
  ccall((:fq_nmod_mat_invert_cols, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ptr{Nothing}, Ref{fqPolyRepField}), x, C_NULL, base_ring(x))
  return x
end
...
function -(x::fqPolyRepMatrix)
  z = similar(x)
  ccall((:fq_nmod_mat_neg, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), z, x, base_ring(x))
  return z
end
...
function +(x::fqPolyRepMatrix, y::fqPolyRepMatrix)
  check_parent(x, y)
  z = similar(x)
  ccall((:fq_nmod_mat_add, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), z, x, y, base_ring(x))
  return z
end
...
function -(x::fqPolyRepMatrix, y::fqPolyRepMatrix)
  check_parent(x, y)
  z = similar(x)
  ccall((:fq_nmod_mat_sub, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), z, x, y, base_ring(x))
...
function *(x::fqPolyRepMatrix, y::fqPolyRepMatrix)
  ...
  ccall((:fq_nmod_mat_mul, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), z, x, y, base_ring(x))
  return z
end
...
function mul!(a::fqPolyRepMatrix, b::fqPolyRepMatrix, c::fqPolyRepMatrix)
  ccall((:fq_nmod_mat_mul, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), a, b, c, base_ring(a))
  return a
end

function add!(a::fqPolyRepMatrix, b::fqPolyRepMatrix, c::fqPolyRepMatrix)
  ccall((:fq_nmod_mat_add, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), a, b, c, base_ring(a))
  return a
end

function zero!(a::fqPolyRepMatrix)
  ccall((:fq_nmod_mat_zero, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), a, base_ring(a))
  return a
end

function mul!(z::Vector{fqPolyRepFieldElem}, a::fqPolyRepMatrix, b::Vector{fqPolyRepFieldElem})
  ccall((:fq_nmod_mat_mul_vec_ptr, libflint), Nothing, (Ptr{Ref{fqPolyRepFieldElem}}, Ref{fqPolyRepMatrix}, Ptr{Ref{fqPolyRepFieldElem}}, Int, Ref{fqPolyRepField}), z, a, b, length(b), base_ring(a))
  return z
end

function mul!(z::Vector{fqPolyRepFieldElem}, a::Vector{fqPolyRepFieldElem}, b::fqPolyRepMatrix)
  ccall((:fq_nmod_mat_vec_mul_ptr, libflint), Nothing, (Ptr{Ref{fqPolyRepFieldElem}}, Ptr{Ref{fqPolyRepFieldElem}}, Int, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), z, a, length(a), b, base_ring(b))
  return z
end
...
function Generic.add_one!(a::fqPolyRepMatrix, i::Int, j::Int)
  ...
  GC.@preserve a begin
    ...
    ccall((:fq_nmod_neg, libflint), Nothing, (Ptr{fqPolyRepFieldElem}, Ptr{fqPolyRepFieldElem}, Ref{fqPolyRepField}), x, x, F)
    ccall((:fq_nmod_sub_one, libflint), Nothing, (Ptr{fqPolyRepFieldElem}, Ptr{fqPolyRepFieldElem}, Ref{fqPolyRepField}), x, x, F)
    ccall((:fq_nmod_neg, libflint), Nothing, (Ptr{fqPolyRepFieldElem}, Ptr{fqPolyRepFieldElem}, Ref{fqPolyRepField}), x, x, F)
  end
  return a
end
...
function rref(a::fqPolyRepMatrix)
  z = similar(a)
  r = ccall((:fq_nmod_mat_rref, libflint), Int, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), z, a, base_ring(a))
  return r, z
end

function rref!(a::fqPolyRepMatrix)
  r = ccall((:fq_nmod_mat_rref, libflint), Int, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), a, a, base_ring(a))
  return r
end
...
function inv(a::fqPolyRepMatrix)
  ...
  z = similar(a)
  r = ccall((:fq_nmod_mat_inv, libflint), Int, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), z, a, base_ring(a))
...
function Solve._can_solve_internal_no_check(A::fqPolyRepMatrix, b::fqPolyRepMatrix, task::Symbol; side::Symbol=:left)
  ...
  fl = ccall((:fq_nmod_mat_can_solve, libflint), Cint, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), x, A, b, base_ring(A))
...
function _solve_tril_right_flint!(x::fqPolyRepMatrix, L::fqPolyRepMatrix, B::fqPolyRepMatrix, unit::Bool)
  ccall((:fq_nmod_mat_solve_tril, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Cint, Ref{fqPolyRepField}), x, L, B, Cint(unit), base_ring(L))
  return nothing
end

function _solve_triu_right_flint!(x::fqPolyRepMatrix, U::fqPolyRepMatrix, B::fqPolyRepMatrix, unit::Bool)
  ccall((:fq_nmod_mat_solve_triu, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Cint, Ref{fqPolyRepField}), x, U, B, Cint(unit), base_ring(U))
  return nothing
end
...
function lu!(P::Generic.Perm, x::fqPolyRepMatrix)
  ...
  rank = Int(ccall((:fq_nmod_mat_lu, libflint), Cint, (Ptr{Int}, Ref{fqPolyRepMatrix}, Cint, Ref{fqPolyRepField}), P.d, x, 0, base_ring(x)))
...
function Base.view(x::fqPolyRepMatrix, r1::Int, c1::Int, r2::Int, c2::Int)
  ...
  z.view_parent = x
  ccall((:fq_nmod_mat_window_init, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Int, Int, Int, Int, Ref{fqPolyRepField}), z, x, r1 - 1, c1 - 1, r2, c2, base_ring(x))
...
function _fq_nmod_mat_window_clear_fn(a::fqPolyRepMatrix)
  ccall((:fq_nmod_mat_window_clear, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), a, base_ring(a))
end
...
function hcat(x::fqPolyRepMatrix, y::fqPolyRepMatrix)
  ...
  ccall((:fq_nmod_mat_concat_horizontal, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), z, x, y, base_ring(x))
  return z
end
...
function vcat(x::fqPolyRepMatrix, y::fqPolyRepMatrix)
  ...
  ccall((:fq_nmod_mat_concat_vertical, libflint), Nothing, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), z, x, y, base_ring(x))
  return z
end
...
function charpoly(R::fqPolyRepPolyRing, a::fqPolyRepMatrix)
  ...
  p = R()
  ccall((:fq_nmod_mat_charpoly, libflint), Nothing, (Ref{fqPolyRepPolyRingElem}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), p, a, base_ring(a))
  return p
end
...
function charpoly_danivlesky!(R::fqPolyRepPolyRing, a::fqPolyRepMatrix)
  ...
  base_ring(R) != base_ring(a) && error("Must have common base ring")
  p = R()
  ccall((:fq_nmod_mat_charpoly_danilevsky, libflint), Nothing, (Ref{fqPolyRepPolyRingElem}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), p, a, base_ring(a))
  return p
end
...
function minpoly(R::fqPolyRepPolyRing, a::fqPolyRepMatrix)
  ...
  m = deepcopy(a)
  p = R()
  ccall((:fq_nmod_mat_minpoly, libflint), Nothing, (Ref{fqPolyRepPolyRingElem}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), p, m, base_ring(a))
  return p
end
...
function nullspace(M::fqPolyRepMatrix)
  ...
  nullity = ccall((:fq_nmod_mat_nullspace, libflint), Int, (Ref{fqPolyRepMatrix}, Ref{fqPolyRepMatrix}, Ref{fqPolyRepField}), N, M, base_ring(M))
...
@inline mat_entry_ptr(A::fqPolyRepMatrix, i::Int, j::Int) = ccall((:fq_nmod_mat_entry, libflint), Ptr{fqPolyRepFieldElem}, (Ref{fqPolyRepMatrix}, Int, Int), A, i - 1, j - 1)

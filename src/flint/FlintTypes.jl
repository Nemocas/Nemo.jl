...
@doc zz_ring_doc struct ZZRing <: Ring end

const ZZ = ZZRing()

integer_ring() = ZZRing()

@doc zz_ring_doc mutable struct ZZRingElem <: RingElem
  d::Int
...
function _fmpz_factor_clear_fn(a::fmpz_factor)
  ccall((:fmpz_factor_clear, libflint), Nothing, (Ref{fmpz_factor},), a)
end
...
@doc qq_field_doc struct QQField <: FracField{ZZRingElem} end

const QQ = QQField()

rational_field() = QQ

@doc qq_field_doc mutable struct QQFieldElem <: FracElem{ZZRingElem}
  num::Int
  den::Int
  ...
  function QQFieldElem(a::ZZRingElem, b::ZZRingElem)
    ...
    z = new()
    ccall((:fmpq_init, libflint), Nothing, (Ref{QQFieldElem},), z)
    ccall((:fmpq_set_fmpz_frac, libflint), Nothing, (Ref{QQFieldElem}, Ref{ZZRingElem}, Ref{ZZRingElem}), z, a, b)
    finalizer(_fmpq_clear_fn, z)
    return z
  end
  ...
  function QQFieldElem(a::Int, b::Int)
    ...
    if b == typemin(Int) || (b < 0 && a == typemin(Int))
      ...
      az = -ZZ(a)
      ccall((:fmpq_init, libflint), Nothing, (Ref{QQFieldElem},), z)
      ccall((:fmpq_set_fmpz_frac, libflint), Nothing, (Ref{QQFieldElem}, Ref{ZZRingElem}, Ref{ZZRingElem}), z, az, bz)
    else
      ...
      ccall((:fmpq_init, libflint), Nothing, (Ref{QQFieldElem},), z)
      ccall((:fmpq_set_si, libflint), Nothing, (Ref{QQFieldElem}, Int, Int), z, a, b)
    end
    finalizer(_fmpq_clear_fn, z)
    return z
  end
  ...
  function QQFieldElem(a::Int)
    z = new()
    ccall((:fmpq_init, libflint), Nothing, (Ref{QQFieldElem},), z)
    ccall((:fmpq_set_si, libflint), Nothing, (Ref{QQFieldElem}, Int, Int), z, a, 1)
    finalizer(_fmpq_clear_fn, z)
    return z
  end
...
mutable struct ZZPolyRingElem <: PolyRingElem{ZZRingElem}
  ...
  function ZZPolyRingElem(a::Vector{ZZRingElem})
    z = new()
    ccall((:fmpz_poly_init2, libflint), Nothing, (Ref{ZZPolyRingElem}, Int), z, length(a))
    for i in 1:length(a)
      ccall((:fmpz_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZPolyRingElem}, Int, Ref{ZZRingElem}), z, i - 1, a[i])
    end
    finalizer(_fmpz_poly_clear_fn, z)
    return z
  end
  ...
  function ZZPolyRingElem(a::ZZRingElem)
    z = new()
    ccall((:fmpz_poly_init, libflint), Nothing, (Ref{ZZPolyRingElem},), z)
    ccall((:fmpz_poly_set_fmpz, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZRingElem}), z, a)
    finalizer(_fmpz_poly_clear_fn, z)
    return z
  end
  ...
  function ZZPolyRingElem(a::ZZPolyRingElem)
    z = new()
    ccall((:fmpz_poly_init, libflint), Nothing, (Ref{ZZPolyRingElem},), z)
    ccall((:fmpz_poly_set, libflint), Nothing, (Ref{ZZPolyRingElem}, Ref{ZZPolyRingElem}), z, a)
    finalizer(_fmpz_poly_clear_fn, z)
    return z
  end
end
...
mutable struct fmpz_poly_factor
  ...
  function fmpz_poly_factor()
    z = new()
    ccall((:fmpz_poly_factor_init, libflint), Nothing, (Ref{fmpz_poly_factor},), z)
...
function _fmpz_poly_factor_clear_fn(f::fmpz_poly_factor)
  ccall((:fmpz_poly_factor_clear, libflint), Nothing, (Ref{fmpz_poly_factor},), f)
  nothing
end
...
mutable struct QQPolyRingElem <: PolyRingElem{QQFieldElem}
  ...
  function QQPolyRingElem(a::Vector{QQFieldElem})
    z = new()
    ccall((:fmpq_poly_init2, libflint), Nothing, (Ref{QQPolyRingElem}, Int), z, length(a))
    for i in 1:length(a)
      ccall((:fmpq_poly_set_coeff_fmpq, libflint), Nothing, (Ref{QQPolyRingElem}, Int, Ref{QQFieldElem}), z, i - 1, a[i])
    end
    finalizer(_fmpq_poly_clear_fn, z)
    return z
  end
  ...
  function QQPolyRingElem(a::ZZRingElem)
    z = new()
    ccall((:fmpq_poly_init, libflint), Nothing, (Ref{QQPolyRingElem},), z)
    ccall((:fmpq_poly_set_fmpz, libflint), Nothing, (Ref{QQPolyRingElem}, Ref{ZZRingElem}), z, a)
    finalizer(_fmpq_poly_clear_fn, z)
    return z
  end
  ...
  function QQPolyRingElem(a::QQFieldElem)
    z = new()
    ccall((:fmpq_poly_init, libflint), Nothing, (Ref{QQPolyRingElem},), z)
    ccall((:fmpq_poly_set_fmpq, libflint), Nothing, (Ref{QQPolyRingElem}, Ref{QQFieldElem}), z, a)
    finalizer(_fmpq_poly_clear_fn, z)
    return z
  end
  ...
  function QQPolyRingElem(a::ZZPolyRingElem)
    z = new()
    ccall((:fmpq_poly_init, libflint), Nothing, (Ref{QQPolyRingElem},), z)
    ccall((:fmpq_poly_set_fmpz_poly, libflint), Nothing, (Ref{QQPolyRingElem}, Ref{ZZPolyRingElem}), z, a)
    finalizer(_fmpq_poly_clear_fn, z)
    return z
  end
  ...
  function QQPolyRingElem(a::QQPolyRingElem)
    z = new()
    ccall((:fmpq_poly_init, libflint), Nothing, (Ref{QQPolyRingElem},), z)
    ccall((:fmpq_poly_set, libflint), Nothing, (Ref{QQPolyRingElem}, Ref{QQPolyRingElem}), z, a)
    finalizer(_fmpq_poly_clear_fn, z)
    return z
  end
end
...
mutable struct zzModPolyRingElem <: PolyRingElem{zzModRingElem}
  ...
  function zzModPolyRingElem(n::UInt, a::UInt)
    z = new()
    ccall((:nmod_poly_init, libflint), Nothing, (Ref{zzModPolyRingElem}, UInt), z, n)
    ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{zzModPolyRingElem}, Int, UInt), z, 0, a)
    finalizer(_nmod_poly_clear_fn, z)
    return z
  end
  ...
  function zzModPolyRingElem(n::UInt, a::Int)
    z = new()
    ccall((:nmod_poly_init, libflint), Nothing, (Ref{zzModPolyRingElem}, UInt), z, n)
    ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{zzModPolyRingElem}, Int, UInt), z, 0, mod(a, n))
    finalizer(_nmod_poly_clear_fn, z)
    return z
  end
  ...
  function zzModPolyRingElem(n::UInt, arr::Vector{ZZRingElem})
    z = new()
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{zzModPolyRingElem}, UInt, Int), z, n, length(arr))
    for i in 1:length(arr)
      tt = ccall((:fmpz_fdiv_ui, libflint), UInt, (Ref{ZZRingElem}, UInt), arr[i], n)
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{zzModPolyRingElem}, Int, UInt), z, i - 1, tt)
    end
    finalizer(_nmod_poly_clear_fn, z)
    return z
  end
  ...
  function zzModPolyRingElem(n::UInt, arr::Vector{UInt})
    ...
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{zzModPolyRingElem}, UInt, Int), z, n, length(arr))
    for i in 1:length(arr)
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{zzModPolyRingElem}, Int, UInt), z, i - 1, arr[i])
    end
    finalizer(_nmod_poly_clear_fn, z)
    return z
  end
  ...
  function zzModPolyRingElem(n::UInt, arr::Vector{zzModRingElem})
    ...
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{zzModPolyRingElem}, UInt, Int), z, n, length(arr))
    for i in 1:length(arr)
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{zzModPolyRingElem}, Int, UInt), z, i - 1, arr[i].data)
    end
    finalizer(_nmod_poly_clear_fn, z)
    return z
  end
  ...
  function zzModPolyRingElem(n::UInt, f::ZZPolyRingElem)
    z = new()
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{zzModPolyRingElem}, UInt, Int), z, n, length(f))
    ccall((:fmpz_poly_get_nmod_poly, libflint), Nothing, (Ref{zzModPolyRingElem}, Ref{ZZPolyRingElem}), z, f)
    finalizer(_nmod_poly_clear_fn, z)
    return z
  end
  ...
  function zzModPolyRingElem(n::UInt, f::zzModPolyRingElem)
    z = new()
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{zzModPolyRingElem}, UInt, Int), z, n, length(f))
    ccall((:nmod_poly_set, libflint), Nothing, (Ref{zzModPolyRingElem}, Ref{zzModPolyRingElem}), z, f)
    finalizer(_nmod_poly_clear_fn, z)
    return z
  end
end
...
mutable struct nmod_poly_factor
  ...
  function nmod_poly_factor(n::UInt)
    z = new()
    ccall((:nmod_poly_factor_init, libflint), Nothing, (Ref{nmod_poly_factor},), z)
    z.n = n
...
function _nmod_poly_factor_clear_fn(a::nmod_poly_factor)
  ccall((:nmod_poly_factor_clear, libflint), Nothing, (Ref{nmod_poly_factor},), a)
end
...
mutable struct fpPolyRingElem <: PolyRingElem{fpFieldElem}
  ...
  function fpPolyRingElem(n::UInt, a::UInt)
    z = new()
    ccall((:nmod_poly_init, libflint), Nothing, (Ref{fpPolyRingElem}, UInt), z, n)
    ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{fpPolyRingElem}, Int, UInt), z, 0, a)
    finalizer(_gfp_poly_clear_fn, z)
    return z
  end
  ...
  function fpPolyRingElem(n::UInt, a::Int)
    z = new()
    ccall((:nmod_poly_init, libflint), Nothing, (Ref{fpPolyRingElem}, UInt), z, n)
    ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{fpPolyRingElem}, Int, UInt), z, 0, mod(a, n))
    finalizer(_gfp_poly_clear_fn, z)
    return z
  end
  ...
  function fpPolyRingElem(n::UInt, arr::Vector{ZZRingElem})
    z = new()
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{fpPolyRingElem}, UInt, Int), z, n, length(arr))
    for i in 1:length(arr)
      tt = ccall((:fmpz_fdiv_ui, libflint), UInt, (Ref{ZZRingElem}, UInt), arr[i], n)
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{fpPolyRingElem}, Int, UInt), z, i - 1, tt)
    end
    finalizer(_gfp_poly_clear_fn, z)
    return z
  end
  ...
  function fpPolyRingElem(n::UInt, arr::Vector{UInt})
    ...
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{fpPolyRingElem}, UInt, Int), z, n, length(arr))
    for i in 1:length(arr)
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{fpPolyRingElem}, Int, UInt), z, i - 1, arr[i])
    end
    finalizer(_gfp_poly_clear_fn, z)
    return z
  end
  ...
  function fpPolyRingElem(n::UInt, arr::Vector{fpFieldElem})
    ...
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{fpPolyRingElem}, UInt, Int), z, n, length(arr))
    for i in 1:length(arr)
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{fpPolyRingElem}, Int, UInt), z, i - 1, arr[i].data)
    end
    finalizer(_gfp_poly_clear_fn, z)
    return z
  end
  ...
  function fpPolyRingElem(n::UInt, f::ZZPolyRingElem)
    z = new()
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{fpPolyRingElem}, UInt, Int), z, n, length(f))
    ccall((:fmpz_poly_get_nmod_poly, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{ZZPolyRingElem}), z, f)
    finalizer(_gfp_poly_clear_fn, z)
    return z
  end
  ...
  function fpPolyRingElem(n::UInt, f::fpPolyRingElem)
    z = new()
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{fpPolyRingElem}, UInt, Int), z, n, length(f))
    ccall((:nmod_poly_set, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{fpPolyRingElem}), z, f)
    finalizer(_gfp_poly_clear_fn, z)
    return z
  end
end
...
mutable struct gfp_poly_factor
  ...
  function gfp_poly_factor(n::UInt)
    z = new()
    ccall((:nmod_poly_factor_init, libflint), Nothing, (Ref{gfp_poly_factor},), z)
    z.n = n
...
function _gfp_poly_factor_clear_fn(a::gfp_poly_factor)
  ccall((:nmod_poly_factor_clear, libflint), Nothing, (Ref{gfp_poly_factor},), a)
end
...
mutable struct ZZModPolyRingElem <: PolyRingElem{ZZModRingElem}
  ...
  function ZZModPolyRingElem(n::fmpz_mod_ctx_struct)
    z = new()
    ccall((:fmpz_mod_poly_init, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}), z, n)
  ...
  function ZZModPolyRingElem(n::fmpz_mod_ctx_struct, a::ZZRingElem)
    z = new()
    ccall((:fmpz_mod_poly_init, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}), z, n)
    ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZModPolyRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, 0, a, n)
    finalizer(_fmpz_mod_poly_clear_fn, z)
    return z
  end
  ...
  function ZZModPolyRingElem(n::fmpz_mod_ctx_struct, a::UInt)
    z = new()
    ccall((:fmpz_mod_poly_init, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}), z, n)
    ccall((:fmpz_mod_poly_set_coeff_ui, libflint), Nothing, (Ref{ZZModPolyRingElem}, Int, UInt, Ref{fmpz_mod_ctx_struct}), z, 0, a, n)
    finalizer(_fmpz_mod_poly_clear_fn, z)
    return z
  end
  ...
  function ZZModPolyRingElem(n::fmpz_mod_ctx_struct, arr::Vector{ZZRingElem})
    ...
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{ZZModPolyRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, length(arr), n)
    for i in 1:length(arr)
      ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZModPolyRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, i - 1, arr[i], n)
    end
    finalizer(_fmpz_mod_poly_clear_fn, z)
    return z
  end
  ...
  function ZZModPolyRingElem(n::fmpz_mod_ctx_struct, arr::Vector{ZZModRingElem})
    ...
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{ZZModPolyRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, length(arr), n)
    for i in 1:length(arr)
      ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZModPolyRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, i - 1, arr[i].data, n)
    end
    finalizer(_fmpz_mod_poly_clear_fn, z)
    return z
  end
  ...
  function ZZModPolyRingElem(n::fmpz_mod_ctx_struct, f::ZZPolyRingElem)
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{ZZModPolyRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, length(f), n)
    ccall((:fmpz_mod_poly_set_fmpz_poly, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{ZZPolyRingElem}, Ref{fmpz_mod_ctx_struct}), z, f, n)
    finalizer(_fmpz_mod_poly_clear_fn, z)
    return z
  end
  ...
  function ZZModPolyRingElem(n::fmpz_mod_ctx_struct, f::ZZModPolyRingElem)
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{ZZModPolyRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, length(f), n)
    ccall((:fmpz_mod_poly_set, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}), z, f, n)
    finalizer(_fmpz_mod_poly_clear_fn, z)
    return z
  end
...
function _fmpz_mod_poly_clear_fn(x::ZZModPolyRingElem)
  ccall((:fmpz_mod_poly_clear, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}), x, base_ring(parent(x)).ninv)
end
...
mutable struct fmpz_mod_poly_factor
  ...
  function fmpz_mod_poly_factor(n::fmpz_mod_ctx_struct)
    z = new()
    ccall((:fmpz_mod_poly_factor_init, libflint), Nothing, (Ref{fmpz_mod_poly_factor}, Ref{fmpz_mod_ctx_struct}), z, n)
    z.n = n
...
function _fmpz_mod_poly_factor_clear_fn(a::fmpz_mod_poly_factor)
  ccall((:fmpz_mod_poly_factor_clear, libflint), Nothing, (Ref{fmpz_mod_poly_factor}, Ref{fmpz_mod_ctx_struct}), a, a.n)
end
...
mutable struct FpPolyRingElem <: PolyRingElem{FpFieldElem}
  ...
  function FpPolyRingElem(n::fmpz_mod_ctx_struct)
    z = new()
    ccall((:fmpz_mod_poly_init, libflint), Nothing, (Ref{FpPolyRingElem}, Ref{fmpz_mod_ctx_struct}), z, n)
    finalizer(_fmpz_mod_poly_clear_fn, z)
    return z
  end
  ...
  function FpPolyRingElem(n::fmpz_mod_ctx_struct, a::ZZRingElem)
    z = new()
    ccall((:fmpz_mod_poly_init, libflint), Nothing, (Ref{FpPolyRingElem}, Ref{fmpz_mod_ctx_struct}), z, n)
    ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{FpPolyRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, 0, a, n)
    finalizer(_fmpz_mod_poly_clear_fn, z)
    return z
  end
  ...
  function FpPolyRingElem(n::fmpz_mod_ctx_struct, arr::Vector{ZZRingElem})
    length(arr) == 0 && error("Array must have length > 0")
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{FpPolyRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, length(arr), n)
    for i in 1:length(arr)
      ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{FpPolyRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, i - 1, arr[i], n)
    end
    finalizer(_fmpz_mod_poly_clear_fn, z)
    return z
  end
  ...
  function FpPolyRingElem(n::fmpz_mod_ctx_struct, arr::Vector{FpFieldElem})
    ...
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{FpPolyRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, length(arr), n)
    for i in 1:length(arr)
      ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{FpPolyRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, i - 1, arr[i].data, n)
    end
    finalizer(_fmpz_mod_poly_clear_fn, z)
    return z
  end
  ...
  function FpPolyRingElem(n::fmpz_mod_ctx_struct, f::ZZPolyRingElem)
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{FpPolyRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, length(f), n)
    ccall((:fmpz_mod_poly_set_fmpz_poly, libflint), Nothing, (Ref{FpPolyRingElem}, Ref{ZZPolyRingElem}, Ref{fmpz_mod_ctx_struct}), z, f, n)
    finalizer(_fmpz_mod_poly_clear_fn, z)
    return z
  end
  ...
  function FpPolyRingElem(n::fmpz_mod_ctx_struct, f::FpPolyRingElem)
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{FpPolyRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, length(f), n)
    ccall((:fmpz_mod_poly_set, libflint), Nothing, (Ref{FpPolyRingElem}, Ref{FpPolyRingElem}, Ref{fmpz_mod_ctx_struct}), z, f, n)
    finalizer(_fmpz_mod_poly_clear_fn, z)
    return z
  end
...
function _fmpz_mod_poly_clear_fn(x::FpPolyRingElem)
  ccall((:fmpz_mod_poly_clear, libflint), Nothing, (Ref{FpPolyRingElem}, Ref{fmpz_mod_ctx_struct}), x, base_ring(parent(x)).ninv)
end
...
mutable struct gfp_fmpz_poly_factor
  ...
  function gfp_fmpz_poly_factor(n::fmpz_mod_ctx_struct)
    z = new()
    ccall((:fmpz_mod_poly_factor_init, libflint), Nothing, (Ref{gfp_fmpz_poly_factor}, Ref{fmpz_mod_ctx_struct}), z, n)
    z.n = n
...
function _gfp_fmpz_poly_factor_clear_fn(a::gfp_fmpz_poly_factor)
  ccall((:fmpz_mod_poly_factor_clear, libflint), Nothing, (Ref{gfp_fmpz_poly_factor}, Ref{fmpz_mod_ctx_struct}), a, a.n)
end
...
@attributes mutable struct ZZMPolyRing <: MPolyRing{ZZRingElem}
  ...
  function ZZMPolyRing(s::Vector{Symbol}, S::Symbol, cached::Bool=true)
    return get_cached!(FmpzMPolyID, (s, S), cached) do
      ...
      z = new()
      ccall((:fmpz_mpoly_ctx_init, libflint), Nothing, (Ref{ZZMPolyRing}, Int, Int), z, length(s), ord)
      z.S = s
...
function _fmpz_mpoly_ctx_clear_fn(a::ZZMPolyRing)
  ccall((:fmpz_mpoly_ctx_clear, libflint), Nothing, (Ref{ZZMPolyRing},), a)
end
...
mutable struct ZZMPolyRingElem <: MPolyRingElem{ZZRingElem}
  ...
  function ZZMPolyRingElem(ctx::ZZMPolyRing)
    z = new()
    ccall((:fmpz_mpoly_init, libflint), Nothing, (Ref{ZZMPolyRingElem}, Ref{ZZMPolyRing}), z, ctx)
    z.parent = ctx
  ...
  function ZZMPolyRingElem(ctx::ZZMPolyRing, a::Vector{ZZRingElem}, b::Vector{Vector{UInt}})
    z = new()
    ccall((:fmpz_mpoly_init2, libflint), Nothing, (Ref{ZZMPolyRingElem}, Int, Ref{ZZMPolyRing}), z, length(a), ctx)
    z.parent = ctx
    finalizer(_fmpz_mpoly_clear_fn, z)

    for i in 1:length(a)
      ccall((:fmpz_mpoly_push_term_fmpz_ui, libflint), Nothing, (Ref{ZZMPolyRingElem}, Ref{ZZRingElem}, Ptr{UInt}, Ref{ZZMPolyRing}), z, a[i], b[i], ctx)
    end

    ccall((:fmpz_mpoly_sort_terms, libflint), Nothing, (Ref{ZZMPolyRingElem}, Ref{ZZMPolyRing}), z, ctx)
    ccall((:fmpz_mpoly_combine_like_terms, libflint), Nothing, (Ref{ZZMPolyRingElem}, Ref{ZZMPolyRing}), z, ctx)
    return z
  end
  ...
  function ZZMPolyRingElem(ctx::ZZMPolyRing, a::Vector{ZZRingElem}, b::Vector{Vector{Int}})
    ...
    for i in 1:length(a)
      ccall((:fmpz_mpoly_push_term_fmpz_ui, libflint), Nothing, (Ref{ZZMPolyRingElem}, Ref{ZZRingElem}, Ptr{Int}, Ref{ZZMPolyRing}), z, a[i], b[i], ctx)
    end
  ...
  function ZZMPolyRingElem(ctx::ZZMPolyRing, a::Vector{ZZRingElem}, b::Vector{Vector{ZZRingElem}})
    ...
    for i in 1:length(a)
      ccall((:fmpz_mpoly_push_term_fmpz_fmpz, libflint), Nothing, (Ref{ZZMPolyRingElem}, Ref{ZZRingElem}, Ptr{Ref{ZZRingElem}}, Ref{ZZMPolyRing}), z, a[i], b[i], ctx)
    end
  ...
  function ZZMPolyRingElem(ctx::ZZMPolyRing, a::ZZRingElem)
    z = new()
    ccall((:fmpz_mpoly_init, libflint), Nothing, (Ref{ZZMPolyRingElem}, Ref{ZZMPolyRing}), z, ctx)
    ccall((:fmpz_mpoly_set_fmpz, libflint), Nothing, (Ref{ZZMPolyRingElem}, Ref{ZZRingElem}, Ref{ZZMPolyRing}), z, a, ctx)
    z.parent = ctx
    finalizer(_fmpz_mpoly_clear_fn, z)
    return z
  end
  ...
  function ZZMPolyRingElem(ctx::ZZMPolyRing, a::Int)
    z = new()
    ccall((:fmpz_mpoly_init, libflint), Nothing, (Ref{ZZMPolyRingElem}, Ref{ZZMPolyRing}), z, ctx)
    ccall((:fmpz_mpoly_set_si, libflint), Nothing, (Ref{ZZMPolyRingElem}, Int, Ref{ZZMPolyRing}), z, a, ctx)
    finalizer(_fmpz_mpoly_clear_fn, z)
    z.parent = ctx
    return z
  end
  ...
  function ZZMPolyRingElem(ctx::ZZMPolyRing, a::UInt)
    z = new()
    ccall((:fmpz_mpoly_init, libflint), Nothing, (Ref{ZZMPolyRingElem}, Ref{ZZMPolyRing}), z, ctx)
    ccall((:fmpz_mpoly_set_ui, libflint), Nothing, (Ref{ZZMPolyRingElem}, UInt, Ref{ZZMPolyRing}), z, a, ctx)
    finalizer(_fmpz_mpoly_clear_fn, z)
    z.parent = ctx
    return z
  end
...
function _fmpz_mpoly_clear_fn(a::ZZMPolyRingElem)
  ccall((:fmpz_mpoly_clear, libflint), Nothing, (Ref{ZZMPolyRingElem}, Ref{ZZMPolyRing}), a, a.parent)
end
...
mutable struct fmpz_mpoly_factor
  ...
  function fmpz_mpoly_factor(ctx::ZZMPolyRing)
    z = new()
    ccall((:fmpz_mpoly_factor_init, libflint), Nothing, (Ref{fmpz_mpoly_factor}, Ref{ZZMPolyRing}), z, ctx)
    z.parent = ctx
...
function _fmpz_mpoly_factor_clear_fn(f::fmpz_mpoly_factor)
  ccall((:fmpz_mpoly_factor_clear, libflint), Nothing, (Ref{fmpz_mpoly_factor}, Ref{ZZMPolyRing}), f, f.parent)
end
...
@attributes mutable struct QQMPolyRing <: MPolyRing{QQFieldElem}
  ...
  function QQMPolyRing(s::Vector{Symbol}, S::Symbol, cached::Bool=true)
    return get_cached!(FmpqMPolyID, (s, S), cached) do
      ...
      z = new()
      ccall((:fmpq_mpoly_ctx_init, libflint), Nothing, (Ref{QQMPolyRing}, Int, Int), z, length(s), ord)
      z.S = s
...
function _fmpq_mpoly_ctx_clear_fn(a::QQMPolyRing)
  ccall((:fmpq_mpoly_ctx_clear, libflint), Nothing, (Ref{QQMPolyRing},), a)
end
...
mutable struct QQMPolyRingElem <: MPolyRingElem{QQFieldElem}
  ...
  function QQMPolyRingElem(ctx::QQMPolyRing)
    z = new()
    ccall((:fmpq_mpoly_init, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, ctx)
    z.parent = ctx
  ...
  function QQMPolyRingElem(ctx::QQMPolyRing, a::Vector{QQFieldElem}, b::Vector{Vector{UInt}})
    z = new()
    ccall((:fmpq_mpoly_init2, libflint), Nothing, (Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), z, length(a), ctx)
    z.parent = ctx
    finalizer(_fmpq_mpoly_clear_fn, z)

    for i in 1:length(a)
      ccall((:fmpq_mpoly_push_term_fmpq_ui, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQFieldElem}, Ptr{UInt}, Ref{QQMPolyRing}), z, a[i], b[i], ctx)
    end

    ccall((:fmpq_mpoly_sort_terms, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, ctx)
    ccall((:fmpq_mpoly_combine_like_terms, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, ctx)
    return z
  end
  ...
  function QQMPolyRingElem(ctx::QQMPolyRing, a::Vector{QQFieldElem}, b::Vector{Vector{Int}})
    ...
    for i in 1:length(a)
      ccall((:fmpq_mpoly_push_term_fmpq_ui, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQFieldElem}, Ptr{Int}, Ref{QQMPolyRing}), z, a[i], b[i], ctx)
    end
  ...
  function QQMPolyRingElem(ctx::QQMPolyRing, a::Vector{QQFieldElem}, b::Vector{Vector{ZZRingElem}})
    ...
    for i in 1:length(a)
      ccall((:fmpq_mpoly_push_term_fmpq_fmpz, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQFieldElem}, Ptr{Ref{ZZRingElem}}, Ref{QQMPolyRing}), z, a[i], b[i], ctx)
    end
  ...
  function QQMPolyRingElem(ctx::QQMPolyRing, a::ZZRingElem)
    z = new()
    ccall((:fmpq_mpoly_init, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, ctx)
    ccall((:fmpq_mpoly_set_fmpz, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{ZZRingElem}, Ref{QQMPolyRing}), z, a, ctx)
    z.parent = ctx
    finalizer(_fmpq_mpoly_clear_fn, z)
    return z
  end
  ...
  function QQMPolyRingElem(ctx::QQMPolyRing, a::QQFieldElem)
    z = new()
    ccall((:fmpq_mpoly_init, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, ctx)
    ccall((:fmpq_mpoly_set_fmpq, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQFieldElem}, Ref{QQMPolyRing}), z, a, ctx)
    z.parent = ctx
    finalizer(_fmpq_mpoly_clear_fn, z)
    return z
  end
  ...
  function QQMPolyRingElem(ctx::QQMPolyRing, a::Int)
    z = new()
    ccall((:fmpq_mpoly_init, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, ctx)
    ccall((:fmpq_mpoly_set_si, libflint), Nothing, (Ref{QQMPolyRingElem}, Int, Ref{QQMPolyRing}), z, a, ctx)
    z.parent = ctx
    finalizer(_fmpq_mpoly_clear_fn, z)
    return z
  end
  ...
  function QQMPolyRingElem(ctx::QQMPolyRing, a::UInt)
    z = new()
    ccall((:fmpq_mpoly_init, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), z, ctx)
    ccall((:fmpq_mpoly_set_ui, libflint), Nothing, (Ref{QQMPolyRingElem}, UInt, Ref{QQMPolyRing}), z, a, ctx)
    z.parent = ctx
    finalizer(_fmpq_mpoly_clear_fn, z)
    return z
  end
...
function _fmpq_mpoly_clear_fn(a::QQMPolyRingElem)
  ccall((:fmpq_mpoly_clear, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, a.parent)
end
...
mutable struct fmpq_mpoly_factor
  ...
  function fmpq_mpoly_factor(ctx::QQMPolyRing)
    z = new()
    ccall((:fmpq_mpoly_factor_init, libflint), Nothing, (Ref{fmpq_mpoly_factor}, Ref{QQMPolyRing}), z, ctx)
    z.parent = ctx
...
function _fmpq_mpoly_factor_clear_fn(f::fmpq_mpoly_factor)
  ccall((:fmpq_mpoly_factor_clear, libflint), Nothing, (Ref{fmpq_mpoly_factor}, Ref{QQMPolyRing}), f, f.parent)
end
...
@attributes mutable struct zzModMPolyRing <: MPolyRing{zzModRingElem}
  ...
  function zzModMPolyRing(R::zzModRing, s::Vector{Symbol}, S::Symbol, cached::Bool=true)
    return get_cached!(NmodMPolyID, (R, s, S), cached) do
      ...
      z = new()
      ccall((:nmod_mpoly_ctx_init, libflint), Nothing, (Ref{zzModMPolyRing}, Int, Cint, UInt), z, length(s), ord, R.n)
      z.base_ring = R
      z.S = s
...
function _nmod_mpoly_ctx_clear_fn(a::zzModMPolyRing)
  ccall((:nmod_mpoly_ctx_clear, libflint), Nothing, (Ref{zzModMPolyRing},), a)
end
...
mutable struct zzModMPolyRingElem <: MPolyRingElem{zzModRingElem}
  ...
  function zzModMPolyRingElem(ctx::zzModMPolyRing)
    z = new()
    ccall((:nmod_mpoly_init, libflint), Nothing, (Ref{zzModMPolyRingElem}, Ref{zzModMPolyRing}), z, ctx)
    z.parent = ctx
  ...
  function zzModMPolyRingElem(ctx::zzModMPolyRing, a::Vector{zzModRingElem}, b::Vector{Vector{UInt}})
    z = new()
    ccall((:nmod_mpoly_init2, libflint), Nothing, (Ref{zzModMPolyRingElem}, Int, Ref{zzModMPolyRing}), z, length(a), ctx)
    z.parent = ctx
    finalizer(_nmod_mpoly_clear_fn, z)

    for i in 1:length(a)
      ccall((:nmod_mpoly_push_term_ui_ui, libflint), Nothing, (Ref{zzModMPolyRingElem}, UInt, Ptr{UInt}, Ref{zzModMPolyRing}), z, a[i].data, b[i], ctx)
    end

    ccall((:nmod_mpoly_sort_terms, libflint), Nothing, (Ref{zzModMPolyRingElem}, Ref{zzModMPolyRing}), z, ctx)
    ccall((:nmod_mpoly_combine_like_terms, libflint), Nothing, (Ref{zzModMPolyRingElem}, Ref{zzModMPolyRing}), z, ctx)
    return z
  end
  ...
  function zzModMPolyRingElem(ctx::zzModMPolyRing, a::Vector{zzModRingElem}, b::Vector{Vector{Int}})
    ...
    for i in 1:length(a)
      ccall((:nmod_mpoly_push_term_ui_ui, libflint), Nothing, (Ref{zzModMPolyRingElem}, UInt, Ptr{Int}, Ref{zzModMPolyRing}), z, a[i].data, b[i], ctx)
    end
  ...
  function zzModMPolyRingElem(ctx::zzModMPolyRing, a::Vector{zzModRingElem}, b::Vector{Vector{ZZRingElem}})
    ...
    for i in 1:length(a)
      ccall((:nmod_mpoly_push_term_ui_fmpz, libflint), Nothing, (Ref{zzModMPolyRingElem}, UInt, Ptr{Ref{ZZRingElem}}, Ref{zzModMPolyRing}), z, a[i].data, b[i], ctx)
    end
  ...
  function zzModMPolyRingElem(ctx::zzModMPolyRing, a::UInt)
    z = new()
    ccall((:nmod_mpoly_init, libflint), Nothing, (Ref{zzModMPolyRingElem}, Ref{zzModMPolyRing}), z, ctx)
    ccall((:nmod_mpoly_set_ui, libflint), Nothing, (Ref{zzModMPolyRingElem}, UInt, Ref{zzModMPolyRing}), z, a, ctx)
    z.parent = ctx
    finalizer(_nmod_mpoly_clear_fn, z)
    return z
  end
  ...
  function zzModMPolyRingElem(ctx::zzModMPolyRing, a::zzModRingElem)
    z = new()
    ccall((:nmod_mpoly_init, libflint), Nothing, (Ref{zzModMPolyRingElem}, Ref{zzModMPolyRing}), z, ctx)
    ccall((:nmod_mpoly_set_ui, libflint), Nothing, (Ref{zzModMPolyRingElem}, UInt, Ref{zzModMPolyRing}), z, a.data, ctx)
    finalizer(_nmod_mpoly_clear_fn, z)
    z.parent = ctx
    return z
  end
...
function _nmod_mpoly_clear_fn(a::zzModMPolyRingElem)
  ccall((:nmod_mpoly_clear, libflint), Nothing, (Ref{zzModMPolyRingElem}, Ref{zzModMPolyRing}), a, a.parent)
end
...
mutable struct nmod_mpoly_factor
  ...
  function nmod_mpoly_factor(ctx::zzModMPolyRing)
    z = new()
    ccall((:nmod_mpoly_factor_init, libflint), Nothing, (Ref{nmod_mpoly_factor}, Ref{zzModMPolyRing}), z, ctx)
    z.parent = ctx
...
function _nmod_mpoly_factor_clear_fn(f::nmod_mpoly_factor)
  ccall((:nmod_mpoly_factor_clear, libflint), Nothing, (Ref{nmod_mpoly_factor}, Ref{zzModMPolyRing}), f, f.parent)
end
...
@attributes mutable struct fpMPolyRing <: MPolyRing{fpFieldElem}
  ...
  function fpMPolyRing(R::fpField, s::Vector{Symbol}, S::Symbol, cached::Bool=true)
    return get_cached!(GFPMPolyID, (R, s, S), cached) do
      ...
      z = new()
      ccall((:nmod_mpoly_ctx_init, libflint), Nothing, (Ref{fpMPolyRing}, Int, Cint, UInt), z, length(s), ord, UInt(modulus(R)))
      z.base_ring = R
      z.S = s
...
function _gfp_mpoly_ctx_clear_fn(a::fpMPolyRing)
  ccall((:nmod_mpoly_ctx_clear, libflint), Nothing, (Ref{fpMPolyRing},), a)
end
...
mutable struct fpMPolyRingElem <: MPolyRingElem{fpFieldElem}
  ...
  function fpMPolyRingElem(ctx::fpMPolyRing)
    z = new()
    ccall((:nmod_mpoly_init, libflint), Nothing, (Ref{fpMPolyRingElem}, Ref{fpMPolyRing}), z, ctx)
    z.parent = ctx
  ...
  function fpMPolyRingElem(ctx::fpMPolyRing, a::Vector{fpFieldElem}, b::Vector{Vector{UInt}})
    z = new()
    ccall((:nmod_mpoly_init2, libflint), Nothing, (Ref{fpMPolyRingElem}, Int, Ref{fpMPolyRing}), z, length(a), ctx)
    z.parent = ctx
    finalizer(_gfp_mpoly_clear_fn, z)

    for i in 1:length(a)
      ccall((:nmod_mpoly_push_term_ui_ui, libflint), Nothing, (Ref{fpMPolyRingElem}, UInt, Ptr{UInt}, Ref{fpMPolyRing}), z, a[i].data, b[i], ctx)
    end

    ccall((:nmod_mpoly_sort_terms, libflint), Nothing, (Ref{fpMPolyRingElem}, Ref{fpMPolyRing}), z, ctx)
    ccall((:nmod_mpoly_combine_like_terms, libflint), Nothing, (Ref{fpMPolyRingElem}, Ref{fpMPolyRing}), z, ctx)
    return z
  end
  ...
  function fpMPolyRingElem(ctx::fpMPolyRing, a::Vector{fpFieldElem}, b::Vector{Vector{Int}})
    ...
    for i in 1:length(a)
      ccall((:nmod_mpoly_push_term_ui_ui, libflint), Nothing, (Ref{fpMPolyRingElem}, UInt, Ptr{Int}, Ref{fpMPolyRing}), z, a[i].data, b[i], ctx)
    end
  ...
  function fpMPolyRingElem(ctx::fpMPolyRing, a::Vector{fpFieldElem}, b::Vector{Vector{ZZRingElem}})
    ...
    for i in 1:length(a)
      ccall((:nmod_mpoly_push_term_ui_fmpz, libflint), Nothing, (Ref{fpMPolyRingElem}, UInt, Ptr{Ref{ZZRingElem}}, Ref{fpMPolyRing}), z, a[i].data, b[i], ctx)
    end
  ...
  function fpMPolyRingElem(ctx::fpMPolyRing, a::UInt)
    z = new()
    ccall((:nmod_mpoly_init, libflint), Nothing, (Ref{fpMPolyRingElem}, Ref{fpMPolyRing}), z, ctx)
    ccall((:nmod_mpoly_set_ui, libflint), Nothing, (Ref{fpMPolyRingElem}, UInt, Ref{fpMPolyRing}), z, a, ctx)
    z.parent = ctx
    finalizer(_gfp_mpoly_clear_fn, z)
    return z
  end
  ...
  function fpMPolyRingElem(ctx::fpMPolyRing, a::fpFieldElem)
    z = new()
    ccall((:nmod_mpoly_init, libflint), Nothing, (Ref{fpMPolyRingElem}, Ref{fpMPolyRing}), z, ctx)
    ccall((:nmod_mpoly_set_ui, libflint), Nothing, (Ref{fpMPolyRingElem}, UInt, Ref{fpMPolyRing}), z, a.data, ctx)
    finalizer(_gfp_mpoly_clear_fn, z)
    z.parent = ctx
    return z
  end
...
function _gfp_mpoly_clear_fn(a::fpMPolyRingElem)
  ccall((:nmod_mpoly_clear, libflint), Nothing, (Ref{fpMPolyRingElem}, Ref{fpMPolyRing}), a, a.parent)
end
...
mutable struct gfp_mpoly_factor
  ...
  function gfp_mpoly_factor(ctx::fpMPolyRing)
    z = new()
    ccall((:nmod_mpoly_factor_init, libflint), Nothing, (Ref{gfp_mpoly_factor}, Ref{fpMPolyRing}), z, ctx)
    z.parent = ctx
...
function _gfp_mpoly_factor_clear_fn(f::gfp_mpoly_factor)
  ccall((:nmod_mpoly_factor_clear, libflint), Nothing, (Ref{gfp_mpoly_factor}, Ref{fpMPolyRing}), f, f.parent)
end
...
@attributes mutable struct FpMPolyRing <: MPolyRing{FpFieldElem}
  ...
  function FpMPolyRing(R::FpField, s::Vector{Symbol}, S::Symbol, cached::Bool=true)
    return get_cached!(GFPFmpzMPolyID, (R, s, S), cached) do
      ...
      z = new()
      ccall((:fmpz_mod_mpoly_ctx_init, libflint), Nothing, (Ref{FpMPolyRing}, Int, Cint, Ref{ZZRingElem}), z, length(s), ord, modulus(R))
      z.base_ring = R
      z.S = s
...
function _gfp_fmpz_mpoly_ctx_clear_fn(a::FpMPolyRing)
  ccall((:fmpz_mod_mpoly_ctx_clear, libflint), Nothing, (Ref{FpMPolyRing},), a)
end
...
mutable struct FpMPolyRingElem <: MPolyRingElem{FpFieldElem}
  ...
  function FpMPolyRingElem(ctx::FpMPolyRing)
    z = new()
    ccall((:fmpz_mod_mpoly_init, libflint), Nothing, (Ref{FpMPolyRingElem}, Ref{FpMPolyRing}), z, ctx)
    z.parent = ctx
  ...
  function FpMPolyRingElem(ctx::FpMPolyRing, a::Vector{FpFieldElem}, b::Vector{Vector{T}}) where {T<:Union{UInt,Int,ZZRingElem}}
    z = new()
    ccall((:fmpz_mod_mpoly_init2, libflint), Nothing, (Ref{FpMPolyRingElem}, Int, Ref{FpMPolyRing}), z, length(a), ctx)
    z.parent = ctx
    finalizer(_gfp_fmpz_mpoly_clear_fn, z)

    for i in 1:length(a)
      if T == ZZRingElem
        ccall((:fmpz_mod_mpoly_push_term_fmpz_fmpz, libflint), Nothing, (Ref{FpMPolyRingElem}, Ref{ZZRingElem}, Ptr{Ref{ZZRingElem}}, Ref{FpMPolyRing}), z, a[i].data, b[i], ctx)
      else
        ccall((:fmpz_mod_mpoly_push_term_fmpz_ui, libflint), Nothing, (Ref{FpMPolyRingElem}, Ref{ZZRingElem}, Ptr{UInt}, Ref{FpMPolyRing}), z, a[i].data, b[i], ctx)
      end
    end

    ccall((:fmpz_mod_mpoly_sort_terms, libflint), Nothing, (Ref{FpMPolyRingElem}, Ref{FpMPolyRing}), z, ctx)
    ccall((:fmpz_mod_mpoly_combine_like_terms, libflint), Nothing, (Ref{FpMPolyRingElem}, Ref{FpMPolyRing}), z, ctx)
    return z
  end
  ...
  function FpMPolyRingElem(ctx::FpMPolyRing, a::Union{ZZRingElem,FpFieldElem})
    z = new()
    ccall((:fmpz_mod_mpoly_init, libflint), Nothing, (Ref{FpMPolyRingElem}, Ref{FpMPolyRing}), z, ctx)
    ccall((:fmpz_mod_mpoly_set_fmpz, libflint), Nothing, (Ref{FpMPolyRingElem}, Ref{ZZRingElem}, Ref{FpMPolyRing}), z, a isa ZZRingElem ? a : data(a), ctx)
    z.parent = ctx
    finalizer(_gfp_fmpz_mpoly_clear_fn, z)
    return z
  end
...
function _gfp_fmpz_mpoly_clear_fn(a::FpMPolyRingElem)
  ccall((:fmpz_mod_mpoly_clear, libflint), Nothing, (Ref{FpMPolyRingElem}, Ref{FpMPolyRing}), a, a.parent)
end
...
mutable struct gfp_fmpz_mpoly_factor
  ...
  function gfp_fmpz_mpoly_factor(ctx::FpMPolyRing)
    z = new()
    ccall((:fmpz_mod_mpoly_factor_init, libflint), Nothing, (Ref{gfp_fmpz_mpoly_factor}, Ref{FpMPolyRing}), z, ctx)
    z.parent = ctx
...
function _gfp_fmpz_mpoly_factor_clear_fn(f::gfp_fmpz_mpoly_factor)
  ccall((:fmpz_mod_mpoly_factor_clear, libflint), Nothing, (Ref{gfp_fmpz_mpoly_factor}, Ref{FpMPolyRing}), f, f.parent)
end
...
@attributes mutable struct fqPolyRepField <: FinField
  ...
  function fqPolyRepField(c::UInt, deg::Int, s::Symbol, cached::Bool=true; check::Bool=true)
    check && !is_prime(c) && throw(DomainError(c, "the characteristic must be a prime"))
    return get_cached!(FqNmodFiniteFieldID, (c, deg, s), cached) do
      d = new()
      ccall((:fq_nmod_ctx_init_ui, libflint), Nothing, (Ref{fqPolyRepField}, UInt, Int, Ptr{UInt8}), d, c, deg, string(s))
  ...
  function fqPolyRepField(f::zzModPolyRingElem, s::Symbol, cached::Bool=true; check::Bool=true)
    check && !is_prime(modulus(f)) && throw(DomainError(base_ring(f), "the base ring of the polynomial must be a field"))
    return get_cached!(FqNmodFiniteFieldIDNmodPol, (parent(f), f, s), cached) do
      z = new()
      ccall((:fq_nmod_ctx_init_modulus, libflint), Nothing, (Ref{fqPolyRepField}, Ref{zzModPolyRingElem}, Ptr{UInt8}), z, f, string(s))
  ...
  function fqPolyRepField(f::fpPolyRingElem, s::Symbol, cached::Bool=true; check::Bool=true)
    ...
    return get_cached!(FqNmodFiniteFieldIDGFPPol, (parent(f), f, s), cached) do
      z = new()
      ccall((:fq_nmod_ctx_init_modulus, libflint), Nothing, (Ref{fqPolyRepField}, Ref{fpPolyRingElem}, Ptr{UInt8}), z, f, string(s))
      finalizer(_FqNmodFiniteField_clear_fn, z)
      return z
    end
  end
...
const FqNmodFiniteFieldIDNmodPol = CacheDictType{Tuple{zzModPolyRing,zzModPolyRingElem,Symbol},fqPolyRepField}()

const FqNmodFiniteFieldIDGFPPol = CacheDictType{Tuple{fpPolyRing,fpPolyRingElem,Symbol},fqPolyRepField}()
...
mutable struct fqPolyRepFieldElem <: FinFieldElem
  ...
  function fqPolyRepFieldElem(ctx::fqPolyRepField)
    d = new()
    ccall((:fq_nmod_init2, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), d, ctx)
  ...
  function fqPolyRepFieldElem(ctx::fqPolyRepField, x::Int)
    ...
    ccall((:fq_nmod_init2, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), d, ctx)
    finalizer(_fq_nmod_clear_fn, d)
    ccall((:fq_nmod_set_si, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Int, Ref{fqPolyRepField}), d, x, ctx)
    return d
  end
  ...
  function fqPolyRepFieldElem(ctx::fqPolyRepField, x::ZZRingElem)
    ...
    ccall((:fq_nmod_init2, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), d, ctx)
    finalizer(_fq_nmod_clear_fn, d)
    ccall((:fq_nmod_set_fmpz, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{ZZRingElem}, Ref{fqPolyRepField}), d, x, ctx)
    return d
  end
  ...
  function fqPolyRepFieldElem(ctx::fqPolyRepField, x::fqPolyRepFieldElem)
    ...
    ccall((:fq_nmod_init2, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), d, ctx)
    finalizer(_fq_nmod_clear_fn, d)
    ccall((:fq_nmod_set, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), d, x, ctx)
    return d
  end
  ...
  function fqPolyRepFieldElem(ctx::fqPolyRepField, x::fpPolyRingElem)
    ...
    ccall((:fq_nmod_init2, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), d, ctx)
    finalizer(_fq_nmod_clear_fn, d)
    ccall((:fq_nmod_set_nmod_poly, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{fpPolyRingElem}, Ref{fqPolyRepField}), d, x, ctx)
    return d
  end
end

function _fq_nmod_clear_fn(a::fqPolyRepFieldElem)
  ccall((:fq_nmod_clear, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), a, a.parent)
end
...
@attributes mutable struct FqField <: FinField
  ...
  function FqField(char::ZZRingElem, deg::Int, s::Symbol, cached::Bool=true)
    return get_cached!(FqDefaultFiniteFieldID, (char, deg, s), cached) do
      ...
      ccall((:fq_default_ctx_init, libflint), Nothing, (Ref{FqField}, Ref{ZZRingElem}, Int, Ptr{UInt8}), d, char, deg, d.var)
      return d
    end
  end

  function FqField(f::ZZModPolyRingElem, s::Symbol, cached::Bool=true; check::Bool=true)
    check && !is_probable_prime(modulus(f)) && throw(DomainError(base_ring(f), "the base ring of the polynomial must be a field"))
    return get_cached!(FqDefaultFiniteFieldIDFmpzPol, (f, s), cached) do
      z = new()
      z.isabsolute = true
      z.isstandard = true
      z.var = string(s)
      ccall((:fq_default_ctx_init_modulus, libflint), Nothing, (Ref{FqField}, Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}, Ptr{UInt8}), z, f, base_ring(parent(f)).ninv, string(s))
  ...
  function FqField(f::FpPolyRingElem, s::Symbol, cached::Bool=true; check::Bool=true)
    ...
    return get_cached!(FqDefaultFiniteFieldIDGFPPol, (f, s), cached) do
      ...
      z.isstandard = true
      z.var = string(s)
      ccall((:fq_default_ctx_init_modulus, libflint), Nothing, (Ref{FqField}, Ref{FpPolyRingElem}, Ref{fmpz_mod_ctx_struct}, Ptr{UInt8}), z, f, base_ring(parent(f)).ninv, string(s))
      finalizer(_FqDefaultFiniteField_clear_fn, z)
      return z
    end
  end
  ...
  function FqField(f::zzModPolyRingElem, s::Symbol, cached::Bool=true; check::Bool=true)
    ...
    return get_cached!(FqDefaultFiniteFieldIDNmodPol, (f, s), cached) do
      ...
      z.isstandard = true
      z.var = string(s)
      ccall((:fq_default_ctx_init_modulus_nmod, libflint), Nothing, (Ref{FqField}, Ref{zzModPolyRingElem}, Ptr{UInt8}), z, f, string(s))
      finalizer(_FqDefaultFiniteField_clear_fn, z)
      return z
    end
  end
  ...
  function FqField(f::fpPolyRingElem, s::Symbol, cached::Bool=true; check::Bool=true)
    ...
    return get_cached!(FqDefaultFiniteFieldIDGFPNmodPol, (f, s), cached) do
      ...
      z.isstandard = true
      z.var = string(s)
      ccall((:fq_default_ctx_init_modulus_nmod, libflint), Nothing, (Ref{FqField}, Ref{fpPolyRingElem}, Ptr{UInt8}), z, f, string(s))
      finalizer(_FqDefaultFiniteField_clear_fn, z)
      return z
    end
  end
...
mutable struct FqFieldElem <: FinFieldElem
  ...
  parent::FqField
  poly::Any#::Union{Nothing, FqPolyRingElem}

  function FqFieldElem(ctx::FqField)
    d = new()
    ccall((:fq_default_init2, libflint), Nothing, (Ref{FqFieldElem}, Ref{FqField}), d, ctx)
  ...
  function FqFieldElem(ctx::FqField, x::Int)
    d = FqFieldElem(ctx)
    ccall((:fq_default_set_si, libflint), Nothing, (Ref{FqFieldElem}, Int, Ref{FqField}), d, x, ctx)
    return d
  end

  function FqFieldElem(ctx::FqField, x::ZZRingElem)
    d = FqFieldElem(ctx)
    ccall((:fq_default_set_fmpz, libflint), Nothing, (Ref{FqFieldElem}, Ref{ZZRingElem}, Ref{FqField}), d, x, ctx)
    return d
  end

  function FqFieldElem(ctx::FqField, x::ZZPolyRingElem)
    d = FqFieldElem(ctx)
    ccall((:fq_default_set_fmpz_poly, libflint), Nothing, (Ref{FqFieldElem}, Ref{ZZPolyRingElem}, Ref{FqField}), d, x, ctx)
    return d
  end

  function FqFieldElem(ctx::FqField, x::zzModPolyRingElem)
    d = FqFieldElem(ctx)
    ccall((:fq_default_set_nmod_poly, libflint), Nothing, (Ref{FqFieldElem}, Ref{zzModPolyRingElem}, Ref{FqField}), d, x, ctx)
    return d
  end

  function FqFieldElem(ctx::FqField, x::fpPolyRingElem)
    d = FqFieldElem(ctx)
    ccall((:fq_default_set_nmod_poly, libflint), Nothing, (Ref{FqFieldElem}, Ref{fpPolyRingElem}, Ref{FqField}), d, x, ctx)
    return d
  end

  function FqFieldElem(ctx::FqField, x::ZZModPolyRingElem)
    d = FqFieldElem(ctx)
    ccall((:fq_default_set_fmpz_mod_poly, libflint), Nothing, (Ref{FqFieldElem}, Ref{ZZModPolyRingElem}, Ref{FqField}), d, x, ctx)
    return d
  end

  function FqFieldElem(ctx::FqField, x::FpPolyRingElem)
    d = FqFieldElem(ctx)
    ccall((:fq_default_set_fmpz_mod_poly, libflint), Nothing, (Ref{FqFieldElem}, Ref{FpPolyRingElem}, Ref{FqField}), d, x, ctx)
    return d
  end

  function FqFieldElem(ctx::FqField, x::FqFieldElem)
    d = FqFieldElem(ctx)
    ccall((:fq_default_set, libflint), Nothing, (Ref{FqFieldElem}, Ref{FqFieldElem}, Ref{FqField}), d, x, ctx)
    return d
  end
end

function _fq_default_clear_fn(a::FqFieldElem)
  ccall((:fq_default_clear, libflint), Nothing, (Ref{FqFieldElem}, Ref{FqField}), a, a.parent)
end
...
@attributes mutable struct FqPolyRepField <: FinField
  ...
  function FqPolyRepField(char::ZZRingElem, deg::Int, s::Symbol, cached::Bool=true; check::Bool=true)
    check && !is_probable_prime(char) && throw(DomainError(char, "the characteristic must be a prime"))
    return get_cached!(FqFiniteFieldID, (char, deg, s), cached) do
      d = new()
      finalizer(_FqFiniteField_clear_fn, d)
      ccall((:fq_ctx_init, libflint), Nothing, (Ref{FqPolyRepField}, Ref{ZZRingElem}, Int, Ptr{UInt8}), d, char, deg, string(s))
      return d
    end
  end
  ...
  function FqPolyRepField(f::ZZModPolyRingElem, s::Symbol, cached::Bool=true; check::Bool=true)
    ...
    return get_cached!(FqFiniteFieldIDFmpzPol, (f, s), cached) do
      z = new()
      ccall((:fq_ctx_init_modulus, libflint), Nothing, (Ref{FqPolyRepField}, Ref{ZZModPolyRingElem}, Ref{fmpz_mod_ctx_struct}, Ptr{UInt8}), z, f, base_ring(parent(f)).ninv, string(s))
  ...
  function FqPolyRepField(f::FpPolyRingElem, s::Symbol, cached::Bool=true; check::Bool=true)
    ...
    return get_cached!(FqFiniteFieldIDGFPPol, (f, s), cached) do
      z = new()
      ccall((:fq_ctx_init_modulus, libflint), Nothing, (Ref{FqPolyRepField}, Ref{FpPolyRingElem}, Ref{fmpz_mod_ctx_struct}, Ptr{UInt8}), z, f, base_ring(parent(f)).ninv, string(s))
      finalizer(_FqFiniteField_clear_fn, z)
      return z
    end
  end
...
mutable struct FqPolyRepFieldElem <: FinFieldElem
  ...
  function FqPolyRepFieldElem(ctx::FqPolyRepField)
    d = new()
    ccall((:fq_init2, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), d, ctx)
  ...
  function FqPolyRepFieldElem(ctx::FqPolyRepField, x::Int)
    ...
    ccall((:fq_init2, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), d, ctx)
    finalizer(_fq_clear_fn, d)
    ccall((:fq_set_si, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Int, Ref{FqPolyRepField}), d, x, ctx)
    d.parent = ctx
    return d
  end
  ...
  function FqPolyRepFieldElem(ctx::FqPolyRepField, x::ZZRingElem)
    ...
    ccall((:fq_init2, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), d, ctx)
    finalizer(_fq_clear_fn, d)
    ccall((:fq_set_fmpz, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{ZZRingElem}, Ref{FqPolyRepField}), d, x, ctx)
    d.parent = ctx
    return d
  end
  ...
  function FqPolyRepFieldElem(ctx::FqPolyRepField, x::FpPolyRingElem)
    ...
    ccall((:fq_init2, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), d, ctx)
    finalizer(_fq_clear_fn, d)
    ccall((:fq_set_fmpz_mod_poly, libflint), Nothing, (Ref{Nemo.FqPolyRepFieldElem}, Ref{Nemo.FpPolyRingElem}, Ref{FqPolyRepField}), d, x, ctx)
    d.parent = ctx
    return d
  end
  ...
  function FqPolyRepFieldElem(ctx::FqPolyRepField, x::FqPolyRepFieldElem)
    ...
    ccall((:fq_init2, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), d, ctx)
    finalizer(_fq_clear_fn, d)
    ccall((:fq_set, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), d, x, ctx)
    d.parent = ctx
    return d
  end
  ...
  function FqPolyRepFieldElem(ctx::FqPolyRepField, x::ZZPolyRingElem)
    ...
    ccall((:fq_init2, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), d, ctx)
    finalizer(_fq_clear_fn, d)
    ccall((:fq_set_fmpz_poly, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{ZZPolyRingElem}, Ref{FqPolyRepField}), d, x, ctx)
    d.parent = ctx
    return d
  end
end
...
function _fq_clear_fn(a::FqPolyRepFieldElem)
  ccall((:fq_clear, libflint), Nothing, (Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), a, a.parent)
end
...
@attributes mutable struct fqPolyRepMPolyRing <: MPolyRing{fqPolyRepFieldElem}
  ...
  function fqPolyRepMPolyRing(R::fqPolyRepField, s::Vector{Symbol}, S::Symbol, cached::Bool=true)
    return get_cached!(FqNmodMPolyID, (R, s, S), cached) do
      ...
      z = new()
      ccall((:fq_nmod_mpoly_ctx_init, libflint), Nothing, (Ref{fqPolyRepMPolyRing}, Int, Cint, Ref{fqPolyRepField}), z, length(s), ord, R)
      z.base_ring = R
      z.S = s
...
function _fq_nmod_mpoly_ctx_clear_fn(a::fqPolyRepMPolyRing)
  ccall((:fq_nmod_mpoly_ctx_clear, libflint), Nothing, (Ref{fqPolyRepMPolyRing},), a)
end
...
mutable struct fqPolyRepMPolyRingElem <: MPolyRingElem{fqPolyRepFieldElem}
  ...
  function fqPolyRepMPolyRingElem(ctx::fqPolyRepMPolyRing)
    z = new()
    ccall((:fq_nmod_mpoly_init, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, ctx)
    z.parent = ctx
  ...
  function fqPolyRepMPolyRingElem(ctx::fqPolyRepMPolyRing, a::Vector{fqPolyRepFieldElem}, b::Vector{Vector{UInt}})
    z = new()
    ccall((:fq_nmod_mpoly_init2, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Int, Ref{fqPolyRepMPolyRing}), z, length(a), ctx)
    z.parent = ctx
    finalizer(_fq_nmod_mpoly_clear_fn, z)

    for i in 1:length(a)
      ccall((:fq_nmod_mpoly_push_term_fq_nmod_ui, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepFieldElem}, Ptr{UInt}, Ref{fqPolyRepMPolyRing}), z, a[i], b[i], ctx)
    end

    ccall((:fq_nmod_mpoly_sort_terms, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, ctx)
    ccall((:fq_nmod_mpoly_combine_like_terms, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, ctx)
    return z
  end
  ...
  function fqPolyRepMPolyRingElem(ctx::fqPolyRepMPolyRing, a::Vector{fqPolyRepFieldElem}, b::Vector{Vector{Int}})
    ...
    for i in 1:length(a)
      ccall((:fq_nmod_mpoly_push_term_fq_nmod_ui, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepFieldElem}, Ptr{Int}, Ref{fqPolyRepMPolyRing}), z, a[i], b[i], ctx)
    end
  ...
  function fqPolyRepMPolyRingElem(ctx::fqPolyRepMPolyRing, a::Vector{fqPolyRepFieldElem}, b::Vector{Vector{ZZRingElem}})
    ...
    for i in 1:length(a)
      ccall((:fq_nmod_mpoly_push_term_fq_nmod_fmpz, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepFieldElem}, Ptr{Ref{ZZRingElem}}, Ref{fqPolyRepMPolyRing}), z, a[i], b[i], ctx)
    end

    ccall((:fq_nmod_mpoly_sort_terms, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, ctx)
    ccall((:nmod_mpoly_combine_like_terms, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, ctx)
    return z
  end
  ...
  function fqPolyRepMPolyRingElem(ctx::fqPolyRepMPolyRing, a::UInt)
    z = new()
    ccall((:fq_nmod_mpoly_init, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, ctx)
    ccall((:fq_nmod_mpoly_set_ui, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, UInt, Ref{fqPolyRepMPolyRing}), z, a, ctx)
    z.parent = ctx
    finalizer(_fq_nmod_mpoly_clear_fn, z)
    return z
  end
  ...
  function fqPolyRepMPolyRingElem(ctx::fqPolyRepMPolyRing, a::fqPolyRepFieldElem)
    z = new()
    ccall((:fq_nmod_mpoly_init, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), z, ctx)
    ccall((:fq_nmod_mpoly_set_fq_nmod, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepMPolyRing}), z, a, ctx)
    z.parent = ctx
    finalizer(_fq_nmod_mpoly_clear_fn, z)
    return z
  end
...
function _fq_nmod_mpoly_clear_fn(a::fqPolyRepMPolyRingElem)
  ccall((:fq_nmod_mpoly_clear, libflint), Nothing, (Ref{fqPolyRepMPolyRingElem}, Ref{fqPolyRepMPolyRing}), a, a.parent)
end
...
mutable struct fq_nmod_mpoly_factor
  ...
  function fq_nmod_mpoly_factor(ctx::fqPolyRepMPolyRing)
    z = new()
    ccall((:fq_nmod_mpoly_factor_init, libflint), Nothing, (Ref{fq_nmod_mpoly_factor}, Ref{fqPolyRepMPolyRing}), z, ctx)
    z.parent = ctx
...
function _fq_nmod_mpoly_factor_clear_fn(f::fq_nmod_mpoly_factor)
  ccall((:fq_nmod_mpoly_factor_clear, libflint), Nothing, (Ref{fq_nmod_mpoly_factor}, Ref{fqPolyRepMPolyRing}), f, f.parent)
end
...
@attributes mutable struct PadicField <: FlintLocalField
  ...
  function PadicField(p::ZZRingElem, prec::Int; cached::Bool=true, check::Bool=true)
    ...
    return get_cached!(PadicBase, (p, prec), cached) do
      d = new()
      ccall((:padic_ctx_init, libflint), Nothing, (Ref{PadicField}, Ref{ZZRingElem}, Int, Int, Cint), d, p, 0, 0, 0)
...
@attributes mutable struct QadicField <: FlintLocalField
  ...
  function QadicField(p::ZZRingElem, d::Int, prec::Int, var::String="a"; cached::Bool=true, check::Bool=true)
    ...
    z = get_cached!(QadicBase, (p, d, prec), cached) do
      zz = new()
      ccall((:qadic_ctx_init, libflint), Nothing, (Ref{QadicField}, Ref{ZZRingElem}, Int, Int, Int, Cstring, Cint), zz, p, d, 0, 0, var, 0)
...
mutable struct ZZRelPowerSeriesRingElem <: RelPowerSeriesRingElem{ZZRingElem}
  ...
  function ZZRelPowerSeriesRingElem(a::Vector{ZZRingElem}, len::Int, prec::Int, val::Int)
    z = new()
    ccall((:fmpz_poly_init2, libflint), Nothing, (Ref{ZZRelPowerSeriesRingElem}, Int), z, len)
    for i in 1:len
      ccall((:fmpz_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZRelPowerSeriesRingElem}, Int, Ref{ZZRingElem}), z, i - 1, a[i])
    end
    z.prec = prec
    z.val = val
    finalizer(_fmpz_rel_series_clear_fn, z)
  ...
  function ZZRelPowerSeriesRingElem(a::ZZRelPowerSeriesRingElem)
    z = new()
    ccall((:fmpz_poly_init, libflint), Nothing, (Ref{ZZRelPowerSeriesRingElem},), z)
    ccall((:fmpz_poly_set, libflint), Nothing, (Ref{ZZRelPowerSeriesRingElem}, Ref{ZZRelPowerSeriesRingElem}), z, a)
    finalizer(_fmpz_rel_series_clear_fn, z)
    return z
  end
end
...
mutable struct ZZAbsPowerSeriesRingElem <: AbsPowerSeriesRingElem{ZZRingElem}
  ...
  function ZZAbsPowerSeriesRingElem(a::Vector{ZZRingElem}, len::Int, prec::Int)
    z = new()
    ccall((:fmpz_poly_init2, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Int), z, len)
    for i in 1:len
      ccall((:fmpz_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Int, Ref{ZZRingElem}), z, i - 1, a[i])
    end
    z.prec = prec
    finalizer(_fmpz_abs_series_clear_fn, z)
    return z
  ...
  function ZZAbsPowerSeriesRingElem(a::ZZAbsPowerSeriesRingElem)
    z = new()
    ccall((:fmpz_poly_init, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem},), z)
    ccall((:fmpz_poly_set, libflint), Nothing, (Ref{ZZAbsPowerSeriesRingElem}, Ref{ZZAbsPowerSeriesRingElem}), z, a)
    finalizer(_fmpz_abs_series_clear_fn, z)
    return z
  end
end
...
mutable struct ZZLaurentSeriesRingElem <: RingElem
  ...
  function ZZLaurentSeriesRingElem(a::Vector{ZZRingElem}, len::Int, prec::Int, val::Int, scale::Int)
    z = new()
    ccall((:fmpz_poly_init2, libflint), Nothing, (Ref{ZZLaurentSeriesRingElem}, Int), z, len)
    for i in 1:len
      ccall((:fmpz_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZLaurentSeriesRingElem}, Int, Ref{ZZRingElem}), z, i - 1, a[i])
    end
    z.prec = prec
    z.val = val
    z.scale = scale
  ...
  function ZZLaurentSeriesRingElem(a::ZZLaurentSeriesRingElem)
    z = new()
    ccall((:fmpz_poly_init, libflint), Nothing, (Ref{ZZLaurentSeriesRingElem},), z)
    ccall((:fmpz_poly_set, libflint), Nothing, (Ref{ZZLaurentSeriesRingElem}, Ref{ZZLaurentSeriesRingElem}), z, a)
    finalizer(_fmpz_laurent_series_clear_fn, z)
    return z
  end
end
...
mutable struct QQRelPowerSeriesRingElem <: RelPowerSeriesRingElem{QQFieldElem}
  ...
  function QQRelPowerSeriesRingElem(a::Vector{QQFieldElem}, len::Int, prec::Int, val::Int)
    z = new()
    ccall((:fmpq_poly_init2, libflint), Nothing, (Ref{QQRelPowerSeriesRingElem}, Int), z, len)
    for i in 1:len
      ccall((:fmpq_poly_set_coeff_fmpq, libflint), Nothing, (Ref{QQRelPowerSeriesRingElem}, Int, Ref{QQFieldElem}), z, i - 1, a[i])
    end
    z.prec = prec
    z.val = val
    finalizer(_fmpq_rel_series_clear_fn, z)
  ...
  function QQRelPowerSeriesRingElem(a::QQRelPowerSeriesRingElem)
    z = new()
    ccall((:fmpq_poly_init, libflint), Nothing, (Ref{QQRelPowerSeriesRingElem},), z)
    ccall((:fmpq_poly_set, libflint), Nothing, (Ref{QQRelPowerSeriesRingElem}, Ref{QQRelPowerSeriesRingElem}), z, a)
    finalizer(_fmpq_rel_series_clear_fn, z)
    return z
  end
end
...
mutable struct QQAbsPowerSeriesRingElem <: AbsPowerSeriesRingElem{QQFieldElem}
  ...
  function QQAbsPowerSeriesRingElem(a::Vector{QQFieldElem}, len::Int, prec::Int)
    z = new()
    ccall((:fmpq_poly_init2, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Int), z, len)
    for i in 1:len
      ccall((:fmpq_poly_set_coeff_fmpq, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Int, Ref{QQFieldElem}), z, i - 1, a[i])
    end
    z.prec = prec
    finalizer(_fmpq_abs_series_clear_fn, z)
    return z
  ...
  function QQAbsPowerSeriesRingElem(a::QQAbsPowerSeriesRingElem)
    z = new()
    ccall((:fmpq_poly_init, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem},), z)
    ccall((:fmpq_poly_set, libflint), Nothing, (Ref{QQAbsPowerSeriesRingElem}, Ref{QQAbsPowerSeriesRingElem}), z, a)
    finalizer(_fmpq_abs_series_clear_fn, z)
    return z
  end
end
...
@attributes mutable struct fpRelPowerSeriesRing <: SeriesRing{zzModRingElem}
  ...
  function fpRelPowerSeriesRing(R::fpField, prec::Int, s::Symbol, cached::Bool=true)
...
const GFPRelSeriesID = CacheDictType{Tuple{fpField,Int,Symbol},fpRelPowerSeriesRing}()
...
mutable struct fpRelPowerSeriesRingElem <: RelPowerSeriesRingElem{fpFieldElem}
  ...
  function fpRelPowerSeriesRingElem(p::UInt)
    z = new()
    ccall((:nmod_poly_init, libflint), Nothing, (Ref{fpRelPowerSeriesRingElem}, UInt), z, p)
  ...
  function fpRelPowerSeriesRingElem(p::UInt, a::Vector{ZZRingElem}, len::Int, prec::Int, val::Int)
    z = new()
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{fpRelPowerSeriesRingElem}, UInt, Int), z, p, len)
    for i in 1:len
      tt = ccall((:fmpz_fdiv_ui, libflint), UInt, (Ref{ZZRingElem}, UInt), a[i], p)
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{fpRelPowerSeriesRingElem}, Int, UInt), z, i - 1, tt)
    end
    z.prec = prec
    z.val = val
    finalizer(_gfp_rel_series_clear_fn, z)
  ...
  function fpRelPowerSeriesRingElem(p::UInt, a::Vector{UInt}, len::Int, prec::Int, val::Int)
    ...
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{fpRelPowerSeriesRingElem}, UInt, Int), z, p, len)
    for i in 1:len
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{fpRelPowerSeriesRingElem}, Int, UInt), z, i - 1, a[i])
    end
    z.prec = prec
    z.val = val
    finalizer(_gfp_rel_series_clear_fn, z)
  ...
  function fpRelPowerSeriesRingElem(p::UInt, a::Vector{fpFieldElem}, len::Int, prec::Int, val::Int)
    ...
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{fpRelPowerSeriesRingElem}, UInt, Int), z, p, len)
    for i in 1:len
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{fpRelPowerSeriesRingElem}, Int, UInt), z, i - 1, data(a[i]))
    end
    z.prec = prec
    z.val = val
    finalizer(_gfp_rel_series_clear_fn, z)
  ...
  function fpRelPowerSeriesRingElem(a::fpRelPowerSeriesRingElem)
    ...
    ccall((:nmod_poly_init, libflint), Nothing, (Ref{fpRelPowerSeriesRingElem}, UInt), z, p)
    ccall((:nmod_poly_set, libflint), Nothing, (Ref{fpRelPowerSeriesRingElem}, Ref{fpRelPowerSeriesRingElem}), z, a)
    finalizer(_gfp_rel_series_clear_fn, z)
    return z
  end
end
...
@attributes mutable struct zzModRelPowerSeriesRing <: SeriesRing{zzModRingElem}
  ...
  function zzModRelPowerSeriesRing(R::zzModRing, prec::Int, s::Symbol, cached::Bool=true)
...
const NmodRelSeriesID = CacheDictType{Tuple{zzModRing,Int,Symbol},zzModRelPowerSeriesRing}()
...
mutable struct zzModRelPowerSeriesRingElem <: RelPowerSeriesRingElem{zzModRingElem}
  ...
  function zzModRelPowerSeriesRingElem(p::UInt)
    z = new()
    ccall((:nmod_poly_init, libflint), Nothing, (Ref{zzModRelPowerSeriesRingElem}, UInt), z, p)
  ...
  function zzModRelPowerSeriesRingElem(p::UInt, a::Vector{ZZRingElem}, len::Int, prec::Int, val::Int)
    z = new()
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{zzModRelPowerSeriesRingElem}, UInt, Int), z, p, len)
    for i in 1:len
      tt = ccall((:fmpz_fdiv_ui, libflint), UInt, (Ref{ZZRingElem}, UInt), a[i], p)
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{zzModRelPowerSeriesRingElem}, Int, UInt), z, i - 1, tt)
    end
    z.prec = prec
    z.val = val
    finalizer(_nmod_rel_series_clear_fn, z)
  ...
  function zzModRelPowerSeriesRingElem(p::UInt, a::Vector{UInt}, len::Int, prec::Int, val::Int)
    ...
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{zzModRelPowerSeriesRingElem}, UInt, Int), z, p, len)
    for i in 1:len
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{zzModRelPowerSeriesRingElem}, Int, UInt), z, i - 1, a[i])
    end
    z.prec = prec
    z.val = val
    finalizer(_nmod_rel_series_clear_fn, z)
  ...
  function zzModRelPowerSeriesRingElem(p::UInt, a::Vector{zzModRingElem}, len::Int, prec::Int, val::Int)
    ...
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{zzModRelPowerSeriesRingElem}, UInt, Int), z, p, len)
    for i in 1:len
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{zzModRelPowerSeriesRingElem}, Int, UInt), z, i - 1, data(a[i]))
    end
    z.prec = prec
    z.val = val
    finalizer(_nmod_rel_series_clear_fn, z)
  ...
  function zzModRelPowerSeriesRingElem(a::zzModRelPowerSeriesRingElem)
    ...
    p = modulus(base_ring(parent(a)))
    ccall((:nmod_poly_init, libflint), Nothing, (Ref{zzModRelPowerSeriesRingElem}, UInt), z, p)
    ccall((:nmod_poly_set, libflint), Nothing, (Ref{zzModRelPowerSeriesRingElem}, Ref{zzModRelPowerSeriesRingElem}), z, a)
    finalizer(_nmod_rel_series_clear_fn, z)
    return z
  end
end
...
@attributes mutable struct FpRelPowerSeriesRing <: SeriesRing{FpFieldElem}
  ...
  function FpRelPowerSeriesRing(R::Ring, prec::Int, s::Symbol, cached::Bool=true)
...
const GFPFmpzRelSeriesID = CacheDictType{Tuple{FpField,Int,Symbol},FpRelPowerSeriesRing}()
...
mutable struct FpRelPowerSeriesRingElem <: RelPowerSeriesRingElem{FpFieldElem}
  ...
  function FpRelPowerSeriesRingElem(p::fmpz_mod_ctx_struct)
    z = new()
    ccall((:fmpz_mod_poly_init, libflint), Nothing, (Ref{FpRelPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), z, p)
  ...
  function FpRelPowerSeriesRingElem(p::fmpz_mod_ctx_struct, a::Vector{ZZRingElem}, len::Int, prec::Int, val::Int)
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{FpRelPowerSeriesRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, len, p)
    for i in 1:len
      ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{FpRelPowerSeriesRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, i - 1, a[i], p)
    end
    z.prec = prec
    z.val = val
    finalizer(_gfp_fmpz_rel_series_clear_fn, z)
  ...
  function FpRelPowerSeriesRingElem(R::FpField, a::Vector{ZZRingElem}, len::Int, prec::Int, val::Int)
    return FpRelPowerSeriesRingElem(R.ninv, a, len, prec, val)
  end

  function FpRelPowerSeriesRingElem(p::fmpz_mod_ctx_struct, a::Vector{FpFieldElem}, len::Int, prec::Int, val::Int)
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{FpRelPowerSeriesRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, len, p)
    for i in 1:len
      ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{FpRelPowerSeriesRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, i - 1, data(a[i]), p)
    end
    z.prec = prec
    z.val = val
    finalizer(_gfp_fmpz_rel_series_clear_fn, z)
  ...
  function FpRelPowerSeriesRingElem(R::FpField, a::Vector{FpFieldElem}, len::Int, prec::Int, val::Int)
    return FpRelPowerSeriesRingElem(R.ninv, a, len, prec, val)
  end
  ...
  function FpRelPowerSeriesRingElem(a::FpRelPowerSeriesRingElem)
    ...
    ccall((:fmpz_mod_poly_init, libflint), Nothing, (Ref{FpRelPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), z, p)
    ccall((:fmpz_mod_poly_set, libflint), Nothing, (Ref{FpRelPowerSeriesRingElem}, Ref{FpRelPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), z, a, p)
    finalizer(_gfp_fmpz_rel_series_clear_fn, z)
    return z
  end
end
...
function _gfp_fmpz_rel_series_clear_fn(a::FpRelPowerSeriesRingElem)
  ccall((:fmpz_mod_poly_clear, libflint), Nothing, (Ref{FpRelPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), a, base_ring(parent(a)).ninv)
end
...
@attributes mutable struct ZZModRelPowerSeriesRing <: SeriesRing{ZZModRingElem}
  ...
  function ZZModRelPowerSeriesRing(R::Ring, prec::Int, s::Symbol, cached::Bool=true)
...
const FmpzModRelSeriesID = CacheDictType{Tuple{ZZModRing,Int,Symbol},ZZModRelPowerSeriesRing}()
...
mutable struct ZZModRelPowerSeriesRingElem <: RelPowerSeriesRingElem{ZZModRingElem}
  ...
  function ZZModRelPowerSeriesRingElem(p::fmpz_mod_ctx_struct)
    z = new()
    ccall((:fmpz_mod_poly_init, libflint), Nothing, (Ref{ZZModRelPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), z, p)
  ...
  function ZZModRelPowerSeriesRingElem(p::fmpz_mod_ctx_struct, a::Vector{ZZRingElem}, len::Int, prec::Int, val::Int)
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{ZZModRelPowerSeriesRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, len, p)
    for i in 1:len
      ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZModRelPowerSeriesRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, i - 1, a[i], p)
    end
    z.prec = prec
    z.val = val
    finalizer(_fmpz_mod_rel_series_clear_fn, z)
  ...
  function ZZModRelPowerSeriesRingElem(R::ZZModRing, a::Vector{ZZRingElem}, len::Int, prec::Int, val::Int)
    return ZZModRelPowerSeriesRingElem(R.ninv, a, len, prec, val)
  end

  function ZZModRelPowerSeriesRingElem(p::fmpz_mod_ctx_struct, a::Vector{ZZModRingElem}, len::Int, prec::Int, val::Int)
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{ZZModRelPowerSeriesRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, len, p)
    for i in 1:len
      ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZModRelPowerSeriesRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, i - 1, data(a[i]), p)
    end
    z.prec = prec
    z.val = val
    finalizer(_fmpz_mod_rel_series_clear_fn, z)
  ...
  function ZZModRelPowerSeriesRingElem(R::ZZModRing, a::Vector{ZZModRingElem}, len::Int, prec::Int, val::Int)
    return ZZModRelPowerSeriesRingElem(R.ninv, a, len, prec, val)
  end
  ...
  function ZZModRelPowerSeriesRingElem(a::ZZModRelPowerSeriesRingElem)
    ...
    p = base_ring(parent(a)).ninv
    ccall((:fmpz_mod_poly_init, libflint), Nothing, (Ref{ZZModRelPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), z, p)
    ccall((:fmpz_mod_poly_set, libflint), Nothing, (Ref{ZZModRelPowerSeriesRingElem}, Ref{ZZModRelPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), z, a, p)
    finalizer(_fmpz_mod_rel_series_clear_fn, z)
    return z
  end
end
...
function _fmpz_mod_rel_series_clear_fn(a::ZZModRelPowerSeriesRingElem)
  ccall((:fmpz_mod_poly_clear, libflint), Nothing, (Ref{ZZModRelPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), a, base_ring(parent(a)).ninv)
end
...
@attributes mutable struct FpAbsPowerSeriesRing <: SeriesRing{FpFieldElem}
  ...
  function FpAbsPowerSeriesRing(R::Ring, prec::Int, s::Symbol, cached::Bool=true)
...
const GFPFmpzAbsSeriesID = CacheDictType{Tuple{FpField,Int,Symbol},FpAbsPowerSeriesRing}()
...
mutable struct FpAbsPowerSeriesRingElem <: AbsPowerSeriesRingElem{FpFieldElem}
  ...
  function FpAbsPowerSeriesRingElem(p::fmpz_mod_ctx_struct)
    z = new()
    ccall((:fmpz_mod_poly_init, libflint), Nothing, (Ref{FpAbsPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), z, p)
  ...
  function FpAbsPowerSeriesRingElem(p::fmpz_mod_ctx_struct, a::Vector{ZZRingElem}, len::Int, prec::Int)
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{FpAbsPowerSeriesRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, len, p)
    for i in 1:len
      ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{FpAbsPowerSeriesRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, i - 1, a[i], p)
    end
    z.prec = prec
    finalizer(_gfp_fmpz_abs_series_clear_fn, z)
    return z
  ...
  function FpAbsPowerSeriesRingElem(p::fmpz_mod_ctx_struct, a::Vector{FpFieldElem}, len::Int, prec::Int)
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{FpAbsPowerSeriesRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, len, p)
    for i in 1:len
      ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{FpAbsPowerSeriesRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, i - 1, data(a[i]), p)
    end
    z.prec = prec
    finalizer(_gfp_fmpz_abs_series_clear_fn, z)
    return z
  ...
  function FpAbsPowerSeriesRingElem(R::FpField, a::Vector{FpFieldElem}, len::Int, prec::Int)
    return FpAbsPowerSeriesRingElem(R.ninv, a, len, prec)
  end
  ...
  function FpAbsPowerSeriesRingElem(a::FpAbsPowerSeriesRingElem)
    ...
    p = base_ring(parent(a)).ninv
    ccall((:fmpz_mod_poly_init, libflint), Nothing, (Ref{FpAbsPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), z, p)
    ccall((:fmpz_mod_poly_set, libflint), Nothing, (Ref{FpAbsPowerSeriesRingElem}, Ref{FpAbsPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), z, a, p)
    finalizer(_gfp_fmpz_abs_series_clear_fn, z)
    return z
  end
end
...
function _gfp_fmpz_abs_series_clear_fn(a::FpAbsPowerSeriesRingElem)
  ccall((:fmpz_mod_poly_clear, libflint), Nothing, (Ref{FpAbsPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), a, base_ring(parent(a)).ninv)
end
...
@attributes mutable struct zzModAbsPowerSeriesRing <: SeriesRing{zzModRingElem}
  ...
  function zzModAbsPowerSeriesRing(R::Ring, prec::Int, s::Symbol, cached::Bool=true)
    m = modulus(R)
...
const NmodAbsSeriesID = CacheDictType{Tuple{zzModRing,Int,Symbol},zzModAbsPowerSeriesRing}()
...
mutable struct zzModAbsPowerSeriesRingElem <: AbsPowerSeriesRingElem{zzModRingElem}
  ...
  function zzModAbsPowerSeriesRingElem(n::UInt)
    z = new()
    ccall((:nmod_poly_init, libflint), Nothing, (Ref{zzModAbsPowerSeriesRingElem}, UInt), z, n)
  ...
  function zzModAbsPowerSeriesRingElem(n::UInt, arr::Vector{ZZRingElem}, len::Int, prec::Int)
    z = new()
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{zzModAbsPowerSeriesRingElem}, UInt, Int), z, n, length(arr))
    for i in 1:len
      tt = ccall((:fmpz_fdiv_ui, libflint), UInt, (Ref{ZZRingElem}, UInt), arr[i], n)
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{zzModAbsPowerSeriesRingElem}, Int, UInt), z, i - 1, tt)
    end
    z.prec = prec
    finalizer(_nmod_abs_series_clear_fn, z)
    return z
  ...
  function zzModAbsPowerSeriesRingElem(n::UInt, arr::Vector{UInt}, len::Int, prec::Int)
    ...
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{zzModAbsPowerSeriesRingElem}, UInt, Int), z, n, length(arr))
    for i in 1:len
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{zzModAbsPowerSeriesRingElem}, Int, UInt), z, i - 1, arr[i])
    end
    z.prec = prec
    finalizer(_nmod_abs_series_clear_fn, z)
    return z
  ...
  function zzModAbsPowerSeriesRingElem(n::UInt, arr::Vector{zzModRingElem}, len::Int, prec::Int)
    ...
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{zzModAbsPowerSeriesRingElem}, UInt, Int), z, n, length(arr))
    for i in 1:len
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{zzModAbsPowerSeriesRingElem}, Int, UInt), z, i - 1, arr[i].data)
    end
    z.prec = prec
    finalizer(_nmod_abs_series_clear_fn, z)
    return z
  ...
  function zzModAbsPowerSeriesRingElem(a::zzModAbsPowerSeriesRingElem)
    z = new()
    R = base_ring(a)
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{zzModAbsPowerSeriesRingElem}, UInt, Int), z, R.n, length(a))
    ccall((:nmod_poly_set, libflint), Nothing, (Ref{zzModAbsPowerSeriesRingElem}, Ref{zzModAbsPowerSeriesRingElem}), z, a)
    z.prec = a.prec
    finalizer(_nmod_abs_series_clear_fn, z)
    return z
  end
...
const GFPAbsSeriesID = CacheDictType{Tuple{fpField,Int,Symbol},fpAbsPowerSeriesRing}()
...
mutable struct fpAbsPowerSeriesRingElem <: AbsPowerSeriesRingElem{fpFieldElem}
  ...
  function fpAbsPowerSeriesRingElem(n::UInt)
    z = new()
    ccall((:nmod_poly_init, libflint), Nothing, (Ref{fpAbsPowerSeriesRingElem}, UInt), z, n)
  ...
  function fpAbsPowerSeriesRingElem(n::UInt, arr::Vector{ZZRingElem}, len::Int, prec::Int)
    z = new()
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{fpAbsPowerSeriesRingElem}, UInt, Int), z, n, length(arr))
    for i in 1:len
      tt = ccall((:fmpz_fdiv_ui, libflint), UInt, (Ref{ZZRingElem}, UInt), arr[i], n)
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{fpAbsPowerSeriesRingElem}, Int, UInt), z, i - 1, tt)
    end
    z.prec = prec
    finalizer(_gfp_abs_series_clear_fn, z)
    return z
  ...
  function fpAbsPowerSeriesRingElem(n::UInt, arr::Vector{UInt}, len::Int, prec::Int)
    ...
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{fpAbsPowerSeriesRingElem}, UInt, Int), z, n, length(arr))
    for i in 1:len
      ccall((:nmod_poly_series_set_coeff_ui, libflint), Nothing, (Ref{fpAbsPowerSeriesRingElem}, Int, UInt), z, i - 1, arr[i])
    end
    z.prec = prec
    finalizer(_gfp_abs_series_clear_fn, z)
    return z
  ...
  function fpAbsPowerSeriesRingElem(n::UInt, arr::Vector{fpFieldElem}, len::Int, prec::Int)
    ...
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{fpAbsPowerSeriesRingElem}, UInt, Int), z, n, length(arr))
    for i in 1:len
      ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{fpAbsPowerSeriesRingElem}, Int, UInt), z, i - 1, arr[i].data)
    end
    z.prec = prec
    finalizer(_gfp_abs_series_clear_fn, z)
    return z
  ...
  function fpAbsPowerSeriesRingElem(a::fpAbsPowerSeriesRingElem)
    z = new()
    R = base_ring(a)
    ccall((:nmod_poly_init2, libflint), Nothing, (Ref{fpAbsPowerSeriesRingElem}, UInt, Int), z, R.n, length(a))
    ccall((:nmod_poly_set, libflint), Nothing, (Ref{fpAbsPowerSeriesRingElem}, Ref{fpAbsPowerSeriesRingElem}), z, a)
    z.prec = a.prec
    finalizer(_gfp_abs_series_clear_fn, z)
    return z
  end
...
const FmpzModAbsSeriesID = CacheDictType{Tuple{ZZModRing,Int,Symbol},ZZModAbsPowerSeriesRing}()
...
mutable struct ZZModAbsPowerSeriesRingElem <: AbsPowerSeriesRingElem{ZZModRingElem}
  ...
  function ZZModAbsPowerSeriesRingElem(p::fmpz_mod_ctx_struct)
    z = new()
    ccall((:fmpz_mod_poly_init, libflint), Nothing, (Ref{ZZModAbsPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), z, p)
  ...
  function ZZModAbsPowerSeriesRingElem(p::fmpz_mod_ctx_struct, a::Vector{ZZRingElem}, len::Int, prec::Int)
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{ZZModAbsPowerSeriesRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, len, p)
    for i in 1:len
      ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZModAbsPowerSeriesRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, i - 1, a[i], p)
    end
    z.prec = prec
    finalizer(_fmpz_mod_abs_series_clear_fn, z)
    return z
  ...
  function ZZModAbsPowerSeriesRingElem(p::fmpz_mod_ctx_struct, a::Vector{ZZModRingElem}, len::Int, prec::Int)
    z = new()
    ccall((:fmpz_mod_poly_init2, libflint), Nothing, (Ref{ZZModAbsPowerSeriesRingElem}, Int, Ref{fmpz_mod_ctx_struct}), z, len, p)
    for i in 1:len
      ccall((:fmpz_mod_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZModAbsPowerSeriesRingElem}, Int, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z, i - 1, data(a[i]), p)
    end
    z.prec = prec
    finalizer(_fmpz_mod_abs_series_clear_fn, z)
    return z
  ...
  function ZZModAbsPowerSeriesRingElem(R::ZZModRing, a::Vector{ZZModRingElem}, len::Int, prec::Int)
    return ZZModAbsPowerSeriesRingElem(R.ninv, a, len, prec)
  end
  ...
  function ZZModAbsPowerSeriesRingElem(a::ZZModAbsPowerSeriesRingElem)
    ...
    p = base_ring(parent(a)).ninv
    ccall((:fmpz_mod_poly_init, libflint), Nothing, (Ref{ZZModAbsPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), z, p)
    ccall((:fmpz_mod_poly_set, libflint), Nothing, (Ref{ZZModAbsPowerSeriesRingElem}, Ref{ZZModAbsPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), z, a, p)
    z.prec = a.prec
    finalizer(_fmpz_mod_abs_series_clear_fn, z)
    return z
  end
...
function _fmpz_mod_abs_series_clear_fn(a::ZZModAbsPowerSeriesRingElem)
  ccall((:fmpz_mod_poly_clear, libflint), Nothing, (Ref{ZZModAbsPowerSeriesRingElem}, Ref{fmpz_mod_ctx_struct}), a, base_ring(parent(a)).ninv)
end
...
@attributes mutable struct FqRelPowerSeriesRing <: SeriesRing{FqFieldElem}
  ...
  function FqRelPowerSeriesRing(R::FqField, prec::Int, s::Symbol, cached::Bool=true)
...
mutable struct FqRelPowerSeriesRingElem <: RelPowerSeriesRingElem{FqFieldElem}
  ...
  function FqRelPowerSeriesRingElem(ctx::FqField)
    z = new()
    ccall((:fq_default_poly_init, libflint), Nothing, (Ref{FqRelPowerSeriesRingElem}, Ref{FqField}), z, ctx)
  ...
  function FqRelPowerSeriesRingElem(ctx::FqField, a::Vector{FqFieldElem}, len::Int, prec::Int, val::Int)
    z = new()
    ccall((:fq_default_poly_init2, libflint), Nothing, (Ref{FqRelPowerSeriesRingElem}, Int, Ref{FqField}), z, len, ctx)
    for i in 1:len
      ccall((:fq_default_poly_set_coeff, libflint), Nothing, (Ref{FqRelPowerSeriesRingElem}, Int, Ref{FqFieldElem}, Ref{FqField}), z, i - 1, a[i], ctx)
    end
    z.prec = prec
    z.val = val
    finalizer(_fq_default_rel_series_clear_fn, z)
  ...
  function FqRelPowerSeriesRingElem(ctx::FqField, a::FqRelPowerSeriesRingElem)
    z = new()
    ccall((:fq_default_poly_init, libflint), Nothing, (Ref{FqRelPowerSeriesRingElem}, Ref{FqField}), z, ctx)
    ccall((:fq_default_poly_set, libflint), Nothing, (Ref{FqRelPowerSeriesRingElem}, Ref{FqRelPowerSeriesRingElem}, Ref{FqField}), z, a, ctx)
    finalizer(_fq_default_rel_series_clear_fn, z)
    return z
  end
end
...
function _fq_default_rel_series_clear_fn(a::FqRelPowerSeriesRingElem)
  ctx = base_ring(a)
  ccall((:fq_default_poly_clear, libflint), Nothing, (Ref{FqRelPowerSeriesRingElem}, Ref{FqField}), a, ctx)
end
...
@attributes mutable struct FqPolyRepRelPowerSeriesRing <: SeriesRing{FqPolyRepFieldElem}
  ...
  function FqPolyRepRelPowerSeriesRing(R::FqPolyRepField, prec::Int, s::Symbol, cached::Bool=true)
...
mutable struct FqPolyRepRelPowerSeriesRingElem <: RelPowerSeriesRingElem{FqPolyRepFieldElem}
  ...
  function FqPolyRepRelPowerSeriesRingElem(ctx::FqPolyRepField)
    z = new()
    ccall((:fq_poly_init, libflint), Nothing, (Ref{FqPolyRepRelPowerSeriesRingElem}, Ref{FqPolyRepField}), z, ctx)
  ...
  function FqPolyRepRelPowerSeriesRingElem(ctx::FqPolyRepField, a::Vector{FqPolyRepFieldElem}, len::Int, prec::Int, val::Int)
    z = new()
    ccall((:fq_poly_init2, libflint), Nothing, (Ref{FqPolyRepRelPowerSeriesRingElem}, Int, Ref{FqPolyRepField}), z, len, ctx)
    for i in 1:len
      ccall((:fq_poly_set_coeff, libflint), Nothing, (Ref{FqPolyRepRelPowerSeriesRingElem}, Int, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, i - 1, a[i], ctx)
    end
    z.prec = prec
    z.val = val
    finalizer(_fq_rel_series_clear_fn, z)
  ...
  function FqPolyRepRelPowerSeriesRingElem(ctx::FqPolyRepField, a::FqPolyRepRelPowerSeriesRingElem)
    z = new()
    ccall((:fq_poly_init, libflint), Nothing, (Ref{FqPolyRepRelPowerSeriesRingElem}, Ref{FqPolyRepField}), z, ctx)
    ccall((:fq_poly_set, libflint), Nothing, (Ref{FqPolyRepRelPowerSeriesRingElem}, Ref{FqPolyRepRelPowerSeriesRingElem}, Ref{FqPolyRepField}), z, a, ctx)
    finalizer(_fq_rel_series_clear_fn, z)
    return z
  end
end
...
function _fq_rel_series_clear_fn(a::FqPolyRepRelPowerSeriesRingElem)
  ctx = base_ring(a)
  ccall((:fq_poly_clear, libflint), Nothing, (Ref{FqPolyRepRelPowerSeriesRingElem}, Ref{FqPolyRepField}), a, ctx)
end
...
@attributes mutable struct FqAbsPowerSeriesRing <: SeriesRing{FqFieldElem}
  ...
  function FqAbsPowerSeriesRing(R::FqField, prec::Int, s::Symbol, cached::Bool=true)
...
mutable struct FqAbsPowerSeriesRingElem <: AbsPowerSeriesRingElem{FqFieldElem}
  ...
  function FqAbsPowerSeriesRingElem(ctx::FqField)
    z = new()
    ccall((:fq_default_poly_init, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqField}), z, ctx)
  ...
  function FqAbsPowerSeriesRingElem(ctx::FqField, a::Vector{FqFieldElem}, len::Int, prec::Int)
    z = new()
    ccall((:fq_default_poly_init2, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, len, ctx)
    for i in 1:len
      ccall((:fq_default_poly_set_coeff, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqFieldElem}, Ref{FqField}), z, i - 1, a[i], ctx)
    end
    z.prec = prec
    finalizer(_fq_default_abs_series_clear_fn, z)
    return z
  ...
  function FqAbsPowerSeriesRingElem(ctx::FqField, a::FqAbsPowerSeriesRingElem)
    z = new()
    ccall((:fq_default_poly_init, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqField}), z, ctx)
    ccall((:fq_default_poly_set, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Ref{FqField}), z, a, ctx)
    finalizer(_fq_default_abs_series_clear_fn, z)
    return z
  end
end
...
function _fq_default_abs_series_clear_fn(a::FqAbsPowerSeriesRingElem)
  ctx = base_ring(a)
  ccall((:fq_default_poly_clear, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqField}), a, ctx)
end
...
@attributes mutable struct FqPolyRepAbsPowerSeriesRing <: SeriesRing{FqPolyRepFieldElem}
  ...
  function FqPolyRepAbsPowerSeriesRing(R::FqPolyRepField, prec::Int, s::Symbol, cached::Bool=true)
...
mutable struct FqPolyRepAbsPowerSeriesRingElem <: AbsPowerSeriesRingElem{FqPolyRepFieldElem}
  ...
  function FqPolyRepAbsPowerSeriesRingElem(ctx::FqPolyRepField)
    z = new()
    ccall((:fq_poly_init, libflint), Nothing, (Ref{FqPolyRepAbsPowerSeriesRingElem}, Ref{FqPolyRepField}), z, ctx)
  ...
  function FqPolyRepAbsPowerSeriesRingElem(ctx::FqPolyRepField, a::Vector{FqPolyRepFieldElem}, len::Int, prec::Int)
    z = new()
    ccall((:fq_poly_init2, libflint), Nothing, (Ref{FqPolyRepAbsPowerSeriesRingElem}, Int, Ref{FqPolyRepField}), z, len, ctx)
    for i in 1:len
      ccall((:fq_poly_set_coeff, libflint), Nothing, (Ref{FqPolyRepAbsPowerSeriesRingElem}, Int, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, i - 1, a[i], ctx)
    end
    z.prec = prec
    finalizer(_fq_abs_series_clear_fn, z)
    return z
  ...
  function FqPolyRepAbsPowerSeriesRingElem(ctx::FqPolyRepField, a::FqPolyRepAbsPowerSeriesRingElem)
    z = new()
    ccall((:fq_poly_init, libflint), Nothing, (Ref{FqPolyRepAbsPowerSeriesRingElem}, Ref{FqPolyRepField}), z, ctx)
    ccall((:fq_poly_set, libflint), Nothing, (Ref{FqPolyRepAbsPowerSeriesRingElem}, Ref{FqPolyRepAbsPowerSeriesRingElem}, Ref{FqPolyRepField}), z, a, ctx)
    finalizer(_fq_abs_series_clear_fn, z)
    return z
  end
end
...
function _fq_abs_series_clear_fn(a::FqPolyRepAbsPowerSeriesRingElem)
  ctx = base_ring(a)
  ccall((:fq_poly_clear, libflint), Nothing, (Ref{FqPolyRepAbsPowerSeriesRingElem}, Ref{FqPolyRepField}), a, ctx)
end
...
const FqNmodRelSeriesID = CacheDictType{Tuple{fqPolyRepField,Int,Symbol},fqPolyRepRelPowerSeriesRing}()
...
mutable struct fqPolyRepRelPowerSeriesRingElem <: RelPowerSeriesRingElem{fqPolyRepFieldElem}
  ...
  function fqPolyRepRelPowerSeriesRingElem(ctx::fqPolyRepField)
    z = new()
    ccall((:fq_nmod_poly_init, libflint), Nothing, (Ref{fqPolyRepRelPowerSeriesRingElem}, Ref{fqPolyRepField}), z, ctx)
  ...
  function fqPolyRepRelPowerSeriesRingElem(ctx::fqPolyRepField, a::Vector{fqPolyRepFieldElem}, len::Int, prec::Int, val::Int)
    z = new()
    ccall((:fq_nmod_poly_init2, libflint), Nothing, (Ref{fqPolyRepRelPowerSeriesRingElem}, Int, Ref{fqPolyRepField}), z, len, ctx)
    for i in 1:len
      ccall((:fq_nmod_poly_set_coeff, libflint), Nothing, (Ref{fqPolyRepRelPowerSeriesRingElem}, Int, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), z, i - 1, a[i], ctx)
    end
    z.prec = prec
    z.val = val
    finalizer(_fq_nmod_rel_series_clear_fn, z)
  ...
  function fqPolyRepRelPowerSeriesRingElem(ctx::fqPolyRepField, a::fqPolyRepRelPowerSeriesRingElem)
    z = new()
    ccall((:fq_nmod_poly_init, libflint), Nothing, (Ref{fqPolyRepRelPowerSeriesRingElem}, Ref{fqPolyRepField}), z, ctx)
    ccall((:fq_nmod_poly_set, libflint), Nothing, (Ref{fqPolyRepRelPowerSeriesRingElem}, Ref{fqPolyRepRelPowerSeriesRingElem}, Ref{fqPolyRepField}), z, a, ctx)
    finalizer(_fq_nmod_rel_series_clear_fn, z)
    return z
  end
end
...
function _fq_nmod_rel_series_clear_fn(a::fqPolyRepRelPowerSeriesRingElem)
  ctx = base_ring(a)
  ccall((:fq_nmod_poly_clear, libflint), Nothing, (Ref{fqPolyRepRelPowerSeriesRingElem}, Ref{fqPolyRepField}), a, ctx)
end
...
const FqNmodAbsSeriesID = CacheDictType{Tuple{fqPolyRepField,Int,Symbol},fqPolyRepAbsPowerSeriesRing}()
...
mutable struct fqPolyRepAbsPowerSeriesRingElem <: AbsPowerSeriesRingElem{fqPolyRepFieldElem}
  ...
  function fqPolyRepAbsPowerSeriesRingElem(ctx::fqPolyRepField)
    z = new()
    ccall((:fq_nmod_poly_init, libflint), Nothing, (Ref{fqPolyRepAbsPowerSeriesRingElem}, Ref{fqPolyRepField}), z, ctx)
  ...
  function fqPolyRepAbsPowerSeriesRingElem(ctx::fqPolyRepField, a::Vector{fqPolyRepFieldElem}, len::Int, prec::Int)
    z = new()
    ccall((:fq_nmod_poly_init2, libflint), Nothing, (Ref{fqPolyRepAbsPowerSeriesRingElem}, Int, Ref{fqPolyRepField}), z, len, ctx)
    for i in 1:len
      ccall((:fq_nmod_poly_set_coeff, libflint), Nothing, (Ref{fqPolyRepAbsPowerSeriesRingElem}, Int, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), z, i - 1, a[i], ctx)
    end
    z.prec = prec
    finalizer(_fq_nmod_abs_series_clear_fn, z)
    return z
  ...
  function fqPolyRepAbsPowerSeriesRingElem(ctx::fqPolyRepField, a::fqPolyRepAbsPowerSeriesRingElem)
    z = new()
    ccall((:fq_nmod_poly_init, libflint), Nothing, (Ref{fqPolyRepAbsPowerSeriesRingElem}, Ref{fqPolyRepField}), z, ctx)
    ccall((:fq_nmod_poly_set, libflint), Nothing, (Ref{fqPolyRepAbsPowerSeriesRingElem}, Ref{fqPolyRepAbsPowerSeriesRingElem}, Ref{fqPolyRepField}), z, a, ctx)
    finalizer(_fq_nmod_abs_series_clear_fn, z)
    return z
  end
end
...
function _fq_nmod_abs_series_clear_fn(a::fqPolyRepAbsPowerSeriesRingElem)
  ctx = base_ring(a)
  ccall((:fq_nmod_poly_clear, libflint), Nothing, (Ref{fqPolyRepAbsPowerSeriesRingElem}, Ref{fqPolyRepField}), a, ctx)
end
...
mutable struct QQMatrix <: MatElem{QQFieldElem}
  ...
  function QQMatrix(r::Int, c::Int)
    z = new()
    ccall((:fmpq_mat_init, libflint), Nothing, (Ref{QQMatrix}, Int, Int), z, r, c)
  ...
  function QQMatrix(r::Int, c::Int, arr::AbstractMatrix{QQFieldElem})
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fmpq_mat_entry, libflint), Ptr{QQFieldElem}, (Ref{QQMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fmpq_set, libflint), Nothing, (Ptr{QQFieldElem}, Ref{QQFieldElem}), el, arr[i, j])
      end
    end
    return z
  end
  ...
  function QQMatrix(r::Int, c::Int, arr::AbstractMatrix{ZZRingElem})
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fmpq_mat_entry, libflint), Ptr{QQFieldElem}, (Ref{QQMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fmpq_set_fmpz_frac, libflint), Nothing, (Ptr{QQFieldElem}, Ref{ZZRingElem}, Ref{ZZRingElem}), el, arr[i, j], b)
      end
    end
    return z
  end
  ...
  function QQMatrix(r::Int, c::Int, arr::AbstractVector{QQFieldElem})
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fmpq_mat_entry, libflint), Ptr{QQFieldElem}, (Ref{QQMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fmpq_set, libflint), Nothing, (Ptr{QQFieldElem}, Ref{QQFieldElem}), el, arr[(i - 1) * c + j])
      end
    end
    return z
  end
  ...
  function QQMatrix(r::Int, c::Int, arr::AbstractVector{ZZRingElem})
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fmpq_mat_entry, libflint), Ptr{QQFieldElem}, (Ref{QQMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fmpq_set_fmpz_frac, libflint), Nothing, (Ptr{QQFieldElem}, Ref{ZZRingElem}, Ref{ZZRingElem}), el, arr[(i - 1) * c + j], b)
      end
    end
    return z
  end
  ...
  function QQMatrix(r::Int, c::Int, arr::AbstractMatrix{T}) where {T<:Integer}
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fmpq_mat_entry, libflint), Ptr{QQFieldElem}, (Ref{QQMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fmpq_set, libflint), Nothing, (Ptr{QQFieldElem}, Ref{QQFieldElem}), el, QQFieldElem(arr[i, j]))
      end
    end
    return z
  end
  ...
  function QQMatrix(r::Int, c::Int, arr::AbstractVector{T}) where {T<:Integer}
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fmpq_mat_entry, libflint), Ptr{QQFieldElem}, (Ref{QQMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fmpq_set, libflint), Nothing, (Ptr{QQFieldElem}, Ref{QQFieldElem}), el, QQFieldElem(arr[(i - 1) * c + j]))
      end
    end
    return z
  end
  ...
  function QQMatrix(r::Int, c::Int, d::QQFieldElem)
    ...
    ccall((:fmpq_mat_init, libflint), Nothing, (Ref{QQMatrix}, Int, Int), z, r, c)
    finalizer(_fmpq_mat_clear_fn, z)
    GC.@preserve z for i in 1:min(r, c)
      el = ccall((:fmpq_mat_entry, libflint), Ptr{QQFieldElem}, (Ref{QQMatrix}, Int, Int), z, i - 1, i - 1)
      ccall((:fmpq_set, libflint), Nothing, (Ptr{QQFieldElem}, Ref{QQFieldElem}), el, d)
    end
    return z
  end
  ...
  function QQMatrix(m::QQMatrix)
    z = new()
    ccall((:fmpq_mat_init_set, libflint), Nothing, (Ref{QQMatrix}, Ref{QQMatrix}), z, m)
    finalizer(_fmpq_mat_clear_fn, z)
    return z
  end
end
...
mutable struct ZZMatrix <: MatElem{ZZRingElem}
  ...
  function ZZMatrix(r::Int, c::Int)
    z = new()
    ccall((:fmpz_mat_init, libflint), Nothing, (Ref{ZZMatrix}, Int, Int), z, r, c)
  ...
  function ZZMatrix(r::Int, c::Int, arr::AbstractMatrix{ZZRingElem})
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fmpz_mat_entry, libflint), Ptr{ZZRingElem}, (Ref{ZZMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fmpz_set, libflint), Nothing, (Ptr{ZZRingElem}, Ref{ZZRingElem}), el, arr[i, j])
      end
    end
    return z
  end
  ...
  function ZZMatrix(r::Int, c::Int, arr::AbstractVector{ZZRingElem})
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fmpz_mat_entry, libflint), Ptr{ZZRingElem}, (Ref{ZZMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fmpz_set, libflint), Nothing, (Ptr{ZZRingElem}, Ref{ZZRingElem}), el, arr[(i - 1) * c + j])
      end
    end
    return z
  end
  ...
  function ZZMatrix(r::Int, c::Int, arr::AbstractMatrix{T}) where {T<:Integer}
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fmpz_mat_entry, libflint), Ptr{ZZRingElem}, (Ref{ZZMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fmpz_set, libflint), Nothing, (Ptr{ZZRingElem}, Ref{ZZRingElem}), el, ZZRingElem(arr[i, j]))
      end
    end
    return z
  end
  ...
  function ZZMatrix(r::Int, c::Int, arr::AbstractVector{T}) where {T<:Integer}
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fmpz_mat_entry, libflint), Ptr{ZZRingElem}, (Ref{ZZMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fmpz_set, libflint), Nothing, (Ptr{ZZRingElem}, Ref{ZZRingElem}), el, ZZRingElem(arr[(i - 1) * c + j]))
      end
    end
    return z
  end
  ...
  function ZZMatrix(r::Int, c::Int, d::ZZRingElem)
    ...
    finalizer(_fmpz_mat_clear_fn, z)
    GC.@preserve z for i in 1:min(r, c)
      el = ccall((:fmpz_mat_entry, libflint), Ptr{ZZRingElem}, (Ref{ZZMatrix}, Int, Int), z, i - 1, i - 1)
      ccall((:fmpz_set, libflint), Nothing, (Ptr{ZZRingElem}, Ref{ZZRingElem}), el, d)
    end
    return z
  end
  ...
  function ZZMatrix(m::ZZMatrix)
    z = new()
    ccall((:fmpz_mat_init_set, libflint), Nothing, (Ref{ZZMatrix}, Ref{ZZMatrix}), z, m)
    finalizer(_fmpz_mat_clear_fn, z)
    return z
  end
end
...
mutable struct zzModMatrix <: MatElem{zzModRingElem}
  ...
  function zzModMatrix(r::Int, c::Int, n::UInt)
    z = new()
    ccall((:nmod_mat_init, libflint), Nothing, (Ref{zzModMatrix}, Int, Int, UInt), z, r, c, n)
  ...
  function zzModMatrix(r::Int, c::Int, n::UInt, arr::AbstractMatrix{ZZRingElem}, transpose::Bool=false)
    ...
    for i in 1:r
      for j in 1:c
        ccall((:fmpz_mod_ui, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, UInt), t, arr[i, j], n)
  ...
  function zzModMatrix(r::Int, c::Int, n::UInt, arr::AbstractVector{ZZRingElem})
    ...
    for i in 1:r
      for j in 1:c
        ccall((:fmpz_mod_ui, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, UInt), t, arr[(i - 1) * c + j], n)
        setindex!(z, t, i, j)
      end
    end
    return z
  ...
  function zzModMatrix(n::UInt, b::ZZMatrix)
    z = new()
    ccall((:nmod_mat_init, libflint), Nothing, (Ref{zzModMatrix}, Int, Int, UInt), z, b.r, b.c, n)
    finalizer(_nmod_mat_clear_fn, z)
    ccall((:fmpz_mat_get_nmod_mat, libflint), Nothing, (Ref{zzModMatrix}, Ref{ZZMatrix}), z, b)
    return z
  end
  ...
  function zzModMatrix(n::ZZRingElem, b::ZZMatrix)
    (n < 0) && error("Modulus must be positive")
    (n > typemax(UInt)) && error("Modulus must be smaller than ", ZZRingElem(typemax(UInt)))
    return zzModMatrix(UInt(n), b)
  end
end
...
mutable struct ZZModMatrix <: MatElem{ZZModRingElem}
  ...
  function ZZModMatrix(r::Int, c::Int, ctx::fmpz_mod_ctx_struct)
    z = new()
    ccall((:fmpz_mod_mat_init, libflint), Nothing, (Ref{ZZModMatrix}, Int, Int, Ref{fmpz_mod_ctx_struct}), z, r, c, ctx)
  ...
  function ZZModMatrix(n::ZZRingElem, b::ZZMatrix)
    ...
    z = new()
    R = ZZModRing(n)
    ccall((:fmpz_mod_mat_init, libflint), Nothing, (Ref{ZZModMatrix}, Int, Int, Ref{fmpz_mod_ctx_struct}), z, b.r, b.c, R.ninv)
    finalizer(_fmpz_mod_mat_clear_fn, z)
    for i in 1:(b.r)
      for j in 1:(b.c)
...
function _fmpz_mod_mat_clear_fn(mat::ZZModMatrix)
  ccall((:fmpz_mod_mat_clear, libflint), Nothing, (Ref{ZZModMatrix}, Ref{Nothing}), mat, C_NULL) # Hack
end
...
mutable struct FpMatrix <: MatElem{FpFieldElem}
  ...
  function FpMatrix(r::Int, c::Int, ctx::fmpz_mod_ctx_struct)
    z = new()
    ccall((:fmpz_mod_mat_init, libflint), Nothing, (Ref{FpMatrix}, Int, Int, Ref{fmpz_mod_ctx_struct}), z, r, c, ctx)
...
function _gfp_fmpz_mat_clear_fn(mat::FpMatrix)
  ccall((:fmpz_mod_mat_clear, libflint), Nothing, (Ref{FpMatrix}, Ref{Nothing}), mat, C_NULL) # Hack
end
...
mutable struct fpMatrix <: MatElem{fpFieldElem}
  ...
  function fpMatrix(r::Int, c::Int, n::UInt)
    z = new()
    ccall((:nmod_mat_init, libflint), Nothing, (Ref{fpMatrix}, Int, Int, UInt), z, r, c, n)
  ...
  function fpMatrix(n::UInt, b::ZZMatrix)
    z = new()
    ccall((:nmod_mat_init, libflint), Nothing, (Ref{fpMatrix}, Int, Int, UInt), z, b.r, b.c, n)
    finalizer(_gfp_mat_clear_fn, z)
    ccall((:fmpz_mat_get_nmod_mat, libflint), Nothing, (Ref{fpMatrix}, Ref{ZZMatrix}), z, b)
    return z
  end
...
mutable struct FqPolyRingElem <: PolyRingElem{FqFieldElem}
  ...
  function FqPolyRingElem(ctx::FqField)
    z = new()
    ccall((:fq_default_poly_init, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{FqField}), z, ctx)
  ...
  function FqPolyRingElem(a::FqPolyRingElem, ctx::FqField)
    z = new()
    ccall((:fq_default_poly_init, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{FqField}), z, ctx)
    ccall((:fq_default_poly_set, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{FqPolyRingElem}, Ref{FqField}), z, a, ctx)
    finalizer(_fq_default_poly_clear_fn, z)
    return z
  end
  ...
  function FqPolyRingElem(a::FqFieldElem, ctx::FqField)
    z = new()
    ccall((:fq_default_poly_init, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{FqField}), z, ctx)
    ccall((:fq_default_poly_set_fq_default, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{FqFieldElem}, Ref{FqField}), z, a, ctx)
    finalizer(_fq_default_poly_clear_fn, z)
    return z
  end
  ...
  function FqPolyRingElem(a::Vector{FqFieldElem}, ctx::FqField)
    z = new()
    ccall((:fq_default_poly_init2, libflint), Nothing, (Ref{FqPolyRingElem}, Int, Ref{FqField}), z, length(a), ctx)
    for i in 1:length(a)
      ccall((:fq_default_poly_set_coeff, libflint), Nothing, (Ref{FqPolyRingElem}, Int, Ref{FqFieldElem}, Ref{FqField}), z, i - 1, a[i], ctx)
    end
    finalizer(_fq_default_poly_clear_fn, z)
    return z
  end
  ...
  function FqPolyRingElem(a::Vector{ZZRingElem}, ctx::FqField)
    ...
    for i in 1:length(a)
      temp = ctx(a[i])
      ccall((:fq_default_poly_set_coeff, libflint), Nothing, (Ref{FqPolyRingElem}, Int, Ref{FqFieldElem}, Ref{FqField}), z, i - 1, temp, ctx)
    end
    finalizer(_fq_default_poly_clear_fn, z)
    return z
  end
  ...
  function FqPolyRingElem(a::ZZPolyRingElem, ctx::FqField)
    z = new()
    ccall((:fq_default_poly_init2, libflint), Nothing, (Ref{FqPolyRingElem}, Int, Ref{FqField}), z, length(a), ctx)
    ccall((:fq_default_poly_set_fmpz_poly, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{ZZPolyRingElem}, Ref{FqField}), z, a, ctx)
    finalizer(_fq_default_poly_clear_fn, z)
    return z
  end
  ...
  function FqPolyRingElem(a::zzModPolyRingElem, ctx::FqField)
    z = new()
    ccall((:fq_default_poly_init2, libflint), Nothing, (Ref{FqPolyRingElem}, Int, Ref{FqField}), z, length(a), ctx)
    ccall((:fq_default_poly_set_nmod_poly, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{zzModPolyRingElem}, Ref{FqField}), z, a, ctx)
    finalizer(_fq_default_poly_clear_fn, z)
    return z
  end
  ...
  function FqPolyRingElem(a::fpPolyRingElem, ctx::FqField)
    z = new()
    ccall((:fq_default_poly_init2, libflint), Nothing, (Ref{FqPolyRingElem}, Int, Ref{FqField}), z, length(a), ctx)
    ccall((:fq_default_poly_set_nmod_poly, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{fpPolyRingElem}, Ref{FqField}), z, a, ctx)
    finalizer(_fq_default_poly_clear_fn, z)
    return z
  end
  ...
  function FqPolyRingElem(a::ZZModPolyRingElem, ctx::FqField)
    z = new()
    ccall((:fq_default_poly_init2, libflint), Nothing, (Ref{FqPolyRingElem}, Int, Ref{FqField}), z, length(a), ctx)
    ccall((:fq_default_poly_set_fmpz_mod_poly, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{ZZModPolyRingElem}, Ref{FqField}), z, a, ctx)
    finalizer(_fq_default_poly_clear_fn, z)
    return z
  end
  ...
  function FqPolyRingElem(a::FpPolyRingElem, ctx::FqField)
    z = new()
    ccall((:fq_default_poly_init2, libflint), Nothing, (Ref{FqPolyRingElem}, Int, Ref{FqField}), z, length(a), ctx)
    ccall((:fq_default_poly_set_fmpz_mod_poly, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{FpPolyRingElem}, Ref{FqField}), z, a, ctx)
    finalizer(_fq_default_poly_clear_fn, z)
    return z
  end
end
...
function _fq_default_poly_clear_fn(a::FqPolyRingElem)
  ccall((:fq_default_poly_clear, libflint), Nothing, (Ref{FqPolyRingElem}, Ref{FqField}), a, base_ring(a))
end
...
mutable struct fq_default_poly_factor
  ...
  function fq_default_poly_factor(ctx::FqField)
    z = new()
    ccall((:fq_default_poly_factor_init, libflint), Nothing, (Ref{fq_default_poly_factor}, Ref{FqField}), z, ctx)
    z.base_field = ctx
...
function _fq_default_poly_factor_clear_fn(a::fq_default_poly_factor)
  K = a.base_field
  ccall((:fq_default_poly_factor_clear, libflint), Nothing, (Ref{fq_default_poly_factor}, Ref{FqField}), a, K)
end
...
mutable struct FqPolyRepPolyRingElem <: PolyRingElem{FqPolyRepFieldElem}
  ...
  function FqPolyRepPolyRingElem(a::FqPolyRepPolyRingElem)
    ...
    ccall((:fq_poly_init, libflint), Nothing, (Ref{FqPolyRepPolyRingElem}, Ref{FqPolyRepField}), z, ctx)
    ccall((:fq_poly_set, libflint), Nothing, (Ref{FqPolyRepPolyRingElem}, Ref{FqPolyRepPolyRingElem}, Ref{FqPolyRepField}), z, a, ctx)
    finalizer(_fq_poly_clear_fn, z)
    return z
  end
  ...
  function FqPolyRepPolyRingElem(a::FqPolyRepFieldElem)
    ...
    ctx = parent(a)
    ccall((:fq_poly_init, libflint), Nothing, (Ref{FqPolyRepPolyRingElem}, Ref{FqPolyRepField}), z, ctx)
    ccall((:fq_poly_set_fq, libflint), Nothing, (Ref{FqPolyRepPolyRingElem}, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, a, ctx)
    finalizer(_fq_poly_clear_fn, z)
    return z
  end
  ...
  function FqPolyRepPolyRingElem(a::Vector{FqPolyRepFieldElem})
    z = new()
    ctx = parent(a[1])
    ccall((:fq_poly_init2, libflint), Nothing, (Ref{FqPolyRepPolyRingElem}, Int, Ref{FqPolyRepField}), z, length(a), ctx)
    for i in 1:length(a)
      ccall((:fq_poly_set_coeff, libflint), Nothing, (Ref{FqPolyRepPolyRingElem}, Int, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, i - 1, a[i], ctx)
    end
    finalizer(_fq_poly_clear_fn, z)
    return z
  end
  ...
  function FqPolyRepPolyRingElem(a::Vector{ZZRingElem}, ctx::FqPolyRepField)
    ...
    for i in 1:length(a)
      temp = ctx(a[i])
      ccall((:fq_poly_set_coeff, libflint), Nothing, (Ref{FqPolyRepPolyRingElem}, Int, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, i - 1, temp, ctx)
    end
    finalizer(_fq_poly_clear_fn, z)
    return z
  end
...
mutable struct fq_poly_factor
  ...
  function fq_poly_factor(ctx::FqPolyRepField)
    z = new()
    ccall((:fq_poly_factor_init, libflint), Nothing, (Ref{fq_poly_factor}, Ref{FqPolyRepField}), z, ctx)
    z.base_field = ctx
...
function _fq_poly_factor_clear_fn(a::fq_poly_factor)
  ccall((:fq_poly_factor_clear, libflint), Nothing, (Ref{fq_poly_factor}, Ref{FqPolyRepField}), a, a.base_field)
end
...
mutable struct fqPolyRepPolyRingElem <: PolyRingElem{fqPolyRepFieldElem}
  ...
  function fqPolyRepPolyRingElem(a::fqPolyRepPolyRingElem)
    z = new()
    ctx = base_ring(parent(a))
    ccall((:fq_nmod_poly_init, libflint), Nothing, (Ref{fqPolyRepPolyRingElem}, Ref{fqPolyRepField}), z, ctx)
    ccall((:fq_nmod_poly_set, libflint), Nothing, (Ref{fqPolyRepPolyRingElem}, Ref{fqPolyRepPolyRingElem}, Ref{fqPolyRepField}), z, a, ctx)
    finalizer(_fq_nmod_poly_clear_fn, z)
    return z
  end
  ...
  function fqPolyRepPolyRingElem(a::fqPolyRepFieldElem)
    ...
    ctx = parent(a)
    ccall((:fq_nmod_poly_init, libflint), Nothing, (Ref{fqPolyRepPolyRingElem}, Ref{fqPolyRepField}), z, ctx)
    ccall((:fq_nmod_poly_set_fq_nmod, libflint), Nothing, (Ref{fqPolyRepPolyRingElem}, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), z, a, ctx)
    finalizer(_fq_nmod_poly_clear_fn, z)
    return z
  end
  ...
  function fqPolyRepPolyRingElem(a::Vector{fqPolyRepFieldElem})
    z = new()
    ctx = parent(a[1])
    ccall((:fq_nmod_poly_init2, libflint), Nothing, (Ref{fqPolyRepPolyRingElem}, Int, Ref{fqPolyRepField}), z, length(a), ctx)
    for i in 1:length(a)
      ccall((:fq_nmod_poly_set_coeff, libflint), Nothing, (Ref{fqPolyRepPolyRingElem}, Int, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), z, i - 1, a[i], ctx)
    end
    finalizer(_fq_nmod_poly_clear_fn, z)
    return z
  end
  ...
  function fqPolyRepPolyRingElem(a::Vector{ZZRingElem}, ctx::fqPolyRepField)
    ...
    for i in 1:length(a)
      temp = ctx(a[i])
      ccall((:fq_nmod_poly_set_coeff, libflint), Nothing, (Ref{fqPolyRepPolyRingElem}, Int, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), z, i - 1, temp, ctx)
    end
    finalizer(_fq_nmod_poly_clear_fn, z)
    return z
  end
...
mutable struct fq_nmod_poly_factor
  ...
  function fq_nmod_poly_factor(ctx::fqPolyRepField)
    z = new()
    ccall((:fq_nmod_poly_factor_init, libflint), Nothing, (Ref{fq_nmod_poly_factor}, Ref{fqPolyRepField}), z, ctx)
    z.base_field = ctx
...
function _fq_nmod_poly_factor_clear_fn(a::fq_nmod_poly_factor)
  ccall((:fq_nmod_poly_factor_clear, libflint), Nothing, (Ref{fq_nmod_poly_factor}, Ref{fqPolyRepField}), a, a.base_field)
end
...
mutable struct FqMatrix <: MatElem{FqFieldElem}
  ...
  function FqMatrix(r::Int, c::Int, ctx::FqField)
    z = new()
    ccall((:fq_default_mat_init, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{FqField}), z, r, c, ctx)
    z.base_ring = ctx
  ...
  function FqMatrix(r::Int, c::Int, arr::AbstractMatrix{FqFieldElem}, ctx::FqField)
    ...
    for i in 1:r
      for j in 1:c
        ccall((:fq_default_mat_entry_set, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{FqFieldElem}, Ref{FqField}), z, i - 1, j - 1, arr[i, j], ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_default_mat_clear_fn, z)
  ...
  function FqMatrix(r::Int, c::Int, arr::AbstractVector{FqFieldElem}, ctx::FqField)
    ...
    for i in 1:r
      for j in 1:c
        ccall((:fq_default_mat_entry_set, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{FqFieldElem}, Ref{FqField}), z, i - 1, j - 1, arr[(i - 1) * c + j], ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_default_mat_clear_fn, z)
  ...
  function FqMatrix(r::Int, c::Int, arr::AbstractMatrix{ZZRingElem}, ctx::FqField)
    ...
    for i in 1:r
      for j in 1:c
        ccall((:fq_default_mat_entry_set_fmpz, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{ZZRingElem}, Ref{FqField}), z, i - 1, j - 1, arr[i, j], ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_default_mat_clear_fn, z)
  ...
  function FqMatrix(r::Int, c::Int, arr::AbstractVector{ZZRingElem}, ctx::FqField)
    ...
    for i in 1:r
      for j in 1:c
        ccall((:fq_default_mat_entry_set_fmpz, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{ZZRingElem}, Ref{FqField}), z, i - 1, j - 1, arr[(i - 1) * c + j], ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_default_mat_clear_fn, z)
  ...
  function FqMatrix(r::Int, c::Int, arr::AbstractMatrix{T}, ctx::FqField) where {T<:Integer}
    ...
    for i in 1:r
      for j in 1:c
        ccall((:fq_default_mat_entry_set, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{FqFieldElem}, Ref{FqField}), z, i - 1, j - 1, ctx(arr[i, j]), ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_default_mat_clear_fn, z)
  ...
  function FqMatrix(r::Int, c::Int, arr::AbstractVector{T}, ctx::FqField) where {T<:Integer}
    ...
    for i in 1:r
      for j in 1:c
        ccall((:fq_default_mat_entry_set, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{FqFieldElem}, Ref{FqField}), z, i - 1, j - 1, ctx(arr[(i - 1) * c + j]), ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_default_mat_clear_fn, z)
  ...
  function FqMatrix(r::Int, c::Int, d::FqFieldElem)
    ...
    ccall((:fq_default_mat_init, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{FqField}), z, r, c, ctx)
    for i in 1:min(r, c)
      ccall((:fq_default_mat_entry_set, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{FqFieldElem}, Ref{FqField}), z, i - 1, i - 1, d, ctx)
    end
    z.base_ring = ctx
    finalizer(_fq_default_mat_clear_fn, z)
    return z
  ...
  function FqMatrix(m::ZZMatrix, ctx::FqField)
    ...
    c = ncols(m)
    ccall((:fq_default_mat_init, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{FqField}), z, r, c, ctx)
    ccall((:fq_default_mat_set_fmpz_mat, libflint), Nothing, (Ref{FqMatrix}, Ref{ZZMatrix}, Ref{FqField}), z, m, ctx)
    z.base_ring = ctx
    finalizer(_fq_default_mat_clear_fn, z)
    return z
  end
  ...
  function FqMatrix(m::ZZModMatrix, ctx::FqField)
    ...
    c = ncols(m)
    ccall((:fq_default_mat_init, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{FqField}), z, r, c, ctx)
    ccall((:fq_default_mat_set_fmpz_mod_mat, libflint), Nothing, (Ref{FqMatrix}, Ref{ZZModMatrix}, Ref{FqField}), z, m, ctx)
    z.base_ring = ctx
    finalizer(_fq_default_mat_clear_fn, z)
    return z
  end
  ...
  function FqMatrix(m::zzModMatrix, ctx::FqField)
    ...
    c = ncols(m)
    ccall((:fq_default_mat_init, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{FqField}), z, r, c, ctx)
    ccall((:fq_default_mat_set_nmod_mat, libflint), Nothing, (Ref{FqMatrix}, Ref{zzModMatrix}, Ref{FqField}), z, m, ctx)
    z.base_ring = ctx
    finalizer(_fq_default_mat_clear_fn, z)
    return z
  end
  ...
  function FqMatrix(m::fpMatrix, ctx::FqField)
    ...
    c = ncols(m)
    ccall((:fq_default_mat_init, libflint), Nothing, (Ref{FqMatrix}, Int, Int, Ref{FqField}), z, r, c, ctx)
    ccall((:fq_default_mat_set_nmod_mat, libflint), Nothing, (Ref{FqMatrix}, Ref{fpMatrix}, Ref{FqField}), z, m, ctx)
    z.base_ring = ctx
    finalizer(_fq_default_mat_clear_fn, z)
    return z
  end
...
function _fq_default_mat_clear_fn(a::FqMatrix)
  ccall((:fq_default_mat_clear, libflint), Nothing, (Ref{FqMatrix}, Ref{FqField}), a, base_ring(a))
end
...
mutable struct FqPolyRepMatrix <: MatElem{FqPolyRepFieldElem}
  ...
  function FqPolyRepMatrix(r::Int, c::Int, ctx::FqPolyRepField)
    z = new()
    ccall((:fq_mat_init, libflint), Nothing, (Ref{FqPolyRepMatrix}, Int, Int, Ref{FqPolyRepField}), z, r, c, ctx)
    z.base_ring = ctx
  ...
  function FqPolyRepMatrix(r::Int, c::Int, arr::AbstractMatrix{FqPolyRepFieldElem}, ctx::FqPolyRepField)
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        ccall((:fq_mat_entry_set, libflint), Nothing, (Ref{FqPolyRepMatrix}, Int, Int, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, i - 1, j - 1, arr[i, j], ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_mat_clear_fn, z)
  ...
  function FqPolyRepMatrix(r::Int, c::Int, arr::AbstractVector{FqPolyRepFieldElem}, ctx::FqPolyRepField)
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        ccall((:fq_mat_entry_set, libflint), Nothing, (Ref{FqPolyRepMatrix}, Int, Int, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, i - 1, j - 1, arr[(i - 1) * c + j], ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_mat_clear_fn, z)
  ...
  function FqPolyRepMatrix(r::Int, c::Int, arr::AbstractMatrix{ZZRingElem}, ctx::FqPolyRepField)
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fq_mat_entry, libflint), Ptr{FqPolyRepFieldElem}, (Ref{FqPolyRepMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fq_set_fmpz, libflint), Nothing, (Ptr{FqPolyRepFieldElem}, Ref{ZZRingElem}, Ref{FqPolyRepField}), el, arr[i, j], ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_mat_clear_fn, z)
  ...
  function FqPolyRepMatrix(r::Int, c::Int, arr::AbstractVector{ZZRingElem}, ctx::FqPolyRepField)
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fq_mat_entry, libflint), Ptr{FqPolyRepFieldElem}, (Ref{FqPolyRepMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fq_set_fmpz, libflint), Nothing, (Ptr{FqPolyRepFieldElem}, Ref{ZZRingElem}, Ref{FqPolyRepField}), el, arr[(i - 1) * c + j], ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_mat_clear_fn, z)
  ...
  function FqPolyRepMatrix(r::Int, c::Int, arr::AbstractMatrix{T}, ctx::FqPolyRepField) where {T<:Integer}
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        ccall((:fq_mat_entry_set, libflint), Nothing, (Ref{FqPolyRepMatrix}, Int, Int, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, i - 1, j - 1, ctx(arr[i, j]), ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_mat_clear_fn, z)
  ...
  function FqPolyRepMatrix(r::Int, c::Int, arr::AbstractVector{T}, ctx::FqPolyRepField) where {T<:Integer}
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        ccall((:fq_mat_entry_set, libflint), Nothing, (Ref{FqPolyRepMatrix}, Int, Int, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, i - 1, j - 1, ctx(arr[(i - 1) * c + j]), ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_mat_clear_fn, z)
  ...
  function FqPolyRepMatrix(r::Int, c::Int, d::FqPolyRepFieldElem)
    ...
    ccall((:fq_mat_init, libflint), Nothing, (Ref{FqPolyRepMatrix}, Int, Int, Ref{FqPolyRepField}), z, r, c, ctx)
    for i in 1:min(r, c)
      ccall((:fq_mat_entry_set, libflint), Nothing, (Ref{FqPolyRepMatrix}, Int, Int, Ref{FqPolyRepFieldElem}, Ref{FqPolyRepField}), z, i - 1, i - 1, d, ctx)
    end
    z.base_ring = ctx
    finalizer(_fq_mat_clear_fn, z)
    return z
  ...
  function FqPolyRepMatrix(m::ZZMatrix, ctx::FqPolyRepField)
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el1 = ccall((:fq_mat_entry, libflint), Ptr{FqPolyRepFieldElem}, (Ref{FqPolyRepMatrix}, Int, Int), z, i - 1, j - 1)
        el2 = ccall((:fmpz_mat_entry, libflint), Ptr{ZZRingElem}, (Ref{ZZMatrix}, Int, Int), m, i - 1, j - 1)

        ccall((:fq_set_fmpz, libflint), Nothing, (Ptr{FqPolyRepFieldElem}, Ptr{ZZRingElem}, Ref{FqPolyRepField}), el1, el2, ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_mat_clear_fn, z)
...
mutable struct fqPolyRepMatrix <: MatElem{fqPolyRepFieldElem}
  ...
  function fqPolyRepMatrix(r::Int, c::Int, ctx::fqPolyRepField)
    z = new()
    ccall((:fq_nmod_mat_init, libflint), Nothing, (Ref{fqPolyRepMatrix}, Int, Int, Ref{fqPolyRepField}), z, r, c, ctx)
    z.base_ring = ctx
  ...
  function fqPolyRepMatrix(r::Int, c::Int, arr::AbstractMatrix{fqPolyRepFieldElem}, ctx::fqPolyRepField)
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        ccall((:fq_nmod_mat_entry_set, libflint), Nothing, (Ref{fqPolyRepMatrix}, Int, Int, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), z, i - 1, j - 1, arr[i, j], ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_nmod_mat_clear_fn, z)
  ...
  function fqPolyRepMatrix(r::Int, c::Int, arr::AbstractVector{fqPolyRepFieldElem}, ctx::fqPolyRepField)
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        ccall((:fq_nmod_mat_entry_set, libflint), Nothing, (Ref{fqPolyRepMatrix}, Int, Int, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), z, i - 1, j - 1, arr[(i - 1) * c + j], ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_nmod_mat_clear_fn, z)
  ...
  function fqPolyRepMatrix(r::Int, c::Int, arr::AbstractMatrix{ZZRingElem}, ctx::fqPolyRepField)
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fq_nmod_mat_entry, libflint), Ptr{fqPolyRepFieldElem}, (Ref{fqPolyRepMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fq_nmod_set_fmpz, libflint), Nothing, (Ptr{fqPolyRepFieldElem}, Ref{ZZRingElem}, Ref{fqPolyRepField}), el, arr[i, j], ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_nmod_mat_clear_fn, z)
  ...
  function fqPolyRepMatrix(r::Int, c::Int, arr::AbstractVector{ZZRingElem}, ctx::fqPolyRepField)
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:fq_nmod_mat_entry, libflint), Ptr{fqPolyRepFieldElem}, (Ref{fqPolyRepMatrix}, Int, Int), z, i - 1, j - 1)
        ccall((:fq_nmod_set_fmpz, libflint), Nothing, (Ptr{fqPolyRepFieldElem}, Ref{ZZRingElem}, Ref{fqPolyRepField}), el, arr[(i - 1) * c + j], ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_nmod_mat_clear_fn, z)
  ...
  function fqPolyRepMatrix(r::Int, c::Int, arr::AbstractMatrix{T}, ctx::fqPolyRepField) where {T<:Integer}
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        ccall((:fq_nmod_mat_entry_set, libflint), Nothing, (Ref{fqPolyRepMatrix}, Int, Int, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), z, i - 1, j - 1, ctx(arr[i, j]), ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_nmod_mat_clear_fn, z)
  ...
  function fqPolyRepMatrix(r::Int, c::Int, arr::AbstractVector{T}, ctx::fqPolyRepField) where {T<:Integer}
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        ccall((:fq_nmod_mat_entry_set, libflint), Nothing, (Ref{fqPolyRepMatrix}, Int, Int, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), z, i - 1, j - 1, ctx(arr[(i - 1) * c + j]), ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_nmod_mat_clear_fn, z)
  ...
  function fqPolyRepMatrix(r::Int, c::Int, d::fqPolyRepFieldElem)
    ...
    ccall((:fq_nmod_mat_init, libflint), Nothing, (Ref{fqPolyRepMatrix}, Int, Int, Ref{fqPolyRepField}), z, r, c, ctx)
    for i in 1:min(r, c)
      ccall((:fq_nmod_mat_entry_set, libflint), Nothing, (Ref{fqPolyRepMatrix}, Int, Int, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), z, i - 1, i - 1, d, ctx)
    end
    z.base_ring = ctx
    finalizer(_fq_nmod_mat_clear_fn, z)
    return z
  ...
  function fqPolyRepMatrix(m::ZZMatrix, ctx::fqPolyRepField)
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el1 = ccall((:fq_nmod_mat_entry, libflint), Ptr{fqPolyRepFieldElem}, (Ref{fqPolyRepMatrix}, Int, Int), z, i - 1, j - 1)
        el2 = ccall((:fmpz_mat_entry, libflint), Ptr{ZZRingElem}, (Ref{ZZMatrix}, Int, Int), m, i - 1, j - 1)

        ccall((:fq_nmod_set_fmpz, libflint), Nothing, (Ptr{fqPolyRepFieldElem}, Ptr{ZZRingElem}, Ref{fqPolyRepField}), el1, el2, ctx)
      end
    end
    z.base_ring = ctx
    finalizer(_fq_nmod_mat_clear_fn, z)
...
const FlintMPolyUnion = Union{ZZMPolyRingElem,QQMPolyRingElem,zzModMPolyRingElem,fpMPolyRingElem,fqPolyRepMPolyRingElem,FpMPolyRingElem}

const _fq_default_mpoly_union = Union{
  AbstractAlgebra.Generic.MPoly{FqPolyRepFieldElem},
...
const FqDefaultMPolyID = CacheDictType{Tuple{FqField,Vector{Symbol},Symbol},FqMPolyRing}()
...
macro fq_default_mpoly_do_op(f, R, a...)
  ...
  res = nothing
  for (tnum, T) in ((1, :(AbstractAlgebra.Generic.MPoly{FqPolyRepFieldElem})), (2, :(fqPolyRepMPolyRingElem)), (3, :(fpMPolyRingElem)))

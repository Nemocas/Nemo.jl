...
function normalise(a::FqAbsPowerSeriesRingElem, len::Int)
  ...
  if len > 0
    c = base_ring(a)()
    ccall((:fq_default_poly_get_coeff, libflint), Nothing, (Ref{FqFieldElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), c, a, len - 1, ctx)
  end
...
function length(x::FqAbsPowerSeriesRingElem)
  return ccall((:fq_default_poly_length, libflint), Int, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqField}), x, base_ring(x))
end
...
function coeff(x::FqAbsPowerSeriesRingElem, n::Int)
  ...
  z = base_ring(x)()
  ccall((:fq_default_poly_get_coeff, libflint), Nothing, (Ref{FqFieldElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, x, n, base_ring(x))
  return z
end
...
function is_gen(a::FqAbsPowerSeriesRingElem)
  return precision(a) == 0 || ccall((:fq_default_poly_is_gen, libflint), Bool, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqField}), a, base_ring(a))
end
...
function isone(a::FqAbsPowerSeriesRingElem)
  return precision(a) == 0 || ccall((:fq_default_poly_is_one, libflint), Bool, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqField}), a, base_ring(a))
end
...
function similar(f::AbsPowerSeriesRingElem, R::FqField, max_prec::Int, var::Symbol=var(parent(f)); cached::Bool=true)
...
function abs_series(R::FqField, arr::Vector{T}, len::Int, prec::Int, var::VarName=:x; max_precision::Int=prec, cached::Bool=true) where {T}
...
function -(x::FqAbsPowerSeriesRingElem)
  z = parent(x)()
  ccall((:fq_default_poly_neg, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Ref{FqField}), z, x, base_ring(x))
  z.prec = x.prec
  return z
end
...
function +(a::FqAbsPowerSeriesRingElem, b::FqAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = prec
  ccall((:fq_default_poly_add_series, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, a, b, lenz, base_ring(a))
  return z
end
...
function -(a::FqAbsPowerSeriesRingElem, b::FqAbsPowerSeriesRingElem)
  ...
  z = parent(a)()
  z.prec = prec
  ccall((:fq_default_poly_sub_series, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, a, b, lenz, base_ring(a))
  return z
end
...
function *(a::FqAbsPowerSeriesRingElem, b::FqAbsPowerSeriesRingElem)
  ...
  ccall((:fq_default_poly_mullow, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, a, b, lenz, base_ring(a))
  return z
end
...
function *(x::FqFieldElem, y::FqAbsPowerSeriesRingElem)
  z = parent(y)()
  z.prec = y.prec
  ccall((:fq_default_poly_scalar_mul_fq_default, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Ref{FqFieldElem}, Ref{FqField}), z, y, x, base_ring(y))
  return z
end
...
function shift_left(x::FqAbsPowerSeriesRingElem, len::Int)
  ...
  ccall((:fq_default_poly_shift_left, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, x, len, base_ring(x))
  ccall((:fq_default_poly_set_trunc, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, z, zlen, base_ring(x))
  return z
end
...
function shift_right(x::FqAbsPowerSeriesRingElem, len::Int)
  ...
  if len >= xlen
    ...
    z.prec = x.prec - len
    ccall((:fq_default_poly_shift_right, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, x, len, base_ring(x))
  end
  return z
end
...
function truncate(x::FqAbsPowerSeriesRingElem, prec::Int)
  ...
  z = parent(x)()
  z.prec = prec
  ccall((:fq_default_poly_set_trunc, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, x, prec, base_ring(x))
  return z
end
...
function ==(x::FqAbsPowerSeriesRingElem, y::FqAbsPowerSeriesRingElem)
  ...
  n = min(n, prec)
  return Bool(ccall((:fq_default_poly_equal_trunc, libflint), Cint, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), x, y, n, base_ring(x)))
end
...
function isequal(x::FqAbsPowerSeriesRingElem, y::FqAbsPowerSeriesRingElem)
  ...
  return Bool(ccall((:fq_default_poly_equal, libflint), Cint, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Ref{FqField}), x, y, base_ring(x)))
end
...
function ==(x::FqAbsPowerSeriesRingElem, y::FqFieldElem)
  ...
  elseif length(x) == 1
    z = base_ring(x)()
    ccall((:fq_default_poly_get_coeff, libflint), Nothing, (Ref{FqFieldElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, x, 0, base_ring(x))
    return z == y
  else
...
function divexact(x::FqAbsPowerSeriesRingElem, y::FqAbsPowerSeriesRingElem; check::Bool=true)
  ...
  z = parent(x)()
  z.prec = prec
  ccall((:fq_default_poly_div_series, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, x, y, prec, base_ring(x))
  return z
end
...
function divexact(x::FqAbsPowerSeriesRingElem, y::FqFieldElem; check::Bool=true)
  ...
  z = parent(x)()
  z.prec = x.prec
  ccall((:fq_default_poly_scalar_div_fq_default, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Ref{FqFieldElem}, Ref{FqField}), z, x, y, base_ring(x))
  return z
end
...
function inv(a::FqAbsPowerSeriesRingElem)
  ...
  ainv = parent(a)()
  ainv.prec = a.prec
  ccall((:fq_default_poly_inv_series, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), ainv, a, a.prec, base_ring(a))
  return ainv
end
...
function sqrt_classical_char2(a::FqAbsPowerSeriesRingElem; check::Bool=true)
  ...
  if check
    for i in 1:2:(precision(a) - 1) # series must have even exponents
      if !iszero(coeff(a, i))
        return false, S()
      end
    end
...
function sqrt_classical(a::FqAbsPowerSeriesRingElem; check::Bool=true)
  ...
  a = divexact(a, c)
  z.prec = a.prec - div(v, 2)
  ccall((:fq_default_poly_sqrt_series, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, a, a.prec, base_ring(a))
  if !isone(s)
    z *= s
  end
  if !iszero(v)
...
function zero!(z::FqAbsPowerSeriesRingElem)
  ccall((:fq_default_poly_zero, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqField}), z, base_ring(z))
  z.prec = parent(z).prec_max
  return z
end

function fit!(z::FqAbsPowerSeriesRingElem, n::Int)
  ccall((:fq_default_poly_fit_length, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, n, base_ring(z))
  return nothing
end

function setcoeff!(z::FqAbsPowerSeriesRingElem, n::Int, x::FqFieldElem)
  ccall((:fq_default_poly_set_coeff, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqFieldElem}, Ref{FqField}), z, n, x, base_ring(z))
  return z
end
...
function mul!(z::FqAbsPowerSeriesRingElem, a::FqAbsPowerSeriesRingElem, b::FqAbsPowerSeriesRingElem)
  ...
  z.prec = prec
  ccall((:fq_default_poly_mullow, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), z, a, b, lenz, base_ring(z))
  return z
end
...
function addeq!(a::FqAbsPowerSeriesRingElem, b::FqAbsPowerSeriesRingElem)
  ...
  lenz = max(lena, lenb)
  a.prec = prec
  ccall((:fq_default_poly_add_series, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), a, a, b, lenz, base_ring(a))
  return a
end
...
function add!(c::FqAbsPowerSeriesRingElem, a::FqAbsPowerSeriesRingElem, b::FqAbsPowerSeriesRingElem)
  ...
  lenc = max(lena, lenb)
  c.prec = prec
  ccall((:fq_default_poly_add_series, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), c, a, b, lenc, base_ring(a))
  return c
end

function set_length!(a::FqAbsPowerSeriesRingElem, n::Int64)
  ccall((:_fq_default_poly_set_length, libflint), Nothing, (Ref{FqAbsPowerSeriesRingElem}, Int, Ref{FqField}), a, n, base_ring(a))
  return a
end

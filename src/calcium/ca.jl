...
function deepcopy_internal(a::CalciumFieldElem, dict::IdDict)
  C = a.parent
  r = C()
  ccall((:ca_set, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  return r
end
...
function same_parent(a::CalciumFieldElem, b::CalciumFieldElem)
  if a.parent == b.parent
    ...
    C = a.parent
    r = C()
    ccall((:ca_transfer, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumField}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a.parent, b, b.parent)
    check_special(r)
    return (a, r)
  end
end
...
function native_string(x::CalciumFieldElem)
  cstr = ccall((:ca_get_str, libflint), Ptr{UInt8}, (Ref{CalciumFieldElem}, Ref{CalciumField}), x, x.parent)
...
function rand(C::CalciumField; depth::Int, bits::Int, randtype::Symbol=:null)
  ...
  if randtype == :null
    ccall((:ca_randtest, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{rand_ctx}, Int, Int, Ref{CalciumField}), x, state, depth, bits, C)
  elseif randtype == :rational
    ccall((:ca_randtest_rational, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{rand_ctx}, Int, Ref{CalciumField}), x, state, bits, C)
  elseif randtype == :special
    ccall((:ca_randtest_special, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{rand_ctx}, Int, Int, Ref{CalciumField}), x, state, depth, bits, C)
  else
...
function ==(a::CalciumFieldElem, b::CalciumFieldElem)
  a, b = same_parent(a, b)
  C = a.parent
  t = ccall((:ca_check_equal, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), a, b, C)
...
function isless(a::CalciumFieldElem, b::CalciumFieldElem)
  a, b = same_parent(a, b)
  C = a.parent
  t = ccall((:ca_check_lt, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), a, b, C)
...
function is_number(a::CalciumFieldElem)
  C = a.parent
  t = ccall((:ca_check_is_number, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumField}), a, C)
...
function iszero(a::CalciumFieldElem)
  C = a.parent
  t = ccall((:ca_check_is_zero, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumField}), a, C)
...
function isone(a::CalciumFieldElem)
  C = a.parent
  t = ccall((:ca_check_is_one, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumField}), a, C)
...
function is_algebraic(a::CalciumFieldElem)
  C = a.parent
  t = ccall((:ca_check_is_algebraic, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumField}), a, C)
...
function is_rational(a::CalciumFieldElem)
  C = a.parent
  t = ccall((:ca_check_is_rational, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumField}), a, C)
...
function isinteger(a::CalciumFieldElem)
  C = a.parent
  t = ccall((:ca_check_is_integer, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumField}), a, C)
...
function isreal(a::CalciumFieldElem)
  C = a.parent
  t = ccall((:ca_check_is_real, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumField}), a, C)
...
function is_imaginary(a::CalciumFieldElem)
  C = a.parent
  t = ccall((:ca_check_is_imaginary, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumField}), a, C)
...
function is_undefined(a::CalciumFieldElem)
  C = a.parent
  t = ccall((:ca_check_is_undefined, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumField}), a, C)
...
function isinf(a::CalciumFieldElem)
  C = a.parent
  t = ccall((:ca_check_is_infinity, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumField}), a, C)
...
function is_uinf(a::CalciumFieldElem)
  C = a.parent
  t = ccall((:ca_check_is_uinf, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumField}), a, C)
...
function is_signed_inf(a::CalciumFieldElem)
  C = a.parent
  t = ccall((:ca_check_is_signed_inf, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumField}), a, C)
...
function is_unknown(a::CalciumFieldElem)
  C = a.parent
  t = Bool(ccall((:ca_is_unknown, libflint), Cint, (Ref{CalciumFieldElem}, Ref{CalciumField}), a, C))
  return t
end
...
function -(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_neg, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function +(a::CalciumFieldElem, b::CalciumFieldElem)
  ...
  C = a.parent
  r = C()
  ccall((:ca_add, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function -(a::Int, b::CalciumFieldElem)
  C = b.parent
  r = C()
  ccall((:ca_si_sub, libflint), Nothing, (Ref{CalciumFieldElem}, Int, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function *(a::CalciumFieldElem, b::CalciumFieldElem)
  ...
  C = a.parent
  r = C()
  ccall((:ca_mul, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function +(a::CalciumFieldElem, b::Int)
  C = a.parent
  r = C()
  ccall((:ca_add_si, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Int, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function +(a::CalciumFieldElem, b::ZZRingElem)
  C = a.parent
  r = C()
  ccall((:ca_add_fmpz, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{ZZRingElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function +(a::CalciumFieldElem, b::QQFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_add_fmpq, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{QQFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function -(a::CalciumFieldElem, b::CalciumFieldElem)
  ...
  C = a.parent
  r = C()
  ccall((:ca_sub, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function -(a::CalciumFieldElem, b::Int)
  C = a.parent
  r = C()
  ccall((:ca_sub_si, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Int, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function -(a::CalciumFieldElem, b::ZZRingElem)
  C = a.parent
  r = C()
  ccall((:ca_sub_fmpz, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{ZZRingElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function -(a::CalciumFieldElem, b::QQFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_sub_fmpq, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{QQFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function -(a::ZZRingElem, b::CalciumFieldElem)
  C = b.parent
  r = C()
  ccall((:ca_fmpz_sub, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{ZZRingElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function -(a::QQFieldElem, b::CalciumFieldElem)
  C = b.parent
  r = C()
  ccall((:ca_fmpq_sub, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{QQFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function *(a::CalciumFieldElem, b::Int)
  C = a.parent
  r = C()
  ccall((:ca_mul_si, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Int, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function *(a::CalciumFieldElem, b::ZZRingElem)
  C = a.parent
  r = C()
  ccall((:ca_mul_fmpz, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{ZZRingElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function *(a::CalciumFieldElem, b::QQFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_mul_fmpq, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{QQFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function //(a::CalciumFieldElem, b::CalciumFieldElem)
  ...
  C = a.parent
  r = C()
  ccall((:ca_div, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function inv(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_inv, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function //(a::CalciumFieldElem, b::Int)
  C = a.parent
  r = C()
  ccall((:ca_div_si, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Int, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function //(a::CalciumFieldElem, b::ZZRingElem)
  C = a.parent
  r = C()
  ccall((:ca_div_fmpz, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{ZZRingElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function //(a::CalciumFieldElem, b::QQFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_div_fmpq, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{QQFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function //(a::Int, b::CalciumFieldElem)
  C = b.parent
  r = C()
  ccall((:ca_si_div, libflint), Nothing, (Ref{CalciumFieldElem}, Int, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function //(a::ZZRingElem, b::CalciumFieldElem)
  C = b.parent
  r = C()
  ccall((:ca_fmpz_div, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{ZZRingElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function //(a::QQFieldElem, b::CalciumFieldElem)
  C = b.parent
  r = C()
  ccall((:ca_fmpq_div, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{QQFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function ^(a::CalciumFieldElem, b::CalciumFieldElem)
  ...
  C = a.parent
  r = C()
  ccall((:ca_pow, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function ^(a::CalciumFieldElem, b::Int)
  C = a.parent
  r = C()
  ccall((:ca_pow_si, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Int, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function ^(a::CalciumFieldElem, b::ZZRingElem)
  C = a.parent
  r = C()
  ccall((:ca_pow_fmpz, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{ZZRingElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function ^(a::CalciumFieldElem, b::QQFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_pow_fmpq, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{QQFieldElem}, Ref{CalciumField}), r, a, b, C)
  check_special(r)
  return r
end
...
function unsigned_infinity(C::CalciumField)
  r = C()
  ccall((:ca_uinf, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumField}), r, C)
  check_special(r)
  return r
end
...
function infinity(C::CalciumField)
  r = C()
  ccall((:ca_pos_inf, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumField}), r, C)
  check_special(r)
  return r
end
...
function undefined(C::CalciumField)
  r = C()
  ccall((:ca_undefined, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumField}), r, C)
  check_special(r)
  return r
end
...
function unknown(C::CalciumField)
  r = C()
  ccall((:ca_unknown, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumField}), r, C)
  check_special(r)
  return r
end
...
function real(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_re, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function imag(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_im, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function angle(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_arg, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function csgn(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_csgn, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function sign(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_sgn, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function abs(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_abs, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function conj(a::CalciumFieldElem; form::Symbol=:default)
  ...
  r = C()
  if form == :default
    ccall((:ca_conj, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  elseif form == :deep
    ccall((:ca_conj_deep, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  elseif form == :shallow
    ccall((:ca_conj_shallow, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  else
...
function floor(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_floor, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function ceil(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_ceil, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function Base.sqrt(a::CalciumFieldElem; check::Bool=true)
  C = a.parent
  r = C()
  ccall((:ca_sqrt, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function exp(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_exp, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function log(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_log, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function pow(a::CalciumFieldElem, b::Int; form::Symbol=:default)
  ...
  elseif form == :arithmetic
    ccall((:ca_pow_si_arithmetic, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Int, Ref{CalciumField}), r, a, b, C)
  else
    error("unknown form: ", form)
  end
  check_special(r)
...
function sin(a::CalciumFieldElem; form::Symbol=:default)
  ...
  r = C()
  if form == :default
    ccall((:ca_sin, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  elseif form == :exponential
    ccall((:ca_sin_cos_exponential, libflint), Nothing, (Ref{CalciumFieldElem}, Ptr{Nothing}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, C_NULL, a, C)
  elseif form == :tangent
    ccall((:ca_sin_cos_tangent, libflint), Nothing, (Ref{CalciumFieldElem}, Ptr{Nothing}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, C_NULL, a, C)
  elseif form == :direct
    ccall((:ca_sin_cos_direct, libflint), Nothing, (Ref{CalciumFieldElem}, Ptr{Nothing}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, C_NULL, a, C)
  else
    error("unknown form: ", form)
  end
  check_special(r)
...
function cos(a::CalciumFieldElem; form::Symbol=:default)
  ...
  r = C()
  if form == :default
    ccall((:ca_cos, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  elseif form == :exponential
    ccall((:ca_sin_cos_exponential, libflint), Nothing, (Ptr{Nothing}, Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), C_NULL, r, a, C)
  elseif form == :tangent
    ccall((:ca_sin_cos_tangent, libflint), Nothing, (Ptr{Nothing}, Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), C_NULL, r, a, C)
  elseif form == :direct || form == :sine_cosine
    ccall((:ca_sin_cos_direct, libflint), Nothing, (Ptr{Nothing}, Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), C_NULL, r, a, C)
  else
    error("unknown form: ", form)
  end
  check_special(r)
...
function tan(a::CalciumFieldElem; form::Symbol=:default)
  ...
  r = C()
  if form == :default
    ccall((:ca_tan, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  elseif form == :exponential
    ccall((:ca_tan_exponential, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  elseif form == :direct || form == :tangent
    ccall((:ca_tan_direct, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  elseif form == :sine_cosine
    ccall((:ca_tan_sine_cosine, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  else
    error("unknown form: ", form)
  end
  check_special(r)
...
function atan(a::CalciumFieldElem; form::Symbol=:default)
  ...
  r = C()
  if form == :default
    ccall((:ca_atan, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  elseif form == :logarithm
    ccall((:ca_atan_logarithm, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  elseif form == :direct || form == :arctangent
    ccall((:ca_atan_direct, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  else
    error("unknown form: ", form)
  end
  check_special(r)
...
function asin(a::CalciumFieldElem; form::Symbol=:default)
  ...
  r = C()
  if form == :default
    ccall((:ca_asin, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  elseif form == :logarithm
    ccall((:ca_asin_logarithm, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  elseif form == :direct
    ccall((:ca_asin_direct, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  else
    error("unknown form: ", form)
  end
  check_special(r)
...
function acos(a::CalciumFieldElem; form::Symbol=:default)
  ...
  r = C()
  if form == :default
    ccall((:ca_acos, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  elseif form == :logarithm
    ccall((:ca_acos_logarithm, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  elseif form == :direct
    ccall((:ca_acos_direct, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  else
    error("unknown form: ", form)
  end
  check_special(r)
...
function gamma(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_gamma, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function erf(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_erf, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function erfi(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_erfi, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function erfc(a::CalciumFieldElem)
  C = a.parent
  r = C()
  ccall((:ca_erfc, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, a, C)
  check_special(r)
  return r
end
...
function complex_normal_form(a::CalciumFieldElem; deep::Bool=true)
  C = a.parent
  r = C()
  ccall((:ca_rewrite_complex_normal_form, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Cint, Ref{CalciumField}), r, a, deep, C)
  check_special(r)
  return r
end
...
function QQFieldElem(a::CalciumFieldElem)
  C = a.parent
  res = QQFieldElem()
  ok = Bool(ccall((:ca_get_fmpq, libflint), Cint, (Ref{QQFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), res, a, C))
...
function ZZRingElem(a::CalciumFieldElem)
  C = a.parent
  res = ZZRingElem()
  ok = Bool(ccall((:ca_get_fmpz, libflint), Cint, (Ref{ZZRingElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), res, a, C))
...
function QQBarFieldElem(a::CalciumFieldElem)
  C = a.parent
  res = QQBarFieldElem()
  ok = Bool(ccall((:ca_get_qqbar, libflint), Cint, (Ref{QQBarFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), res, a, C))
...
function (R::AcbField)(a::CalciumFieldElem; parts::Bool=false)
  ...
  z = R()
  if parts
    ccall((:ca_get_acb_accurate_parts, libflint), Nothing, (Ref{AcbFieldElem}, Ref{CalciumFieldElem}, Int, Ref{CalciumField}), z, a, prec, C)
  else
    ccall((:ca_get_acb, libflint), Nothing, (Ref{AcbFieldElem}, Ref{CalciumFieldElem}, Int, Ref{CalciumField}), z, a, prec, C)
  end
  return z
end
...
function mul!(z::CalciumFieldElem, x::CalciumFieldElem, y::CalciumFieldElem)
  ...
  C = z.parent
  ccall((:ca_mul, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), z, x, y, C)
  check_special(z)
  return z
end
...
function addeq!(z::CalciumFieldElem, x::CalciumFieldElem)
  ...
  C = z.parent
  ccall((:ca_add, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), z, z, x, C)
  check_special(z)
  return z
end
...
function add!(z::CalciumFieldElem, x::CalciumFieldElem, y::CalciumFieldElem)
  ...
  C = z.parent
  ccall((:ca_add, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumFieldElem}, Ref{CalciumField}), z, x, y, C)
  check_special(z)
  return z
end
...
function (C::CalciumField)(v::CalciumFieldElem)
  ...
  r = C()
  ccall((:ca_transfer, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{CalciumField}, Ref{CalciumFieldElem}, Ref{CalciumField}), r, C, v, D)
  check_special(r)
  return r
end
...
function (C::CalciumField)(v::Int)
  z = CalciumFieldElem(C)
  ccall((:ca_set_si, libflint), Nothing, (Ref{CalciumFieldElem}, Int, Ref{CalciumField}), z, v, C)
  return z
end

function (C::CalciumField)(v::ZZRingElem)
  z = CalciumFieldElem(C)
  ccall((:ca_set_fmpz, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{ZZRingElem}, Ref{CalciumField}), z, v, C)
  return z
end

function (C::CalciumField)(v::QQFieldElem)
  z = CalciumFieldElem(C)
  ccall((:ca_set_fmpq, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{QQFieldElem}, Ref{CalciumField}), z, v, C)
  return z
end

function (C::CalciumField)(v::QQBarFieldElem)
  z = CalciumFieldElem(C)
  ccall((:ca_set_qqbar, libflint), Nothing, (Ref{CalciumFieldElem}, Ref{QQBarFieldElem}, Ref{CalciumField}), z, v, C)
  return z
end

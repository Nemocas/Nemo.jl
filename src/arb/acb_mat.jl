...
function zero!(z::AcbMatrix)
  ccall((:acb_mat_zero, libflint), Nothing, (Ref{AcbMatrix},), z)
  return z
end

function one!(z::AcbMatrix)
  ccall((:acb_mat_one, libflint), Nothing, (Ref{AcbMatrix},), z)
  return z
end

function neg!(z::AcbMatrix, a::AcbMatrix)
  ccall((:acb_mat_neg, libflint), Nothing, (Ref{AcbMatrix}, Ref{AcbMatrix}), z, a)
  return z
end

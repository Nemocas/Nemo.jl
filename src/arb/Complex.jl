...
for (s, f) in ((:+, "acb_add"), (:*, "acb_mul"), (://, "acb_div"), (:-, "acb_sub"), (:^, "acb_pow"))
  @eval begin
    function ($s)(x::ComplexFieldElem, y::ComplexFieldElem, prec::Int=precision(Balls))
      z = ComplexFieldElem()
      ccall(($f, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, x, y, prec)
      return z
    end
  end
end
...
for (f, s) in ((:+, "add"), (:-, "sub"), (:*, "mul"), (://, "div"), (:^, "pow"))
  @eval begin
    function ($f)(x::ComplexFieldElem, y::UInt, prec::Int=precision(Balls))
      z = ComplexFieldElem()
      ccall(($("acb_" * s * "_ui"), libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, UInt, Int), z, x, y, prec)
      return z
    end

    function ($f)(x::ComplexFieldElem, y::Int, prec::Int=precision(Balls))
      z = ComplexFieldElem()
      ccall(($("acb_" * s * "_si"), libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int, Int), z, x, y, prec)
      return z
    end

    function ($f)(x::ComplexFieldElem, y::ZZRingElem, prec::Int=precision(Balls))
      z = ComplexFieldElem()
      ccall(($("acb_" * s * "_fmpz"), libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ZZRingElem}, Int), z, x, y, prec)
      return z
    end

    function ($f)(x::ComplexFieldElem, y::RealFieldElem, prec::Int=precision(Balls))
      z = ComplexFieldElem()
      ccall(($("acb_" * s * "_arb"), libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{RealFieldElem}, Int), z, x, y, prec)
      return z
    end
  end
end
...
function abs(x::ComplexFieldElem, prec::Int=precision(Balls))
  z = RealFieldElem()
  ccall((:acb_abs, libflint), Nothing, (Ref{RealFieldElem}, Ref{ComplexFieldElem}, Int), z, x, prec)
  return z
end
...
function ldexp(x::ComplexFieldElem, y::Int)
  z = ComplexFieldElem()
  ccall((:acb_mul_2exp_si, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, x, y)
  return z
end

function ldexp(x::ComplexFieldElem, y::ZZRingElem)
  z = ComplexFieldElem()
  ccall((:acb_mul_2exp_fmpz, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ZZRingElem}), z, x, y)
  return z
end
...
function unique_integer(x::ComplexFieldElem)
  z = ZZRingElem()
  unique = ccall((:acb_get_unique_fmpz, libflint), Int, (Ref{ZZRingElem}, Ref{ComplexFieldElem}), z, x)
  return (unique != 0, z)
end
...
function angle(x::ComplexFieldElem, prec::Int=precision(Balls))
  z = RealFieldElem()
  ccall((:acb_arg, libflint), Nothing, (Ref{RealFieldElem}, Ref{ComplexFieldElem}, Int), z, x, prec)
  return z
end
...
function eisenstein_g(k::Int, x::ComplexFieldElem, prec::Int=precision(Balls))
  ...
  len = div(k, 2) - 1
  vec = acb_vec(len)
  ccall((:acb_modular_eisenstein, libflint), Nothing, (Ptr{acb_struct}, Ref{ComplexFieldElem}, Int, Int), vec, x, len, prec)
  z = array(CC, vec, len)
...
function hilbert_class_polynomial(D::Int, R::ZZPolyRing)
  ...
  z = R()
  ccall((:acb_modular_hilbert_class_poly, Nemo.libflint), Nothing, (Ref{ZZPolyRingElem}, Int), z, D)
  return z
end
...
function sincos(x::ComplexFieldElem, prec::Int=precision(Balls))
  s = ComplexFieldElem()
  c = ComplexFieldElem()
  ccall((:acb_sin_cos, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), s, c, x, prec)
  return (s, c)
end
...
function sincospi(x::ComplexFieldElem, prec::Int=precision(Balls))
  s = ComplexFieldElem()
  c = ComplexFieldElem()
  ccall((:acb_sin_cos_pi, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), s, c, x, prec)
  return (s, c)
end
...
function sinhcosh(x::ComplexFieldElem, prec::Int=precision(Balls))
  s = ComplexFieldElem()
  c = ComplexFieldElem()
  ccall((:acb_sinh_cosh, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), s, c, x, prec)
  return (s, c)
end
...
function zeta(s::ComplexFieldElem, a::ComplexFieldElem, prec::Int=precision(Balls))
  z = parent(s)()
  ccall((:acb_hurwitz_zeta, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, s, a, prec)
  return z
end
...
function polygamma(s::ComplexFieldElem, a::ComplexFieldElem, prec::Int=precision(Balls))
  z = parent(s)()
  ccall((:acb_polygamma, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, s, a, prec)
  return z
end

function rising_factorial(x::ComplexFieldElem, n::UInt, prec::Int=precision(Balls))
  z = ComplexFieldElem()
  ccall((:acb_rising_ui, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, UInt, Int), z, x, n, prec)
  return z
end
...
function rising_factorial2(x::ComplexFieldElem, n::UInt, prec::Int=precision(Balls))
  z = ComplexFieldElem()
  w = ComplexFieldElem()
  ccall((:acb_rising2_ui, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, UInt, Int), z, w, x, n, prec)
  return (z, w)
end
...
function polylog(s::ComplexFieldElem, a::ComplexFieldElem, prec::Int=precision(Balls))
  z = parent(s)()
  ccall((:acb_polylog, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, s, a, prec)
  return z
end

function polylog(s::Int, a::ComplexFieldElem, prec::Int=precision(Balls))
  z = parent(a)()
  ccall((:acb_polylog_si, libflint), Nothing, (Ref{ComplexFieldElem}, Int, Ref{ComplexFieldElem}, Int), z, s, a, prec)
  return z
end
...
function log_integral(x::ComplexFieldElem, prec::Int=precision(Balls))
  z = ComplexFieldElem()
  ccall((:acb_hypgeom_li, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int, Int), z, x, 0, prec)
  return z
end
...
function log_integral_offset(x::ComplexFieldElem, prec::Int=precision(Balls))
  z = ComplexFieldElem()
  ccall((:acb_hypgeom_li, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int, Int), z, x, 1, prec)
  return z
end
...
function exp_integral_e(s::ComplexFieldElem, x::ComplexFieldElem, prec::Int=precision(Balls))
  z = parent(s)()
  ccall((:acb_hypgeom_expint, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, s, x, prec)
  return z
end
...
function gamma(s::ComplexFieldElem, x::ComplexFieldElem, prec::Int=precision(Balls))
  z = parent(s)()
  ccall((:acb_hypgeom_gamma_upper, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int, Int), z, s, x, 0, prec)
  return z
end
...
function gamma_regularized(s::ComplexFieldElem, x::ComplexFieldElem, prec::Int=precision(Balls))
  z = parent(s)()
  ccall((:acb_hypgeom_gamma_upper, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int, Int), z, s, x, 1, prec)
  return z
end
...
function gamma_lower(s::ComplexFieldElem, x::ComplexFieldElem, prec::Int=precision(Balls))
  z = parent(s)()
  ccall((:acb_hypgeom_gamma_lower, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int, Int), z, s, x, 0, prec)
  return z
end
...
function gamma_lower_regularized(s::ComplexFieldElem, x::ComplexFieldElem, prec::Int=precision(Balls))
  z = parent(s)()
  ccall((:acb_hypgeom_gamma_lower, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int, Int), z, s, x, 1, prec)
  return z
end
...
function bessel_j(nu::ComplexFieldElem, x::ComplexFieldElem, prec::Int=precision(Balls))
  z = ComplexFieldElem()
  ccall((:acb_hypgeom_bessel_j, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, nu, x, prec)
  return z
end
...
function bessel_y(nu::ComplexFieldElem, x::ComplexFieldElem, prec::Int=precision(Balls))
  z = ComplexFieldElem()
  ccall((:acb_hypgeom_bessel_y, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, nu, x, prec)
  return z
end
...
function bessel_i(nu::ComplexFieldElem, x::ComplexFieldElem, prec::Int=precision(Balls))
  z = ComplexFieldElem()
  ccall((:acb_hypgeom_bessel_i, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, nu, x, prec)
  return z
end
...
function bessel_k(nu::ComplexFieldElem, x::ComplexFieldElem, prec::Int=precision(Balls))
  z = ComplexFieldElem()
  ccall((:acb_hypgeom_bessel_k, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, nu, x, prec)
  return z
end
...
function airy_ai(x::ComplexFieldElem, prec::Int=precision(Balls))
  ai = ComplexFieldElem()
  ccall((:acb_hypgeom_airy, libflint), Nothing, (Ref{ComplexFieldElem}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ref{ComplexFieldElem}, Int), ai, C_NULL, C_NULL, C_NULL, x, prec)
  return ai
end
...
function airy_bi(x::ComplexFieldElem, prec::Int=precision(Balls))
  bi = ComplexFieldElem()
  ccall((:acb_hypgeom_airy, libflint), Nothing, (Ptr{Cvoid}, Ptr{Cvoid}, Ref{ComplexFieldElem}, Ptr{Cvoid}, Ref{ComplexFieldElem}, Int), C_NULL, C_NULL, bi, C_NULL, x, prec)
  return bi
end
...
function airy_ai_prime(x::ComplexFieldElem, prec::Int=precision(Balls))
  ...
  ccall((:acb_hypgeom_airy, libflint), Nothing, (Ptr{Cvoid}, Ref{ComplexFieldElem}, Ptr{Cvoid}, Ptr{Cvoid}, Ref{ComplexFieldElem}, Int), C_NULL, ai_prime, C_NULL, C_NULL, x, prec)
  return ai_prime
end
...
function airy_bi_prime(x::ComplexFieldElem, prec::Int=precision(Balls))
  ...
  ccall((:acb_hypgeom_airy, libflint), Nothing, (Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), C_NULL, C_NULL, C_NULL, bi_prime, x, prec)
  return bi_prime
end
...
function hypergeometric_1f1(a::ComplexFieldElem, b::ComplexFieldElem, x::ComplexFieldElem, prec::Int=precision(Balls))
  z = ComplexFieldElem()
  ccall((:acb_hypgeom_m, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int, Int), z, a, b, x, 0, prec)
  return z
end
...
function hypergeometric_1f1_regularized(a::ComplexFieldElem, b::ComplexFieldElem, x::ComplexFieldElem, prec::Int=precision(Balls))
  z = ComplexFieldElem()
  ccall((:acb_hypgeom_m, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int, Int), z, a, b, x, 1, prec)
  return z
end
...
function hypergeometric_u(a::ComplexFieldElem, b::ComplexFieldElem, x::ComplexFieldElem, prec::Int=precision(Balls))
  z = ComplexFieldElem()
  ccall((:acb_hypgeom_u, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, a, b, x, prec)
  return z
end
...
function hypergeometric_2f1(a::ComplexFieldElem, b::ComplexFieldElem, c::ComplexFieldElem, x::ComplexFieldElem, prec::Int=precision(Balls); flags=0)
  z = ComplexFieldElem()
  ccall(
    (:acb_hypgeom_2f1, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int, Int), z, a, b, c, x, flags, prec
  )
  return z
end
...
function weierstrass_p(z::ComplexFieldElem, tau::ComplexFieldElem, prec::Int=precision(Balls))
  r = parent(z)()
  ccall((:acb_elliptic_p, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), r, z, tau, prec)
  return r
end
...
function weierstrass_p_prime(z::ComplexFieldElem, tau::ComplexFieldElem, prec::Int=precision(Balls))
  r = parent(z)()
  ccall((:acb_elliptic_p_prime, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), r, z, tau, prec)
  return r
end
...
function add!(z::ComplexFieldElem, x::ComplexFieldElem, y::ComplexFieldElem, prec::Int=precision(Balls))
  ccall((:acb_add, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, x, y, prec)
  return z
end

function addeq!(z::ComplexFieldElem, y::ComplexFieldElem, prec::Int=precision(Balls))
  ccall((:acb_add, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, z, y, prec)
  return z
end

function sub!(z::ComplexFieldElem, x::ComplexFieldElem, y::ComplexFieldElem, prec::Int=precision(Balls))
  ccall((:acb_sub, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, x, y, prec)
  return z
end

function mul!(z::ComplexFieldElem, x::ComplexFieldElem, y::ComplexFieldElem, prec::Int=precision(Balls))
  ccall((:acb_mul, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, x, y, prec)
  return z
end

function div!(z::ComplexFieldElem, x::ComplexFieldElem, y::ComplexFieldElem, prec::Int=precision(Balls))
  ccall((:acb_div, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Int), z, x, y, prec)
  return z
end
...
for (typeofx, passtoc) in ((ComplexFieldElem, Ref{ComplexFieldElem}), (Ptr{ComplexFieldElem}, Ptr{ComplexFieldElem}))
  for (f, t) in (("acb_set_si", Int), ("acb_set_ui", UInt), ("acb_set_d", Float64))
    @eval begin
      ...
      function _acb_set(x::($typeofx), y::($t), p::Int)
        _acb_set(x, y)
        ccall((:acb_set_round, libflint), Nothing, (($passtoc), ($passtoc), Int), x, x, p)
      end
    end
  end
  ...
  @eval begin
    ...
    function _acb_set(x::($typeofx), y::ZZRingElem, p::Int)
      ccall((:acb_set_round_fmpz, libflint), Nothing, (($passtoc), Ref{ZZRingElem}, Int), x, y, p)
    end

    function _acb_set(x::($typeofx), y::QQFieldElem, p::Int)
      ccall((:acb_set_fmpq, libflint), Nothing, (($passtoc), Ref{QQFieldElem}, Int), x, y, p)
    end
    ...
    function _acb_set(x::($typeofx), y::ComplexFieldElem, p::Int)
      ccall((:acb_set_round, libflint), Nothing, (($passtoc), Ref{ComplexFieldElem}, Int), x, y, p)
    end
    ...
    function _acb_set(x::($typeofx), y::Int, z::Int, p::Int)
      ccall((:acb_set_si_si, libflint), Nothing, (($passtoc), Int, Int), x, y, z)
      ccall((:acb_set_round, libflint), Nothing, (($passtoc), ($passtoc), Int), x, x, p)
    end

    function _acb_set(x::($typeofx), y::RealFieldElem, z::RealFieldElem)
      ccall((:acb_set_arb_arb, libflint), Nothing, (($passtoc), Ref{RealFieldElem}, Ref{RealFieldElem}), x, y, z)
    end

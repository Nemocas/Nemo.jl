...
length(x::ArbPolyRingElem) = ccall((:arb_poly_length, libflint), Int, (Ref{ArbPolyRingElem},), x)

function set_length!(x::ArbPolyRingElem, n::Int)
  ccall((:_arb_poly_set_length, libflint), Nothing, (Ref{ArbPolyRingElem}, Int), x, n)
  return x
end
...
function coeff(a::ArbPolyRingElem, n::Int)
  ...
  ccall((:arb_poly_get_coeff_arb, libflint), Nothing, (Ref{ArbFieldElem}, Ref{ArbPolyRingElem}, Int), t, a, n)
  return t
end
...
function gen(a::ArbPolyRing)
  z = ArbPolyRingElem()
  ccall((:arb_poly_set_coeff_si, libflint), Nothing, (Ref{ArbPolyRingElem}, Int, Int), z, 1, 1)
  z.parent = a
  return z
end
...
function isequal(x::ArbPolyRingElem, y::ArbPolyRingElem)
  return ccall((:arb_poly_equal, libflint), Bool, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}), x, y)
end
...
function overlaps(x::ArbPolyRingElem, y::ArbPolyRingElem)
  return ccall((:arb_poly_overlaps, libflint), Bool, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}), x, y)
end
...
function contains(x::ArbPolyRingElem, y::ArbPolyRingElem)
  return ccall((:arb_poly_contains, libflint), Bool, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}), x, y)
end
...
function contains(x::ArbPolyRingElem, y::ZZPolyRingElem)
  return ccall((:arb_poly_contains_fmpz_poly, libflint), Bool, (Ref{ArbPolyRingElem}, Ref{ZZPolyRingElem}), x, y)
end
...
function contains(x::ArbPolyRingElem, y::QQPolyRingElem)
  return ccall((:arb_poly_contains_fmpq_poly, libflint), Bool, (Ref{ArbPolyRingElem}, Ref{QQPolyRingElem}), x, y)
end
...
function unique_integer(x::ArbPolyRingElem)
  ...
  unique = ccall((:arb_poly_get_unique_fmpz_poly, libflint), Int, (Ref{ZZPolyRingElem}, Ref{ArbPolyRingElem}), z, x)
  return (unique != 0, z)
end
...
function shift_left(x::ArbPolyRingElem, len::Int)
  ...
  z = parent(x)()
  ccall((:arb_poly_shift_left, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int), z, x, len)
  return z
end
...
function shift_right(x::ArbPolyRingElem, len::Int)
  len < 0 && throw(DomainError(len, "Shift must be non-negative"))
  z = parent(x)()
  ccall((:arb_poly_shift_right, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int), z, x, len)
  return z
end
...
function +(x::ArbPolyRingElem, y::ArbPolyRingElem)
  z = parent(x)()
  ccall((:arb_poly_add, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int), z, x, y, precision(parent(x)))
  return z
end

function *(x::ArbPolyRingElem, y::ArbPolyRingElem)
  z = parent(x)()
  ccall((:arb_poly_mul, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int), z, x, y, precision(parent(x)))
  return z
end

function -(x::ArbPolyRingElem, y::ArbPolyRingElem)
  z = parent(x)()
  ccall((:arb_poly_sub, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int), z, x, y, precision(parent(x)))
  return z
end
...
function ^(x::ArbPolyRingElem, y::Int)
  ...
  z = parent(x)()
  ccall((:arb_poly_pow_ui, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, UInt, Int), z, x, y, precision(parent(x)))
  return z
end
...
function Base.divrem(x::ArbPolyRingElem, y::ArbPolyRingElem)
  ...
  q = parent(x)()
  r = parent(x)()
  if (ccall((:arb_poly_divrem, libflint), Int, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int), q, r, x, y, precision(parent(x))) == 1)
    return (q, r)
  else
    throw(DivideError())
  end
...
function truncate(a::ArbPolyRingElem, n::Int)
  ...
  z = deepcopy(a)
  ccall((:arb_poly_truncate, libflint), Nothing, (Ref{ArbPolyRingElem}, Int), z, n)
  return z
end
...
function mullow(x::ArbPolyRingElem, y::ArbPolyRingElem, n::Int)
  n < 0 && throw(DomainError(n, "Index must be non-negative"))
  z = parent(x)()
  ccall((:arb_poly_mullow, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int, Int), z, x, y, n, precision(parent(x)))
  return z
end
...
function evaluate(x::ArbPolyRingElem, y::ArbFieldElem)
  z = parent(y)()
  ccall((:arb_poly_evaluate, libflint), Nothing, (Ref{ArbFieldElem}, Ref{ArbPolyRingElem}, Ref{ArbFieldElem}, Int), z, x, y, precision(parent(y)))
  return z
end

function evaluate(x::ArbPolyRingElem, y::AcbFieldElem)
  z = parent(y)()
  ccall((:arb_poly_evaluate_acb, libflint), Nothing, (Ref{AcbFieldElem}, Ref{ArbPolyRingElem}, Ref{AcbFieldElem}, Int), z, x, y, precision(parent(y)))
  return z
end
...
function evaluate2(x::ArbPolyRingElem, y::ArbFieldElem)
  z = parent(y)()
  w = parent(y)()
  ccall((:arb_poly_evaluate2, libflint), Nothing, (Ref{ArbFieldElem}, Ref{ArbFieldElem}, Ref{ArbPolyRingElem}, Ref{ArbFieldElem}, Int), z, w, x, y, precision(parent(y)))
  return z, w
end
...
function evaluate2(x::ArbPolyRingElem, y::AcbFieldElem)
  z = parent(y)()
  w = parent(y)()
  ccall((:arb_poly_evaluate2_acb, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{ArbPolyRingElem}, Ref{AcbFieldElem}, Int), z, w, x, y, precision(parent(y)))
  return z, w
end
...
function AbstractAlgebra._compose_right(x::ArbPolyRingElem, y::ArbPolyRingElem)
  z = parent(x)()
  ccall((:arb_poly_compose, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int), z, x, y, precision(parent(x)))
  return z
end
...
function derivative(x::ArbPolyRingElem)
  z = parent(x)()
  ccall((:arb_poly_derivative, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int), z, x, precision(parent(x)))
  return z
end

function integral(x::ArbPolyRingElem)
  z = parent(x)()
  ccall((:arb_poly_integral, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int), z, x, precision(parent(x)))
  return z
end
...
function arb_vec(b::Vector{ArbFieldElem})
  ...
  for i in 1:length(b)
    ccall((:arb_set, libflint), Nothing, (Ptr{arb_struct}, Ref{ArbFieldElem}), v + (i - 1) * sizeof(arb_struct), b[i])
  end
  return v
end
...
function array(R::ArbField, v::Ptr{arb_struct}, n::Int)
  ...
  for i in 1:n
    r[i] = R()
    ccall((:arb_set, libflint), Nothing, (Ref{ArbFieldElem}, Ptr{arb_struct}), r[i], v + (i - 1) * sizeof(arb_struct))
  end
  return r
end
...
function from_roots(R::ArbPolyRing, b::Vector{ArbFieldElem})
  z = R()
  tmp = arb_vec(b)
  ccall((:arb_poly_product_roots, libflint), Nothing, (Ref{ArbPolyRingElem}, Ptr{arb_struct}, Int, Int), z, tmp, length(b), precision(R))
  arb_vec_clear(tmp, length(b))
  return z
end

function evaluate_iter(x::ArbPolyRingElem, b::Vector{ArbFieldElem})
  return ArbFieldElem[evaluate(x, b[i]) for i in 1:length(b)]
end

function evaluate_fast(x::ArbPolyRingElem, b::Vector{ArbFieldElem})
  tmp = arb_vec(b)
  ccall((:arb_poly_evaluate_vec_fast, libflint), Nothing, (Ptr{arb_struct}, Ref{ArbPolyRingElem}, Ptr{arb_struct}, Int, Int), tmp, x, tmp, length(b), precision(parent(x)))
...
function interpolate_newton(R::ArbPolyRing, xs::Vector{ArbFieldElem}, ys::Vector{ArbFieldElem})
  ...
  xsv = arb_vec(xs)
  ysv = arb_vec(ys)
  ccall((:arb_poly_interpolate_newton, libflint), Nothing, (Ref{ArbPolyRingElem}, Ptr{arb_struct}, Ptr{arb_struct}, Int, Int), z, xsv, ysv, length(xs), precision(R))
...
function interpolate_barycentric(R::ArbPolyRing, xs::Vector{ArbFieldElem}, ys::Vector{ArbFieldElem})
  ...
  xsv = arb_vec(xs)
  ysv = arb_vec(ys)
  ccall((:arb_poly_interpolate_barycentric, libflint), Nothing, (Ref{ArbPolyRingElem}, Ptr{arb_struct}, Ptr{arb_struct}, Int, Int), z, xsv, ysv, length(xs), precision(R))
  arb_vec_clear(xsv, length(xs))
  arb_vec_clear(ysv, length(ys))
  return z
end
...
function interpolate_fast(R::ArbPolyRing, xs::Vector{ArbFieldElem}, ys::Vector{ArbFieldElem})
  ...
  xsv = arb_vec(xs)
  ysv = arb_vec(ys)
  ccall((:arb_poly_interpolate_fast, libflint), Nothing, (Ref{ArbPolyRingElem}, Ptr{arb_struct}, Ptr{arb_struct}, Int, Int), z, xsv, ysv, length(xs), precision(R))
  arb_vec_clear(xsv, length(xs))
  arb_vec_clear(ysv, length(ys))
  return z
end
...
function roots_upper_bound(x::ArbPolyRingElem)
  ...
  GC.@preserve x z begin
    ...
    ccall((:arb_poly_root_bound_fujiwara, libflint), Nothing, (Ptr{mag_struct}, Ref{ArbPolyRingElem}), t, x)
...
function zero!(z::ArbPolyRingElem)
  ccall((:arb_poly_zero, libflint), Nothing, (Ref{ArbPolyRingElem},), z)
  return z
end

function fit!(z::ArbPolyRingElem, n::Int)
  ccall((:arb_poly_fit_length, libflint), Nothing, (Ref{ArbPolyRingElem}, Int), z, n)
  return nothing
end

function setcoeff!(z::ArbPolyRingElem, n::Int, x::ZZRingElem)
  ccall((:arb_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ArbPolyRingElem}, Int, Ref{ZZRingElem}), z, n, x)
  return z
end

function setcoeff!(z::ArbPolyRingElem, n::Int, x::ArbFieldElem)
  ccall((:arb_poly_set_coeff_arb, libflint), Nothing, (Ref{ArbPolyRingElem}, Int, Ref{ArbFieldElem}), z, n, x)
  return z
end

function mul!(z::ArbPolyRingElem, x::ArbPolyRingElem, y::ArbPolyRingElem)
  ccall((:arb_poly_mul, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int), z, x, y, precision(parent(z)))
  return z
end

function addeq!(z::ArbPolyRingElem, x::ArbPolyRingElem)
  ccall((:arb_poly_add, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int), z, z, x, precision(parent(z)))
  return z
end

function add!(z::ArbPolyRingElem, x::ArbPolyRingElem, y::ArbPolyRingElem)
  ccall((:arb_poly_add, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int), z, x, y, precision(parent(z)))
  return z
end

...
function getindex!(z::ArbFieldElem, x::RealMat, r::Int, c::Int)
  GC.@preserve x begin
    v = ccall((:arb_mat_entry_ptr, libflint), Ptr{RealFieldElem}, (Ref{RealMat}, Int, Int), x, r - 1, c - 1)
...
for T in [Int, UInt, ZZRingElem, QQFieldElem, Float64, BigFloat, RealFieldElem, AbstractString]
  @eval begin
    @inline function setindex!(x::RealMat, y::$T, r::Int, c::Int)
      ...
      GC.@preserve x begin
        z = ccall((:arb_mat_entry_ptr, libflint), Ptr{RealFieldElem}, (Ref{RealMat}, Int, Int), x, r - 1, c - 1)
...
Base.@propagate_inbounds setindex!(x::RealMat, y::Integer, r::Int, c::Int) = setindex!(x, ZZRingElem(y), r, c)

Base.@propagate_inbounds setindex!(x::RealMat, y::Rational{T}, r::Int, c::Int) where {T<:Integer} = setindex!(x, ZZRingElem(y), r, c)
...
function transpose(x::RealMat)
  ...
  ccall((:arb_mat_transpose, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}), z, x)
  return z
end
...
function +(x::RealMat, y::RealMat)
  check_parent(x, y)
  z = similar(x)
  ccall((:arb_mat_add, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}, Ref{RealMat}, Int), z, x, y, precision(Balls))
  return z
end
...
function -(x::RealMat, y::RealMat)
  check_parent(x, y)
  z = similar(x)
  ccall((:arb_mat_sub, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}, Ref{RealMat}, Int), z, x, y, precision(Balls))
  return z
end
...
function *(x::RealMat, y::RealMat)
  ...
  ccall((:arb_mat_mul, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}, Ref{RealMat}, Int), z, x, y, precision(Balls))
  return z
end
...
function ^(x::RealMat, y::UInt)
  ...
  z = similar(x)
  ccall((:arb_mat_pow_ui, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}, UInt, Int), z, x, y, precision(Balls))
  return z
end

function *(x::RealMat, y::Int)
  z = similar(x)
  ccall((:arb_mat_scalar_mul_si, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}, Int, Int), z, x, y, precision(Balls))
  return z
end
...
function *(x::RealMat, y::ZZRingElem)
  z = similar(x)
  ccall((:arb_mat_scalar_mul_fmpz, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}, Ref{ZZRingElem}, Int), z, x, y, precision(Balls))
  return z
end
...
function *(x::RealMat, y::ArbFieldElem)
  z = similar(x)
  ccall((:arb_mat_scalar_mul_arb, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}, Ref{RealFieldElem}, Int), z, x, y, precision(Balls))
  return z
end
...
function ldexp(x::RealMat, y::Int)
  z = similar(x)
  ccall((:arb_mat_scalar_mul_2exp_si, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}, Int), z, x, y)
  return z
end
...
function isequal(x::RealMat, y::RealMat)
  r = ccall((:arb_mat_equal, libflint), Cint, (Ref{RealMat}, Ref{RealMat}), x, y)
  return Bool(r)
end
...
function overlaps(x::RealMat, y::RealMat)
  r = ccall((:arb_mat_overlaps, libflint), Cint, (Ref{RealMat}, Ref{RealMat}), x, y)
  return Bool(r)
end
...
function contains(x::RealMat, y::RealMat)
  r = ccall((:arb_mat_contains, libflint), Cint, (Ref{RealMat}, Ref{RealMat}), x, y)
  return Bool(r)
end
...
function contains(x::RealMat, y::ZZMatrix)
  r = ccall((:arb_mat_contains_fmpz_mat, libflint), Cint, (Ref{RealMat}, Ref{ZZMatrix}), x, y)
  return Bool(r)
end
...
function contains(x::RealMat, y::QQMatrix)
  r = ccall((:arb_mat_contains_fmpq_mat, libflint), Cint, (Ref{RealMat}, Ref{QQMatrix}), x, y)
  return Bool(r)
end
...
function is_invertible_with_inverse(x::RealMat)
  ...
  z = similar(x)
  r = ccall((:arb_mat_inv, libflint), Cint, (Ref{RealMat}, Ref{RealMat}, Int), z, x, precision(Balls))
  return Bool(r), z
end
...
function divexact(x::RealMat, y::Int; check::Bool=true)
  ...
  z = similar(x)
  ccall((:arb_mat_scalar_div_si, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}, Int, Int), z, x, y, precision(Balls))
  return z
end

function divexact(x::RealMat, y::ZZRingElem; check::Bool=true)
  z = similar(x)
  ccall((:arb_mat_scalar_div_fmpz, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}, Ref{ZZRingElem}, Int), z, x, y, precision(Balls))
  return z
end

function divexact(x::RealMat, y::ArbFieldElem; check::Bool=true)
  z = similar(x)
  ccall((:arb_mat_scalar_div_arb, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}, Ref{RealFieldElem}, Int), z, x, y, precision(Balls))
  return z
end
...
function charpoly(x::RealPolyRing, y::RealMat, prec::Int=precision(Balls))
  ...
  z = x()
  ccall((:arb_mat_charpoly, libflint), Nothing, (Ref{RealPoly}, Ref{RealMat}, Int), z, y, prec)
  return z
end
...
function det(x::RealMat, prec::Int=precision(Balls))
  ...
  z = base_ring(x)()
  ccall((:arb_mat_det, libflint), Nothing, (Ref{RealFieldElem}, Ref{RealMat}, Int), z, x, prec)
  return z
end
...
function Base.exp(x::RealMat)
  ncols(x) != nrows(x) && error("Matrix must be square")
  z = similar(x)
  ccall((:arb_mat_exp, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}, Int), z, x, precision(Balls))
  return z
end
...
function lu!(P::Generic.Perm, x::RealMat)
  ...
  P.d .-= 1
  r = ccall((:arb_mat_lu, libflint), Cint, (Ptr{Int}, Ref{RealMat}, Ref{RealMat}, Int), P.d, x, x, precision(Balls))
...
function _solve!(z::RealMat, x::RealMat, y::RealMat)
  r = ccall((:arb_mat_solve, libflint), Cint, (Ref{RealMat}, Ref{RealMat}, Ref{RealMat}, Int), z, x, y, precision(Balls))
...
function _solve_lu_precomp!(z::RealMat, P::Generic.Perm, LU::RealMat, y::RealMat)
  Q = inv(P)
  ccall((:arb_mat_solve_lu_precomp, libflint), Nothing, (Ref{RealMat}, Ptr{Int}, Ref{RealMat}, Ref{RealMat}, Int), z, Q.d .- 1, LU, y, precision(Balls))
  nothing
end
...
function Solve._can_solve_internal_no_check(A::RealMat, b::RealMat, task::Symbol; side::Symbol=:left)
  ...
  fl = ccall((:arb_mat_solve, libflint), Cint, (Ref{RealMat}, Ref{RealMat}, Ref{RealMat}, Int), x, A, b, precision(Balls))
...
function Solve._init_reduce(C::Solve.SolveCtx{RealFieldElem})
  ...
  P.d .-= 1
  fl = ccall((:arb_mat_lu, libflint), Cint, (Ptr{Int}, Ref{RealMat}, Ref{RealMat}, Int), P.d, x, A, precision(Balls))
...
function Solve._can_solve_internal_no_check(C::Solve.SolveCtx{RealFieldElem}, b::RealMat, task::Symbol; side::Symbol=:left)
  ...
  ccall((:arb_mat_solve_lu_precomp, libflint), Nothing, (Ref{RealMat}, Ptr{Int}, Ref{RealMat}, Ref{RealMat}, Int), x, inv(p).d .- 1, LU, b, precision(Balls))
...
function swap_rows!(x::RealMat, i::Int, j::Int)
  ccall((:arb_mat_swap_rows, libflint), Nothing, (Ref{RealMat}, Ptr{Nothing}, Int, Int), x, C_NULL, i - 1, j - 1)
end
...
function bound_inf_norm(x::RealMat)
  ...
  GC.@preserve x z begin
    ...
    ccall((:arb_mat_bound_inf_norm, libflint), Nothing, (Ptr{mag_struct}, Ref{RealMat}), t, x)
...
for (s, f) in (("add!", "arb_mat_add"), ("mul!", "arb_mat_mul"), ("sub!", "arb_mat_sub"))
  @eval begin
    function ($(Symbol(s)))(z::RealMat, x::RealMat, y::RealMat, prec::Int=precision(Balls))
      ccall(($f, libflint), Nothing, (Ref{RealMat}, Ref{RealMat}, Ref{RealMat}, Int), z, x, y, prec)
      return z
    end
  end
end
...
function (x::RealMatSpace)(y::Union{Int,UInt,ZZRingElem,QQFieldElem,Float64,BigFloat,RealFieldElem,AbstractString})
  z = x()
  for i in 1:nrows(z)
    for j in 1:ncols(z)
      if i != j

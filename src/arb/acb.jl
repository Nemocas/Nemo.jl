...
function check_parent(a::AcbFieldElem, b::AcbFieldElem)
  parent(a) != parent(b) && error("Incompatible AcbFieldElem elements")
end
...
for (s, f) in ((:+, "acb_add"), (:*, "acb_mul"), (://, "acb_div"), (:-, "acb_sub"), (:^, "acb_pow"))
  @eval begin
    function ($s)(x::AcbFieldElem, y::AcbFieldElem)
      z = parent(x)()
      ccall(($f, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, x, y, parent(x).prec)
      return z
    end
  end
end
...
for (f, s) in ((:+, "add"), (:-, "sub"), (:*, "mul"), (://, "div"), (:^, "pow"))
  @eval begin
    function ($f)(x::AcbFieldElem, y::UInt)
      z = parent(x)()
      ccall(($("acb_" * s * "_ui"), libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, UInt, Int), z, x, y, parent(x).prec)
      return z
    end

    function ($f)(x::AcbFieldElem, y::Int)
      z = parent(x)()
      ccall(($("acb_" * s * "_si"), libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int, Int), z, x, y, parent(x).prec)
      return z
    end

    function ($f)(x::AcbFieldElem, y::ZZRingElem)
      z = parent(x)()
      ccall(($("acb_" * s * "_fmpz"), libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{ZZRingElem}, Int), z, x, y, parent(x).prec)
      return z
    end

    function ($f)(x::AcbFieldElem, y::ArbFieldElem)
      z = parent(x)()
      ccall(($("acb_" * s * "_arb"), libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{ArbFieldElem}, Int), z, x, y, parent(x).prec)
      return z
    end
  end
end
...
function ldexp(x::AcbFieldElem, y::Int)
  z = parent(x)()
  ccall((:acb_mul_2exp_si, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, x, y)
  return z
end

function ldexp(x::AcbFieldElem, y::ZZRingElem)
  z = parent(x)()
  ccall((:acb_mul_2exp_fmpz, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{ZZRingElem}), z, x, y)
  return z
end
...
function unique_integer(x::AcbFieldElem)
  z = ZZRingElem()
  unique = ccall((:acb_get_unique_fmpz, libflint), Int, (Ref{ZZRingElem}, Ref{AcbFieldElem}), z, x)
  return (unique != 0, z)
end
...
function angle(x::AcbFieldElem)
  z = ArbFieldElem()
  ccall((:acb_arg, libflint), Nothing, (Ref{ArbFieldElem}, Ref{AcbFieldElem}, Int), z, x, parent(x).prec)
  z.parent = ArbField(parent(x).prec)
  return z
end
...
function eisenstein_g(k::Int, x::AcbFieldElem)
  ...
  len = div(k, 2) - 1
  vec = acb_vec(len)
  ccall((:acb_modular_eisenstein, libflint), Nothing, (Ptr{acb_struct}, Ref{AcbFieldElem}, Int, Int), vec, x, len, CC.prec)
  z = array(CC, vec, len)
...
function sincos(x::AcbFieldElem)
  s = parent(x)()
  c = parent(x)()
  ccall((:acb_sin_cos, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), s, c, x, parent(x).prec)
  return (s, c)
end
...
function sincospi(x::AcbFieldElem)
  s = parent(x)()
  c = parent(x)()
  ccall((:acb_sin_cos_pi, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), s, c, x, parent(x).prec)
  return (s, c)
end
...
function sinhcosh(x::AcbFieldElem)
  s = parent(x)()
  c = parent(x)()
  ccall((:acb_sinh_cosh, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), s, c, x, parent(x).prec)
  return (s, c)
end
...
function zeta(s::AcbFieldElem, a::AcbFieldElem)
  z = parent(s)()
  ccall((:acb_hurwitz_zeta, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, s, a, parent(s).prec)
  return z
end
...
function polygamma(s::AcbFieldElem, a::AcbFieldElem)
  z = parent(s)()
  ccall((:acb_polygamma, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, s, a, parent(s).prec)
  return z
end

function rising_factorial(x::AcbFieldElem, n::UInt)
  z = parent(x)()
  ccall((:acb_rising_ui, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, UInt, Int), z, x, n, parent(x).prec)
  return z
end
...
function rising_factorial2(x::AcbFieldElem, n::UInt)
  z = parent(x)()
  w = parent(x)()
  ccall((:acb_rising2_ui, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, UInt, Int), z, w, x, n, parent(x).prec)
  return (z, w)
end
...
function polylog(s::AcbFieldElem, a::AcbFieldElem)
  z = parent(s)()
  ccall((:acb_polylog, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, s, a, parent(s).prec)
  return z
end

function polylog(s::Int, a::AcbFieldElem)
  z = parent(a)()
  ccall((:acb_polylog_si, libflint), Nothing, (Ref{AcbFieldElem}, Int, Ref{AcbFieldElem}, Int), z, s, a, parent(a).prec)
  return z
end
...
function log_integral(x::AcbFieldElem)
  z = parent(x)()
  ccall((:acb_hypgeom_li, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int, Int), z, x, 0, parent(x).prec)
  return z
end
...
function log_integral_offset(x::AcbFieldElem)
  z = parent(x)()
  ccall((:acb_hypgeom_li, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int, Int), z, x, 1, parent(x).prec)
  return z
end
...
function exp_integral_e(s::AcbFieldElem, x::AcbFieldElem)
  z = parent(s)()
  ccall((:acb_hypgeom_expint, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, s, x, parent(s).prec)
  return z
end
...
function gamma(s::AcbFieldElem, x::AcbFieldElem)
  z = parent(s)()
  ccall((:acb_hypgeom_gamma_upper, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int, Int), z, s, x, 0, parent(s).prec)
  return z
end
...
function gamma_regularized(s::AcbFieldElem, x::AcbFieldElem)
  z = parent(s)()
  ccall((:acb_hypgeom_gamma_upper, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int, Int), z, s, x, 1, parent(s).prec)
  return z
end
...
function gamma_lower(s::AcbFieldElem, x::AcbFieldElem)
  z = parent(s)()
  ccall((:acb_hypgeom_gamma_lower, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int, Int), z, s, x, 0, parent(s).prec)
  return z
end
...
function gamma_lower_regularized(s::AcbFieldElem, x::AcbFieldElem)
  z = parent(s)()
  ccall((:acb_hypgeom_gamma_lower, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int, Int), z, s, x, 1, parent(s).prec)
  return z
end
...
function bessel_j(nu::AcbFieldElem, x::AcbFieldElem)
  z = parent(x)()
  ccall((:acb_hypgeom_bessel_j, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, nu, x, parent(x).prec)
  return z
end
...
function bessel_y(nu::AcbFieldElem, x::AcbFieldElem)
  z = parent(x)()
  ccall((:acb_hypgeom_bessel_y, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, nu, x, parent(x).prec)
  return z
end
...
function bessel_i(nu::AcbFieldElem, x::AcbFieldElem)
  z = parent(x)()
  ccall((:acb_hypgeom_bessel_i, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, nu, x, parent(x).prec)
  return z
end
...
function bessel_k(nu::AcbFieldElem, x::AcbFieldElem)
  z = parent(x)()
  ccall((:acb_hypgeom_bessel_k, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, nu, x, parent(x).prec)
  return z
end
...
function airy_ai(x::AcbFieldElem)
  ai = parent(x)()
  ccall((:acb_hypgeom_airy, libflint), Nothing, (Ref{AcbFieldElem}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ref{AcbFieldElem}, Int), ai, C_NULL, C_NULL, C_NULL, x, parent(x).prec)
  return ai
end
...
function airy_bi(x::AcbFieldElem)
  bi = parent(x)()
  ccall((:acb_hypgeom_airy, libflint), Nothing, (Ptr{Cvoid}, Ptr{Cvoid}, Ref{AcbFieldElem}, Ptr{Cvoid}, Ref{AcbFieldElem}, Int), C_NULL, C_NULL, bi, C_NULL, x, parent(x).prec)
  return bi
end
...
function airy_ai_prime(x::AcbFieldElem)
  ai_prime = parent(x)()
  ccall((:acb_hypgeom_airy, libflint), Nothing, (Ptr{Cvoid}, Ref{AcbFieldElem}, Ptr{Cvoid}, Ptr{Cvoid}, Ref{AcbFieldElem}, Int), C_NULL, ai_prime, C_NULL, C_NULL, x, parent(x).prec)
  return ai_prime
end
...
function airy_bi_prime(x::AcbFieldElem)
  bi_prime = parent(x)()
  ccall((:acb_hypgeom_airy, libflint), Nothing, (Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), C_NULL, C_NULL, C_NULL, bi_prime, x, parent(x).prec)
  return bi_prime
end
...
function hypergeometric_1f1(a::AcbFieldElem, b::AcbFieldElem, x::AcbFieldElem)
  z = parent(x)()
  ccall((:acb_hypgeom_m, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int, Int), z, a, b, x, 0, parent(x).prec)
  return z
end
...
function hypergeometric_1f1_regularized(a::AcbFieldElem, b::AcbFieldElem, x::AcbFieldElem)
  z = parent(x)()
  ccall((:acb_hypgeom_m, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int, Int), z, a, b, x, 1, parent(x).prec)
  return z
end
...
function hypergeometric_u(a::AcbFieldElem, b::AcbFieldElem, x::AcbFieldElem)
  z = parent(x)()
  ccall((:acb_hypgeom_u, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, a, b, x, parent(x).prec)
  return z
end
...
function hypergeometric_2f1(a::AcbFieldElem, b::AcbFieldElem, c::AcbFieldElem, x::AcbFieldElem; flags=0)
  z = parent(x)()
  ccall((:acb_hypgeom_2f1, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int, Int), z, a, b, c, x, flags, parent(x).prec)
  return z
end
...
function weierstrass_p(z::AcbFieldElem, tau::AcbFieldElem)
  r = parent(z)()
  ccall((:acb_elliptic_p, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), r, z, tau, parent(z).prec)
  return r
end
...
function weierstrass_p_prime(z::AcbFieldElem, tau::AcbFieldElem)
  r = parent(z)()
  ccall((:acb_elliptic_p_prime, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), r, z, tau, parent(z).prec)
  return r
end
...
function add!(z::AcbFieldElem, x::AcbFieldElem, y::AcbFieldElem)
  ccall((:acb_add, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, x, y, parent(z).prec)
  return z
end

function addeq!(z::AcbFieldElem, y::AcbFieldElem)
  ccall((:acb_add, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, z, y, parent(z).prec)
  return z
end

function sub!(z::AcbFieldElem, x::AcbFieldElem, y::AcbFieldElem)
  ccall((:acb_sub, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, x, y, parent(z).prec)
  return z
end

function mul!(z::AcbFieldElem, x::AcbFieldElem, y::AcbFieldElem)
  ccall((:acb_mul, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, x, y, parent(z).prec)
  return z
end

function div!(z::AcbFieldElem, x::AcbFieldElem, y::AcbFieldElem)
  ccall((:acb_div, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbFieldElem}, Int), z, x, y, parent(z).prec)
  return z
end
...
for (typeofx, passtoc) in ((AcbFieldElem, Ref{AcbFieldElem}), (Ptr{AcbFieldElem}, Ptr{AcbFieldElem}))
  ...
  @eval begin
    ...
    function _acb_set(x::($typeofx), y::AcbFieldElem, p::Int)
      ccall((:acb_set_round, libflint), Nothing, (($passtoc), Ref{AcbFieldElem}, Int), x, y, p)
    end
    ...
    function _acb_set(x::($typeofx), y::ArbFieldElem, z::ArbFieldElem)
      ccall((:acb_set_arb_arb, libflint), Nothing, (($passtoc), Ref{ArbFieldElem}, Ref{ArbFieldElem}), x, y, z)
    end

...
length(x::AcbPolyRingElem) = ccall((:acb_poly_length, libflint), Int, (Ref{AcbPolyRingElem},), x)

function set_length!(x::AcbPolyRingElem, n::Int)
  ccall((:_acb_poly_set_length, libflint), Nothing, (Ref{AcbPolyRingElem}, Int), x, n)
  return x
end
...
function coeff(a::AcbPolyRingElem, n::Int)
  ...
  ccall((:acb_poly_get_coeff_acb, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbPolyRingElem}, Int), t, a, n)
  return t
end
...
function gen(a::AcbPolyRing)
  z = AcbPolyRingElem()
  ccall((:acb_poly_set_coeff_si, libflint), Nothing, (Ref{AcbPolyRingElem}, Int, Int), z, 1, 1)
  z.parent = a
  return z
end
...
function isequal(x::AcbPolyRingElem, y::AcbPolyRingElem)
  return ccall((:acb_poly_equal, libflint), Bool, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}), x, y)
end
...
function overlaps(x::AcbPolyRingElem, y::AcbPolyRingElem)
  return ccall((:acb_poly_overlaps, libflint), Bool, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}), x, y)
end
...
function contains(x::AcbPolyRingElem, y::AcbPolyRingElem)
  return ccall((:acb_poly_contains, libflint), Bool, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}), x, y)
end
...
function contains(x::AcbPolyRingElem, y::ZZPolyRingElem)
  return ccall((:acb_poly_contains_fmpz_poly, libflint), Bool, (Ref{AcbPolyRingElem}, Ref{ZZPolyRingElem}), x, y)
end
...
function contains(x::AcbPolyRingElem, y::QQPolyRingElem)
  return ccall((:acb_poly_contains_fmpq_poly, libflint), Bool, (Ref{AcbPolyRingElem}, Ref{QQPolyRingElem}), x, y)
end
...
function !=(x::AcbPolyRingElem, y::AcbPolyRingElem)
  for i in 0:max(degree(x), degree(y))
    if coeff(x, i) != coeff(y, i)
      return true
    end
  end
...
function unique_integer(x::AcbPolyRingElem)
  ...
  unique = ccall((:acb_poly_get_unique_fmpz_poly, libflint), Int, (Ref{ZZPolyRingElem}, Ref{AcbPolyRingElem}), z, x)
  return (unique != 0, z)
end
...
function shift_left(x::AcbPolyRingElem, len::Int)
  ...
  z = parent(x)()
  ccall((:acb_poly_shift_left, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), z, x, len)
  return z
end
...
function shift_right(x::AcbPolyRingElem, len::Int)
  len < 0 && throw(DomainError(len, "Shift must be non-negative"))
  z = parent(x)()
  ccall((:acb_poly_shift_right, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), z, x, len)
  return z
end
...
function +(x::AcbPolyRingElem, y::AcbPolyRingElem)
  z = parent(x)()
  ccall((:acb_poly_add, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), z, x, y, precision(parent(x)))
  return z
end

function *(x::AcbPolyRingElem, y::AcbPolyRingElem)
  z = parent(x)()
  ccall((:acb_poly_mul, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), z, x, y, precision(parent(x)))
  return z
end

function -(x::AcbPolyRingElem, y::AcbPolyRingElem)
  z = parent(x)()
  ccall((:acb_poly_sub, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), z, x, y, precision(parent(x)))
  return z
end
...
function ^(x::AcbPolyRingElem, y::Int)
  ...
  z = parent(x)()
  ccall((:acb_poly_pow_ui, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, UInt, Int), z, x, y, precision(parent(x)))
  return z
end
...
function Base.divrem(x::AcbPolyRingElem, y::AcbPolyRingElem)
  ...
  q = parent(x)()
  r = parent(x)()
  if (ccall((:acb_poly_divrem, libflint), Int, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), q, r, x, y, precision(parent(x))) == 1)
    return (q, r)
  else
    throw(DivideError())
  end
...
function truncate(a::AcbPolyRingElem, n::Int)
  ...
  z = deepcopy(a)
  ccall((:acb_poly_truncate, libflint), Nothing, (Ref{AcbPolyRingElem}, Int), z, n)
  return z
end
...
function mullow(x::AcbPolyRingElem, y::AcbPolyRingElem, n::Int)
  n < 0 && throw(DomainError(n, "Index must be non-negative"))
  z = parent(x)()
  ccall((:acb_poly_mullow, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int, Int), z, x, y, n, precision(parent(x)))
  return z
end
...
function evaluate(x::AcbPolyRingElem, y::AcbFieldElem)
  z = parent(y)()
  ccall((:acb_poly_evaluate, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbPolyRingElem}, Ref{AcbFieldElem}, Int), z, x, y, precision(parent(y)))
  return z
end
...
function evaluate2(x::AcbPolyRingElem, y::AcbFieldElem)
  z = parent(y)()
  w = parent(y)()
  ccall((:acb_poly_evaluate2, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{AcbPolyRingElem}, Ref{AcbFieldElem}, Int), z, w, x, y, precision(parent(y)))
  return z, w
end
...
function AbstractAlgebra._compose_right(x::AcbPolyRingElem, y::AcbPolyRingElem)
  z = parent(x)()
  ccall((:acb_poly_compose, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), z, x, y, precision(parent(x)))
  return z
end
...
function derivative(x::AcbPolyRingElem)
  z = parent(x)()
  ccall((:acb_poly_derivative, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), z, x, precision(parent(x)))
  return z
end

function integral(x::AcbPolyRingElem)
  z = parent(x)()
  ccall((:acb_poly_integral, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), z, x, precision(parent(x)))
  return z
end
...
function acb_vec(b::Vector{AcbFieldElem})
  ...
  for i in 1:length(b)
    ccall((:acb_set, libflint), Nothing, (Ptr{acb_struct}, Ref{AcbFieldElem}), v + (i - 1) * sizeof(acb_struct), b[i])
  end
  return v
end
...
function array(R::AcbField, v::Ptr{acb_struct}, n::Int)
  ...
  for i in 1:n
    r[i] = R()
    ccall((:acb_set, libflint), Nothing, (Ref{AcbFieldElem}, Ptr{acb_struct}), r[i], v + (i - 1) * sizeof(acb_struct))
  end
  return r
end
...
function from_roots(R::AcbPolyRing, b::Vector{AcbFieldElem})
  z = R()
  tmp = acb_vec(b)
  ccall((:acb_poly_product_roots, libflint), Nothing, (Ref{AcbPolyRingElem}, Ptr{acb_struct}, Int, Int), z, tmp, length(b), precision(R))
  acb_vec_clear(tmp, length(b))
  return z
end

function evaluate_iter(x::AcbPolyRingElem, b::Vector{AcbFieldElem})
  return AcbFieldElem[evaluate(x, b[i]) for i in 1:length(b)]
end

function evaluate_fast(x::AcbPolyRingElem, b::Vector{AcbFieldElem})
  tmp = acb_vec(b)
  ccall((:acb_poly_evaluate_vec_fast, libflint), Nothing, (Ptr{acb_struct}, Ref{AcbPolyRingElem}, Ptr{acb_struct}, Int, Int), tmp, x, tmp, length(b), precision(parent(x)))
...
function interpolate_newton(R::AcbPolyRing, xs::Vector{AcbFieldElem}, ys::Vector{AcbFieldElem})
  ...
  xsv = acb_vec(xs)
  ysv = acb_vec(ys)
  ccall((:acb_poly_interpolate_newton, libflint), Nothing, (Ref{AcbPolyRingElem}, Ptr{acb_struct}, Ptr{acb_struct}, Int, Int), z, xsv, ysv, length(xs), precision(R))
...
function interpolate_barycentric(R::AcbPolyRing, xs::Vector{AcbFieldElem}, ys::Vector{AcbFieldElem})
  ...
  xsv = acb_vec(xs)
  ysv = acb_vec(ys)
  ccall((:acb_poly_interpolate_barycentric, libflint), Nothing, (Ref{AcbPolyRingElem}, Ptr{acb_struct}, Ptr{acb_struct}, Int, Int), z, xsv, ysv, length(xs), precision(R))
  acb_vec_clear(xsv, length(xs))
  acb_vec_clear(ysv, length(ys))
  return z
end
...
function interpolate_fast(R::AcbPolyRing, xs::Vector{AcbFieldElem}, ys::Vector{AcbFieldElem})
  ...
  xsv = acb_vec(xs)
  ysv = acb_vec(ys)
  ccall((:acb_poly_interpolate_fast, libflint), Nothing, (Ref{AcbPolyRingElem}, Ptr{acb_struct}, Ptr{acb_struct}, Int, Int), z, xsv, ysv, length(xs), precision(R))
  acb_vec_clear(xsv, length(xs))
  acb_vec_clear(ysv, length(ys))
  return z
end
...
function roots(x::AcbPolyRingElem; target=0, isolate_real=false, initial_prec=0, max_prec=0, max_iter=0)
  ...
  while true
    ...
    isolated = ccall((:acb_poly_find_roots, libflint), Int, (Ptr{acb_struct}, Ref{AcbPolyRingElem}, Ptr{acb_struct}, Int, Int), roots, x, in_roots, step_max_iter, wp)
    ...
    if isolated == deg
      ...
      if target > 0
        for i in 0:(deg - 1)
          re = ccall((:acb_real_ptr, libflint), Ptr{arb_struct}, (Ptr{AcbFieldElem},), roots + i * sizeof(acb_struct))
          im = ccall((:acb_imag_ptr, libflint), Ptr{arb_struct}, (Ptr{AcbFieldElem},), roots + i * sizeof(acb_struct))
          ...
          ok = ok && (ccall((:mag_cmp_2exp_si, libflint), Cint, (Ptr{mag_struct}, Int), t, -target) <= 0)
          ok = ok && (ccall((:mag_cmp_2exp_si, libflint), Cint, (Ptr{mag_struct}, Int), u, -target) <= 0)
        end
      end

      if isreal(x)
        real_ok = ccall((:acb_poly_validate_real_roots, libflint), Bool, (Ptr{acb_struct}, Ref{AcbPolyRingElem}, Int), roots, x, wp)
  ...
  if isolated == deg
    ccall((:_acb_vec_sort_pretty, libflint), Nothing, (Ptr{acb_struct}, Int), roots, deg)
...
function roots_upper_bound(x::AcbPolyRingElem)
  ...
  GC.@preserve x z begin
    ...
    ccall((:acb_poly_root_bound_fujiwara, libflint), Nothing, (Ptr{mag_struct}, Ref{AcbPolyRingElem}), t, x)
    ...
    ccall((:arf_set_round, libflint), Nothing, (Ptr{arf_struct}, Ptr{arf_struct}, Int, Cint), s, s, p, ARB_RND_CEIL)
...
function fit!(z::AcbPolyRingElem, n::Int)
  ccall((:acb_poly_fit_length, libflint), Nothing, (Ref{AcbPolyRingElem}, Int), z, n)
  return nothing
end

function setcoeff!(z::AcbPolyRingElem, n::Int, x::ZZRingElem)
  ccall((:acb_poly_set_coeff_fmpz, libflint), Nothing, (Ref{AcbPolyRingElem}, Int, Ref{ZZRingElem}), z, n, x)
  return z
end

function setcoeff!(z::AcbPolyRingElem, n::Int, x::AcbFieldElem)
  ccall((:acb_poly_set_coeff_acb, libflint), Nothing, (Ref{AcbPolyRingElem}, Int, Ref{AcbFieldElem}), z, n, x)
  return z
end

function mul!(z::AcbPolyRingElem, x::AcbPolyRingElem, y::AcbPolyRingElem)
  ccall((:acb_poly_mul, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), z, x, y, precision(parent(z)))
  return z
end

function addeq!(z::AcbPolyRingElem, x::AcbPolyRingElem)
  ccall((:acb_poly_add, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), z, z, x, precision(parent(z)))
  return z
end

function add!(z::AcbPolyRingElem, x::AcbPolyRingElem, y::AcbPolyRingElem)
  ccall((:acb_poly_add, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), z, x, y, precision(parent(z)))
  return z
end

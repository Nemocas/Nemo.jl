...
length(x::ComplexPoly) = ccall((:acb_poly_length, libflint), Int, (Ref{ComplexPoly},), x)

function set_length!(x::ComplexPoly, n::Int)
  ccall((:_acb_poly_set_length, libflint), Nothing, (Ref{ComplexPoly}, Int), x, n)
  return x
end
...
function coeff(a::ComplexPoly, n::Int)
  ...
  t = ComplexFieldElem()
  ccall((:acb_poly_get_coeff_acb, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexPoly}, Int), t, a, n)
  return t
end
...
function gen(a::ComplexPolyRing)
  z = ComplexPoly()
  ccall((:acb_poly_set_coeff_si, libflint), Nothing, (Ref{ComplexPoly}, Int, Int), z, 1, 1)
  z.parent = a
  return z
end
...
function isequal(x::ComplexPoly, y::ComplexPoly)
  return ccall((:acb_poly_equal, libflint), Bool, (Ref{ComplexPoly}, Ref{ComplexPoly}), x, y)
end
...
function overlaps(x::ComplexPoly, y::ComplexPoly)
  return ccall((:acb_poly_overlaps, libflint), Bool, (Ref{ComplexPoly}, Ref{ComplexPoly}), x, y)
end
...
function contains(x::ComplexPoly, y::ComplexPoly)
  return ccall((:acb_poly_contains, libflint), Bool, (Ref{ComplexPoly}, Ref{ComplexPoly}), x, y)
end
...
function contains(x::ComplexPoly, y::ZZPolyRingElem)
  return ccall((:acb_poly_contains_fmpz_poly, libflint), Bool, (Ref{ComplexPoly}, Ref{ZZPolyRingElem}), x, y)
end
...
function contains(x::ComplexPoly, y::QQPolyRingElem)
  return ccall((:acb_poly_contains_fmpq_poly, libflint), Bool, (Ref{ComplexPoly}, Ref{QQPolyRingElem}), x, y)
end
...
function unique_integer(x::ComplexPoly)
  ...
  unique = ccall((:acb_poly_get_unique_fmpz_poly, libflint), Int, (Ref{ZZPolyRingElem}, Ref{ComplexPoly}), z, x)
  return (unique != 0, z)
end
...
function shift_left(x::ComplexPoly, len::Int)
  ...
  z = parent(x)()
  ccall((:acb_poly_shift_left, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Int), z, x, len)
  return z
end
...
function shift_right(x::ComplexPoly, len::Int)
  len < 0 && throw(DomainError(len, "Shift must be non-negative"))
  z = parent(x)()
  ccall((:acb_poly_shift_right, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Int), z, x, len)
  return z
end
...
function +(x::ComplexPoly, y::ComplexPoly)
  z = parent(x)()
  ccall((:acb_poly_add, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Ref{ComplexPoly}, Int), z, x, y, precision(Balls))
  return z
end

function *(x::ComplexPoly, y::ComplexPoly)
  z = parent(x)()
  ccall((:acb_poly_mul, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Ref{ComplexPoly}, Int), z, x, y, precision(Balls))
  return z
end

function -(x::ComplexPoly, y::ComplexPoly)
  z = parent(x)()
  ccall((:acb_poly_sub, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Ref{ComplexPoly}, Int), z, x, y, precision(Balls))
  return z
end
...
function ^(x::ComplexPoly, y::Int)
  ...
  z = parent(x)()
  ccall((:acb_poly_pow_ui, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, UInt, Int), z, x, y, precision(Balls))
  return z
end
...
function Base.divrem(x::ComplexPoly, y::ComplexPoly)
  ...
  q = parent(x)()
  r = parent(x)()
  if (ccall((:acb_poly_divrem, libflint), Int, (Ref{ComplexPoly}, Ref{ComplexPoly}, Ref{ComplexPoly}, Ref{ComplexPoly}, Int), q, r, x, y, precision(Balls)) == 1)
    return (q, r)
  else
    throw(DivideError())
  end
...
function truncate(a::ComplexPoly, n::Int)
  ...
  z = deepcopy(a)
  ccall((:acb_poly_truncate, libflint), Nothing, (Ref{ComplexPoly}, Int), z, n)
  return z
end
...
function mullow(x::ComplexPoly, y::ComplexPoly, n::Int, prec::Int=precision(Balls))
  n < 0 && throw(DomainError(n, "Index must be non-negative"))
  z = parent(x)()
  ccall((:acb_poly_mullow, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Ref{ComplexPoly}, Int, Int), z, x, y, n, prec)
  return z
end
...
function evaluate(x::ComplexPoly, y::ComplexFieldElem, prec::Int=precision(Balls))
  z = parent(y)()
  ccall((:acb_poly_evaluate, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexPoly}, Ref{ComplexFieldElem}, Int), z, x, y, prec)
  return z
end
...
function evaluate2(x::ComplexPoly, y::ComplexFieldElem, prec::Int=precision(Balls))
  z = ComplexFieldElem()
  w = ComplexFieldElem()
  ccall((:acb_poly_evaluate2, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexFieldElem}, Ref{ComplexPoly}, Ref{ComplexFieldElem}, Int), z, w, x, y, prec)
  return z, w
end
...
function compose(x::ComplexPoly, y::ComplexPoly, prec::Int=precision(Balls); inner::Symbol)
  ...
  @assert inner == :second
  z = parent(x)()
  ccall((:acb_poly_compose, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Ref{ComplexPoly}, Int), z, x, y, prec)
  return z
end
...
function derivative(x::ComplexPoly, prec::Int=precision(Balls))
  z = parent(x)()
  ccall((:acb_poly_derivative, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Int), z, x, prec)
  return z
end

function integral(x::ComplexPoly, prec::Int=precision(Balls))
  z = parent(x)()
  ccall((:acb_poly_integral, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Int), z, x, prec)
  return z
end
...
function acb_vec(b::Vector{ComplexFieldElem})
  ...
  for i in 1:length(b)
    ccall((:acb_set, libflint), Nothing, (Ptr{acb_struct}, Ref{ComplexFieldElem}), v + (i - 1) * sizeof(acb_struct), b[i])
  end
  return v
end
...
function array(R::ComplexField, v::Ptr{acb_struct}, n::Int)
  ...
  for i in 1:n
    r[i] = R()
    ccall((:acb_set, libflint), Nothing, (Ref{ComplexFieldElem}, Ptr{acb_struct}), r[i], v + (i - 1) * sizeof(acb_struct))
  end
  return r
end
...
function from_roots(R::ComplexPolyRing, b::Vector{ComplexFieldElem}, prec::Int=precision(Balls))
  z = R()
  tmp = acb_vec(b)
  ccall((:acb_poly_product_roots, libflint), Nothing, (Ref{ComplexPoly}, Ptr{acb_struct}, Int, Int), z, tmp, length(b), prec)
  acb_vec_clear(tmp, length(b))
  return z
end

function evaluate_iter(x::ComplexPoly, b::Vector{ComplexFieldElem}, prec::Int=precision(Balls))
  return ComplexFieldElem[evaluate(x, b[i], prec) for i in 1:length(b)]
end

function evaluate_fast(x::ComplexPoly, b::Vector{ComplexFieldElem}, prec::Int=precision(Balls))
  tmp = acb_vec(b)
  ccall((:acb_poly_evaluate_vec_fast, libflint), Nothing, (Ptr{acb_struct}, Ref{ComplexPoly}, Ptr{acb_struct}, Int, Int), tmp, x, tmp, length(b), prec)
...
function interpolate_newton(R::ComplexPolyRing, xs::Vector{ComplexFieldElem}, ys::Vector{ComplexFieldElem}, prec::Int=precision(Balls))
  ...
  xsv = acb_vec(xs)
  ysv = acb_vec(ys)
  ccall((:acb_poly_interpolate_newton, libflint), Nothing, (Ref{ComplexPoly}, Ptr{acb_struct}, Ptr{acb_struct}, Int, Int), z, xsv, ysv, length(xs), prec)
...
function interpolate_barycentric(R::ComplexPolyRing, xs::Vector{ComplexFieldElem}, ys::Vector{ComplexFieldElem}, prec::Int=precision(Balls))
  ...
  xsv = acb_vec(xs)
  ysv = acb_vec(ys)
  ccall((:acb_poly_interpolate_barycentric, libflint), Nothing, (Ref{ComplexPoly}, Ptr{acb_struct}, Ptr{acb_struct}, Int, Int), z, xsv, ysv, length(xs), prec)
  acb_vec_clear(xsv, length(xs))
  acb_vec_clear(ysv, length(ys))
  return z
end
...
function interpolate_fast(R::ComplexPolyRing, xs::Vector{ComplexFieldElem}, ys::Vector{ComplexFieldElem}, prec::Int=precision(Balls))
  ...
  xsv = acb_vec(xs)
  ysv = acb_vec(ys)
  ccall((:acb_poly_interpolate_fast, libflint), Nothing, (Ref{ComplexPoly}, Ptr{acb_struct}, Ptr{acb_struct}, Int, Int), z, xsv, ysv, length(xs), prec)
  acb_vec_clear(xsv, length(xs))
  acb_vec_clear(ysv, length(ys))
  return z
end
...
function roots(x::ComplexPoly; target=0, isolate_real=false, initial_prec=0, max_prec=0, max_iter=0)
  ...
  while true
    ...
    isolated = ccall((:acb_poly_find_roots, libflint), Int, (Ptr{acb_struct}, Ref{ComplexPoly}, Ptr{acb_struct}, Int, Int), roots, x, in_roots, step_max_iter, wp)
    ...
    if isolated == deg
      ...
      if target > 0
        for i in 0:(deg - 1)
          re = ccall((:acb_real_ptr, libflint), Ptr{arb_struct}, (Ptr{acb_struct},), roots + i * sizeof(acb_struct))
          im = ccall((:acb_imag_ptr, libflint), Ptr{arb_struct}, (Ptr{acb_struct},), roots + i * sizeof(acb_struct))
      ...
      if isreal(x)
        real_ok = ccall((:acb_poly_validate_real_roots, libflint), Bool, (Ptr{acb_struct}, Ref{ComplexPoly}, Int), roots, x, wp)
        ...
        if real_ok
          for i in 0:(deg - 1)
            im = ccall((:acb_imag_ptr, libflint), Ptr{arb_struct}, (Ptr{ComplexFieldElem},), roots + i * sizeof(acb_struct))
...
function roots_upper_bound(x::ComplexPoly)
  ...
  GC.@preserve x z begin
    ...
    ccall((:acb_poly_root_bound_fujiwara, libflint), Nothing, (Ptr{mag_struct}, Ref{ComplexPoly}), t, x)
...
function fit!(z::ComplexPoly, n::Int)
  ccall((:acb_poly_fit_length, libflint), Nothing, (Ref{ComplexPoly}, Int), z, n)
  return nothing
end

function setcoeff!(z::ComplexPoly, n::Int, x::ZZRingElem)
  ccall((:acb_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ComplexPoly}, Int, Ref{ZZRingElem}), z, n, x)
  return z
end

function setcoeff!(z::ComplexPoly, n::Int, x::ComplexFieldElem)
  ccall((:acb_poly_set_coeff_acb, libflint), Nothing, (Ref{ComplexPoly}, Int, Ref{ComplexFieldElem}), z, n, x)
  return z
end

function mul!(z::ComplexPoly, x::ComplexPoly, y::ComplexPoly)
  ccall((:acb_poly_mul, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Ref{ComplexPoly}, Int), z, x, y, precision(parent(z)))
  return z
end

function addeq!(z::ComplexPoly, x::ComplexPoly)
  ccall((:acb_poly_add, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Ref{ComplexPoly}, Int), z, z, x, precision(parent(z)))
  return z
end

function add!(z::ComplexPoly, x::ComplexPoly, y::ComplexPoly)
  ccall((:acb_poly_add, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Ref{ComplexPoly}, Int), z, x, y, precision(parent(z)))
  return z
end

...
mutable struct acb_calc_integrate_opts
  ...
  function acb_calc_integrate_opts(deg_limit::Int, eval_limit::Int, depth_limit::Int, use_heap::Int32, verbose::Int32)
    return new(deg_limit, eval_limit, depth_limit, use_heap, verbose)
  end

  function acb_calc_integrate_opts()
    opts = new()
    ccall((:acb_calc_integrate_opt_init, libflint), Nothing, (Ref{acb_calc_integrate_opts},), opts)
    return opts
  end
end
...
mutable struct RealPoly <: PolyRingElem{RealFieldElem}
  ...
  function RealPoly(x::RealFieldElem, p::Int)
    z = new()
    ccall((:arb_poly_init, libflint), Nothing, (Ref{RealPoly},), z)
    ccall((:arb_poly_set_coeff_arb, libflint), Nothing, (Ref{RealPoly}, Int, Ref{RealFieldElem}), z, 0, x)
    finalizer(_RealPoly_clear_fn, z)
    return z
  end
  ...
  function RealPoly(x::Vector{RealFieldElem}, p::Int)
    ...
    ccall((:arb_poly_init, libflint), Nothing, (Ref{RealPoly},), z)
    for i in 1:length(x)
      ccall((:arb_poly_set_coeff_arb, libflint), Nothing, (Ref{RealPoly}, Int, Ref{RealFieldElem}), z, i - 1, x[i])
    end
    finalizer(_RealPoly_clear_fn, z)
    return z
  end
  ...
  function RealPoly(x::RealPoly, p::Int)
    z = new()
    ccall((:arb_poly_init, libflint), Nothing, (Ref{RealPoly},), z)
    ccall((:arb_poly_set_round, libflint), Nothing, (Ref{RealPoly}, Ref{RealPoly}, Int), z, x, p)
    finalizer(_RealPoly_clear_fn, z)
    return z
  end
  ...
  function RealPoly(x::ZZPolyRingElem, p::Int)
    z = new()
    ccall((:arb_poly_init, libflint), Nothing, (Ref{RealPoly},), z)
    ccall((:arb_poly_set_fmpz_poly, libflint), Nothing, (Ref{RealPoly}, Ref{ZZPolyRingElem}, Int), z, x, p)
    finalizer(_RealPoly_clear_fn, z)
    return z
  end
  ...
  function RealPoly(x::QQPolyRingElem, p::Int)
    z = new()
    ccall((:arb_poly_init, libflint), Nothing, (Ref{RealPoly},), z)
    ccall((:arb_poly_set_fmpq_poly, libflint), Nothing, (Ref{RealPoly}, Ref{QQPolyRingElem}, Int), z, x, p)
    finalizer(_RealPoly_clear_fn, z)
    return z
  end
end
...
mutable struct ArbPolyRingElem <: PolyRingElem{ArbFieldElem}
  ...
  function ArbPolyRingElem(x::ArbFieldElem, p::Int)
    z = new()
    ccall((:arb_poly_init, libflint), Nothing, (Ref{ArbPolyRingElem},), z)
    ccall((:arb_poly_set_coeff_arb, libflint), Nothing, (Ref{ArbPolyRingElem}, Int, Ref{ArbFieldElem}), z, 0, x)
    finalizer(_arb_poly_clear_fn, z)
    return z
  end
  ...
  function ArbPolyRingElem(x::Vector{ArbFieldElem}, p::Int)
    ...
    ccall((:arb_poly_init, libflint), Nothing, (Ref{ArbPolyRingElem},), z)
    for i in 1:length(x)
      ccall((:arb_poly_set_coeff_arb, libflint), Nothing, (Ref{ArbPolyRingElem}, Int, Ref{ArbFieldElem}), z, i - 1, x[i])
    end
    finalizer(_arb_poly_clear_fn, z)
    return z
  end
  ...
  function ArbPolyRingElem(x::ArbPolyRingElem, p::Int)
    z = new()
    ccall((:arb_poly_init, libflint), Nothing, (Ref{ArbPolyRingElem},), z)
    ccall((:arb_poly_set_round, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbPolyRingElem}, Int), z, x, p)
    finalizer(_arb_poly_clear_fn, z)
    return z
  end
  ...
  function ArbPolyRingElem(x::ZZPolyRingElem, p::Int)
    z = new()
    ccall((:arb_poly_init, libflint), Nothing, (Ref{ArbPolyRingElem},), z)
    ccall((:arb_poly_set_fmpz_poly, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ZZPolyRingElem}, Int), z, x, p)
    finalizer(_arb_poly_clear_fn, z)
    return z
  end
  ...
  function ArbPolyRingElem(x::QQPolyRingElem, p::Int)
    z = new()
    ccall((:arb_poly_init, libflint), Nothing, (Ref{ArbPolyRingElem},), z)
    ccall((:arb_poly_set_fmpq_poly, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{QQPolyRingElem}, Int), z, x, p)
    finalizer(_arb_poly_clear_fn, z)
    return z
  end
end
...
mutable struct ComplexPoly <: PolyRingElem{ComplexFieldElem}
  ...
  function ComplexPoly(x::ComplexFieldElem, p::Int)
    z = new()
    ccall((:acb_poly_init, libflint), Nothing, (Ref{ComplexPoly},), z)
    ccall((:acb_poly_set_coeff_acb, libflint), Nothing, (Ref{ComplexPoly}, Int, Ref{ComplexFieldElem}), z, 0, x)
    finalizer(_acb_poly_clear_fn, z)
    return z
  end
  ...
  function ComplexPoly(x::Vector{ComplexFieldElem}, p::Int)
    ...
    ccall((:acb_poly_init, libflint), Nothing, (Ref{ComplexPoly},), z)
    for i in 1:length(x)
      ccall((:acb_poly_set_coeff_acb, libflint), Nothing, (Ref{ComplexPoly}, Int, Ref{ComplexFieldElem}), z, i - 1, x[i])
    end
    finalizer(_acb_poly_clear_fn, z)
    return z
  end
  ...
  function ComplexPoly(x::RealPoly, p::Int)
    z = new()
    ccall((:acb_poly_init, libflint), Nothing, (Ref{ComplexPoly},), z)
    ccall((:acb_poly_set_arb_poly, libflint), Nothing, (Ref{ComplexPoly}, Ref{ArbPolyRingElem}, Int), z, x, p)
    ccall((:acb_poly_set_round, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Int), z, z, p)
    finalizer(_acb_poly_clear_fn, z)
    return z
  end
  ...
  function ComplexPoly(x::ComplexPoly, p::Int)
    z = new()
    ccall((:acb_poly_init, libflint), Nothing, (Ref{ComplexPoly},), z)
    ccall((:acb_poly_set_round, libflint), Nothing, (Ref{ComplexPoly}, Ref{ComplexPoly}, Int), z, x, p)
    finalizer(_acb_poly_clear_fn, z)
    return z
  end
  ...
  function ComplexPoly(x::ZZPolyRingElem, p::Int)
    z = new()
    ccall((:acb_poly_init, libflint), Nothing, (Ref{ComplexPoly},), z)
    ccall((:acb_poly_set_fmpz_poly, libflint), Nothing, (Ref{ComplexPoly}, Ref{ZZPolyRingElem}, Int), z, x, p)
    finalizer(_acb_poly_clear_fn, z)
    return z
  end
  ...
  function ComplexPoly(x::QQPolyRingElem, p::Int)
    z = new()
    ccall((:acb_poly_init, libflint), Nothing, (Ref{ComplexPoly},), z)
    ccall((:acb_poly_set_fmpq_poly, libflint), Nothing, (Ref{ComplexPoly}, Ref{QQPolyRingElem}, Int), z, x, p)
    finalizer(_acb_poly_clear_fn, z)
    return z
  end
end
...
mutable struct AcbPolyRingElem <: PolyRingElem{AcbFieldElem}
  ...
  function AcbPolyRingElem(x::AcbFieldElem, p::Int)
    z = new()
    ccall((:acb_poly_init, libflint), Nothing, (Ref{AcbPolyRingElem},), z)
    ccall((:acb_poly_set_coeff_acb, libflint), Nothing, (Ref{AcbPolyRingElem}, Int, Ref{AcbFieldElem}), z, 0, x)
    finalizer(_acb_poly_clear_fn, z)
    return z
  end
  ...
  function AcbPolyRingElem(x::Vector{AcbFieldElem}, p::Int)
    ...
    ccall((:acb_poly_init, libflint), Nothing, (Ref{AcbPolyRingElem},), z)
    for i in 1:length(x)
      ccall((:acb_poly_set_coeff_acb, libflint), Nothing, (Ref{AcbPolyRingElem}, Int, Ref{AcbFieldElem}), z, i - 1, x[i])
    end
    finalizer(_acb_poly_clear_fn, z)
    return z
  end
  ...
  function AcbPolyRingElem(x::ArbPolyRingElem, p::Int)
    z = new()
    ccall((:acb_poly_init, libflint), Nothing, (Ref{AcbPolyRingElem},), z)
    ccall((:acb_poly_set_arb_poly, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{ArbPolyRingElem}, Int), z, x, p)
    ccall((:acb_poly_set_round, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), z, z, p)
    finalizer(_acb_poly_clear_fn, z)
    return z
  end
  ...
  function AcbPolyRingElem(x::AcbPolyRingElem, p::Int)
    z = new()
    ccall((:acb_poly_init, libflint), Nothing, (Ref{AcbPolyRingElem},), z)
    ccall((:acb_poly_set_round, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{AcbPolyRingElem}, Int), z, x, p)
    finalizer(_acb_poly_clear_fn, z)
    return z
  end
  ...
  function AcbPolyRingElem(x::ZZPolyRingElem, p::Int)
    z = new()
    ccall((:acb_poly_init, libflint), Nothing, (Ref{AcbPolyRingElem},), z)
    ccall((:acb_poly_set_fmpz_poly, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{ZZPolyRingElem}, Int), z, x, p)
    finalizer(_acb_poly_clear_fn, z)
    return z
  end
  ...
  function AcbPolyRingElem(x::QQPolyRingElem, p::Int)
    z = new()
    ccall((:acb_poly_init, libflint), Nothing, (Ref{AcbPolyRingElem},), z)
    ccall((:acb_poly_set_fmpq_poly, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{QQPolyRingElem}, Int), z, x, p)
    finalizer(_acb_poly_clear_fn, z)
    return z
  end
end
...
mutable struct RealMat <: MatElem{RealFieldElem}
  ...
  function RealMat(a::ZZMatrix)
    z = new()
    ccall((:arb_mat_init, libflint), Nothing, (Ref{RealMat}, Int, Int), z, a.r, a.c)
    ccall((:arb_mat_set_fmpz_mat, libflint), Nothing, (Ref{RealMat}, Ref{ZZMatrix}), z, a)
    finalizer(_arb_mat_clear_fn, z)
    return z
  end
  ...
  function RealMat(a::ZZMatrix, prec::Int)
    z = new()
    ccall((:arb_mat_init, libflint), Nothing, (Ref{RealMat}, Int, Int), z, a.r, a.c)
    ccall((:arb_mat_set_round_fmpz_mat, libflint), Nothing, (Ref{RealMat}, Ref{ZZMatrix}, Int), z, a, prec)
    finalizer(_arb_mat_clear_fn, z)
    return z
  end
  ...
  function RealMat(r::Int, c::Int, arr::AbstractMatrix{T}) where {T<:Union{Int,UInt,ZZRingElem,Float64,BigFloat,RealFieldElem}}
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:arb_mat_entry_ptr, libflint), Ptr{RealFieldElem}, (Ref{RealMat}, Int, Int), z, i - 1, j - 1)
  ...
  function RealMat(a::QQMatrix, prec::Int)
    z = new()
    ccall((:arb_mat_init, libflint), Nothing, (Ref{RealMat}, Int, Int), z, a.r, a.c)
    ccall((:arb_mat_set_fmpq_mat, libflint), Nothing, (Ref{RealMat}, Ref{QQMatrix}, Int), z, a, prec)
    finalizer(_arb_mat_clear_fn, z)
    return z
  end
end
...
mutable struct ArbMatrix <: MatElem{ArbFieldElem}
  ...
  function ArbMatrix(a::ZZMatrix)
    z = new()
    ccall((:arb_mat_init, libflint), Nothing, (Ref{ArbMatrix}, Int, Int), z, a.r, a.c)
    ccall((:arb_mat_set_fmpz_mat, libflint), Nothing, (Ref{ArbMatrix}, Ref{ZZMatrix}), z, a)
    finalizer(_arb_mat_clear_fn, z)
    return z
  end
  ...
  function ArbMatrix(a::ZZMatrix, prec::Int)
    z = new()
    ccall((:arb_mat_init, libflint), Nothing, (Ref{ArbMatrix}, Int, Int), z, a.r, a.c)
    ccall((:arb_mat_set_round_fmpz_mat, libflint), Nothing, (Ref{ArbMatrix}, Ref{ZZMatrix}, Int), z, a, prec)
    finalizer(_arb_mat_clear_fn, z)
    return z
  end
  ...
  function ArbMatrix(r::Int, c::Int, arr::AbstractMatrix{T}) where {T<:Union{Int,UInt,ZZRingElem,Float64,BigFloat,ArbFieldElem}}
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:arb_mat_entry_ptr, libflint), Ptr{ArbFieldElem}, (Ref{ArbMatrix}, Int, Int), z, i - 1, j - 1)
        Nemo._arb_set(el, arr[i, j])
      end
    end
    return z
  ...
  function ArbMatrix(a::QQMatrix, prec::Int)
    z = new()
    ccall((:arb_mat_init, libflint), Nothing, (Ref{ArbMatrix}, Int, Int), z, a.r, a.c)
    ccall((:arb_mat_set_fmpq_mat, libflint), Nothing, (Ref{ArbMatrix}, Ref{QQMatrix}, Int), z, a, prec)
    finalizer(_arb_mat_clear_fn, z)
    return z
  end
end
...
mutable struct ComplexMat <: MatElem{ComplexFieldElem}
  ...
  function ComplexMat(a::ZZMatrix)
    z = new()
    ccall((:acb_mat_init, libflint), Nothing, (Ref{ComplexMat}, Int, Int), z, a.r, a.c)
    ccall((:acb_mat_set_fmpz_mat, libflint), Nothing, (Ref{ComplexMat}, Ref{ZZMatrix}), z, a)
    finalizer(_acb_mat_clear_fn, z)
    return z
  end
  ...
  function ComplexMat(a::ZZMatrix, prec::Int)
    z = new()
    ccall((:acb_mat_init, libflint), Nothing, (Ref{ComplexMat}, Int, Int), z, a.r, a.c)
    ccall((:acb_mat_set_round_fmpz_mat, libflint), Nothing, (Ref{ComplexMat}, Ref{ZZMatrix}, Int), z, a, prec)
    finalizer(_acb_mat_clear_fn, z)
    return z
  end
  ...
  function ComplexMat(a::RealMat)
    z = new()
    ccall((:acb_mat_init, libflint), Nothing, (Ref{ComplexMat}, Int, Int), z, a.r, a.c)
    ccall((:acb_mat_set_arb_mat, libflint), Nothing, (Ref{ComplexMat}, Ref{ArbMatrix}), z, a)
    finalizer(_acb_mat_clear_fn, z)
    return z
  end
  ...
  function ComplexMat(a::ArbMatrix, prec::Int)
    z = new()
    ccall((:acb_mat_init, libflint), Nothing, (Ref{ComplexMat}, Int, Int), z, a.r, a.c)
    ccall((:acb_mat_set_round_arb_mat, libflint), Nothing, (Ref{ComplexMat}, Ref{ArbMatrix}, Int), z, a, prec)
    finalizer(_acb_mat_clear_fn, z)
    return z
  end
  ...
  function ComplexMat(r::Int, c::Int, arr::AbstractMatrix{T}) where {T<:Union{Int,UInt,Float64,ZZRingElem}}
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:acb_mat_entry_ptr, libflint), Ptr{AcbFieldElem}, (Ref{ComplexMat}, Int, Int), z, i - 1, j - 1)
        _acb_set(el, arr[i, j])
      end
    end
    return z
  ...
  function ComplexMat(r::Int, c::Int, arr::AbstractMatrix{T}, prec::Int) where {T<:Union{BigFloat,RealFieldElem,AbstractString,ComplexFieldElem}}
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:acb_mat_entry_ptr, libflint), Ptr{ComplexFieldElem}, (Ref{ComplexMat}, Int, Int), z, i - 1, j - 1)
        _acb_set(el, arr[i, j], prec)
      end
    end
    return z
  ...
  function ComplexMat(a::QQMatrix, prec::Int)
    z = new()
    ccall((:acb_mat_init, libflint), Nothing, (Ref{ComplexMat}, Int, Int), z, a.r, a.c)
    ccall((:acb_mat_set_fmpq_mat, libflint), Nothing, (Ref{ComplexMat}, Ref{QQMatrix}, Int), z, a, prec)
    finalizer(_acb_mat_clear_fn, z)
    return z
  end
end
...
mutable struct AcbMatrix <: MatElem{AcbFieldElem}
  ...
  function AcbMatrix(a::ZZMatrix)
    z = new()
    ccall((:acb_mat_init, libflint), Nothing, (Ref{AcbMatrix}, Int, Int), z, a.r, a.c)
    ccall((:acb_mat_set_fmpz_mat, libflint), Nothing, (Ref{AcbMatrix}, Ref{ZZMatrix}), z, a)
    finalizer(_acb_mat_clear_fn, z)
    return z
  end
  ...
  function AcbMatrix(a::ZZMatrix, prec::Int)
    z = new()
    ccall((:acb_mat_init, libflint), Nothing, (Ref{AcbMatrix}, Int, Int), z, a.r, a.c)
    ccall((:acb_mat_set_round_fmpz_mat, libflint), Nothing, (Ref{AcbMatrix}, Ref{ZZMatrix}, Int), z, a, prec)
    finalizer(_acb_mat_clear_fn, z)
    return z
  end
  ...
  function AcbMatrix(a::ArbMatrix)
    z = new()
    ccall((:acb_mat_init, libflint), Nothing, (Ref{AcbMatrix}, Int, Int), z, a.r, a.c)
    ccall((:acb_mat_set_arb_mat, libflint), Nothing, (Ref{AcbMatrix}, Ref{ArbMatrix}), z, a)
    finalizer(_acb_mat_clear_fn, z)
    return z
  end
  ...
  function AcbMatrix(a::ArbMatrix, prec::Int)
    z = new()
    ccall((:acb_mat_init, libflint), Nothing, (Ref{AcbMatrix}, Int, Int), z, a.r, a.c)
    ccall((:acb_mat_set_round_arb_mat, libflint), Nothing, (Ref{AcbMatrix}, Ref{ArbMatrix}, Int), z, a, prec)
    finalizer(_acb_mat_clear_fn, z)
    return z
  end
  ...
  function AcbMatrix(r::Int, c::Int, arr::AbstractMatrix{T}) where {T<:Union{Int,UInt,Float64,ZZRingElem}}
    ...
    GC.@preserve z for i in 1:r
      for j in 1:c
        el = ccall((:acb_mat_entry_ptr, libflint), Ptr{AcbFieldElem}, (Ref{AcbMatrix}, Int, Int), z, i - 1, j - 1)
        _acb_set(el, arr[i, j])
      end
    end
    return z
  ...
  function AcbMatrix(a::QQMatrix, prec::Int)
    z = new()
    ccall((:acb_mat_init, libflint), Nothing, (Ref{AcbMatrix}, Int, Int), z, a.r, a.c)
    ccall((:acb_mat_set_fmpq_mat, libflint), Nothing, (Ref{AcbMatrix}, Ref{QQMatrix}, Int), z, a, prec)
    finalizer(_acb_mat_clear_fn, z)
    return z
  end
end

...
function getindex!(z::ArbFieldElem, x::ArbMatrix, r::Int, c::Int)
  GC.@preserve x begin
    v = ccall((:arb_mat_entry_ptr, libflint), Ptr{ArbFieldElem}, (Ref{ArbMatrix}, Int, Int), x, r - 1, c - 1)
...
for T in [Int, UInt, ZZRingElem, QQFieldElem, Float64, BigFloat, ArbFieldElem, AbstractString]
  @eval begin
    @inline function setindex!(x::ArbMatrix, y::$T, r::Int, c::Int)
      ...
      GC.@preserve x begin
        z = ccall((:arb_mat_entry_ptr, libflint), Ptr{ArbFieldElem}, (Ref{ArbMatrix}, Int, Int), x, r - 1, c - 1)
...
Base.@propagate_inbounds setindex!(x::ArbMatrix, y::Integer, r::Int, c::Int) = setindex!(x, ZZRingElem(y), r, c)

Base.@propagate_inbounds setindex!(x::ArbMatrix, y::Rational{T}, r::Int, c::Int) where {T<:Integer} = setindex!(x, ZZRingElem(y), r, c)
...
function transpose(x::ArbMatrix)
  ...
  ccall((:arb_mat_transpose, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}), z, x)
  return z
end
...
function +(x::ArbMatrix, y::ArbMatrix)
  check_parent(x, y)
  z = similar(x)
  ccall((:arb_mat_add, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, Ref{ArbMatrix}, Int), z, x, y, precision(parent(x)))
  return z
end
...
function -(x::ArbMatrix, y::ArbMatrix)
  check_parent(x, y)
  z = similar(x)
  ccall((:arb_mat_sub, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, Ref{ArbMatrix}, Int), z, x, y, precision(parent(x)))
  return z
end
...
function *(x::ArbMatrix, y::ArbMatrix)
  ...
  ccall((:arb_mat_mul, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, Ref{ArbMatrix}, Int), z, x, y, precision(base_ring(x)))
  return z
end
...
function ^(x::ArbMatrix, y::UInt)
  ...
  z = similar(x)
  ccall((:arb_mat_pow_ui, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, UInt, Int), z, x, y, precision(base_ring(x)))
  return z
end

function *(x::ArbMatrix, y::Int)
  z = similar(x)
  ccall((:arb_mat_scalar_mul_si, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, Int, Int), z, x, y, precision(base_ring(x)))
  return z
end
...
function *(x::ArbMatrix, y::ZZRingElem)
  z = similar(x)
  ccall((:arb_mat_scalar_mul_fmpz, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, Ref{ZZRingElem}, Int), z, x, y, precision(base_ring(x)))
  return z
end
...
function *(x::ArbMatrix, y::ArbFieldElem)
  z = similar(x)
  ccall((:arb_mat_scalar_mul_arb, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, Ref{ArbFieldElem}, Int), z, x, y, precision(base_ring(x)))
  return z
end
...
function ldexp(x::ArbMatrix, y::Int)
  z = similar(x)
  ccall((:arb_mat_scalar_mul_2exp_si, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, Int), z, x, y)
  return z
end
...
function isequal(x::ArbMatrix, y::ArbMatrix)
  r = ccall((:arb_mat_equal, libflint), Cint, (Ref{ArbMatrix}, Ref{ArbMatrix}), x, y)
  return Bool(r)
end
...
function overlaps(x::ArbMatrix, y::ArbMatrix)
  r = ccall((:arb_mat_overlaps, libflint), Cint, (Ref{ArbMatrix}, Ref{ArbMatrix}), x, y)
  return Bool(r)
end
...
function contains(x::ArbMatrix, y::ArbMatrix)
  r = ccall((:arb_mat_contains, libflint), Cint, (Ref{ArbMatrix}, Ref{ArbMatrix}), x, y)
  return Bool(r)
end
...
function contains(x::ArbMatrix, y::ZZMatrix)
  r = ccall((:arb_mat_contains_fmpz_mat, libflint), Cint, (Ref{ArbMatrix}, Ref{ZZMatrix}), x, y)
  return Bool(r)
end
...
function contains(x::ArbMatrix, y::QQMatrix)
  r = ccall((:arb_mat_contains_fmpq_mat, libflint), Cint, (Ref{ArbMatrix}, Ref{QQMatrix}), x, y)
  return Bool(r)
end
...
function is_invertible_with_inverse(x::ArbMatrix)
  ...
  z = similar(x)
  r = ccall((:arb_mat_inv, libflint), Cint, (Ref{ArbMatrix}, Ref{ArbMatrix}, Int), z, x, precision(base_ring(x)))
  return Bool(r), z
end
...
function divexact(x::ArbMatrix, y::Int; check::Bool=true)
  ...
  z = similar(x)
  ccall((:arb_mat_scalar_div_si, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, Int, Int), z, x, y, precision(base_ring(x)))
  return z
end

function divexact(x::ArbMatrix, y::ZZRingElem; check::Bool=true)
  z = similar(x)
  ccall((:arb_mat_scalar_div_fmpz, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, Ref{ZZRingElem}, Int), z, x, y, precision(base_ring(x)))
  return z
end

function divexact(x::ArbMatrix, y::ArbFieldElem; check::Bool=true)
  z = similar(x)
  ccall((:arb_mat_scalar_div_arb, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, Ref{ArbFieldElem}, Int), z, x, y, precision(base_ring(x)))
  return z
end
...
function charpoly(x::ArbPolyRing, y::ArbMatrix)
  ...
  z = x()
  ccall((:arb_mat_charpoly, libflint), Nothing, (Ref{ArbPolyRingElem}, Ref{ArbMatrix}, Int), z, y, precision(base_ring(y)))
  return z
end
...
function det(x::ArbMatrix)
  ...
  z = base_ring(x)()
  ccall((:arb_mat_det, libflint), Nothing, (Ref{ArbFieldElem}, Ref{ArbMatrix}, Int), z, x, precision(base_ring(x)))
  return z
end
...
function Base.exp(x::ArbMatrix)
  ncols(x) != nrows(x) && error("Matrix must be square")
  z = similar(x)
  ccall((:arb_mat_exp, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, Int), z, x, precision(base_ring(x)))
  return z
end
...
function lu!(P::Generic.Perm, x::ArbMatrix)
  ...
  P.d .-= 1
  r = ccall((:arb_mat_lu, libflint), Cint, (Ptr{Int}, Ref{ArbMatrix}, Ref{ArbMatrix}, Int), P.d, x, x, precision(base_ring(x)))
...
function _solve!(z::ArbMatrix, x::ArbMatrix, y::ArbMatrix)
  r = ccall((:arb_mat_solve, libflint), Cint, (Ref{ArbMatrix}, Ref{ArbMatrix}, Ref{ArbMatrix}, Int), z, x, y, precision(base_ring(x)))
...
function _solve_lu_precomp!(z::ArbMatrix, P::Generic.Perm, LU::ArbMatrix, y::ArbMatrix)
  Q = inv(P)
  ccall((:arb_mat_solve_lu_precomp, libflint), Nothing, (Ref{ArbMatrix}, Ptr{Int}, Ref{ArbMatrix}, Ref{ArbMatrix}, Int), z, Q.d .- 1, LU, y, precision(base_ring(LU)))
  nothing
end
...
function _solve_cholesky_precomp!(z::ArbMatrix, cho::ArbMatrix, y::ArbMatrix)
  ccall((:arb_mat_solve_cho_precomp, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, Ref{ArbMatrix}, Int), z, cho, y, precision(base_ring(cho)))
  nothing
end
...
function Solve._can_solve_internal_no_check(A::ArbMatrix, b::ArbMatrix, task::Symbol; side::Symbol=:left)
  ...
  fl = ccall((:arb_mat_solve, libflint), Cint, (Ref{ArbMatrix}, Ref{ArbMatrix}, Ref{ArbMatrix}, Int), x, A, b, precision(base_ring(A)))
...
function Solve._init_reduce(C::Solve.SolveCtx{ArbFieldElem})
  ...
  P.d .-= 1
  fl = ccall((:arb_mat_lu, libflint), Cint, (Ptr{Int}, Ref{ArbMatrix}, Ref{ArbMatrix}, Int), P.d, x, A, precision(base_ring(A)))
...
function Solve._can_solve_internal_no_check(C::Solve.SolveCtx{ArbFieldElem}, b::ArbMatrix, task::Symbol; side::Symbol=:left)
  ...
  ccall((:arb_mat_solve_lu_precomp, libflint), Nothing, (Ref{ArbMatrix}, Ptr{Int}, Ref{ArbMatrix}, Ref{ArbMatrix}, Int), x, inv(p).d .- 1, LU, b, precision(base_ring(LU)))
...
function swap_rows!(x::ArbMatrix, i::Int, j::Int)
  ccall((:arb_mat_swap_rows, libflint), Nothing, (Ref{ArbMatrix}, Ptr{Nothing}, Int, Int), x, C_NULL, i - 1, j - 1)
end
...
function bound_inf_norm(x::ArbMatrix)
  ...
  GC.@preserve x z begin
    ...
    ccall((:arb_mat_bound_inf_norm, libflint), Nothing, (Ptr{mag_struct}, Ref{ArbMatrix}), t, x)
...
for (s, f) in (("add!", "arb_mat_add"), ("mul!", "arb_mat_mul"), ("sub!", "arb_mat_sub"))
  @eval begin
    function ($(Symbol(s)))(z::ArbMatrix, x::ArbMatrix, y::ArbMatrix)
      ccall(($f, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}, Ref{ArbMatrix}, Int), z, x, y, precision(base_ring(x)))
      return z
    end
  end
end

...
function zero!(z::ArbMatrix)
  ccall((:arb_mat_zero, libflint), Nothing, (Ref{ArbMatrix},), z)
  return z
end

function one!(z::ArbMatrix)
  ccall((:arb_mat_one, libflint), Nothing, (Ref{ArbMatrix},), z)
  return z
end

function neg!(z::ArbMatrix, a::ArbMatrix)
  ccall((:arb_mat_neg, libflint), Nothing, (Ref{ArbMatrix}, Ref{ArbMatrix}), z, a)
  return z
end

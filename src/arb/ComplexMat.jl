...
function getindex!(z::ComplexFieldElem, x::ComplexMat, r::Int, c::Int)
  GC.@preserve x begin
    v = ccall((:acb_mat_entry_ptr, libflint), Ptr{ComplexFieldElem}, (Ref{ComplexMat}, Int, Int), x, r - 1, c - 1)
...
for T in [Integer, Float64, ZZRingElem, QQFieldElem, RealFieldElem, BigFloat, ComplexFieldElem, AbstractString]
  @eval begin
    @inline function setindex!(x::ComplexMat, y::$T, r::Int, c::Int)
      ...
      GC.@preserve x begin
        z = ccall((:acb_mat_entry_ptr, libflint), Ptr{ComplexFieldElem}, (Ref{ComplexMat}, Int, Int), x, r - 1, c - 1)
...
Base.@propagate_inbounds setindex!(x::ComplexMat, y::Rational{T}, r::Int, c::Int) where {T<:Integer} = setindex!(x, QQFieldElem(y), r, c)
...
setindex!(x::ComplexMat, y::Tuple{Rational{T},Rational{T}}, r::Int, c::Int) where {T<:Integer} = setindex!(x, map(QQFieldElem, y), r, c)
...
function transpose(x::ComplexMat)
  ...
  ccall((:acb_mat_transpose, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}), z, x)
  return z
end
...
function +(x::ComplexMat, y::ComplexMat)
  check_parent(x, y)
  z = similar(x)
  ccall((:acb_mat_add, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Ref{ComplexMat}, Int), z, x, y, precision(Balls))
  return z
end
...
function -(x::ComplexMat, y::ComplexMat)
  check_parent(x, y)
  z = similar(x)
  ccall((:acb_mat_sub, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Ref{ComplexMat}, Int), z, x, y, precision(Balls))
  return z
end
...
function *(x::ComplexMat, y::ComplexMat)
  ...
  ccall((:acb_mat_mul, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Ref{ComplexMat}, Int), z, x, y, precision(Balls))
  return z
end
...
function ^(x::ComplexMat, y::UInt)
  ...
  z = similar(x)
  ccall((:acb_mat_pow_ui, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, UInt, Int), z, x, y, precision(Balls))
  return z
end

function *(x::ComplexMat, y::Int)
  z = similar(x)
  ccall((:acb_mat_scalar_mul_si, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Int, Int), z, x, y, precision(Balls))
  return z
end
...
function *(x::ComplexMat, y::ZZRingElem)
  z = similar(x)
  ccall((:acb_mat_scalar_mul_fmpz, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Ref{ZZRingElem}, Int), z, x, y, precision(Balls))
  return z
end
...
function *(x::ComplexMat, y::RealFieldElem)
  z = similar(x)
  ccall((:acb_mat_scalar_mul_arb, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Ref{RealFieldElem}, Int), z, x, y, precision(Balls))
  return z
end
...
function *(x::ComplexMat, y::ComplexFieldElem)
  z = similar(x)
  ccall((:acb_mat_scalar_mul_acb, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Ref{ComplexFieldElem}, Int), z, x, y, precision(Balls))
  return z
end
...
function ldexp(x::ComplexMat, y::Int)
  z = similar(x)
  ccall((:acb_mat_scalar_mul_2exp_si, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Int), z, x, y)
  return z
end
...
function isequal(x::ComplexMat, y::ComplexMat)
  r = ccall((:acb_mat_equal, libflint), Cint, (Ref{ComplexMat}, Ref{ComplexMat}), x, y)
  return Bool(r)
end
...
function overlaps(x::ComplexMat, y::ComplexMat)
  r = ccall((:acb_mat_overlaps, libflint), Cint, (Ref{ComplexMat}, Ref{ComplexMat}), x, y)
  return Bool(r)
end
...
function contains(x::ComplexMat, y::ComplexMat)
  r = ccall((:acb_mat_contains, libflint), Cint, (Ref{ComplexMat}, Ref{ComplexMat}), x, y)
  return Bool(r)
end
...
function contains(x::ComplexMat, y::ZZMatrix)
  r = ccall((:acb_mat_contains_fmpz_mat, libflint), Cint, (Ref{ComplexMat}, Ref{ZZMatrix}), x, y)
  return Bool(r)
end
...
function contains(x::ComplexMat, y::QQMatrix)
  r = ccall((:acb_mat_contains_fmpq_mat, libflint), Cint, (Ref{ComplexMat}, Ref{QQMatrix}), x, y)
  return Bool(r)
end
...
isreal(x::ComplexMat) = Bool(ccall((:acb_mat_is_real, libflint), Cint, (Ref{ComplexMat},), x))
...
function is_invertible_with_inverse(x::ComplexMat)
  ...
  z = similar(x)
  r = ccall((:acb_mat_inv, libflint), Cint, (Ref{ComplexMat}, Ref{ComplexMat}, Int), z, x, precision(Balls))
  return Bool(r), z
end
...
function divexact(x::ComplexMat, y::Int; check::Bool=true)
  ...
  z = similar(x)
  ccall((:acb_mat_scalar_div_si, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Int, Int), z, x, y, precision(Balls))
  return z
end

function divexact(x::ComplexMat, y::ZZRingElem; check::Bool=true)
  z = similar(x)
  ccall((:acb_mat_scalar_div_fmpz, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Ref{ZZRingElem}, Int), z, x, y, precision(Balls))
  return z
end

function divexact(x::ComplexMat, y::RealFieldElem; check::Bool=true)
  z = similar(x)
  ccall((:acb_mat_scalar_div_arb, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Ref{RealFieldElem}, Int), z, x, y, precision(Balls))
  return z
end

function divexact(x::ComplexMat, y::ComplexFieldElem; check::Bool=true)
  z = similar(x)
  ccall((:acb_mat_scalar_div_acb, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Ref{ComplexFieldElem}, Int), z, x, y, precision(Balls))
  return z
end
...
function charpoly(x::AcbPolyRing, y::ComplexMat, prec::Int=precision(Balls))
  ...
  z = x()
  ccall((:acb_mat_charpoly, libflint), Nothing, (Ref{AcbPolyRingElem}, Ref{ComplexMat}, Int), z, y, prec)
  return z
end
...
function det(x::ComplexMat, prec::Int=precision(Balls))
  ...
  z = base_ring(x)()
  ccall((:acb_mat_det, libflint), Nothing, (Ref{ComplexFieldElem}, Ref{ComplexMat}, Int), z, x, prec)
  return z
end
...
function Base.exp(x::ComplexMat)
  ncols(x) != nrows(x) && error("Matrix must be square")
  z = similar(x)
  ccall((:acb_mat_exp, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Int), z, x, precision(Balls))
  return z
end
...
function lu!(P::Generic.Perm, x::ComplexMat)
  P.d .-= 1
  r = ccall((:acb_mat_lu, libflint), Cint, (Ptr{Int}, Ref{ComplexMat}, Ref{ComplexMat}, Int), P.d, x, x, precision(Balls))
...
function _solve!(z::ComplexMat, x::ComplexMat, y::ComplexMat)
  r = ccall((:acb_mat_solve, libflint), Cint, (Ref{ComplexMat}, Ref{ComplexMat}, Ref{ComplexMat}, Int), z, x, y, precision(Balls))
...
function _solve_lu_precomp!(z::ComplexMat, P::Generic.Perm, LU::ComplexMat, y::ComplexMat)
  Q = inv(P)
  ccall((:acb_mat_solve_lu_precomp, libflint), Nothing, (Ref{ComplexMat}, Ptr{Int}, Ref{ComplexMat}, Ref{ComplexMat}, Int), z, Q.d .- 1, LU, y, precision(Balls))
  nothing
end
...
function Solve._can_solve_internal_no_check(A::ComplexMat, b::ComplexMat, task::Symbol; side::Symbol=:left)
  ...
  fl = ccall((:acb_mat_solve, libflint), Cint, (Ref{ComplexMat}, Ref{ComplexMat}, Ref{ComplexMat}, Int), x, A, b, precision(Balls))
...
function Solve._init_reduce(C::Solve.SolveCtx{ComplexFieldElem})
  ...
  P.d .-= 1
  fl = ccall((:acb_mat_lu, libflint), Cint, (Ptr{Int}, Ref{ComplexMat}, Ref{ComplexMat}, Int), P.d, x, A, precision(Balls))
...
function Solve._can_solve_internal_no_check(C::Solve.SolveCtx{ComplexFieldElem}, b::ComplexMat, task::Symbol; side::Symbol=:left)
  ...
  ccall((:acb_mat_solve_lu_precomp, libflint), Nothing, (Ref{ComplexMat}, Ptr{Int}, Ref{ComplexMat}, Ref{ComplexMat}, Int), x, inv(p).d .- 1, LU, b, precision(Balls))
...
function swap_rows!(x::ComplexMat, i::Int, j::Int)
  ccall((:acb_mat_swap_rows, libflint), Nothing, (Ref{ComplexMat}, Ptr{Nothing}, Int, Int), x, C_NULL, i - 1, j - 1)
end
...
function bound_inf_norm(x::ComplexMat)
  ...
  GC.@preserve x z begin
    ...
    ccall((:acb_mat_bound_inf_norm, libflint), Nothing, (Ptr{mag_struct}, Ref{ComplexMat}), t, x)
...
for (s, f) in (("add!", "acb_mat_add"), ("mul!", "acb_mat_mul"), ("sub!", "acb_mat_sub"))
  @eval begin
    function ($(Symbol(s)))(z::ComplexMat, x::ComplexMat, y::ComplexMat, prec::Int=precision(Balls))
      ccall(($f, libflint), Nothing, (Ref{ComplexMat}, Ref{ComplexMat}, Ref{ComplexMat}, Int), z, x, y, prec)
      return z
    end
  end
end
...
(x::ComplexMatSpace)(y::AbstractMatrix{Tuple{T,T}}) where {T<:Integer} = x(map(z -> (ZZRingElem(z[1]), ZZRingElem(z[2])), y))

(x::ComplexMatSpace)(y::AbstractVector{Tuple{T,T}}) where {T<:Integer} = x(map(z -> (ZZRingElem(z[1]), ZZRingElem(z[2])), y))

(x::ComplexMatSpace)(y::AbstractMatrix{Tuple{Rational{T},Rational{T}}}) where {T<:Integer} = x(map(z -> (QQFieldElem(z[1]), QQFieldElem(z[2])), y))

(x::ComplexMatSpace)(y::AbstractVector{Tuple{Rational{T},Rational{T}}}) where {T<:Integer} = x(map(z -> (QQFieldElem(z[1]), QQFieldElem(z[2])), y))
...
function __approx_eig_qr!(v::Ptr{acb_struct}, R::ComplexMat, A::ComplexMat)
  n = nrows(A)
  ccall((:acb_mat_approx_eig_qr, libflint), Cint, (Ptr{acb_struct}, Ptr{Nothing}, Ref{ComplexMat}, Ref{ComplexMat}, Ptr{Nothing}, Int, Int), v, C_NULL, R, A, C_NULL, 0, precision(Balls))
  return nothing
end
...
function _eig_multiple(A::ComplexMat, check::Bool=true)
  ...
  __approx_eig_qr!(v, R, A)
  b = ccall((:acb_mat_eig_multiple, libflint), Cint, (Ptr{acb_struct}, Ref{ComplexMat}, Ptr{acb_struct}, Ref{ComplexMat}, Int), v_approx, A, v, R, precision(Balls))
...
function _eig_simple(A::ComplexMat; check::Bool=true, algorithm::Symbol=:default)
  ...
  if algorithm == :vdhoeven_mourrain
    b = ccall(
      ...
      Cint,
      (Ptr{acb_struct}, Ref{ComplexMat}, Ref{ComplexMat}, Ref{ComplexMat}, Ptr{acb_struct}, Ref{ComplexMat}, Int),
      v_approx,
      L,
      R,
      A,

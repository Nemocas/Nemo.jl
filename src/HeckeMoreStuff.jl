...
function mul!(z::AcbFieldElem, x::AcbFieldElem, y::ArbFieldElem)
  ccall((:acb_mul_arb, libflint), Nothing, (Ref{AcbFieldElem}, Ref{AcbFieldElem}, Ref{ArbFieldElem}, Int), z, x, y, parent(z).prec)
  return z
end
...
function roots(f::ZZModPolyRingElem, fac::Fac{ZZRingElem})
  ...
  for i in 1:(res.num)
    g = parent(f)()
    ccall((:fmpz_mod_poly_factor_get_fmpz_mod_poly, libflint), Nothing, (Ref{ZZModPolyRingElem}, Ref{fmpz_mod_poly_factor}, Int, Ref{fmpz_mod_ctx_struct}), g, res, i - 1, base_ring(f).ninv)
...
function one!(a::QQMPolyRingElem)
  ccall((:fmpq_mpoly_one, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRing}), a, parent(a))
  return a
end
...
function Base.:(^)(a::AbsSimpleNumFieldElem, e::UInt)
  b = parent(a)()
  ccall((:nf_elem_pow, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, UInt, Ref{AbsSimpleNumField}), b, a, e, parent(a))
  return b
end
...
function mod!(a::AbsSimpleNumFieldElem, b::ZZRingElem)
  ccall((:nf_elem_mod_fmpz, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), a, a, b, parent(a))
  return a
end
...
function numerator(a::AbsSimpleNumFieldElem)
  _one = one(ZZ)
  z = deepcopy(a)
  ccall((:nf_elem_set_den, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), z, _one, a.parent)
  return z
end
...
function divexact!(z::AbsSimpleNumFieldElem, x::AbsSimpleNumFieldElem, y::ZZRingElem)
  ccall((:nf_elem_scalar_div_fmpz, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), z, x, y, parent(x))
  return z
end

function sub!(a::AbsSimpleNumFieldElem, b::AbsSimpleNumFieldElem, c::AbsSimpleNumFieldElem)
  ccall((:nf_elem_sub, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}), a, b, c, a.parent)
end
...
function evaluate(f::fpPolyRingElem, v::Vector{fpFieldElem})
  ...
  ccall((:nmod_poly_evaluate_nmod_vec, libflint), Nothing, (Ptr{UInt}, Ref{fpPolyRingElem}, Ptr{UInt}, UInt), res, f, v1, UInt(length(v)))
...
function divexact!(a::ZZRingElem, b::ZZRingElem)
  ccall((:fmpz_divexact, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}), a, a, b)
  return a
end
...
function setcoeff!(z::ZZPolyRingElem, n::Int, x::Ptr{ZZRingElem})
  ccall((:fmpz_poly_set_coeff_fmpz, libflint), Nothing, (Ref{ZZPolyRingElem}, Int, Ptr{ZZRingElem}), z, n, x)
  return z
end
...
function elem_to_mat_row!(M::MatElem, i::Int, a::ResElem{T}) where {T<:PolyRingElem}
  z = zero(parent(M[1, 1]))
  for j in 0:degree(a.data)
    M[i, j + 1] = coeff(a.data, j)
  end
  for j in (degree(a.data) + 2):ncols(M)
    M[i, j] = z
  end
end
...
function set!(z::fqPolyRepFieldElem, x::fqPolyRepFieldElem)
  ccall((:fq_nmod_set, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Ref{fqPolyRepFieldElem}, Ref{fqPolyRepField}), z, x, parent(z))
end
...
function mul!(res::QQMPolyRingElem, a::QQMPolyRingElem, c::ZZRingElem)
  ccall((:fmpq_mpoly_scalar_mul_fmpz, libflint), Nothing, (Ref{QQMPolyRingElem}, Ref{QQMPolyRingElem}, Ref{ZZRingElem}, Ref{QQMPolyRing}), res, a, c, parent(a))
  return nothing
end
...
function mul!(z::fpFieldElem, x::fpFieldElem, y::ZZRingElem)
  ...
  r = ccall((:n_mulmod2_preinv, libflint), UInt, (UInt, UInt, UInt, UInt), x.data, d, R.n, R.ninv)
  z.data = r
  return z
end
...
function mul!(z::FpFieldElem, x::FpFieldElem, y::ZZRingElem)
  R = parent(x)
  ccall((:fmpz_mod, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}), z.data, y, R.n)

  ccall((:fmpz_mod_mul, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{fmpz_mod_ctx_struct}), z.data, x.data, z.data, R.ninv)
  return z
end

function rem!(z::fpPolyRingElem, a::fpPolyRingElem, b::fpPolyRingElem)
  ccall((:nmod_poly_rem, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{fpPolyRingElem}, Ref{fpPolyRingElem}, Ptr{Nothing}), z, a, b, pointer_from_objref(base_ring(z)) + sizeof(ZZRingElem))
  return z
end
...
function setcoeff!(x::fqPolyRepFieldElem, n::Int, u::UInt)
  ccall((:nmod_poly_set_coeff_ui, libflint), Nothing, (Ref{fqPolyRepFieldElem}, Int, UInt), x, n, u)
end
...
function (Rx::Generic.PolyRing{PadicFieldElem})(a::QadicFieldElem)
  ...
  for i in 1:length(coeffs)
    c = R()
    ccall((:padic_poly_get_coeff_padic, libflint), Nothing, (Ref{PadicFieldElem}, Ref{QadicFieldElem}, Int, Ref{QadicField}), c, a, i - 1, parent(a))
    coeffs[i] = c
  end
  return Rx(coeffs)
end
...
function coeff(x::QadicFieldElem, i::Int)
  ...
  c = R()
  ccall((:padic_poly_get_coeff_padic, libflint), Nothing, (Ref{PadicFieldElem}, Ref{QadicFieldElem}, Int, Ref{QadicField}), c, x, i, parent(x))
  return c
end

function setcoeff!(x::QadicFieldElem, i::Int, y::PadicFieldElem)
  ccall((:padic_poly_set_coeff_padic, libflint), Nothing, (Ref{QadicFieldElem}, Int, Ref{PadicFieldElem}, Ref{QadicField}), x, i, y, parent(x))
end
...
function mod_sym!(a::AbsSimpleNumFieldElem, b::ZZRingElem)
  ccall((:nf_elem_smod_fmpz, libflint), Nothing, (Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumFieldElem}, Ref{ZZRingElem}, Ref{AbsSimpleNumField}), a, a, b, parent(a))
  return a
end
...
function nf_elem_to_fmpz_mod_poly!(r::ZZModPolyRingElem, a::AbsSimpleNumFieldElem, useden::Bool=true)
  ccall(
    (:nf_elem_get_fmpz_mod_poly_den, libflint),
    Nothing,
...
function nf_elem_to_gfp_poly!(r::fpPolyRingElem, a::AbsSimpleNumFieldElem, useden::Bool=true)
  ccall((:nf_elem_get_nmod_poly_den, libflint), Nothing, (Ref{fpPolyRingElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}, Cint), r, a, a.parent, Cint(useden))
  return nothing
end
...
function nf_elem_to_nmod_poly!(r::zzModPolyRingElem, a::AbsSimpleNumFieldElem, useden::Bool=true)
  ccall((:nf_elem_get_nmod_poly_den, libflint), Nothing, (Ref{zzModPolyRingElem}, Ref{AbsSimpleNumFieldElem}, Ref{AbsSimpleNumField}, Cint), r, a, a.parent, Cint(useden))
  return nothing
end

...
function sqr!(z::ZZiRingElem, a::ZZiRingElem, t::ZZiRingElem)
  ...
  if 5 < nx < 2 * ny && 5 < ny < 2 * nx
    ...
    mul!(z.y, a.x, a.y)
    sub!(z.x, t.x, t.y)
    ccall((:fmpz_mul_2exp, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, UInt), z.y, z.y, 1)
  end
  return z
end
...
function smod(a::ZZRingElem, b::ZZRingElem)
  z = ZZRingElem()
  ccall((:fmpz_smod, libflint), Nothing, (Ref{ZZRingElem}, Ref{ZZRingElem}, Ref{ZZRingElem}), z, a, b)
  return z
end

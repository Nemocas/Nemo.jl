...
@testset "CalciumFieldElem.functions" begin
  ...
  @test string(complex_normal_form(sin(C(1); form=:direct)) + C(1im)) == "0.841471 + 1.00000*I {(-a^2*b+2*a*b+b)/(2*a) where a = 0.540302 + 0.841471*I [Exp(1.00000*I {b})], b = I [b^2+1=0]}"
end
...
@testset "CalciumFieldElem.rand" begin
  ...
  @test_throws DomainError [rand(C; depth=1, bits=1, randtype=:special) for i in 1:100]

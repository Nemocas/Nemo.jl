@testset "AnticNumberFieldElem.constructors" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")

   @test elem_type(K) == AnticNumberFieldElem
   @test elem_type(AnticNumberField) == AnticNumberFieldElem
   @test parent_type(AnticNumberFieldElem) == AnticNumberField
   ...
   @test isa(a, AnticNumberFieldElem)

   b = K(a)

   @test isa(b, AnticNumberFieldElem)

   c = K(ZZRingElem(12))

   @test isa(c, AnticNumberFieldElem)

   d = K()

   @test isa(d, AnticNumberFieldElem)

   f = K(QQFieldElem(2, 3))

   @test isa(f, AnticNumberFieldElem)

   h = K(1//2)

   @test isa(h, AnticNumberFieldElem)

   g = K(x^2 + 2x - 7)

   @test isa(g, AnticNumberFieldElem)
end

@testset "AnticNumberFieldElem.rand" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.printing" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
   g = K(x^2 + 2x - 7)
...
@testset "AnticNumberFieldElem.fmpz_mat_conversions" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.fmpq_poly_conversion" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.denominator" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.conversions" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.manipulation" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.unary_ops" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.binary_ops" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.adhoc_binary" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.powering" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.comparison" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.adhoc_comparison" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.inversion" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.exact_division" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.adhoc_exact_division" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.divides" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.norm_trace" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.representation_matrix" begin
  R, x = polynomial_ring(QQ, "x")
  K, a = number_field(x^3 + 3x + 1, "a")
...
@testset "AnticNumberFieldElem.Polynomials" begin
   R, x = polynomial_ring(QQ, "x")
   K, a = number_field(x^3 + 3x + 1, "a")

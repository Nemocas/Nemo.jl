RR = RealField()
coeff_types = [Int8, Int, UInt, BigInt, Float32, Float64, BigFloat, Rational{Int8}, Rational{Int}, Rational{BigInt}, ZZRingElem, QQFieldElem]
...
@testset "RealPoly.evaluation_interpolation" begin
  ...
  n = 5
  xs = RealFieldElem[inv(RR(i)) for i in 1:n]
  ys = RealFieldElem[RR(i) for i in 1:n]
